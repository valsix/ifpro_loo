...
class CI_DB_oci8_driver extends CI_DB {
	...
	{
		/*
		$username = "(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=siuk2-3.pelindo.co.id)(PORT=1528)))(CONNECT_DATA=(SERVICE_NAME=intranet)))";
		$enkripsi = $this->mencrypt($username);
		echo $enkripsi;
		echo "<br>";
		echo $this->mdecrypt($enkripsi);
		exit;
		*/
		return @oci_pconnect($this->mdecrypt($this->username), $this->mdecrypt($this->password), $this->mdecrypt($this->hostname), $this->char_set);
	}
