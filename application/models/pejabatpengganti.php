...
class PejabatPengganti extends Entity{ 
	...
	**/ 
	...
	{
		$str = "SELECT PEJABAT_PENGGANTI_ID, SATUAN_KERJA_ID, SATUAN_KERJA, CABANG_ID, PEGAWAI_ID, NAMA, PEGAWAI_ID_PENGGANTI, 
	...
	function selectByParamsSatuanKerja($paramsArray=array(), $limit=-1, $from=-1, $statement="", $order=" ORDER BY A.PEJABAT_PENGGANTI_ID ASC")
	{
		$str = "
		SELECT 
			A.PEJABAT_PENGGANTI_ID, A.SATUAN_KERJA_ID, A.SATUAN_KERJA, A.CABANG_ID, A.PEGAWAI_ID, A.NAMA, A.PEGAWAI_ID_PENGGANTI
			, A.NAMA_PENGGANTI, A.TANGGAL_MULAI, A.TANGGAL_SELESAI, A.LAST_CREATE_USER
			, A.LAST_CREATE_DATE, A.LAST_UPDATE_USER, A.LAST_UPDATE_DATE
			, A.AN_TAMBAHAN, A.STATUS_AKTIF, SK.SK_CABANG_ID
		FROM PEJABAT_PENGGANTI A
