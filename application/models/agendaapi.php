  ...
  class Agenda extends Entity{ 
    ...
    **/
	...
	function insert()
	{
		...
		$this->setField("AGENDA_ID", $this->getNextId("AGENDA_ID","AGENDA_API")); 		

		$str = "
				INSERT INTO AGENDA_API (
    ...
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1, $statement="")
	{
		$str = "
					SELECT 
						   ...
						   A.FILE_UPLOAD, CASE WHEN A.STATUS = 1 THEN 'Aktif' ELSE 'Non-aktif' END STATUS, A.STATUS STATUS_AKTIF
					FROM AGENDA_API A WHERE AGENDA_ID IS NOT NULL
				"; 
    ...
    **/ 
	...
	{
		$str = "SELECT COUNT(AGENDA_ID) AS ROWCOUNT FROM AGENDA_API A
