  ...
  class TrLoo extends Entity{ 
    ...
    **/ 
	...
	function selectlampirandua($paramsArray=array(),$limit=-1,$from=-1,$statement="", $order=" ")
	{
		$str = "
		SELECT
		ANGSURAN_SISA_DIKURANG_DP / TOP ANSURAN_SEWA_BULANAN
	...
	function selectperhitungantabel($paramsArray=array(),$limit=-1,$from=-1,$statement="", $order=" ")
	{
		...
		(
			...
			UNION ALL
			SELECT
			R.BULAN + 1 BULAN, R.TR_LOO_ID, R.ANGSURAN_SISA_DIKURANG_DP, R.MASA_KERJA_SAMA, R.BAYAR_SC_BULANAN, R.ANSURAN_SEWA_BULANAN
			, 'Angsuran ' || (R.BULAN + 1)::TEXT NAMA_ANGSURAN, R.BULAN + 1 VBULAN
			, R.ANSURAN_SEWA_BULANAN SEWA_INC_PPN, COALESCE(R.TOTAL_SEWA,0) - COALESCE(R.SEWA_INC_PPN,0) TOTAL_SEWA
