  ...
  class DaftarAlamat extends Entity{ 
	...
	function insert()
	{
		...
		$str = "
				INSERT INTO DAFTAR_ALAMAT (DAFTAR_ALAMAT_ID, DAFTAR_ALAMAT_GROUP_ID, INSTANSI, ALAMAT, KOTA, NO_TELP, EMAIL, STATUS, 
						KODE_POS, FAX, NAMA_KEPALA, HP, LAST_CREATE_USER, LAST_CREATE_DATE) 
				VALUES(
    ...
    **/ 
    function selectByParams($paramsArray=array(),$limit=-1,$from=-1,$statement="", $order="")
	{
		$str = "
				SELECT 
				DAFTAR_ALAMAT_ID, DAFTAR_ALAMAT_GROUP_ID, INSTANSI, ALAMAT, KOTA, NO_TELP, EMAIL, STATUS, KODE_POS, FAX, NAMA_KEPALA, HP
				FROM DAFTAR_ALAMAT		
				WHERE 1 = 1
			"; 
	...
	function selectByParamsMonitoring($paramsArray=array(),$limit=-1,$from=-1,$statement="", $order="")
	{
		$str = "
				SELECT 
				DAFTAR_ALAMAT_ID, A.DAFTAR_ALAMAT_GROUP_ID, COALESCE(B.NAMA, 'Belum ada Group') DAFTAR_ALAMAT_GROUP, INSTANSI, ALAMAT, KOTA, NO_TELP, EMAIL, STATUS, KODE_POS, FAX, NAMA_KEPALA, HP
	...
	function selectByParamsLike($paramsArray=array(),$limit=-1,$from=-1, $statement="")
	{
		$str = "
				SELECT 
				DAFTAR_ALAMAT_ID, INSTANSI, ALAMAT, KOTA, NO_TELP, EMAIL, STATUS, KODE_POS, FAX, NAMA_KEPALA, HP
				FROM DAFTAR_ALAMAT		
				WHERE 1 = 1
				"; 
		while(list($key,$val) = each($paramsArray))
