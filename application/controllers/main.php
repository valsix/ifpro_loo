...
class Main extends CI_Controller {
	...
	function __construct() {
		...
		$this->SATKER_ID_NOT_PENGGANTI	= $this->kauth->getInstance()->getIdentity()->SATKER_ID_NOT_PENGGANTI;
		$this->SATKER_JABATAN_NOT_PENGGANTI	= $this->kauth->getInstance()->getIdentity()->SATKER_JABATAN_NOT_PENGGANTI;

		$this->AN_TAMBAHAN	= $this->kauth->getInstance()->getIdentity()->AN_TAMBAHAN;
		$this->SATKER_ID_PENGGANTI	= $this->kauth->getInstance()->getIdentity()->SATKER_ID_PENGGANTI;
		$this->SATKER_JABATAN_PENGGANTI	= $this->kauth->getInstance()->getIdentity()->SATKER_JABATAN_PENGGANTI;
		...
		$this->MULTIJABATAN= $this->kauth->getInstance()->getIdentity()->MULTIJABATAN;
