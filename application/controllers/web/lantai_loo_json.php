...
class lantai_loo_json extends CI_Controller
{
	...
	function json()
	{
		...
		$aColumns		= array("LANTAI_LOO_ID", "KODE", "NAMA", "DESKRIPSI");
		...
		if (isset($_GET['iSortCol_0'])) {
			...
			if (trim($sOrder) == "ORDER BY LANTAI_LOO_ID asc") {
				/*
	...
	function add()
	{
		...
		$set->setField("LANTAI_LOO_ID", $reqId);
