...
class user_group_json extends CI_Controller {
	...
	function json() 
	{
		...
		$user_login = new UserGroupNew();

		$reqCabangId = $this->input->get("reqCabangId");
		// echo $reqKategori;exit;
		
		$aColumns		= array("USER_GROUP_ID","KODE","NAMA","KETERANGAN","USER_GROUP_ID");
		$aColumnsAlias	= array("USER_GROUP_ID","KODE","NAMA","KETERANGAN","USER_GROUP_ID");
