...
class permohonan_stpd_json extends CI_Controller
{
	...
	function add()
	{
		...
		// khusus status draft atau revisi
		if($reqStatusSurat == "DRAFT" || $reqStatusSurat == "REVISI" || ($reqStatusSurat == "KIRIM" && empty($vinfoid)) || ($reqStatusSurat == "KIRIM" && $reqSebelumStatusSurat == "REVISI") )
		{
