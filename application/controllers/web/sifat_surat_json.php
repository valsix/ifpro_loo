...
class sifat_surat_json extends CI_Controller {
	...
	function json() 
	{
		...
		$aColumnsAlias	= array("SIFAT_SURAT_ID","KODE","NAMA","KETERANGAN");
		...
		if ( isset( $_GET['iSortCol_0'] ) )
		{
			...
			if ( trim($sOrder) == "ORDER BY SIFAT_SURAT_ID asc" )
			{
				/*
	...
	function add() 
	{
		...
		$sifat_surat->setField("SIFAT_SURAT_ID", $reqId);
	...
	function combo() 
	{
		...
		$sifat_surat->selectByParams(array("NOT SIFAT_SURAT_ID" => "0"));
		$i = 0;
		while($sifat_surat->nextRow())
		{
