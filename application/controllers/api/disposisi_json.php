...
class disposisi_json extends REST_Controller {
    ...
    function index_post() {
		...
		{
			$this->response(array('status' => 'success', 'code' => 200, 'message' => "X-Isi terlebih dahulu tujuan disposisi."));
			return;
		}
		if($reqBalasCepat == "")
		{
			$this->response(array('status' => 'success', 'code' => 200, 'message' => "X-Isi terlebih dahulu pesan disposisi."));
			return;
		}
