...
// echo $reqPemesanSatuanKerjaIsi; exit;
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div id="toolbar-container" style="width:99.5%"></div>
                                    <div id="reqPemesanSatuanKerjaIsi"  name="reqPemesanSatuanKerjaIsi">
                                        <p  style="border-top:solid black 1px;"><?=$reqPemesanSatuanKerjaIsi?></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
...
<script>
      ...
      DecoupledEditor
            .create( document.querySelector( '#reqPemesanSatuanKerjaIsi' ) )
            .then( editor => {
