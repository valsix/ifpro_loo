                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <textarea id="reqKeterangan" class="tox-target editorsummernote" name="reqKeterangan" style="margin-top: 30px;"><?=$reqKeterangan?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
...
<script>
    ...
    function setinfovalidasi()
    {
        ...
        reqKeterangan= $("#reqKeterangan").summernote('code');
    ...
    function setsimpan()
    {
        ...
        /*vthis= $('#ff');
        if (vthis.form('enableValidation').form('validate') == false) {
            if ($("#button i").attr("class") == "fa fa-gears")
            {
                $("#button").click();
            }
        ...
        if(vthis.form('enableValidation').form('validate'))
        {
            // var win = $.messager.progress({title:'Proses simpan data', msg:'Proses simpan data...'});
        }

        var formData = new FormData(document.querySelector('#ff'));
