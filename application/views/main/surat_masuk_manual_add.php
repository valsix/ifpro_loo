        ...
        <table class="table">
        	<tr>
                ...
                <td>
                    ...
                    <!-- <input type="text" id="reqSatuanKerjaId" class="easyui-validatebox textbox" name="reqSatuanKerjaId" value="<?=$this->SATUAN_KERJA_ID_ASAL?>" /> -->
...
<script>
    ...
    function submitForm(reqStatusSurat) {
        ...
        if(reqPerihal == "" || reqDariInfo == "" || reqNomorSuratInfo == "" || reqSatuanKerjaIdTujuan == "")
        {
            reqvalidasibaru= "";
