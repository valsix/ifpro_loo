...
$arrdata= array(
    ...
    , array("label"=>"TANGGAPAN KE", "width"=>"")
);
?>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "web/surat_masuk_json/jsonsuratkeluartanggapan?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun=<?=$reqTahun?>",
            ...
            $("#example tbody").click(function(event) {
				...
				if(anSelectedId !== "")
                window.location = ("<?= base_url() ?>main/index/kotak_masuk_disposisi_detil/?reqMode=kotak_keluar_tanggapan&reqId="+anSelectedId+"&reqRowId="+anSelectedRowId);
            });
            ...
            $('#btnCari').on('click', function () {
                ...
                oTable.fnReloadAjax("web/surat_masuk_json/jsonsuratkeluartanggapan?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian);
            });
            ...
            $('#btnCetak').on('click', function () {
                ...
                newWindow = window.open("<?= base_url() ?>app/loadUrl/main/kotak_keluar_tanggapan_export/?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian, 'Cetak');
                newWindow.focus();
            });
