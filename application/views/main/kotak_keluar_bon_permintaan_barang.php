	...
	<script type="text/javascript" charset="utf-8">
		...
		$(document).ready(function() {
			...
			oTable = $('#example').dataTable({
				...
				"bProcessing": true,
				"bServerSide": true,
				"sAjaxSource": "web/surat_masuk_json/jsonsuratkeluar?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun=<?=$reqTahun?>",
			...
			$("#example tbody").click(function(event) {
				...
				if(anSelectedId !== "")
				window.location = ("<?= base_url() ?>main/index/kotak_masuk_detil/?reqMode=kotak_keluar_nota_dinas&reqId=" + anSelectedId+"&reqPilihan="+reqPilihan);
			});

			$("#reqTahun,#reqPilihan").change(function() {
				setCariInfo();
			});
			...
			$('#btnCari').on('click', function () {
				...
				oTable.fnReloadAjax("web/surat_masuk_json/jsonsuratkeluar?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPilihan="+reqPilihan+"&reqPencarian="+reqPencarian);
			});
			...
			$('#btnCetak').on('click', function () {
				...
				newWindow = window.open("<?= base_url() ?>app/loadUrl/main/kotak_keluar_export/?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPilihan="+reqPilihan+"&reqPencarian="+reqPencarian, 'Cetak');
				newWindow.focus();
			});
        ...
        /*$(function(){
			$("#reqPilihan").on('change', function(){
				reqPilihan= $("#reqPilihan").val();
				reqTahun= $("#reqTahun").val();
			   	oTable.fnReloadAjax("web/surat_masuk_json/jsonsuratkeluar?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPilihan="+reqPilihan);
			})
		});*/
	</script>
	...
	<div id="wadah">
		...
		<div id="bluemenu" class="bluetabs">
        	<ul>
            	...
            	{
            	?>
            		<input type="hidden" id="reqPilihan" value="" />
            	<?
            	}
                ?>
                <li class="pull-right">
