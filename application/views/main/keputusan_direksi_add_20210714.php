                           ...
                           <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    BAB I <span class="text-danger">*</span>
                                </td>
                                <td>:</td>
                                <td>
...
<script>
    ...
    function submitForm(reqStatusSurat) {
        ...
        if(((reqPerihal=="" || reqSatuanKerjaId=="" || reqKlasifikasiId=="") && reqStatusSurat=='DRAFT') || (reqPerihal=="" || reqSatuanKerjaId=="" || reqSatuanKerjaIdTujuan=="" || reqKlasifikasiId=="") && reqStatusSurat=='UBAHDATADRAFTPARAF')
        {
            reqvalidasibaru= "";
...
<script type="text/javascript">
    ...
    var arrnomorpasal= ["BAB II", "BAB III", "BAB IV", "BAB V", "BAB VI", "BAB VII", "BAB VIII", "BAB IX", "BAB X", "BAB XI", "BAB XII", "BAB XIII", "BAB XIV", "BAB XV", "BAB XVI", "BAB XVII", "BAB XVIII", "BAB XIX", "BAB XX", "BAB XXI", "BAB XXII", "BAB XXIII", "BAB XXIV", "BAB XXV"];
    ...
    function tambahpasal()
    {
        ...
        $.get("app/loadUrl/main/keputusan_direksi_add_pasal?reqId=<?=$reqId?>&nomorpasal="+nomorpasal, function (data) {
            // console.log(data);
