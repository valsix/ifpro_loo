...
$reqFilename= "realisasi permohonan revisi";
...
<script type="text/javascript">
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json/permohonan_stpd_json/json?reqStatusSurat=<?=$reqStatusSurat?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian+"&reqStatusSurat="+reqStatusSurat+"&reqPilihan="+reqPilihan;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json/permohonan_stpd_json/json?reqStatusSurat=<?=$reqStatusSurat?>";
