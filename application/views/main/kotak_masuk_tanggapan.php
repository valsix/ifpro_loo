...
$arrdata= array(
    ...
    , array("label"=>"TANGGAPAN DARI", "width"=>"")
);
?>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "web/surat_masuk_json/jsonsurattanggapan?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun=<?=$reqTahun?>",
            ...
            $("#example tbody").click(function(event) {
                ...
                window.location = ("<?= base_url() ?>main/index/kotak_masuk_disposisi_detil/?reqMode=kotak_masuk_tanggapan&reqId="+anSelectedId+"&reqRowId="+anSelectedRowId);
            });
            ...
            $('#btnCari').on('click', function () {
                ...
                oTable.fnReloadAjax("web/surat_masuk_json/jsonsurattanggapan?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian);
            });
            ...
            $('#btnCetak').on('click', function () {
                ...
                newWindow = window.open("<?= base_url() ?>app/loadUrl/main/kotak_masuk_tanggapan_export/?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian, 'Cetak');
                newWindow.focus();
            });
