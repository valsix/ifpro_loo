...
// echo $tembusan_kepada;exit;
// echo $reqTembusanKelompok;exit;
?>
...
<div class="col-lg-12 col-konten-full">
    <div class="judul-halaman bg-course">
        ...
        <div class="btn-atas clearfix">
            <button class="btn btn-primary btn-sm pull-right" type="button" onClick="cetak('surat_keluar')"><i class="fa fa-print"></i> Cetak</button>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            // print_r($suratmasukinfo->EKSTERNAL_KEPADA); exit;
                            // foreach ($arrKepada as $key => $value) {
                            ...
                            <ol class="list-unstyled">
                                ...
                                {
                                ?>
                                <li><?=strtoupper($itemKepada)?></li>
                                <?
                                }
                                else
                                {
                                ?>
                                <li><?=$no?>.&nbsp;<?=strtoupper($itemKepada)?></li>
                                <?
                                }
                                ?>
                            </ol>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            // print_r($arrayAllTembusan);exit;
                            // foreach ($arrTembusan as $key => $value) {
                            foreach ($arrayAllTembusan as $itemTembusan) {
                            ?>
                            <ol class="list-unstyled">
                                <?if (count($arrayAllTembusan) == 1)
                                {
                                ?>
                                <li>xx<?=strtoupper($itemTembusan)?></li>
                                 <?
                                }
                                else
                                {
                                ?>
                                <li><?=$no?>.&nbsp;<?=strtoupper($itemTembusan)?></li>
                                <?
                                }
                                ?>
