                                ...
                                <td>
                                    <span style="display: <?=$infodisplay?>;">
                                        ...
                                        , onSelect: function(node){
                                            clickNodes($('#reqEksternalKepadaInfo'), node.id, 'reqEksternalKepadaId', 'infodetilkepadaeksternal', 'select');
                                        }
                                        , onUnselect: function(node){
                                            clickNodes($('#reqEksternalKepadaInfo'), node.id, 'reqEksternalKepadaId', 'infodetilkepadaeksternal', 'unselect');
                                        }
                                        , width:'500'
                                        , panelHeight:'120'
                                        , valueField:'id'
...
<script type="text/javascript">
    ...
    function clickNodes(cc, id, valinfo, infolabel, select)
    {
        var infoid= [];
        infoid= String($("#"+valinfo).val()).split(",");
        var elementRow= infoid.indexOf(id);
        ...
        if (select=='select')
        {
            if(infoid[0] == "")
                ...
                infoid.push(String(id));
        }
        cc.combobox('setValues', infoid);

        var values= cc.combobox('getValues');
        // console.log(values);return false;
        $("#"+valinfo).val(values);

        // var textdata= cc.combobox('getText');
        // // console.log(textdata);return false;
        // infotextdata= textdata.split(",");
