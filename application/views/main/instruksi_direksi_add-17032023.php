...
<script>
    new FroalaEditor('#reqMenimbang,#reqMengingat,#reqMenetapkan,#reqPertama,.froalaeditor', {
        events: {
            'keyup': function (keyupEvent) {
              // Do something here.
              // this is the editor instance.
              setinfovalidasi('darifroala');
            },
            'html.set': function () {
              // Do something here.
              // this is the editor instance.
    ...
    const editorInstance = new FroalaEditor('#reqMenimbang,#reqMengingat,#reqPertama,.froalaeditor', {
