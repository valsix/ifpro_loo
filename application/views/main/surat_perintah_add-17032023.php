...
<script>
    ...
    function setinfovalidasi(mode)
    {
        ...
        if (mode=='darifroala') 
        {
            reqDasar= jQuery($('#reqDasar').val()).text();
            reqIsiPerintah= jQuery($('#reqIsiPerintah').val()).text();
...
<script>
    ...
    new FroalaEditor('#reqDasar,#reqIsiPerintah,#reqLainLain', {
        events: {
    ...
    const editorInstance = new FroalaEditor('#reqDasar,#reqIsiPerintah,#reqLainLain', {
