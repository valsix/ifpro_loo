                ...
                <table class="table">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="text" id="reqKodeParent" class="easyui-validatebox textbox form-control" required name="reqKodeParent" value="<?=$reqKodeParent?>" data-options="required:true" style="width:100%" readonly/>
                            </td>
                        </tr>
                        <?
                        }
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="text" id="reqKode" class="easyui-validatebox textbox form-control" required name="reqKode" value="<?=$reqKode?>" data-options="required:true" style="width:100%" />
                            </td>
                        </tr>
                        <tr>           
                            <td>Keterangan</td>
