...
if ($reqId == "") {
    ...
    $reqJenisNaskahNama= "Surat Keputusan Direksi";
    $reqJenisTTD = "QRCODE";
...
<div class="col-lg-12 col-konten-full">
    ...
    <div class="judul-halaman bg-course">
        <span><img src="images/icon-course.png"></span> Surat Keputusan Direksi
...
<script type="text/javascript">
    ...
    function tambahpasal()
    {
        ...
        $.get("app/loadUrl/main/surat_keputusan_direksi_add_pasal?reqId=<?=$reqId?>&nomorpasal="+nomorpasal, function (data) {
            // console.log(data);
    ...
    function setagenda()
    {
        document.location.href = 'main/index/surat_keputusan_direksi_lihat?reqMode=surat_keputusan_direksi_add&reqId=<?=$reqId?>';
    }
</script>
...
<script>
    ...
    const editorInstance = new FroalaEditor('#reqMenimbang,#reqMengingat,#reqMenetapkan,#reqPertama,.froalaeditor', {
