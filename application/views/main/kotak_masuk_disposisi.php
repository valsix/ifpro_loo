...
<script type="text/javascript">
    ...
    $('#btnCetak').on('click', function () {
        ...
        newWindow = window.open("app/loadUrl/main/kotak_masuk_disposisi_export/?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian, 'Cetak');
        newWindow.focus();
    });
    ...
    $('#btnCari').on('click', function () {
        ...
        jsonurl= "json/surat_masuk_json/jsonsuratdisposisi?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian;
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json/surat_masuk_json/jsonsuratdisposisi?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun=<?=$reqTahun?>";
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                if(valinfoid !== "")
                {
                    ...
                    window.location = "main/index/kotak_masuk_disposisi_detil/?reqMode=kotak_masuk_disposisi&reqId="+valinfoid+"&reqRowId="+valinforowid;
                }
            }
        } );
