...
$(document).ready(function() {
   ...
   $('#test').click(function() {
      jQuery.ajax({ 
        type:'post',
        url: 'web/pegawai_json/combo/?reqMode=user_login',
        data:[],
        dataType:'json',
...
<body class="body-popup">
    ...
    <div class="container-fluid container-treegrid">
        ...
        <div class="row row-treegrid">
            <div class="col-md-12 col-treegrid">
                ...
                <li class="nav-item">
                <a class="nav-link" href="app/loadUrl/main/pegawai_pengganti_lookup?&reqValReload=1" role="tab" id="disposisi" aria-expanded="false" aria-disabled="false">
                  Disposisi Masuk
                </a>
                </li>
                </ul>
                <div id="tableContainer" class="tableContainer tableContainer-treegrid">
                    <table id="treeSatker" class="easyui-treegrid" style="min-width:100px !important;height:300px"
                            data-options="
                                url: 'web/referensi_lookup_json/combo/?reqMode=user_login',
                                pagination: true,            
                                pageSize: 50,
                                pageList: [50, 100],
                                method: 'get',
                        ...
                        <thead>
                            <tr>
                                <th data-options="field:'NOMOR',width:300"></th>
                                <!-- <th data-options="field:'NAMA',width:300">Dari</th>
                                <th data-options="field:'PERIHAL',width:100">Perihal</th>
                                <th data-options="field:'TANGGAL_ENTRI',width:300">Jabatan</th> -->
                            </tr>
                        </thead>
                    </table>
                </div>
 ...
 $(document).ready( function () {
        $('input[name=reqPencarian]').keyup(function() {
            ...
            var urlApp = 'web/pegawai_json/combo/?reqMode=user_login&reqPencarian='+ value;
            $('#treeSatker').treegrid(
            {
                url: urlApp
            }); 
        ...
        $('#treeSatker').treegrid({
              onDblClickRow: function(param){
                 ...
                 top.tambahPegawaiPengganti(param.id, param.text);
