...
if ($reqId == "") {
    ...
    $reqJenisNaskahNama= "Surat Edaran";
    $reqJenisTTD = "QRCODE";
...
<div class="col-lg-12 col-konten-full">
    ...
    <div class="judul-halaman bg-course">
        <span><img src="images/icon-course.png"></span> Surat Edaran
...
<script>
    ...
    function setinfovalidasi(mode)
    {
        ...
        if (mode=='darifroala') 
        {
            reqKeterangan= jQuery($('#reqKeterangan').val()).text();
    ...
    function submitForm(reqStatusSurat) {
        ...
        if((reqKeterangan=="Powered by Froala Editor" || reqKeterangan=="") && reqvalidasibaru == "1")
        {
            reqvalidasibaru= "";
    ...
    function setsimpan()
    {
        $('#ff').form('submit', {
            ...
            success: function(data) {
                ...
                {
                    $.messager.alertLink('Info', arrData[1], 'info', "app/loadUrl/main/surat_edaran_add?reqMode=<?=$reqLinkMode?>&reqId=<?=$reqId?>");
                }
...
<script type="text/javascript">
    ...
    function setagenda()
    {
        document.location.href = 'main/index/surat_edaran_lihat?reqMode=surat_edaran_add&reqId=<?=$reqId?>';
    }
</script>
...
<script>
    ...
    new FroalaEditor('#reqKeterangan', {
        events: {
