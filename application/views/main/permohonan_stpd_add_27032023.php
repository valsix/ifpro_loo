...
$statement="   ";
$kelompok->selectByParams(array(),-1,-1,$statement);
                    ...
                    <table id="tbbiaya" style="width: 100%">
                       ...
                       <tr>
                        ...
                        ?>
                            ...
                            <td></td>
                            <td><input class='easyui-validatebox textbox form-control' type='text' name='reqPengajuan[]' id='reqPengajuan' value='<?=$pengajuan?>'  ></td>
                            <td  class="realisasi" style="width: 25%" ><input class='easyui-validatebox textbox form-control txtCal' type='text' name='reqRealisasi[]' id='reqRealisasi' value='<?=$realisasi?>'  ></td>
                        </tr>
                        <?
                        }
                        ?>
                        <tr>
                            <td><label>Uang Saku</label></td>
                            <td>
                                <table style="width: 100%" id="kelompok">
                                    ...
                                    {
                                    ?>
                                    <tr id ="<?=$value["KELOMPOK_ID"]?>">
                                        <td>
                                            <label for="orang"><?=$value["NAMA"]?></label>
                                        </td>
                                        <td>
                                            <input  class="easyui-validatebox textbox form-control" style="width: 50px" name="reqOrang" id="reqOrang" readonly />
                                        </td>
                                        <td>
                                            <label>Orang</label>
                                        </td>
                            ...
                            <td style="width: 25%" >
                                ...
                                <tr>
                                    <td>
                                    <input class='easyui-validatebox textbox form-control' type='text' name='reqPengajuan[]' id='reqPengajuan' value='<?= $reqBiaya?>'  >
                                    </td>
                                </tr>
                                <?   
                                }
...
<script>
  ...
  // });
    ...
    function sethidekelompok(id) 
    {
        ...
        // id = [];
        // $("input[name='reqKelompokId']").each(function() {
    ...
    $(function(){
        ...
        $("#kelompok").hide();
         ...
         // $("#kelompok").show();
         //    $('#kelompok tr').not('#DIREKSI,#KARYAWAN,#MAN,#MANAGER').hide();
         //     $('#kelompok tr').hide();
    ...
    function addmultisatuanKerja(JENIS, multiinfoid, multiinfonama, IDFIELD, kelompok) 
    {
        ...
        if(batas > 0)
        {
            rekursivemultisatuanKerja(0, JENIS, multiinfoid, multiinfonama, IDFIELD, kelompok);
        }
    }

    var arrkelompok=[]; 

    function rekursivemultisatuanKerja(index, JENIS, multiinfoid, multiinfonama, IDFIELD, kelompok) 
    {
            ...
            if (rv == true) 
            {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        rekursivemultisatuanKerja(index, JENIS, multiinfoid, multiinfonama, IDFIELD, kelompok);
                    },
