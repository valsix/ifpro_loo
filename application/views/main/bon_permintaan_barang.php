...
if ($reqId == "") {
    ...
    $reqButuhAksiId= 2;
    $reqJenisNaskah= "22";
    $reqJenisNaskahNama= "Bon Permintaan Barang Umum";
    $reqJenisTTD = "QRCODE";
  ...
  <head>
    ...
    <div class="col-lg-12 col-konten-full">
        ...
        <div class="judul-halaman bg-course">
            <span><img src="images/icon-course.png"></span> Bon Permintaan Barang Umum
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <table style="width:100%;margin-left: 5px;">
                                            <thead>
                                                <tr>
                                                    <th colspan="4" style="border: solid black 1pt;text-align: center;">DIISI OLEH DEPARTEMEN YANG MEMINTA</th>
                                                    <th colspan="5" style="border: solid black 1pt;text-align: center;">DIISI OLEH BAGIAN RUMAH TANGGA</th>
                                                    <th rowspan="3" style="border: solid black 1pt;text-align: center;">AKSI</th>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <th rowspan="2" style="border: solid black 1pt;text-align: center; background-color: lightgray; width: 7;width: 10%">Disetujui (QTY)</th>
                                            ...
                                            <tbody id='tbodyObyek'>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td>
                                                            <input type="hidden" name="reqIdBarang[]" value="<?=$reqIdBarang?>">
                                                            <input type="text" name="reqNamaBarang[]" class="easyui-validatebox"style="width: 100%;" value="<?=$reqNamaBarang?>">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="reqKtsBarang[]" class="easyui-validatebox" style="width: 100%;" value="<?=$reqKtsBarang?>">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="reqSatuanBarang[]" class="easyui-validatebox" style="width: 100%;" value="<?=$reqSatuanBarang?>">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="reqKeperluanBarang[]" class="easyui-validatebox" style="width: 100%;" value="<?=$reqKeperluanBarang?>">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="reqSisaStockBarang[]" class="easyui-validatebox" style="width: 100%;" value="<?=$reqSisaStockBarang?>">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="reqDisetujuiBarang[]" class="easyui-validatebox" style="width: 100%;" value="<?=$reqDisetujuiBarang?>">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="reqStockBarang[]" class="easyui-validatebox" style="width: 100%;" value="<?=$reqStockBarang?>">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="reqPengadaanBarang[]" class="easyui-validatebox" style="width: 100%;" value="<?=$reqPengadaanBarang?>">
                                                        </td>
                                                        <td>
                                                            <textarea name="reqKeteranganBarang[]" class="easyui-validatebox" style="width: 100%;"><?=$reqKeteranganBarang?></textarea>
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-danger btn-sm pull-right" type="button" onClick="deleteRowSave(this,<?=$reqIdBarang?>)"><i class="fa fa-trash-o"></i></button>
                                                        </td>
                                                    </tr>
                                                <?}?>
                                            </tbody>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        {
            ?>
            if ("<?=$reqJenisNaskahNama?>" == 'Bon Permintaan Barang Umum') {
...
<script>
    function addRow(array) {
        // console.log("masuk");
        test = `<tr>
        <td><input type="hidden" name="reqIdBarang[]"><input type="text" name="reqNamaBarang[]" class="easyui-validatebox" style="width: 100%;"></td>
        <td><input type="text" name="reqKtsBarang[]" class="easyui-validatebox" style="width: 100%;"></td>
        <td><input type="text" name="reqSatuanBarang[]" class="easyui-validatebox" style="width: 100%;"></td>
        <td><input type="text" name="reqKeperluanBarang[]" class="easyui-validatebox" style="width: 100%;"></td>
        <td><input type="text" name="reqSisaStockBarang[]" class="easyui-validatebox" style="width: 100%;"></td>
        <td><input type="text" name="reqDisetujuiBarang[]" class="easyui-validatebox" style="width: 100%;"></td>
        <td><input type="text" name="reqStockBarang[]" class="easyui-validatebox" style="width: 100%;"></td>
        <td><input type="text" name="reqPengadaanBarang[]" class="easyui-validatebox" style="width: 100%;"></td>
        <td><textarea name="reqKeteranganBarang[]" class="easyui-validatebox" style="width: 100%;"></textarea></td>
