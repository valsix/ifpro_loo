...
<script type="text/javascript">
	...
	$('#btnCetak').on('click', function () {
		...
		newWindow = window.open("app/loadUrl/main/kotak_keluar_export/?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian+"&reqPilihan="+reqPilihan, 'Cetak');
		newWindow.focus();
	});
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json/surat_masuk_json/jsonsuratkeluar?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian+"&reqStatusSurat="+reqStatusSurat+"&reqPilihan="+reqPilihan;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json/surat_masuk_json/jsonsuratkeluar?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun=<?=$reqTahun?>";
