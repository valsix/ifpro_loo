...
<script>
    ...
    function hapus(){
        $('#divTujuanSurat').val(divTujuanSurat);
        $('#divPerintahSurat').val(divPerintahSurat);
        // console.log(a);
        $(divTujuanSurat).parent().remove();
        $(divPerintahSurat).parent().remove();
    }

     function addSatuanKerjaPerintah(JENIS, SATUAN_KERJA_ID, NAMA, IDFIELD) {
        // console.log(IDFIELD);
        // var TEST = "PERINTAH";
        //alert("topp");
        var rv = true;
    ...
    function setinfovalidasi()
    {
        ...
        reqKeterangan= 
        reqButuhAksiId= reqSifatNaskah= reqDasar = reqIsiPerintah = reqId="";
        ...
        reqDasar= jQuery($('textarea#reqDasar').froalaEditor('html.get')).text();
        // console.log(reqDasar);
        reqIsiPerintah= jQuery($('textarea#reqIsiPerintah').froalaEditor('html.get')).text();
        ...
        // if(reqPerihal == ""  )
        if(((reqPerihal=="" || reqSatuanKerjaId=="" || reqUserAtasanId=="" || reqKlasifikasiId=="")  && reqId=="") || ((reqPerihal=="" || reqSatuanKerjaId=="" || reqSatuanKerjaIdTujuan=="" || reqUserAtasanId=="" || reqKlasifikasiId=="")  && reqId!=""))
        {
        ...
        //     if (tinyMCE.editors[i].id=='reqLainLain') {} 
        //     else 
        //     {
        //         if(content == "")
        //         {
    ...
    function submitForm(reqStatusSurat) {
        ...
        reqvalidasibaru= reqDasar= reqIsiPerintah= "";
        ...
        if(((reqDasar=="Powered by Froala Editor" || reqDasar == "") && reqvalidasibaru == "1") || ((reqIsiPerintah=="Powered by Froala Editor" || reqIsiPerintah=="") && reqvalidasibaru == "1"))
        {
            reqvalidasibaru= "";
        ...
        //     var content = tinyMCE.editors[i].getContent();
        //     console.log('Editor-Id(' + tinyMCE.editors[i].id + '):' + content);
        //     if (tinyMCE.editors[i].id=="reqLainLain" || tinyMCE.editors[i].id=="reqPemesanSatuanKerjaIsi") {} 
        //     else 
        //     {
...
<script type="text/javascript">
    ...
    function setagenda()
    {
        document.location.href = 'main/index/surat_perintah_lihat?reqMode=surat_perintah_add&reqId=<?=$reqId?>';
    }
</script>
...
<script type="text/javascript">
    tinymce.init({
        selector: "#reqPemesanSatuanKerjaIsi, #reqLainLain, #reqDasar, #reqIsiPerintah",
        //height: 200,
        plugins: [
        ...
        setup : function(ed) {
            ...
            ed.on('keyup', function(e) {
                ...
                if($(ed).attr('id') == "reqDasar" || $(ed).attr('id') == "reqIsiPerintah")
                {
                    setinfovalidasi();
                }
...
<script>
    ...
    // event keyup
    $('textarea#reqDasar,textarea#reqIsiPerintah').on('froalaEditor.keyup', function (e, editor, keyupEvent) {
        setinfovalidasi();
    });

    // event like ready
    $('textarea#reqDasar,textarea#reqIsiPerintah').on('froalaEditor.html.set', function (e, editor) {
        setinfovalidasi();
    });

    // event paste after
    $('textarea#reqDasar,textarea#reqIsiPerintah').on('froalaEditor.paste.after', function (e, editor) {
        setinfovalidasi();
    });


    $(function(){
        $('textarea#reqDasar,textarea#reqIsiPerintah,textarea#reqLainLain').froalaEditor({
