...
<body style="overflow:hidden;">
	...
	<div id="wadah">
	    ...
	    <table id="treeSatker" class="easyui-treegrid" style="width:700px;height:300px"
                data-options="
                    url: 'web/lokasi_arsip_json/treetable/',
                    pagination: true,            
                    pageSize: 50,
					pageList: [50, 100],
            ...
            <thead>
                <tr>                                
                    <th data-options="field:'NAMA_LOKASI_ARSIP'" >NAMA</th>
                    <th data-options="field:'SATUAN_KERJA'" > UNIT KERJA</th>
                    <th data-options="field:'CABANG'" > CABANG</th>
                </tr>
            </thead>
        </table>
	</div>
