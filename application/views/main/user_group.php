...
$aColumns = array("USER_GROUP_ID","KODE","NAMA","KETERANGAN");
?>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/user_group_json/json/?reqCabangId=<?=$this->CABANG_ID?>",     
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				...
				$('#btnDelete').on('click', function () {
                  ...
                  deleteData("web/user_group_json/delete", anSelectedId);
