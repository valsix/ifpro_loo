...
$satuanKerjaIdTujuan = "PEGAWAI".$this->ID;
...
<div class="col-lg-12 col-konten-full">
    <div class="judul-halaman">Surat Masuk Detil</div>
    	...
    	<div class="area-surat-detil">
            ...
            <div class="header-surat">
                ...
                <div class="col-md-4 area-kanan">
                    ...
                    <script>
                        ...
                        {   
                            // alert('feefe');return false;
                            window.location.href = 'main/index/inbox_detil?reqId=<?=$reqId?>&reqDisposisiId=<?=$reqDisposisiId?>&reqMode='+AKSI;
                        }
                    </script>
                    </div>
                </div>
                     ...
                     <div class="field-item">
                      <div class="tab-pane fade in active" id="tab1">
                        <div class="form-group">
                            ...
                            <?
                            if(!empty($surat_masuk->getField("DISPOSISI_PARENT_ID")))
                            {
                                $setdetil= new Disposisi();
                                $setdetil->selectByParamsAttachment(array("A.DISPOSISI_ID"=>$surat_masuk->getField("DISPOSISI_PARENT_ID")), -1,-1);
                                $setdetil->firstRow();
                                if(!empty($setdetil->getField("DISPOSISI_ID")))
                                {
                            ?>
                                <div class="col-md-12">
                                    <fieldset class="attachment-surat">
                                        ...
                                        <div class="inner">
                                            <div class="item">
                                                <div class="ikon"><i class="fa fa-file-pdf-o"></i></div>
                                                <div class="nama-file"><?=$setdetil->getField("NAMA")?></div>
                                                <div class="ukuran-file"><?=round(($setdetil->getField("UKURAN")/1024), 2)?> kb</div>
                                                <div class="hover-konten">
                                                    <?
                                                    if($setdetil->getField("TIPE") == "pdf")
                                                    {
                                                    ?>
                                                    <i class="fa fa-eye" onClick="parent.openAdd('<?=base_url()."uploads/".$reqId."/".$setdetil->getField("ATTACHMENT")?>')"></i>
                                                    <?
                                                    }
                                                    ?>
                                                    <i class="fa fa-download" onClick="window.open('<?=base_url()."uploads/".$reqId."/".$setdetil->getField("ATTACHMENT")?>', '_blank')"></i>
                                                </div>
                                            </div>
            ...
            ?>
                <fieldset class="attachment-surat">
                    ...
                    ?>
                            <tr>
                                <td><?=generateTingkat($tingkat)."<i class='fa ".$icon."'></i> ".$disposisi->getField("NAMA_SATKER").$infodetil?></td>
                    ...
                    ?>
                        <tr>
                            <td><i class="fa <?=$icon?>"></i> <?=$disposisi->getField("NAMA_SATKER").$infodetil?></td>
