...
$disposisi_sifat_surat = new DisposisiSifatSurat();
...
{
	$reqMode = "update";
	$disposisi_sifat_surat->selectByParams(array("A.DISPOSISI_SIFAT_SURAT_ID" => $reqId));
	$disposisi_sifat_surat->firstRow();

	$reqId            	    = $disposisi_sifat_surat->getField("DISPOSISI_SIFAT_SURAT_ID");
	$reqNama                = $disposisi_sifat_surat->getField("NAMA");
    $reqKode                = $disposisi_sifat_surat->getField("KODE");
    $reqWarna               = $disposisi_sifat_surat->getField("WARNA");
    $reqKunci               = $disposisi_sifat_surat->getField("KUNCI");
	$reqKeterangan          = $disposisi_sifat_surat->getField("KETERANGAN");
}
?>
...
function submitForm(){
    $('#ff').form('submit',{
        url:'web/disposisi_sifat_surat_json/add',
        onSubmit:function(){
            return $(this).form('enableValidation').form('validate');
        },
        success:function(data){
            // alert(data);return false;
            $.messager.alertLink('Info', data, 'info', "app/loadUrl/admin/disposisi_sifat_surat");
        }
    });
