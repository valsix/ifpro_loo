...
<script type="text/javascript">
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json/tr_loo_json/jsondraft?reqPencarian="+reqPencarian;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json/tr_loo_json/jsondraft";
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                if(valinfoid !== "")
                {
					...
					window.location = "main/index/loo_add/?reqMode=<?=$reqFilename?>&reqId="+valinfoid;
                }
            }
        } );
