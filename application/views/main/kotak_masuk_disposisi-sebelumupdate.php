...
$arrdata= array(
    ...
    , array("label"=>"DISPOSISI DARI", "width"=>"")
    , array("label"=>"DISPOSISI", "width"=>"")
);
?>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).ready(function() {
            ...
            oTable = $('#example').dataTable({
                ...
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "web/surat_masuk_json/jsonsuratdisposisi?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun=<?=$reqTahun?>",
                ...
                "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                    ...
                    $($(nRow).children()).attr('style', 'font-weight:'+bold+';');
                }
                //"responsive": true
            });
            /* Click event handler */
            ...
            $("#example tbody").click(function(event) {
                ...
                if(anSelectedId !== "")
                window.location = ("<?= base_url() ?>main/index/kotak_masuk_disposisi_detil/?reqMode=kotak_masuk_disposisi&reqId="+anSelectedId+"&reqRowId="+anSelectedRowId);
            });
            ...
            $('#btnCari').on('click', function () {
                ...
                oTable.fnReloadAjax("web/surat_masuk_json/jsonsuratdisposisi?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian);
            });
            ...
            $('#btnCetak').on('click', function () {
                ...
                newWindow = window.open("<?= base_url() ?>app/loadUrl/main/kotak_masuk_disposisi_export/?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian, 'Cetak');
                newWindow.focus();
            });
