...
if ($reqId == "") {
    ...
    $reqJenisNaskahNama= "Instruksi Direksi";
    $reqJenisTTD = "QRCODE";
...
<div class="col-lg-12 col-konten-full">
    ...
    <div class="judul-halaman bg-course">
        <span><img src="images/icon-course.png"></span> Instruksi Direksi
                                        ...
                                        <div class="btn-group">
                                            ...
                                            ?>
                                                <div class="item">TUJUAN:<?=$valkepadalabel?>
                                                    ...
                                                    if($valkepadatipe == "langsung")
                                                    {
                                                        ...
                                                        {
                                                    ?>
                                                        <i class="fa fa-times-circle" onclick="$(this).parent().remove(); $('#itemisi<?= $valkepadaid ?>').empty(); setinfovalidasi();"></i>
                                                    <?
                                                        }
                                                    ?>
                                            ...
                                            ?>
                                                <div class="item">TUJUAN:<?= $value->SATUAN_KERJA ?>
                                                    ...
                                                    {
                                                    ?>
                                                    <i class="fa fa-times-circle" onclick="$(this).parent().remove(); $('#itemisi<?= $value->SATUAN_KERJA_ID ?>').empty();"></i>
                                                    <?
                                                    }
                                                    ?>
                                            ...
                                            ?>
                                                <div class="item">TUJUAN:<?= $value->NAMA_KELOMPOK ?>
                                                    <i class="fa fa-times-circle" onclick="$(this).parent().remove(); $('#itemisi<?=$value->SATUAN_KERJA_KELOMPOK_ID?>').empty();"></i>
                    ...
                    <table class="table">
                        <thead>
                           <tr>
                            ...
                            <tr>
                                <td><b>MENGINSTRUKSIKAN</b><span class="text-danger">*</span></td>
                            </tr>
                            <tr>
                                <td>Kepada <span class="text-danger" id="kepadaaa">*</span></td>
                                <td>:</td>
                                <td><label id="divPerintahSurat">
                                    <?
                                    $arrKepada = json_decode($reqKepada);
                                    foreach ($arrKepada as $key => $value) {
                                    ?>
                                        <div class='item' id='itemisi<?=$value->SATUAN_KERJA_ID?>'><?= $value->SATUAN_KERJA ?></div>
                                    <?
                                    }
                                    ?>
                                    <?
                                    ...
                                    foreach ($arrKepadaKelompok as $key => $value) {
                                    ?>
                                        <div class="item" id="itemisi<?=$value->SATUAN_KERJA_KELOMPOK_ID?>"><?= $value->NAMA_KELOMPOK ?>
                                        </div>
                                    <?
                                    }
                                    ?>
...
<script>
            ...
            if (rv == true) 
            {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if(IDFIELD=="divTujuanSurat")
                        {
                            $("#divPerintahSurat").append("<div class='item' id='itemisi"+SATUAN_KERJA_ID+"'>"+NAMA+" </div>");
                        }
    ...
    function setinfovalidasi()
    {
        ...
        if(reqMenimbang == "Powered by Froala Editor" || reqMenimbang == "" || reqMengingat == "Powered by Froala Editor" || reqMengingat == "" || reqPertama == "Powered by Froala Editor" || reqPertama == "")
        {
            $("#tab-isi-danger").show();
    ...
    function submitForm(reqStatusSurat) {
        ...
        if(((reqMenimbang=="Powered by Froala Editor" || reqMenimbang=="") && reqvalidasibaru == "1") || ((reqMengingat=="Powered by Froala Editor" || reqMengingat=="") && reqvalidasibaru == "1") || ((reqPertama=="Powered by Froala Editor" || reqPertama=="") && reqvalidasibaru == "1"))
        {
            reqvalidasibaru= "";
    ...
    function setsimpan()
    {
        $('#ff').form('submit', {
            ...
            success: function(data) {
                ...
                {
                    $.messager.alertLink('Info', arrData[1], 'info', "app/loadUrl/main/instruksi_direksi_add?reqMode=<?=$reqLinkMode?>&reqId=<?=$reqId?>");
                }
...
<script type="text/javascript">
    ...
    function tambahpasal()
    {
        ...
        $.get("app/loadUrl/main/instruksi_direksi_add_pasal?reqId=<?=$reqId?>&nomorpasal="+nomorpasal, function (data) {
            // console.log(data);
    ...
    function setagenda()
    {
        document.location.href = 'main/index/instruksi_direksi_lihat?reqMode=instruksi_direksi_add&reqId=<?=$reqId?>';
    }
</script>
...
<script>
    // event keyup
    $('textarea#reqMenimbang, textarea#reqMengingat, textarea#reqPertama').on('froalaEditor.keyup', function (e, editor, keyupEvent) {
        setinfovalidasi();
    });

    // event like ready
    $('textarea#reqMenimbang, textarea#reqMengingat, textarea#reqPertama').on('froalaEditor.html.set', function (e, editor) {
        setinfovalidasi();
    });

    // event paste after
    $('textarea#reqMenimbang, textarea#reqMengingat, textarea#reqPertama').on('froalaEditor.paste.after', function (e, editor) {
        setinfovalidasi();
    });


    $(function(){
        $('textarea#reqMenimbang, textarea#reqMengingat, textarea#reqPertama, .froalaeditor').froalaEditor({
