    ...
    <div class="konten-detil">
        ...
        <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#tab-informasi"><i class="fa fa-times-circle text-danger" aria-hidden="true"></i> Informasi Surat</a></li>
                <li><a data-toggle="tab" href="#tab-isi"><i class="fa fa-times-circle text-danger" aria-hidden="true"></i> Isi</a></li>
                <li><a data-toggle="tab" href="#tab-atribut"><i class="fa fa-check-circle text-success" aria-hidden="true"></i> Atribut</a></li>
            </ul>
            ...
            <div class="tab-content">
                <div id="tab-informasi" class="tab-pane fade in active">
                    <table class="table">
                    	<thead>
                    		<tr>
                                <td>Kepada Eksternal <span class="text-danger">*</span></td>
                                <td>:</td>
                                <td>
                                	<a onClick="top.openAdd('app/loadUrl/main/satuan_kerja_tujuan_lookup/?reqJenis=TUJUAN&reqJenisSurat=INTERNAL')">Tujuan <i class="fa fa-users" aria-hidden="true"></i></a>
                                    ...
                                    <div class="inner" id="divTujuanSurat">
                                        ...
                                        */
                                            ?>
                                            <?php /*?><a class="btn btn-primary btn-xs dropdown-toggle" data-toggle="dropdown" href="#">
                                                Tambah
                            ...
                            <tr>
                                <td>Kepada Internal <span class="text-danger">*</span></td>
                                <td>:</td>
                                <td>
                                	<a onClick="top.openAdd('app/loadUrl/main/satuan_kerja_tujuan_lookup/?reqJenis=TUJUAN&reqJenisSurat=INTERNAL')">Tujuan <i class="fa fa-users" aria-hidden="true"></i></a>
                            ...
                            <tr>
                                <td>Tembusan Ekternal</td>
                                <td>:</td>
                                <td>
                                	<a onClick="top.openAdd('app/loadUrl/main/satuan_kerja_tujuan_lookup/?reqJenis=TEMBUSAN&reqJenisSurat=INTERNAL')">Tembusan <i class="fa fa-users" aria-hidden="true"></i></a>
                            ...
                            <tr>
                                <td>Kota Tujuan <span class="text-danger">*</span></td>
                                <td>:</td>
                                <td>test</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <textarea placeholder="Isi Catatan Pemesan..." id="reqCatatanPemesan" name="reqCatatanPemesan"><?=$reqCatatanPemesan?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>Pengirim <span class="text-danger">*</span></td>
                                <td>:</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <input type="text" name="reqPerihal" class="easyui-validatebox" value="<?=$reqPerihal?>" style="width: 900px;" placeholder="Silakan tulis perihal surat Anda...">
                                </td>
                            </tr>
...
<script type="text/javascript">
    tinymce.init({
        selector: "#reqKeterangan, #reqCatatanPemesan",
        //height: 200,
        plugins: [
