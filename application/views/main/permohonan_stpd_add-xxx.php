...
if(!empty($reqId))
{
    $statement=" AND B.PERMOHONAN_STPD_ID = ".$reqId;

}
$kelompok->selectByParamsStpd(array(),-1,-1,$statement);
...
if(!empty($reqId))
{
    $statement=" AND A.ALOKASI_BIAYA <> 'uang_saku_kelompok' AND A.PERMOHONAN_STPD_ID = ".$reqId;
                  ...
                  <!--   <div style="margin-top: 10px"> <a href="javascript:void(0)" class="btn btn-primary btn-sm" onclick="AddBaris('')">Tambah</a></div> -->
                    ...
                    <table id="tbbiaya" style="width: 100%">
                       ...
                       <tr>
                        ...
                        foreach ($arrAlokasi as $key => $value) 
                        {
                            ...
                            $vbiaya=$arrKelompokperjalanan[$key]["PENGAJUAN_BIAYA"];
                            if(!empty($vbiaya))
                            {
                        ...
                        ?>
                            <td><label><?=$value["nama"]?></label>
                                <input class='easyui-validatebox textbox form-control' type='hidden' name='reqAlokasi[]' id='reqAlokasi' value='<?=$value["nama"]?>'  >
                            </td>
                            <td>
                                 <input  class="easyui-validatebox textbox form-control" type='hidden'  style="width: 50px" name="reqOrang[]"  />
                            </td>
                            <td><input class='easyui-validatebox textbox form-control' type='text' name='reqPengajuan[]' id='reqPengajuan' value='<?=$vbiaya?>'  ></td>
                            <td  class="realisasi" style="width: 25%" >
                                <input class='easyui-validatebox textbox form-control txtCal' type='text' name='reqRealisasi[]' id='reqRealisasi' value='<?=$realisasi?>'  >
                        ...
                        ?>
                        <tr>
                            <td><label>Uang Saku</label>

                            </td>
                            <td>
                                <table style="width: 100%" id="kelompok">
                                    <?
                                    ...
                                    <tr id ="<?=$vkelompokid?>">
                                        ...
                                        <td>
                                            ...
                                            <input  class="easyui-validatebox textbox form-control" type='text'  style="width: 50px" name="reqOrang[]" id="req<?=$value["KELOMPOK_ID"]?>" value="<?=$vkelompokorang?>" readonly />
                            ...
                            <td style="width: 25%" id="kelompokbiaya">
                                <table style="width: 100%">
                                <?
                                foreach ($arrKelompok as $key => $value) 
                                {
                                ...
                                ?>
                                <tr class="<?=$vkelompokid?>">
                                    <td>
                                        <input class='easyui-validatebox textbox form-control kondisiuang' type='text' name='reqPengajuan[]' id='reqPengajuan<?=$vkelompokid?>' value='<?=$reqBiaya?>'  >
                                    </td>
                                </tr>
                                <?   
                                }
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                           <!--  <td>
                                <input type="text" id="reqRealisasiDisiapkanId" class="easyui-combotree" name="reqRealisasiDisiapkanId" data-options="width:'500'
                                , panelHeight:'120'
                                , valueField:'id'
                                , textField:'text'
                                , url:'web/satuan_kerja_json/combotreesatker/'
                                , prompt:'Tentukan Pelaksana...'," value="<?=$reqRealisasiDisiapkanId?>"
                                />
                            </td> -->
                            <td>
...
<script>
    ...
    $('#reqPengajuan,#reqRealisasi,#reqJumlah,.kondisiuang').bind('keyup paste', function(){
         var numeric = $(this).val().replace(/\D/g, '');
  ...
  // });
    ...
    function sethidekelompok(id,biaya) 
    {
        var str = id.toString();
        // console.log(str);
        // console.log(biaya);
        if(id)
        {
            ...
            strclass = str.replace(/#/g, ".");
            // console.log(text);
            $(str).show();
            $(strclass).show();


            // set value untuk lewati uang saku
            arrstr = str.replace("#", "reqPengajuan").split(',');
            // console.log(strcek);
            // console.log(arrstr);

            $('.kondisiuang').each(function(){
                infoid= $(this).attr('id');
                // console.log(infoid);

                if(arrstr.includes(infoid) == false)
                {
                    $(this).val(-1);
                }
                // console.log(arrstr.includes(infoid));
            });

            // set value untuk ambil uang di data
            arrstr = str.split(',');
            // console.log(arrstr)
            arrstr.forEach(function (item, index) {
                reqPengajuan= "reqPengajuan" + item.replace("#", "");
                // console.log(reqPengajuan)
                $("#"+reqPengajuan).val(biaya[index]);
            });


            // $('#kelompok tr').not(str).hide();
        }
    ...
    function rekursivemultisatuanKerja(index, JENIS, multiinfoid, multiinfonama, IDFIELD, kelompok, biaya) 
    {
        ...
        if(index < batas)
        {
            ...
            carikalauadakelompokygsama= arrkelompok.indexOf( kel );
            if(parseInt(carikalauadakelompokygsama) >= 0)
            {
            }
            else
            {
                arrkelompok.push(kel);
                arrkelompokbiaya.push(kelbiaya);
            }

            // carikalauadabiayasama= arrkelompokbiaya.indexOf( kelbiaya );
            /*if(parseInt(carikalauadabiayasama) >= 0)
            {
            }
            else
            {
                arrkelompokbiaya.push(biaya);
            }*/
            // console.log(arrkelompok);
            // console.log(carikalauadakelompokygsama+'--'+arrkelompok);
        ...
        {
            sethidekelompok(arrkelompok, arrkelompokbiaya);
        }
    }
