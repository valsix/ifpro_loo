...
$arrtabledata= array(
    ...
    , array("label"=>"Jenis", "field"=> "JENIS_SURAT_NAMA", "display"=>"",  "width"=>"25", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Status", "field"=> "STATUS_NAMA", "display"=>"",  "width"=>"25", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Posisi Surat", "field"=> "POSISI_SURAT_INFO", "display"=>"",  "width"=>"25", "colspan"=>"", "rowspan"=>"")
...
<script type="text/javascript">
  ...
  $('#btnCari').on('click', function () {
    ...
    jsonurl= "json/permohonan_stpd_json/json_status?reqTahun="+reqTahun+"&reqPencarian="+reqPencarian+"&reqStatusSurat="+reqStatusSurat+"&reqPilihan="+reqPilihan;
  ...
  jQuery(document).ready(function() {
    var jsonurl= "json/permohonan_stpd_json/json_status";
