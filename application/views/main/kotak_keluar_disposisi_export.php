...
$reqJenisNaskahNamaFile= "kotak_keluar_disposisi_";
...
$arrdata= array(
	...
	, array("label"=>"DISPOSISI KE", "field"=>"DETIL_INFO_KEPADA_DIPOSISI", "width"=>"")
);

$sOrder = " ORDER BY B.TANGGAL_DISPOSISI DESC";
$set= new SuratMasuk();
$set->selectByParamsKeluarDisposisi(array(), -1, -1, $this->ID, $statement.$searchJson, $sOrder);
// echo $set->query;exit;
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
				...
				?>
                	...
                	for($i=0; $i<count($arrdata); $i++)
					{
						...
						// elseif($field == "DETIL_INFO_KEPADA_DIPOSISI")
						// {
