...
$this->load->model("UserGroupNew");
$set = new UserGroupNew();
...
{
    $reqMode = "ubah";
    $set->selectByParams(array("A.USER_GROUP_ID" => $reqId));
...
$(function(){
	$('#ff').form({
		url:'<?=base_url()?>web/user_group_json/add',
		onSubmit:function(){
			return $(this).form('validate');
		},
		success:function(data){
			$.messager.alertLink('Info', data, 'info','main/index/user_group');	
...
<body class="bg-kanan-full">
	<div id="judul-popup">Kelola User Group</div>
	<div id="konten">
    	<div id="popup-tabel2">
                ...
                <table class="table">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="text" id="reqNama" class="easyui-validatebox textbox form-control" required name="reqKode"  value="<?=$reqKode?>"  data-options="required:true" style="width:50%" />
                            </td>
                        </tr> 
                        ...
                        <tr>
                        	...
                        	<td>:</td>
                        	<td>
                                <input type="text" id="reqNama" class="easyui-validatebox textbox form-control"  name="reqNama"  value="<?=$reqNama ?>"style="width:50%" />
                        	</td>
                        </tr>
