  ...
  <script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function() {
      ...
      oTable = $('#example').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "web/surat_masuk_json/jsonnewdraft?reqMode=manual",
      ...
      $("#example tbody").click(function(event) {
        ...
        if(anSelectedId !== "")
        window.location = ("<?= base_url() ?>main/index/"+anSelectedRowId+"/?reqId="+anSelectedId);
      });
      ...
      $('#btnCari').on('click', function () {
        ...
        oTable.fnReloadAjax("web/surat_masuk_json/jsonnewdraft??reqMode=manual&reqPencarian="+reqPencarian);
...
<body style="overflow:hidden;">
  ...
  <div id="wadah">
    <div class="judul-halaman">Data Draft Manual</div>
