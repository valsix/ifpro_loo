...
{
    $reqMode = "ubah";
    $balas_cepat->selectByParams(array("BALAS_ID" => $reqId));
    
    $balas_cepat->firstRow();
    $reqId                      = $balas_cepat->getField("BALAS_ID");
    $reqNama                    = $balas_cepat->getField("NAMA");
...
<body class="bg-kanan-full">
	<div id="judul-popup">Kelola Balas Cepat</div>
	<div id="konten">
    	<div id="popup-tabel2">
...
function submitForm(){
    $('#ff').form('submit',{
        url:'web/balas_cepat_json/add',
        onSubmit:function(){
            return $(this).form('enableValidation').form('validate');
        },
        success:function(data){
            $.messager.alertLink('Info', data, 'info', "app/loadUrl/main/balas_cepat");
        }
    });
}
function clearForm(){
