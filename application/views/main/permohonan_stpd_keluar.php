...
$arrdata= array(
  array("label"=>"Nomor", "width"=>"100")
  , array("label"=>"Tanggal", "width"=>"")
  , array("label"=>"Dokumen Acuan", "width"=>"")
  , array("label"=>"Jumlah Pelaksana", "width"=>"")
  ...
  <script type="text/javascript" charset="utf-8">
    ...
    $(document).ready(function() {
      ...
      oTable = $('#example').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "web/permohonan_stpd_json/json?reqKeluar=1",
      ...
      $("#example tbody").click(function(event) {
        ...
        // alert("--"+anSelectedRowId);return false;

        if(anSelectedId !== "")
        window.location = ("<?= base_url() ?>main/index/permohonan_stpd_add/?reqId="+anSelectedId);
      });
      ...
      $('#btnCari').on('click', function () {
        ...
        oTable.fnReloadAjax("web/surat_masuk_json/jsonnewdraft?reqPencarian="+reqPencarian);
...
<body style="overflow:hidden;">
  ...
  <div id="wadah">
    <div class="judul-halaman">Data </div>
