...
<head>
	...
	<script type="text/javascript">
		...
		function setubah()
		{
			document.location.href = 'main/index/<?=$infolinkedit?>?reqMode=loi_perlu_persetujuan_detil&reqId=<?=$reqId?>';
		}
		...
		function submitForm(reqStatusSurat) 
		{
	        ...
	        {
	        	urllink= "web/trloi_json/logparaf";
	        	reqMode= "";
	        ...
	        {
	        	urllink= "web/trloi_json/logposting";
	        	reqMode= "";
		...
		function setinfonomorsesuaitanggalentri()
		{
			...
			infotanggalajax= "web/trloi_json/setinfonomorsesuaitanggalentri?v=<?=$reqId?>&t="+tanggalapproval;
			$.ajax({
				url: infotanggalajax,
				type: "GET",
				dataType: "json",
