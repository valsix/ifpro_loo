...
// $jumlahbelum = $suratmasukinfo->JUMLAH_KOTAK_MASUK_NOTA_DINAS;
// $jumlahterbaca = $suratmasukinfo->JUMLAH_KOTAK_MASUK_NOTA_DINAS_TERBACA;
	...
	<script type="text/javascript" charset="utf-8">
		...
		$(document).ready(function() {
			...
			$("#example tbody").click(function(event) {
				...
				if(anSelectedId !== "")
				window.location = ("<?= base_url() ?>main/index/kotak_masuk_detil/?reqMode=kotak_masuk_nota_dinas&reqId="+anSelectedId+"&reqRowId="+anSelectedRowId+"&reqPilihan="+reqPilihan);
			});

			$("#reqTahun,#reqStatusSurat").change(function() {
				setCariInfo();
			});
			...
			$('#btnCari').on('click', function () {
				...
				oTable.fnReloadAjax("web/surat_masuk_json/jsonsuratmasuk?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian+"&reqStatusSurat="+reqStatusSurat);
			});
			...
			$('#btnCetak').on('click', function () {
				...
				newWindow = window.open("<?= base_url() ?>app/loadUrl/main/kotak_masuk_export/?reqJenisNaskahId=<?=$reqJenisNaskahId?>&reqTahun="+reqTahun+"&reqPencarian="+reqPencarian, 'Cetak');
				newWindow.focus();
			});
