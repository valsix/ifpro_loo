...
<body class="bg-kanan-full">
    <div id="judul-popup">Kelola Konten</div>
    <div id="konten">
        <div id="popup-tabel2">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <input type="text" id="reqKode" class="easyui-validatebox textbox form-control" required name="reqKode"  value="<?=$reqKode ?>" data-options="required:true" style="width:80%" />
...
function submitForm(){
    $('#ff').form('submit',{
        url:'web/konten_json/add',
        onSubmit:function(){
            return $(this).form('enableValidation').form('validate');
        },
        success:function(data){
            $.messager.alertLink('Info', data, 'info', "app/loadUrl/main/konten");
        }
    });
}
function clearForm(){
