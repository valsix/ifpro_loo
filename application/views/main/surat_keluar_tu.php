...
<head>
	...
	<?php
$aColumns = array("SURAT_MASUK_ID", "STATUS_SURAT", "NOMOR", "PERIHAL", "TANGGAL_ENTRI", "KEPADA", "INSTANSI_ASAL", 
...
<script type="text/javascript" language="javascript" class="init">	
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
			...
			"bProcessing": true,
			"bServerSide": true,		
			"sAjaxSource": "web/surat_masuk_json/json_surat_keluar_tu",		
		...
		$('#btnLihat').on('click', function () {
		  ...
		  if(anSelectedStatus == "TU-NOMOR"){
			  document.location.href = "<?=base_url()?>main/index/surat_keluar_tu_nomor?reqId="+anSelectedId;  			
          }
		  else{
			  document.location.href = "<?=base_url()?>main/index/surat_keluar_tu_lihat?reqId="+anSelectedId;  			
          }
...
<body style="overflow:hidden;">
	...
	<div id="wadah">
		<div class="judul-halaman">Register Surat Keluar (Aplikasi)</div>
