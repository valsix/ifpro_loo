            ...
            <div class="tab-content">
                <div id="tab-informasi" class="tab-pane fade in active">
                    <table class="table">
                        <thead>
                            <tr>
                                <td>Kepada Eksternal<span style="display: xnone;" class="text-danger">*</span></td>
                                <td>:</td>
                                <td>
                                    <span style="display: <?=$infodisplay?>;">
                                        <input type="text" class="easyui-combotree" id="reqEksternalKepadaInfo" name="reqEksternalKepadaInfo"
                                        data-options="
                                        onLoadSuccess: function (row, data) {
                                            loadNode($('#reqEksternalKepadaInfo'), 'reqEksternalKepadaId', 'infodetilkepadaeksternal');
                                        },
                                        onClick: function(node){
                                            clickNode($('#reqEksternalKepadaInfo'), node.id, 'reqEksternalKepadaId', 'infodetilkepadaeksternal');
                                            setinfovalidasi();
                                        }
                                        , width:'500'
                                        , panelHeight:'120'
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if(empty($aksibutton) || !empty($checkparafid) || $reqStatusSurat == "REVISI")
                                    {
                                        $infodisplay= "none";
                                    ?>
...
<script>
    ...
    function submitForm(reqStatusSurat) {
        ...
        if(reqKeterangan == "Powered by Froala Editor" && reqvalidasibaru == "1")
        {
            reqvalidasibaru= "";
...
<script type="text/javascript">
    ...
    function setreloaddaftaralamat(infoid)
    {
        if(infoid == "reqEksternalKepadaId")
        {
            reqEksternalKepadaInfo= setundefined($("#reqEksternalKepadaInfo").combobox("getText"));
        }
        else if(infoid == "reqEksternalTembusanId")
        {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if(infoid == "reqEksternalKepadaId")
                            {
                                ...
                                $('#reqEksternalKepadaInfo').combotree(
                                {
                                    url: urlApp
                                    , onLoadSuccess: function (row, data) {
                                        clickNode($('#reqEksternalKepadaInfo'), response, 'reqEksternalKepadaId', 'infodetilkepadaeksternal');
                                    }
                                });
