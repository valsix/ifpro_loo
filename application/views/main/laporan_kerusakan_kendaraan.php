...
if ($reqId == "") {
    ...
    $reqButuhAksiId= 2;
    $reqJenisNaskah= "24";
    $reqJenisNaskahNama= "Laporan Kerusakan Kendaraan";
    $reqJenisTTD = "QRCODE";
  ...
  <head>
    ...
    <div class="col-lg-12 col-konten-full">
        ...
        <div class="judul-halaman bg-course">
            <span><img src="images/icon-course.png"></span> Laporan Kerusakan Kendaraan
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        {
            ?>
            if ("<?=$reqJenisNaskahNama?>" == 'Laporan Kerusakan Kendaraan') {
...
<script>
    function addRow(array) {
        // console.log("masuk");
        test = `<tr>
        <td><input type="hidden" name="reqKerusakanId[]"><textarea name="reqKerusakanUraian[]" class="easyui-validatebox" style="width: 100%;"></textarea></td>        
