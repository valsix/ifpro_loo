...
<body class="body-popup">
        	...
        	<div class="col-md-12 col-treegrid">
				...
				<div id="tableContainer" class="tableContainer tableContainer-treegrid">
                	<table id="treeSatker" class="easyui-treegrid" style="min-width:100px !important;height:300px"
                            data-options="
                                url: 'web/pegawai_json/combo/?reqMode=approval_sttpd&reqParentId=<?=$reqParentId?>',
                                pagination: true,            
                                pageSize: 50,
								pageList: [50, 100],
                                method: 'get',
 ...
 $(document).ready( function () {
        $('input[name=reqPencarian]').keyup(function() {
            ...
            var urlApp = 'web/pegawai_json/combo/?reqMode=approval_sttpd&reqPencarian='+ value;
            $('#treeSatker').treegrid(
            {
                url: urlApp
            }); 
        ...
        $('#treeSatker').treegrid({
              onDblClickRow: function(param){
                 ...
                 top.setapprovalsttpd(param.id, param.text);
