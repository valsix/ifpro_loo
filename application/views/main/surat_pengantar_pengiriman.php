...
if ($reqId == "") {
    ...
    $reqButuhAksiId= 2;
    $reqJenisNaskah= "21";
    $reqJenisNaskahNama= "Surat Pengantar Pengiriman";
    $reqJenisTTD = "QRCODE";
    ...
    $reqKapal= $surat_masuk->getField("NAMA_KAPAL");
    $reqPPB= $surat_masuk->getField("PPB");
  ...
  <head>
    ...
    <div class="col-lg-12 col-konten-full">
        ...
        <div class="judul-halaman bg-course">
            <span><img src="images/icon-course.png"></span> Surat Pengantar Pengiriman
                    ...
                    <div id="tab-informasi" class="tab-pane fade in active">
                        <table class="table">
                            <thead>
                                ...
                                <tr>
                                    <td>No PPB/BPB <span class="text-danger">*</td>
                                    <td>:</td>
                                    <td>
                                        <input type="text" name="reqPPB" id="reqPPB" class="easyui-validatebox" value="<?=$reqPPB?>" style="width: 900px;" onkeyup="setinfovalidasi();" required />
                                    </td>
                                </tr>
                                <tr>
                                    <td>Nama Kapal <span class="text-danger">*</td>
                                    <td>:</td>
                                    <td>
                                        <input type="text" name="reqKapal" id="reqKapal" class="easyui-validatebox" value="<?=$reqKapal?>" style="width: 900px;" onkeyup="setinfovalidasi();" required />
                                    </td>
                                </tr>
                            </thead>
                        </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <table style="width:100%;margin-left: 5px;">
                                            <thead>
                                              <tr>
                                                <th style="width:15%; border: solid black 1pt;">Kode Barang</th>
                                                <th style="width:30%; border: solid black 1pt;">Nama Barang</th>
                                                <th style="width:15%; border: solid black 1pt;">Kts</th>
                                                <th style="width:15%; border: solid black 1pt;">Satuan</th>
                                                <th style="width:20%; border: solid black 1pt;">Keterangan</th>
                                                <th style="width:5%; border: solid black 1pt;">Aksi</th>
                                              </tr>
                                            </thead>
                                            <tbody id='tbodyObyek'>
                                                <?
                                                ...
                                                ?>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <input type="text" name="reqKodeBarang[]" class="easyui-validatebox" style="width: 100%;" value="<?=$reqKodeBarang?>">
                                                        </td>
                                                        <td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        {
            ?>
            if ("<?=$reqJenisNaskahNama?>" == 'Surat Pengantar Pengiriman') {
...
<script>
    function addRow(array) {
        // console.log("masuk");
        test = `<tr>
        <td><input type="hidden" name="reqIdBarang[]"><input type="text" name="reqKodeBarang[]" class="easyui-validatebox" style="width: 100%;"></td>
        <td><input type="text" name="reqNamaBarang[]" class="easyui-validatebox" style="width: 100%;"></td>
