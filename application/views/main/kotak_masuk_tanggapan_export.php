...
$reqJenisNaskahNamaFile= "kotak_masuk_tanggapan_";
...
$arrdata= array(
	...
	, array("label"=>"TANGGAPAN DARI", "field"=>"DETIL_INFO_DARI_DIPOSISI", "width"=>"")
);

$sOrder = " ORDER BY B.TANGGAL_DISPOSISI DESC";
$set= new SuratMasuk();
$set->selectByParamsTanggapanDisposisi(array(), -1, -1, $this->ID, $statement.$searchJson, $sOrder);
// echo $set->query;exit;
?>
<!DOCTYPE html>
<html lang="en">
