...
$aColumns = array("TR_LOO_ID","PERUSAHAAN","NOMOR [LOO]","TANGGAL [LOO]","NOMOR [LOI]","TANGGAL [LOI]", "KETERANGAN");
?>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/loo_loi_json/json/?reqCabangId=<?=$this->CABANG_ID?>",     
...
<div id="wadah">
    ...
    <thead>
    	<tr>
    		...
    		<th colspan="2" style="text-align: center">LOO</th>
    		<th colspan="2" style="text-align: center">LOI</th>
