...
if ($reqId == "") {
    ...
    $reqJenisNaskahNama= "Petikan Surat Keputusan Direksi";
    $reqJenisTTD = "QRCODE";
    ...
    $reqMemperhatikan= $surat_masuk->getField("MEMPERHATIKAN");
    ...
    $reqSatuanKerjaIdPetikan = $surat_masuk->getField("SATUAN_KERJA_ID_ASAL_PETIKAN");
...
// print_r($arrpasal); echo $totalpasal;exit;
...
<div class="col-lg-12 col-konten-full">
    ...
    <div class="judul-halaman bg-course">
        <span><img src="images/icon-course.png"></span> Petikan Surat Keputusan Direksi
    ...
    <div class="konten-detil">
        ...
        <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
            ...
            <div class="tab-content">
                  ...
                  <!-- <div id="tab-informasi" class="tab-pane fade"> -->
                    <table class="table">
                        <thead>
                            <tr>
                ...
                <!-- <div id="tab-isi" class="tab-pane fade in active"> -->
                    ...
                    <table class="table">
                        <thead>
                           <tr>
                            ...
                            <tr>
                                <td>Memperhatikan <span class="text-danger">*</span></td>
                                <td>:</td>
                                <td>
                                    <textarea placeholder="isi pesan..." id="reqMemperhatikan" name="reqMemperhatikan"><?=$reqMemperhatikan?></textarea>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    Pertama <span class="text-danger">*</span>
                                </td>
                                <td>:</td>
                                <td>
                            ...
                            <tr>
                                <td>Petikan Oleh <span class="text-danger">*</td>
                                <td>:</td>
                                <td>
                                    <?
                                    // kalau nota dinas perihal boleh edit
                                    ...
                                    ?>
                                    <span style="display: none;">
                                        <input type="text" id="reqSatuanKerjaIdPetikan" class="easyui-combotree" name="reqSatuanKerjaIdPetikan" value="<?=$reqSatuanKerjaIdPetikan?>" />
                                    </span>
                                    <?=$infosatuankerjainfo?>
                                    <?
                                    }
                                    ...
                                    {
                                    ?>
                                    <input type="text" id="reqSatuanKerjaIdPetikan" class="easyui-combotree" name="reqSatuanKerjaIdPetikan" data-options="
                                    onClick: function(rec){
                                        $('#infopenandatangankode').text(rec.KODE_SURAT);
                                        $('#infopenandatangannamapejabat').text(rec.NAMA_PEGAWAI);
                                        $('#infopenandatangannip').text(rec.NIP);
                                        ...
                                        if(rec.NIP == '')
                                        {
                                            ...
                                            $('#reqAsalSuratInstansi, #reqUserAtasanId').val(rec.NIP);
                                            $('#reqSatuanKerjaIdPetikan').combotree('setValue', '');
                                        }
                                        setinfovalidasi();
                                    }
                                    , width:'500'
                                    ...
                                    , textField:'text'
                                    , url:'web/satuan_kerja_json/combotreesatker/'
                                    , prompt:'Tentukan Pengirim...'," value="<?=$reqSatuanKerjaIdPetikan?>"
                                    required="required"
                                    />
                                    <?
                                    }
                                    ?>
                                    <!-- <input type="text" id="reqSatuanKerjaIdPetikan" class="easyui-combobox" name="reqSatuanKerjaIdPetikan" data-options="width:'500', panelHeight:'60', valueField:'id', textField:'text', url:'web/satuan_kerja_json/combo_level/?reqId=<?=$reqKdLevel?>',prompt:'Tentukan dari...',
                                        onSelect: function(rec){
                                            

                                            var url = 'web/permohonan_nomor_json/combo_statement/?reqSatuanKerjaIdPetikan='+rec.SATUAN_KERJA_ID+'&reqJenisNaskahId='+$('#reqJenisNaskah').combobox('getValue')+'&reqTipeNaskah=INTERNAL';
                                            $('#reqPermohonanNomorId').combobox('reload', url);
                                            $('#reqPermohonanNomorId').combobox('setValue', '');
                                            $('#reqAsalSuratInstansi').val(rec.SATUAN_KERJA);
                                            var url = 'web/satuan_kerja_json/combo_paraf/?reqId='+rec.SATUAN_KERJA_ID;
                                            ...
                                            $('#reqSatuanKerjaIdParaf').combotree('setValue', '');
                                            setinfovalidasi();
                                        }" value="<?=$reqSatuanKerjaIdPetikan?>" required="required" /> -->
                                    <!-- <input type="text" name="reqAsalSuratInstansi" id="reqAsalSuratInstansi" class="easyui-validatebox textbox" readonly data-options="required:true" value="<?= $this->SATUAN_KERJA_ASAL ?>" style="width:100%"> -->
                                </td>
                            </tr>
                             <tr>
...
<script>
    ...
    function setinfovalidasi()
    {
        ...
        reqKeterangan= 
        reqButuhAksiId= reqSifatNaskah= reqDasar = reqIsiPerintah = reqLainLain = reqPetikanOleh= "";
        ...
        reqMemperhatikan= jQuery($('textarea#reqMemperhatikan').froalaEditor('html.get')).text();
        reqPertama= jQuery($('textarea#reqPertama').froalaEditor('html.get')).text();

        reqPetikanOleh = setundefined($("#reqSatuanKerjaIdPetikan").combobox("getValue"));
        ...
        if(((reqPerihal=="" || reqSatuanKerjaId=="" || reqUserAtasanId=="" )  && reqIdd=="") || ((reqPerihal=="" || reqSatuanKerjaId=="" || reqSatuanKerjaIdTujuan=="" || reqUserAtasanId=="")  && reqIdd!=""))
        ...
        if(reqMenimbang == "Powered by Froala Editor" || reqMenimbang == "" || reqMengingat == "Powered by Froala Editor" || reqMengingat == "" || reqMenetapkan == "Powered by Froala Editor" || reqMenetapkan == "" || reqMemperhatikan == "Powered by Froala Editor" || reqMemperhatikan == "" || reqPertama == "Powered by Froala Editor" || reqPertama == "" || reqPetikanOleh == "")
        {
            $("#tab-isi-danger").show();
        ...
        //     // if (tinyMCE.editors[i].id=="reqKedua" || tinyMCE.editors[i].id=="reqKetiga" || tinyMCE.editors[i].id=="reqKeempat" || tinyMCE.editors[i].id=="reqKelima" || tinyMCE.editors[i].id=="reqKeenam" || tinyMCE.editors[i].id=="reqKetujuh" || tinyMCE.editors[i].id=="reqKedelapan" || tinyMCE.editors[i].id=="reqKesembilan" || tinyMCE.editors[i].id=="reqKesepuluh") {}
        //     if (tinyMCE.editors[i].id=="reqPemesanSatuanKerjaIsi") {}
        //     else 
        //     {
        //         if(content == "")
        //         {
    ...
    function submitForm(reqStatusSurat) {
        ...
        reqvalidasibaru= reqDasar= reqPetikanOleh= "";
        ...
        if(((reqPerihal=="" || reqSatuanKerjaId=="" ||reqSatuanKerjaIdTujuan=="") && reqStatusSurat=='DRAFT') || (reqPerihal=="" || reqSatuanKerjaId=="" || reqSatuanKerjaIdTujuan=="") && reqStatusSurat=='UBAHDATADRAFTPARAF')
        {
            reqvalidasibaru= "";
        ...
        if(((reqMenimbang=="Powered by Froala Editor" || reqMenimbang=="") && reqvalidasibaru == "1") || ((reqMengingat=="Powered by Froala Editor" || reqMengingat=="") && reqvalidasibaru == "1") || ((reqMenetapkan=="Powered by Froala Editor" || reqMenetapkan=="") && reqvalidasibaru == "1") || ((reqMemperhatikan=="Powered by Froala Editor" || reqMemperhatikan=="") && reqvalidasibaru == "1") || ((reqPertama=="Powered by Froala Editor" || reqPertama=="") && reqvalidasibaru == "1") || (reqPetikanOleh == "" && reqvalidasibaru == "1"))
        {
            reqvalidasibaru= "";
   ...
   function setsimpan()
    {
        $('#ff').form('submit', {
            ...
            onSubmit: function() {
                // console.log($(this).form('enableValidation').form('validate') ); return false;
...
<script type="text/javascript">
    ...
    var arrnomorpasal= ["Kedua", "Ketiga", "Keempat", "Kelima", "Keenam", "Ketujuh", "Kedelapan", "Kesembilan", "Kesepuluh", "Kesebelas", "Keduabelas", "Ketigabelas", "Keempatbelas", "Kelimabelas", "Keenambelas", "Ketujuhbelas", "Kedelapanbelas", "Kesembilanbelas", "Keduapuluh", "Keduapuluhsatu", "Keduapuluhdua", "Keduapuluhtiga", "Keduapuluhempat", "Keduapuluhlima"];
    ...
    function tambahpasal()
    {
        ...
        nomorpasal= parseInt(nomorpasal) + 3;
        // nomorpasal= parseInt(nomorpasal) + 1;
        $.get("app/loadUrl/main/petikan_skd_add_pasal?reqId=<?=$reqId?>&nomorpasal="+nomorpasal, function (data) {
            // console.log(data);
    ...
    function setagenda()
    {
        document.location.href = 'main/index/petikan_skd_lihat?reqMode=petikan_skd_add&reqId=<?=$reqId?>';
    }
</script>
...
<script type="text/javascript">
    ...
    tinymce.init({
        selector: "#reqPemesanSatuanKerjaIsi, #reqMenimbang, #reqMengingat, #reqMemperhatikan, #reqMenetapkan, #reqPertama, .tinyMCESimple",
        //height: 200,
        plugins: [
        ...
        setup : function(ed) {
            ...
            ed.on('keyup', function(e) {
                ...
                if($(ed).attr('id') == "reqMenimbang" || $(ed).attr('id') == "reqMengingat" || $(ed).attr('id') == "reqMemperhatikan" || $(ed).attr('id') == "reqMenetapkan" || $(ed).attr('id') == "reqPertama")
                {
                    setinfovalidasi();
                }
...
<script>
    ...
    // event keyup
    $('textarea#reqMenimbang, textarea#reqMengingat, textarea#reqMenetapkan, textarea#reqPertama, textarea#reqMemperhatikan').on('froalaEditor.keyup', function (e, editor, keyupEvent) {
        setinfovalidasi();
    });

    // event like ready
    $('textarea#reqMenimbang, textarea#reqMengingat, textarea#reqMenetapkan, textarea#reqPertama, textarea#reqMemperhatikan').on('froalaEditor.html.set', function (e, editor) {
        setinfovalidasi();
    });

    // event paste after
    $('textarea#reqMenimbang, textarea#reqMengingat, textarea#reqMenetapkan, textarea#reqPertama, textarea#reqMemperhatikan').on('froalaEditor.paste.after', function (e, editor) {
        setinfovalidasi();
    });


    $(function(){
        $('textarea#reqMenimbang, textarea#reqMengingat, textarea#reqMenetapkan, textarea#reqPertama, textarea#reqMemperhatikan, .froalaeditor').froalaEditor({
