...
$reqJenisNaskahNamaFile= "kotak_keluar_tanggapan_";
...
$arrdata= array(
	...
	, array("label"=>"TANGGAPAN KE", "field"=>"DETIL_INFO_DARI_DIPOSISI", "width"=>"")
);

$sOrder = " ORDER BY B.TANGGAL_DISPOSISI DESC";
$set= new SuratMasuk();
$set->selectByParamsTanggapanKeluarDisposisi(array(), -1, -1, $this->ID, $statement.$searchJson, $sOrder);
// echo $set->query;exit;
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <tbody>
				...
				?>
                	...
                	for($i=0; $i<count($arrdata); $i++)
					{
						...
						{
							$tempValue= $set->getField("NAMA_USER")."<br/>".$set->getField("NAMA_SATKER");
						}
