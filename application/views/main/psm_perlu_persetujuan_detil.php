...
$rloo->setpsmterbaca($arrparam);

$infolinkdetil= $reqMode;
$infolinkedit= "psm_add";

$arrattachment= array();
$index_data= 0;
$set= new TrPsm();
$set->selectByParamsAttachment(array("A.TR_PSM_ID" => (int)$reqId));
while($set->nextRow())
{
...
<head>
	...
	<script type="text/javascript">
		...
		function setubah()
		{
			document.location.href = 'main/index/<?=$infolinkedit?>?reqMode=psm_perlu_persetujuan_detil&reqId=<?=$reqId?>';
		}
		...
		function submitForm(reqStatusSurat) 
		{
	        ...
	        {
	        	urllink= "web/trpsm_json/logparaf";
	        	reqMode= "";
	        ...
	        {
	        	urllink= "web/trpsm_json/logposting";
	        	reqMode= "";
		...
		function setinfonomorsesuaitanggalentri()
		{
			...
			infotanggalajax= "web/trpsm_json/setinfonomorsesuaitanggalentri?v=<?=$reqId?>&t="+tanggalapproval;
			$.ajax({
				url: infotanggalajax,
				type: "GET",
				dataType: "json",
...
<body style="overflow:hidden;">
	...
	<div id="wadah">
        ...
        <div class="konten-pdf <?=$classlampiran?>">
        	<iframe name="contentFrame" src="app/loadUrl/report/loo_cetak/?reqId=<?=$reqId?>&templateSurat=psm"></iframe>
        </div>
