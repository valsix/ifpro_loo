...
{
	$reqMode = "ubah";
	$set->selectByParams(array("A.LANTAI_LOO_ID" => $reqId));
	$set->firstRow();
    
	$reqId= $set->getField("LANTAI_LOO_ID");
...
//             $.messager.alertLink('Info', data, 'info', "app/loadUrl/admin/lantai_loo");	
//         }
//     });
...
<body class="bg-kanan-full">
	<div id="judul-popup">Kelola Lantai LOO</div>
	<div id="konten">
    	<div id="popup-tabel2">
...
function submitForm(){
    ...
    $('#ff').form('submit',{
        ...
        success:function(data){
            $.messager.alertLink('Info', data, 'info', "main/index/lantai_loo");  
        }
    });
}
function clearForm(){
