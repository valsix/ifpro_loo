...
$arrdata= array(
    array("label"=>"Note", "width"=>"100")
    , array("label"=>"No SK", "width"=>"")
    , array("label"=>"Tanggal Mutasi", "width"=>"")
    , array("label"=>"Nip", "width"=>"")
    , array("label"=>"Nama Pegawai", "width"=>"")
    , array("label"=>"Jabatan Sebelumnya", "width"=>"")
    , array("label"=>"Jabatan Baru", "width"=>"")
);
?>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 25,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/mutasi_pejabat_json/json",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				...
				$('#btnDelete').on('click', function() {
					...
					deleteData("web/mutasi_pejabat_json/delete", anSelectedId);
    ...
    <div id="bluemenu" class="bluetabs">    
        <ul>
			<li>
                ...
                <?php /*?><a id="btnEdit" title="Ubah"><img src="<?=base_url()?>images/icon-edit.png" /> Ubah</a><?php */?>
