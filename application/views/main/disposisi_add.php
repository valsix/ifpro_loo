...
{
    $reqMode = "ubah";
    $balas_disposisi->selectByParams(array("BALAS_DISPOSISI_ID" => $reqId));
    
    $balas_disposisi->firstRow();
    $reqId                      = $balas_disposisi->getField("BALAS_DISPOSISI_ID");
    $reqNama                    = $balas_disposisi->getField("NAMA");
...
<script type="text/javascript">
	...
	function openPopup(page) {
    	eModal.iframe(page, 'Aplikasi E-Office - PT. Jembatan NusantaraServices ')
	}
