...
<script>
    ...
    function setinfovalidasi(mode)
    {
        ...
        //IKI FUNGSI NYAR
        reqMenimbang= jQuery($('#reqMenimbang').val()).text();
        reqMengingat= jQuery($('#reqMengingat').val()).text();
        reqMenetapkan= jQuery($('#reqMenetapkan').val()).text();
        reqMemperhatikan= jQuery($('#reqMemperhatikan').val()).text();
        reqPertama= jQuery($('#reqPertama').val()).text();
...
<script>
    ...
    new FroalaEditor('#reqMenimbang,#reqMengingat,#reqMenetapkan,#reqPertama,#reqMemperhatikan,.froalaeditor', {
        events: {
    ...
    const editorInstance = new FroalaEditor('#reqMenimbang,#reqMengingat,#reqMenetapkan,#reqPertama,#reqMemperhatikan,.froalaeditor', {
