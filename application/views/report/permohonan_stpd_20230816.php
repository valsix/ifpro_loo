...
<body>
  ...
  <table border="1" style="width: 100%;">
    ...
    <tr>
      <td>&ensp;Pemimpin</td>
      <td>&ensp;:</td>
      <td colspan="5">&ensp;<?=$reqNamaKetua?></td>
    ...
    {?>
      <tr>
        <?if($i==1){?>
          ...
          <td>&ensp;:</td>
          <td colspan="5" width="40%">&ensp;<?=$setinfo->getField("NAMA_pegawai")?></td>
          <td >&ensp;<?=$setinfo->getField("NAMA")?></td>
        <?}else{?>
          <td>&ensp;</td>
          <td>&ensp;</td>
          <td colspan="5">&ensp;<?=$setinfo->getField("NAMA_pegawai")?></td>
          <td >&ensp;<?=$setinfo->getField("NAMA")?></td>
        <?}?>
      </tr>
    <?
  ...
  <table border="1" style="width: 100%;">
    ...
    foreach ($arrKelompok as $key => $value) 
    {
        ...
        $vkelompokbiayastpd= $value["BIAYA"];
        $vkelompokrealisasibiayastpd= $value["PENGAJUAN_BIAYA"];
    ?>
  ...
  <table border="1" style="width: 100%;">
    <tr>
      ...
      <td colspan="3" style="text-align: center">&ensp;LAPORAN REALISASI STPD</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="text-align: center;height: 70px;">&ensp;</td>
