...
$aColumns		= array("PEJABAT_PENGGANTI_ID", "UNIT_KERJA", "NIP_PEJABAT", "PEJABAT", "NIP_PENGGANTI", "NAMA_PENGGANTI", "TANGGAL_MULAI", "TANGGAL_SELESAI");
?>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/pejabat_pengganti_json/json",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				...
				$('#btnDelete').on('click', function() {
					...
					deleteData("web/pejabat_pengganti_json/delete", anSelectedId);
