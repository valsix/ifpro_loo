...
$aColumns = array("DAFTAR_ALAMAT_ID","INSTANSI","ALAMAT","KOTA","NO_TELP","EMAIL","STATUS","KODE_POS","FAX","NAMA_KEPALA","HP");
?>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/daftar_alamat_json/json",			  
			...
			$('#btnDelete').on('click', function () {
	              if(anSelectedData == "")
	                  return false; 
	              // alert(anSelectedId);return false;
	                  
	              deleteData("web/daftar_alamat_json/delete", anSelectedId);
