...
$aColumns = array("JENIS_NASKAH_ID","JENIS_NASKAH", "LEVEL NASKAH (PUSAT)", "LEVEL NASKAH (CABANG)", "NOMOR SURAT", "TIPE NASKAH");
?>
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			...
			/* Click event handler */
			  ...
			  $('#btnDelete').on('click', function () {
				 	...
				 	deleteData("web/jenis_naskah_json/delete", anSelectedId);
