...
$aColumns = array("PEGAWAI_ID", "NIP", "NAMA", "JABATAN", "UNIT KERJA", "DIREKTORAT");
?>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/pegawai_json/json_non_pegawai/?reqCabangId=<?=$this->CABANG_ID?>",    
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				...
				$('#btnDelete').on('click', function () {
		          ...
		          konfirmasiAksi("Non-aktifkan pegawai terpilih?", "web/pegawai_json/nonaktif", anSelectedId);
        ...
        <ul>
			<li>
                <div style="padding-left: 10px">
	            	<span><a id="btnDelete"></i> Non-Aktifkan</a></span>
	                <span style="margin-left:150px;">
	            	<label>Unit Kerja :</label>
	                <input name="reqDepartemen" class="easyui-combotree textbox form-control" id="reqDepartemen" value="<?=$this->CABANG_ID?>"
	                data-options="width:'400',panelHeight:'400',panelWidth:'500',editable:false,valueField:'id',textField:'text',url:'web/satuan_kerja_json/combobox_cabang_satker'"  />
	                </span>

	                <span style="margin-top:-30px; right:0; margin-right:30px; position:absolute"><a id="btnAdd">ImportExcel</a></span>
            	</div>     
            </li>        
        </ul>
    </div>
