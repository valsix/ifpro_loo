...
{
    $reqMode = "update";
    $media_arsip->selectByParams(array("A.MEDIA_ARSIP_ID" => $reqId));
    $media_arsip->firstRow();

    $reqId                  = $media_arsip->getField("MEDIA_ARSIP_ID");
    $reqNama                = $media_arsip->getField("NAMA");
    $reqKode                = $media_arsip->getField("KODE");
    $reqKeterangan          = $media_arsip->getField("KETERANGAN");
}
?>
...
<body class="bg-kanan-full">
	<div id="judul-popup">Kelola Media Arsip</div>
	<div id="konten">
    	<div id="popup-tabel2">
