...
<body style="overflow:hidden;">
	...
	<div id="wadah">
				...
				<li>
					<div style="padding-left: 10px">
						<form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
							...
							<input type="text" name="reqUnitKerjaId" class="easyui-combobox" id="reqUnitKerjaId" data-options="width:'400',editable:false, valueField:'id',textField:'text',url:'web/satuan_kerja_json/combo_cabang'" value="<?= $this->CABANG_ID ?>" required />
							<span>Upload Kode Jabatan <a onClick="downloadTemplate()"><i class="fa fa-download"></i></a>
								<input type="file" name="reqLinkFile" required class="easyui-validatebox"></span>
		...
		<table id="treeSatker" class="easyui-treegrid" style="width:1270px; height:600px" data-options="
                url: 'http://192.168.88.100/asdp_eoffice/web/satuan_kerja_json/treetable/',
                pagination: true,            
                pageSize: 50,
				pageList: [50, 100],
			...
			<thead>
				<tr>
					<th data-options="field:'NAMA'" width="450px">Unit Kerja</th>
