...
$aColumns = array("SATUAN_KERJA_KELOMPOK_ID","KELOMPOK");
?>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/satuan_kerja_kelompok_json/json",			  
			  ...
			  $('#btnEdit').on('click', function () {
				...
				$('#btnDelete').on('click', function () {
                  if(anSelectedData == "")
                      return false; 
                  // alert(anSelectedId);
                  deleteData("web/satuan_kerja_kelompok_json/delete", anSelectedId);
