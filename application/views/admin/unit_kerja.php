...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "web/satuan_kerja_json/json/?reqStatus=1",			  
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
                    $.messager.confirm('Konfirmasi',"Sinkronisasi data unit kerja untuk periode terpilih?",function(r){
                        if (r){
                          var win = $.messager.progress({
                                  title:'E-Office - ASDP Indonesia Ferry',
                                  msg:'Sinkronisasi data satuan kerja...'
                              }); 
                              
                          var jqxhr = $.get("web/satuan_kerja_json/sinkronisasi", function(data) {
                              
                              oTable.fnReloadAjax("web/satuan_kerja_json/json");
                              $.messager.progress('close');
                              $.messager.alert("Pesan", data);
...
<div id="wadah">
    ...
    <div id="bluemenu" class="bluetabs" style="background:url(<?=base_url()?>css/media/bluetab.gif)">    
        <ul>
			<li>
                <a id="btnAdd" title="Tambah"><img src="<?=base_url()?>images/icon-tambah.png" /> Singkron</a>
                <a id="btnEdit" title="Ubah"><img src="<?=base_url()?>images/icon-edit.png" /> Ubah Alamat</a>
                <a id="btnNonAktif" style="display:none" title="Ubah"><img src="<?=base_url()?>images/icon-edit.png" /> Non Aktif</a>
                <a id="btnAktif" style="display:none" title="Ubah"><img src="<?=base_url()?>images/icon-edit.png" /> Aktif</a>
