	...
	<div id="konten">
    	<div id="popup-tabel2">
            ...
            <form id="ff" method="post" novalidate enctype="multipart/form-data">
                ...
                <input type="hidden" name="reqKdLevel" value="" />
                <input type="hidden" name="reqNamaLevel" value="" />
                <input type="hidden" name="reqKdLevelCabang" value="" />
                <input type="hidden" name="reqNamaLevelCabang" value="" />
                 <input type="hidden" name="reqTipeNaskah" value="" />
                <input type="hidden" name="reqJenisTTD" value="" />
