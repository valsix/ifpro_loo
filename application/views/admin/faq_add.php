...
//             $.messager.alertLink('Info', data, 'info', "app/loadUrl/admin/faq");  
//         }
//     });
    	...
    	<div id="popup-tabel2">
            ...
            <form id="ff" method="post" novalidate enctype="multipart/form-data">
                ...
                <div style="text-align:center;padding:5px">
                    ...
                    <!-- <input type="submit" name="reqSubmit"  class="btn btn-primary" value="Submit" onclick="submitForm()"/>
                    -->
                    <input type="reset" id="rst_form"  class="btn btn-warning" value="Reset" /> 
                </div>
            </form>
