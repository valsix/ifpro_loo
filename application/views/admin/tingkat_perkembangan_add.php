...
{
    $reqMode = "update";
    $tingkat_perkembangan->selectByParams(array("A.TINGKAT_PERKEMBANGAN_ID" => $reqId));
    $tingkat_perkembangan->firstRow();

    $reqId                  = $tingkat_perkembangan->getField("TINGKAT_PERKEMBANGAN_ID");
    $reqNama                = $tingkat_perkembangan->getField("NAMA");
    $reqKode                = $tingkat_perkembangan->getField("KODE");
    $reqKeterangan          = $tingkat_perkembangan->getField("KETERANGAN");
}
?>
