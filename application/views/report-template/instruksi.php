...
<body oncontextmenu="return false;">
  ...
  <div class="konten-naskah">
    ...
    <div class="jenis-naskah">
      <div class="nama-jenis-naskah"><u><b>INSTRUKSI DIREKSI PT ASDP INDONESIA FERRY (PERSERO)</u></b></div>
    ...
    <!-- Start Tentang Naskah -->
    <div class="jenis-naskah">
      <div class="nomor-naskah"><b>DIREKSI PT ASDP INDONESIA FERRY (PERSERO)</b></div>
    </div>
    <!-- End Tentang Naskah -->
    ...
    <div class="isi-naskah">
      <table width="100%">
        ...
        <tr>
          ...
          <td>:</td>
          <td>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sed faucibus dui. Morbi tempor, risus at sodales fringilla, ligula lorem tincidunt elit, ac efficitur ligula dolor id lorem. Donec vel augue lectus. Proin facilisis metus quis mi rhoncus luctus.
          </td>
        </tr>
        <tr>
          <td><b>KEDUA</b></td>
    ...
    <!-- Start Tembusan -->
    <div class="tembusan">
      <b><u>Salinan Keputusan ini disampaikan kepada Yth. :</u></b>
      <ol>
