...
<body oncontextmenu="return false;">
  ...
  <div class="konten-naskah">
    ...
    <div class="jenis-naskah">
      <div class="nama-jenis-naskah"><u>S U R A T&nbsp;&nbsp;&nbsp;&nbsp;P E R I N T A H</u></div>
    ...
    <div class="isi-naskah">
      <table width="100%">
        <tr>
          <td width="20%"><b>Pertimbangan</b></td>
          <td width="1%">:</td>
          <td width="79%">
            <ol type="a">
        ...
        <tr>
          <td colspan="3" align="center"><b>DIPERINTAHKAN :</b></td>
        </tr>
        <tr>
          <td colspan="3" align="center">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td>
            <ol>
              <li>Lorem Ipsum Dolor (NIP.1687687-S / Business Research Officer)</li>
              <li>Lorem Ipsum Dolor (NIP.1687687-S / Business Research Officer)</li>
            </ol>
          </td>
        </tr>
