...
<script type="text/javascript">	
	$(function(){
	$('#ff').form({
		url:'<?=base_url()?>pegawai_proyek_json/addImport/',
		onSubmit:function(){
...
<body class="bg-kanan-full">
	<div id="judul-popup">Import Pegawai Proyek</div>
	<div id="konten">
    	<div id="popup-tabel2">
            ...
            <thead>      
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <a href="<?=base_url()?>app/loadUrl/app/pegawai_proyek_template_excel" target="_blank"><img src="<?=base_url()?>images/icon-excel.png" /> Download </a>
                    </td>
                </tr>   
                <tr>
                    <td>File</td>
