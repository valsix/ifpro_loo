...
$worksheet->set_column(35, 35, 5.00);
...
$worksheet->set_column(40, 40, 16.00);
$worksheet->set_column(41, 41, 14.00);
...
$worksheet->write(5, 4, "BULAN ".strtoupper(getSelectFormattedDate($reqBulan))." ".$reqTahun."", $text_format_merge_line_bold);
...
$worksheet->write(5, 35, "KETIDAK HADIRAN ", $text_format_merge_line_bold);
...
$worksheet->write(6, 35, "SAKIT", $text_format_merge_line_bold);
$worksheet->write(6, 36, "IZIN", $text_format_merge_line_bold);
$worksheet->write(6, 37, "ALFA", $text_format_merge_line_bold);
$worksheet->write(6, 38, "CUTI", $text_format_merge_line_bold);
$worksheet->write(6, 39, "DINAS", $text_format_merge_line_bold);

$worksheet->write(5, 40, "TOTAL TIDAK HADIR", $text_format_line_bold_no_bottom);
$worksheet->write(6, 40, "", $text_format_line_bold_no_top);
$worksheet->write(5, 41, "TOTAL KEHADIRAN", $text_format_line_bold_no_bottom);
$worksheet->write(6, 41, "", $text_format_line_bold_no_top);
...
while($absensi_rekap->nextRow())
{
	...
	$worksheet->write($row, 35, $absensi_rekap->getField('SAKIT'), $text_format_line_left);
	$worksheet->write($row, 36, $absensi_rekap->getField('IJIN'), $text_format_line_left);
	$worksheet->write($row, 37, $absensi_rekap->getField('ALPHA'), $text_format_line_left);
	$worksheet->write($row, 38, $absensi_rekap->getField('CUTI'), $text_format_line_left);
	$worksheet->write($row, 39, $absensi_rekap->getField('DINAS'), $text_format_line_left);
	$worksheet->write($row, 40, $absensi_rekap->getField('TIDAK_HADIR'), $text_format_line_left);
	$worksheet->write($row, 41, $absensi_rekap->getField('HADIR'), $text_format_line_left);
	$no++;
	$row++;
}
