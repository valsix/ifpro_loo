...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>jam_kerja_shift_json/json",		  
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
				 window.parent.openPopup("<?=base_url()?>app/loadUrl/app/jam_kerja_shift_add/");
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/jam_kerja_shift_add/?reqId="+anSelectedId);
...
<div id="wadah">
    <div class="judul-halaman">Data Master Jam Kerja Shift</div>
    ...
    <thead>
        <tr>
            ...
            <th width="100px">Jam Awal</th>
            <th width="100px">Jam Akhir</th>
            <th width="100px" >Status</th> 
            <th width="100px" >Satker ID</th> 
            <th width="100px">Terlambat Awal</th> 
            <th width="100px">Terlambat Akhir</th> 
        </tr>
    </thead>
    </table> 
</div>
