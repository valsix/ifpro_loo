...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>phpshoutbox_json/json",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/phpshoutbox_add/?reqId="+anSelectedId);
...
<div id="wadah">
    <div class="judul-halaman">Chatting</div>
    <div id="bluemenu" class="bluetabs" style="background:url(<?=base_url()?>css/media/bluetab.gif)">    
        <ul>
			<li>
                <a href="#" id="btnEdit" title="Ubah"><img src="<?=base_url()?>images/icon-edit.png" /> Balas</a>
            </li>        
        </ul>
    </div>
    ...
    <thead>
        <tr>
            ...
            <th width="200px">Pesan Terakhir</th>
