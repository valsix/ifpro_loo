...
<script type="text/javascript">	
	$(function(){
	$('#ff').form({
		url:'<?=base_url()?>import_cuti_bersalin_json/addImport',
		onSubmit:function(){
...
<body class="bg-kanan-full">
	<div id="judul-popup">Import Cuti Besar</div>
	<div id="konten">
    	<div id="popup-tabel2">
            ...
            <thead>      
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <a href="<?=base_url()?>app/loadUrl/app/import_cuti_besar_import_template_excel" target="_blank"><img src="<?=base_url()?>images/icon-excel.png" /> Download </a>
                    </td>
                </tr>   
                <tr>
                    <td>File</td>
