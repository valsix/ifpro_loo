...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>jam_kerja_json/json",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/jam_kerja_add/?reqId="+anSelectedId);
...
<div id="wadah">
    <div class="judul-halaman">Data Master Jam Kerja</div>
    ...
    <thead>
        <tr>
                        ...
                        <th width="200px">Jam Awal</th> 
                        <th width="150px">Jam Akhir</th>
                        <th width="200px">Terlambat Awal</th> 
                        <th width="150px">Terlambat Akhir</th>
