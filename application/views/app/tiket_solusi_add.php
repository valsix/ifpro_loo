...
$this->load->model('TiketSolusi');

$tiket_solusi = new TiketSolusi();
...
{
	$reqMode = "update";	
	$tiket_solusi->selectByParams(array('TIKET_SOLUSI_ID'=>$reqId), -1, -1);
	$tiket_solusi->firstRow();

	$reqTiketPenerimaanId = $tiket_solusi->getField("TIKET_PENERIMAAN_ID");
	$reqTanggal = dateToPageCheck($tiket_solusi->getField("TANGGAL"));
	$reqKode = $tiket_solusi->getField("KODE");
	$reqSolusi = $tiket_solusi->getField("SOLUSI");
	$reqLinkFile = $tiket_solusi->getField("DOKUMENTASI");
...
$(function(){
	$('#ff').form({
		url:'<?=base_url()?>tiket_solusi_json/add',
		onSubmit:function(){
...
<body class="bg-kanan-full">
	<div id="judul-popup">Tambah Tiket Solusi</div>
	<div id="konten">
    	<div id="popup-tabel2">
            <form id="ff" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <textarea name="reqSolusi" style="width:250px; height:100px;"><?=$reqSolusi?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>Dokumentasi</td>
