...
$finger_scan_lokasi->selectByParams();
$i = 0;
$mesin_id = "";
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>fingerscan_json/json/?reqTanggal=<?=date("dmY")?>&reqMesin=<?=$mesin_id?>",			  
...
<div id="wadah">
    <div class="judul-halaman">Data Fingerscan</div>
    <div id="bluemenu" class="bluetabs" style="background:url(<?=base_url()?>css/media/bluetab.gif)">    
        <ul>
			<li>
                <a href="#" title="Import" id="btnImport">&nbsp;Import</a>    
            </li>        
        </ul>
    </div>
    ...
    <thead>
        <tr>
            <th width="50px" rowspan="2">NRP</th>
            <th width="150px" rowspan="2">Nama</th>
            <th width="200px" rowspan="2">Departemen</th>
		   <?
           for($i=0;$i<count($arrMesin);$i++)
           {
           ?>
            <th width="150px" colspan="2" style="text-align:center"><?=$arrMesin[$i]["KETERANGAN"]?></th>           												 								 
           <?
           }
           ?>                                        
        </tr>
        <tr>
           ...
           {
           ?>
            <th width="50px" style="text-align:center">IN</th>
            <th width="50px" style="text-align:center">OUT</th>        
           <?
           }
           ?>                                        
        </tr>
