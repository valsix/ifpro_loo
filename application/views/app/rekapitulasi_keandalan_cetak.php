...
$fname = tempnam("/tmp", "rekapitulasi_keandalan_cetak.xls");
...
$worksheet->set_column(35, 35, 30.00);
...
$worksheet->write(1, 1, "ABSENSI PIKET KEANDALAN UNIT ORGANIK", $text_format_merge);
for($i=2; $i<=35; $i++)
{
...
$worksheet->write(5, 35, "JUMLAH KEHADIRAN", $text_format_line_bold_no_bottom);
$worksheet->write(6, 35, "", $text_format_line_bold_no_top);
...
header("Content-Type: application/x-msexcel; name=\"rekapitulasi_keandalan_cetak.xls\"");
header("Content-Disposition: inline; filename=\"rekapitulasi_keandalan_cetak.xls\"");
$fh=fopen($fname, "rb");
fpassthru($fh);
unlink($fname);
?>