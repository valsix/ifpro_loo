...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>permohonan_proyek_json/json_pencarian/?reqJenis=garansi",		  
			...
			/* Click event handler */
			  ...
			  $("#example tbody").click(function(event) {
					  ...
					  anSelectedTanggalAwal = element[7];
					  anSelectedTanggalAkhir = element[8];
			  ...
			  $('#btnPilih').on('click', function () {
				  ...
				  parent.pilih(anSelectedNama, anSelectedId, anSelectedTanggalAwal, anSelectedTanggalAkhir);
...
<div id="wadah">
    <div class="judul-halaman">Data Proyek</div>
