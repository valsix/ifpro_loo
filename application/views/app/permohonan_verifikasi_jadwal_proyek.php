...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>permohonan_proyek_json/json_verifikator",		  
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
			   ...
			   $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedPublish == "" || anSelectedPublish == "0")	  
				  	  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_verifikasi_jadwal_proyek_add_data/?reqMode=update&reqId="+anSelectedId);
				  else
			  ...
			  $('#btnLihat').on('click', function () {
				  ...
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_verifikasi_jadwal_proyek_add_data/?reqMode=view&reqId="+anSelectedId);
