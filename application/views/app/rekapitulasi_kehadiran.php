...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>rekapitulasi_kehadiran_json/json/?reqTahun=<?=$reqTahun?>&reqBulan=<?=$reqBulan?>&reqDepartemen=<?=$reqDepartemen?>",			  
			...
			/* Click event handler */
			  ...
			  $('#reqDepartemen').combotree({
					onSelect: function(param){
						 oTable.fnReloadAjax("<?=base_url()?>rekapitulasi_kehadiran_json/json/?reqTahun=" +$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val()+"&reqDepartemen="+param.id);				 	 
					}
			  });
			  ...
			  $('#btnCetak').on('click', function () {
				  newWindow = window.open('rekapitulasi_kehadiran_cetak.php?reqBulan='+$("#reqBulan").val()+'&reqTahun='+ $("#reqTahun").val()+"&reqDepartemen="+$('#reqDepartemen').combotree('getValue'), 'Cetak');
				  newWindow.focus();
			  });
		});
</script>
...
<div id="wadah">
    <div class="judul-halaman">Monitoring Kehadiran</div>
    ...
    <div id="parameter-tambahan">
                ...
                Departemen : <input id="reqDepartemen" class="easyui-combotree" name="reqDepartemen" data-options="url:'<?=base_url()?>departemen_combotree_json/json'" style="width:400px;" value="<?=$reqDepartemen?>">&nbsp;&nbsp;&nbsp; 
    </div>
    ...
    <thead>
            <tr>
                ...
                <th width="20px" colspan="7" style="text-align:center">Hadir</th>
                <th width="20px" colspan="7" style="text-align:center">Ijin</th>
                <th width="20px" colspan="8" style="text-align:center">Cuti Lainnya</th>
                <th width="20px" rowspan="2">Cuti Tahunan</th>
                <th width="20px" rowspan="2">Istirahat</th>
            ...
            <tr>
                ...
                <th width="20px">HTAD</th> 
                <th width="20px">HTAP</th> 
                <th width="20px">Jumlah</th> 
                <th width="20px">IM</th> 
                <th width="20px">IMKK</th> 
                <th width="20px">IMMPAK</th> 
                <th width="20px">IKM</th> 
                <th width="20px">IKAK</th> 
                <th width="20px">SDK</th> 
                <th width="20px">Jumlah</th> 
                <th width="20px">CB</th> 
                <th width="20px">CBS</th> 
                <th width="20px">CD</th> 
                <th width="20px">CGK</th> 
                <th width="20px">CH</th> 
                <th width="20px">CIK</th> 
                <th width="20px">CKW</th> 
            </tr>
    </thead>
    </table> 
</div>
