...
$fname = tempnam("/tmp", "import_istirahat.xls");
...
for ($i=0; $i < 2; $i++)
{
	...
	if ($i==0)
	{
		...
		$worksheet->set_column(8, 8, 14.00);
			...
			$worksheet->write(0, 7, "TAHUN", $text_format_line_bold);
...
header("Content-Type: application/x-msexcel; name=\"import_istirahat_import_template.xls\"");
header("Content-Disposition: inline; filename=\"import_istirahat_import_template.xls\"");
$fh=fopen($fname, "rb");
fpassthru($fh);
unlink($fname);
?>