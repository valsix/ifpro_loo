...
if($reqMode == "update" || $reqMode == "view")
{
...
$(function(){
	$('#ff').form({
		...
		success:function(data){
			...
			window.parent.location.href = "<?=base_url()?>app/loadUrl/app/permohonan_jadwal_proyek_garansi_add/?reqId=" + data[0] +"reqMode=update";
			//top.closePopup();
		}
	});
