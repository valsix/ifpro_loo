...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>rekapitulasi_json/json_rekap_kehadiran/?reqTahun=<?=$reqTahun?>&reqBulan=<?=$reqBulan?>&reqPegawaiId=<?=$reqPegawaiId?>",			  
...
<div id="wadah">
    <div class="judul-halaman">Keterlambatan Pegawai Periode Bulan <?=getSelectFormattedDate($reqBulan)?> Tahun <?=$reqTahun?></div>
    ...
    <thead>
        <tr>
            ...
            <th width="150px">Pulang Cepat</th>
            <th width="150px">Total</th>
            <th width="150px">Toleransi</th>
        </tr>
    </thead>
    </table> 
</div>
