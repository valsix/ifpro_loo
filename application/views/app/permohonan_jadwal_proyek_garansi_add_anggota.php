...
$(function(){
	...
	$("#reqSubmit").hide();
	$("#rst_form").hide();
	$("#reqTanggalAwal, #reqTanggalAkhir").datebox({
        disabled:true
    });
...
<body class="bg-kanan-full" onload="AlasanTolak()">
	<div id="judul-popup">Data Anggota Garansi Proyek</div>
    <div class="aksi-area">
        <span>
        	<a id="btnAdd" title="Tambah" onClick="openPopupProyek('<?=base_url()?>app/loadUrl/main/pegawai_proyek_anggota_garansi/?reqId=<?=$reqId?>&reqPermohonanProyekParentId=<?=$reqPermohonanProyekParentId?>')"><img src="<?=base_url()?>images/icon-tambah.png" /> Tambah</a>
                ...
                ?>
                    <tr id="<?=$i?>">
                        ...
                        <td align="center">
                            ...
                            <input type="hidden" name="reqTanggalAwal[]" value="<?=$kelompok_proyek_pegawai->getField("TANGGAL_AWAL")?>">
                ...
                <table class="table">
                	<tbody>
                    	...
                    	<tr>
                            ...
                            <td>:</td>
                            <td>
                        		<input name="reqLampiranBso[]" type="file" multiple class="maxsize-1024" accept="pdf|jpg|jpeg" id="reqLampiranBso" value="" />
                            </td>
                        </tr>
                        <? 
						if ($reqLampiranBso == "") 
