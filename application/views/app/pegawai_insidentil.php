...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>pegawai_json/json_insidentil",			  
			...
			/* Click event handler */
			  ...
			  $("#example tbody").click(function(event) {
					  ...
					  anSelectedJabatan = element[3];
					  anSelectedEmail = element[4];
					  anSelectedTelepon = element[5];
			  ...
			  $('#btnPilih').on('click', function () {
				  ...
				  parent.createRow(anSelectedId,anSelectedNama);
				  
				  //alert('ll');
				  window.parent.closePopup();
				  
				  //eModal.close();  
				  //top.createRow(anSelectedId,anSelectedNama,anSelectedJabatan);
			  });
		});
</script>
