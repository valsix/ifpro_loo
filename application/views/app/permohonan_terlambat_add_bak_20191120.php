...
else
{
	...
	$reqPegawaiId = $permohonan_lambat_pc->getField("PEGAWAI_ID");
	$reqTahun = $permohonan_lambat_pc->getField("TAHUN");
	...
	$reqCabang = $permohonan_lambat_pc->getField("CABANG");
	...
	$reqPegawaiIdApproval = $permohonan_lambat_pc->getField("PEGAWAI_ID_APPROVAL");
	$reqApproval1 = $permohonan_lambat_pc->getField("APPROVAL1");
	$reqApproval2 = $permohonan_lambat_pc->getField("APPROVAL2");
    	...
    	<div id="popup-tabel2">
            <form id="ff" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <thead>
                        ...
                        ?>
                        <tr>
                        	<th colspan="3">Approval <?=$permohonan_lambat_pc->getField("NAMA_APPROVAL1")?></th>
                        </tr>
                        <tr>
                            <td>Persetujuan</td>
                            <td>:</td>
                            <td>
                                <?=$permohonan_lambat_pc->getField("APPROVAL1")?>
                            </td>
                        </tr>
                        <?
                            if ($permohonan_lambat_pc->getField("APPROVAL1") == "Ditolak")
							{
							?>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <?=$permohonan_lambat_pc->getField("ALASAN_TOLAK1")?>
                                    </td>
                                </tr>
                        <?
							}
						?>
                        <tr>
                        	<th colspan="3">Approval <?=$permohonan_lambat_pc->getField("NAMA_APPROVAL2")?></th>
                        </tr>
                        <tr>
                            <td>Persetujuan</td>
                            <td>:</td>
                            <td>
                                <?=$permohonan_lambat_pc->getField("APPROVAL2")?>
                            </td>
                        </tr>
                        <?
                            if ($permohonan_lambat_pc->getField("APPROVAL2") == "Ditolak")
							{
							?>
                                <tr>
                                    <td>Alasan Penolakan</td>
                                    <td>:</td>
                                    <td>
                                        <?=$permohonan_lambat_pc->getField("ALASAN_TOLAK2")?>
                                    </td>
                                </tr>
                        <?
							}
