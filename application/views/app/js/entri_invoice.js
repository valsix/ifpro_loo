function addRow()
{
	...
	button.innerHTML = '<center><a style="cursor:pointer;" onclick="deleteRowDrawTable(\'dataTableRowDinamis\', this)"><img src="../../vendor/WEB-INF/images/delete-icon.png" width="15" height="15" border="0" /></a><input type="hidden" name="reqLokasi[]" value="0"></center>';
	...
	$('#reqInventaris'+rowCount).combobox({  
		...
		valueField: 'id', 
		textField: 'text',
		url:'../json-masterdata/inventaris_combo_json.php?reqTahun='+$("#reqTahun").val()+''
	});
