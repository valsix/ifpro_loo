...
{
	$reqMode = "update";	
	$kelompok_keandalan->selectByParams(array("KELOMPOK_KEANDALAN_ID" => $reqId));
	$kelompok_keandalan->firstRow();
	$reqPermohonanKeandalanId = $kelompok_keandalan->getField("PERMOHONAN_KEANDALAN_ID");
	$reqCabangId = $kelompok_keandalan->getField("CABANG_ID");
	$reqNama = $kelompok_keandalan->getField("NAMA");
	$reqKeterangan = $kelompok_keandalan->getField("KETERANGAN");
}
...
$(function(){
	$('#ff').form({
		url:'<?=base_url()?>kelompok_keandalan_json/add',
		onSubmit:function(){
...
<body class="bg-kanan-full">
	<div id="judul-popup">Tambah Kelompok Keandalan</div>
	<div id="konten">
    	<div id="popup-tabel2">
            <form id="ff" method="post" novalidate>
                    ...
                    <thead>
                        <tr>
                            <td>Permohonan Keandalan Id</td>
                            <td>:</td>
                            <td>
                                <input type="text" name="reqPermohonanKeandalanId" class="easyui-validatebox" style="width:350px;" value="<?=$reqPermohonanKeandalanId?>" />
                            </td>
                        </tr>
                        <tr>
                            <td>Cabang Id</td>
