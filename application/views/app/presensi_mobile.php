...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>rekapitulasi_json/json_presensi_mobile/?reqTahun=<?=$reqTahun?>&reqBulan=<?=$reqBulan?>&reqDepartemen=<?=$reqDepartemen?>",			  
			...
			/* Click event handler */
			  ...
			  $('#btnProses').on('click', function () {
				  if(confirm("Proses keterlambatan ?"))
				  {
					  ...
					  var jqxhr = $.get("<?=base_url()?>rekapitulasi_json/proses_rekap_terlambat/?reqTahun="+$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val()+"&reqDepartemen="+$('#reqDepartemen').combotree('getValue'), function(data) {
						  ...
						  oTable.fnReloadAjax("<?=base_url()?>rekapitulasi_json/json_presensi_mobile/?reqTahun="+$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val()+"&reqDepartemen="+$('#reqDepartemen').combotree('getValue'));	
			  ...
			  $('#btnDetil').on('click', function () {
				  ...
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/presensi_mobile_detil/?reqTahun="+$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val()+"&reqPegawaiId="+anSelectedId);
			 ...
			 $("#reqTahun").change(function() {
			  ...
			  $('#reqDepartemen').combotree({
					onSelect: function(param){
						oTable.fnReloadAjax("<?=base_url()?>rekapitulasi_json/json_presensi_mobile/?reqTahun=" +$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val()+"&reqDepartemen="+param.id);
					}
			  });
...
<div id="wadah">
    <div class="judul-halaman">Rekapitulasi Presensi Mobile</div>
    ...
    <thead>
            <tr>
                ...
                <th width="150px" style="text-align:center">Jabatan</th> 
                <th width="70px" style="text-align:center">Departemen</th> 
