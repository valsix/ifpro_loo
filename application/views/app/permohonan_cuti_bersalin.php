        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
				  document.location.href = "app/index/permohonan_cuti_bersalin_add";
			   ...
			   $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;			
				  document.location.href = "app/index/permohonan_cuti_bersalin_add/reqMode=view"+anSelectedId;	
...
<div id="wadah">
    <div class="judul-halaman">Permohonan Cuti Bersalin</div>
    <div id="bluemenu" class="bluetabs" style="background:url(<?=base_url()?>css/media/bluetab.gif)">    
        <ul>
			<li>
                <a href="#" id="btnEdit" title="Tambah"><img src="<?=base_url()?>images/icon-tambah.png" /> Lihat</a> 
            </li>        
        </ul>
    </div>
