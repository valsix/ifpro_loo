...
$reqCabangNama = $this->input->get("reqCabangNama");
...
$cabang->firstRow();
//echo "adsfasdfasdf".$absensi_rekap->query; exit;
...
$worksheet->write(1, 5, "DAFTAR KEHADIRAN CABANG/UNIT ".strtoupper($cabang->getField('NAMA')), $text_format);
$worksheet->write(2, 5, "BULAN ".getNamePeriode($periode), $text_format_merge);
