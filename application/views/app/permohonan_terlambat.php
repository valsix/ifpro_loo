        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
				  document.location.href = "app/index/permohonan_terlambat_add";
			  ...
			  $('#btnEdit').on('click', function () {
				...
				if(anSelectedPublish == "" || anSelectedPublish == "0")	  
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_terlambat_add/?reqId="+anSelectedId+"&reqMode=update");
				else
			  ...
			  $('#btnLihat').on('click', function () {
				  ...
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_terlambat_add/?reqId="+anSelectedId+"&reqMode=view");
...
<div id="wadah">
    ...
    <thead>
        <tr>
            ...
            <th width="100px">Tanggal Permohonan</th>
            <th width="100px">Tanggal Ijin</th>
            <th width="100px">Jam Datang</th>
