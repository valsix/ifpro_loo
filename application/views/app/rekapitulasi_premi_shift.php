...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>rekapitulasi_premi_shift_json/json/?reqTahun=<?=$reqTahun?>&reqBulan=<?=$reqBulan?>&reqDepartemen=<?=$reqDepartemen?>",			  
			...
			/* Click event handler */
			  ...
			  $("#reqBulan, #reqTahun").change(function() { 
				 oTable.fnReloadAjax("<?=base_url()?>rekapitulasi_premi_shift_json/json/?reqTahun=" +$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val()+"&reqDepartemen="+$('#reqDepartemen').combotree('getValue'));				 	 
			  });
			  
			  $('#reqDepartemen').combotree({
					onSelect: function(param){
						oTable.fnReloadAjax("<?=base_url()?>rekapitulasi_premi_shift_json/json/?reqTahun=" +$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val()+"&reqDepartemen="+param.id);
					}
			  });
			  ...
			  $('#btnCetak').on('click', function () {
				  newWindow = window.open('rekapitulasi_premi_shift_cetak.php?reqBulan='+$("#reqBulan").val()+'&reqTahun='+ $("#reqTahun").val()+"&reqDepartemen="+$('#reqDepartemen').combotree('getValue'), 'Cetak');
				  newWindow.focus();
			  });
		});
</script>
...
<div id="wadah">
    <div class="judul-halaman">Rekapitulasi Premi Shift</div>
    ...
    <thead>
            <tr>
                ...
                <th width="250px" rowspan="2">Keterangan</th>
                <th colspan="6" style="text-align:center">Libur Nasional</th>
                <th colspan="3" style="text-align:center">Normal</th>
                <th colspan="3" style="text-align:center">Jumlah Shift Hari Kerja</th>
                <th colspan="3" style="text-align:center">Jumlah Shift Hari Libur</th>
            </tr>
            <tr>
                <?
                 $x=1;
                 ...
                 ?> 
            	<th width="30px" style="text-align:center">P</th>
            	<th width="30px" style="text-align:center">S</th>
            	<th width="30px" style="text-align:center">M</th>
            	<th width="30px" style="text-align:center">PS</th>
            	<th width="30px" style="text-align:center">SM</th>
            	<th width="30px" style="text-align:center">MP</th>
            	<th width="30px" style="text-align:center">PS</th>
            	<th width="30px" style="text-align:center">SM</th>
            	<th width="30px" style="text-align:center">MP</th>
            	<th width="30px" style="text-align:center">Pagi</th>
            	<th width="30px" style="text-align:center">Sore</th>
            	<th width="30px" style="text-align:center">Malam</th>
            	<th width="30px" style="text-align:center">Pagi</th>
            	<th width="30px" style="text-align:center">Sore</th>
            	<th width="30px" style="text-align:center">Malam</th>
            </tr>
