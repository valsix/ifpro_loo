...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>import_cuti_bersalin_json/json?reqIjinKoreksiId=8&reqDepartemen=<?=$reqDepartemen?>",		  
			...
			/* Click event handler */
			  ...
			  $('#btnImport').on('click', function () {
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/import_cuti_besar_import/");
			  ...
			  $('#reqDepartemen').combotree({
					onSelect: function(param){
						oTable.fnReloadAjax("<?=base_url()?>import_cuti_bersalin_json/json?reqIjinKoreksiId=8&reqDepartemen="+param.id);	
					}
			  });
		});
</script>
...
<div id="wadah">
    <div class="judul-halaman">Import Cuti Besar</div>
