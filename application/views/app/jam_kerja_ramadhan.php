...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>jam_kerja_ramadhan_json/json",			  
			...
			/* Click event handler */
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/jam_kerja_ramadhan_add/?reqId="+anSelectedId);
...
<div id="wadah">
    <div class="judul-halaman">Data Master Jam Kerja Ramadhan</div>
    ...
    <thead>
    	<tr>
            <th rowspan="2">Id</th>
            <th width="150px" rowspan="2" style="text-align:center">Tahun</th>
            <th width="150px" colspan="2" style="text-align:center">Periode</th>         
            <th width="150px" colspan="2" style="text-align:center">Senin-Kamis</th>                
            <th width="150px" colspan="2" style="text-align:center">Jumat</th>                                 
        </tr>
        <tr>
			<th>Awal</th>        
			<th>Akhir</th>        
