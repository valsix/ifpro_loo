...
{
	$reqMode = "update";	
	$provinsi->selectByParams(array('PROVINSI_ID'=>$reqId), -1, -1);
	$provinsi->firstRow();
	
	$reqNama= $provinsi->getField('NAMA');
	$reqKeterangan= $provinsi->getField('KETERANGAN');
	$reqHari= $provinsi->getField('HARI');
}
...
$(function(){
	$('#ff').form({
		url:'<?=base_url()?>provinsi_json/add',
		onSubmit:function(){
...
<body class="bg-kanan-full">
	<div id="judul-popup">Tambah Provinsi</div>
	<div id="konten">
    	<div id="popup-tabel2">
            <form id="ff" method="post" novalidate>
                    ...
                    <thead>
                        ...
                        <tr>           
                             <td>Jumlah Hari</td><td>:</td>
                             <td>
                             <input type="text" name="reqHari" value="<?=$reqHari?>"> Hari
                            </td>			
                        </tr>
                    </table>
                    </thead>
