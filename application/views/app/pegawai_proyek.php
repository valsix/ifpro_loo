...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>pegawai_proyek_json/json/?reqDepartemen=<?=$reqDepartemen?>",		  
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/pegawai_proyek_add/");
			  ...
			  $('#btnEditData').on('click', function () {
				  ...
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/pegawai_proyek_add/?reqId="+anSelectedId);
			  ...
			  $('#btnEdit').on('click', function () {
			   ...
			   $('#btnDelete').on('click', function () {
					...
					$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
						if (r){
							$.getJSON("<?=base_url()?>pegawai_proyek_json/delete/?reqId="+anSelectedId,
							  function(data){
									  $.messager.alert('Info', data.PESAN, 'info');
									  oTable.fnReloadAjax("<?=base_url()?>pegawai_proyek_json/json/?reqDepartemen="+$('#reqDepartemen').combotree('getValue'));
							});
			  ...
			  $('#reqDepartemen').combotree({
					onSelect: function(param){
						oTable.fnReloadAjax("<?=base_url()?>pegawai_proyek_json/json/?reqDepartemen="+param.id);	
					}
			  });
			  
			  $('#btnImport').on('click', function () {
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/pegawai_proyek_import/");
...
<div id="wadah">
    <div class="judul-halaman">Pegawai Proyek</div>
    ...
    <thead>
        <tr>
            ...
            <th width="100px">Jabatan Proyek</th>
        </tr>
    </thead>
    </table> 
</div>
