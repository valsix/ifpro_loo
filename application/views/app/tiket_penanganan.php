...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>tiket_penanganan_json/json",			  
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
				  window.parent.createWindow2("<?=base_url()?>app/loadUrl/app/tiket_penanganan_add");
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.createWindow2("<?=base_url()?>app/loadUrl/app/tiket_penanganan_add/?reqId="+anSelectedId);
			  ...
			  $('#btnDelete').on('click', function () {
					...
					$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
						if (r){
							$.getJSON("<?=base_url()?>tiket_penanganan_json/delete/?reqId="+anSelectedId,
							  function(data){
									  $.messager.alert('Info', data.PESAN, 'info');
									  oTable.fnReloadAjax("<?=base_url()?>tiket_penanganan_json/json");
							});
...
<div id="wadah">
    <div class="judul-halaman">Data Tiket Penanganan</div>
    ...
    <thead>
        <tr>
            <th>Id</th>
            <th width="150px">Nama Tiket</th>
            <th width="150px">Tingkat Kesulitan</th>
            <th width="70px">Tanggal</th>
            <th width="70px">Estimasi Selesai</th>
            <th width="70px">Estimasi Selesai Sd</th>
        </tr>
     </thead>
    </table> 
</div>
