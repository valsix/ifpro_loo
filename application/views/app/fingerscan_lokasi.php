...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>fingerscan_lokasi_json/json",		  
			...
			/* Click event handler */
			  ...
			  $("#example tbody").click(function(event) {
			   ...
			   $('#btnAdd').on('click', function () {
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/fingerscan_lokasi_add");
			  ...
			  $('#btnEdit').on('click', function () {
				  ...
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/fingerscan_lokasi_add/?reqId="+anSelectedId);
			   ...
			   $('#btnDelete').on('click', function () {
					...
					$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
						if (r){
							$.getJSON("<?=base_url()?>fingerscan_lokasi_json/delete/"+anSelectedId,
							  function(data){
									  $.messager.alert('Info', data.PESAN, 'info');
									  oTable.fnReloadAjax("<?=base_url()?>fingerscan_lokasi_json/json/?reqStatusAgenda=" +$("#reqStatusAgenda").val());
							});
...
<div id="wadah">
    <div class="judul-halaman">Lokasi Fingerscan</div>
    ...
    <thead>
        <tr>
            ...
            <th width="80px">IP Address</th> 
            <th width="80px">Port</th> 
            <th width="120px">Nomor Mesin</th> 
        </tr>
    </thead>
    </table> 
</div>
