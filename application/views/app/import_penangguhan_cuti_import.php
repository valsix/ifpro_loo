...
<script type="text/javascript">	
	$(function(){
	$('#ff').form({
		url:'<?=base_url()?>import_penangguhan_cuti_json/addImport',
		onSubmit:function(){
...
<body class="bg-kanan-full">
	<div id="judul-popup">Import Penangguhan Cuti</div>
	<div id="konten">
    	<div id="popup-tabel2">
            ...
            <thead>      
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <a href="<?=base_url()?>app/loadUrl/app/import_penangguhan_cuti_import_template_excel" target="_blank"><img src="<?=base_url()?>images/icon-excel.png" /> Download </a>
                    </td>
                </tr>   
                <tr>
                    <td>File</td>
