...
{
	$reqMode = "update";	
	$jabatan_proyek->selectByParams(array('JABATAN_PROYEK_ID'=>$reqId), -1, -1);
	$jabatan_proyek->firstRow();
	
	$reqNama= $jabatan_proyek->getField('NAMA');
	$reqKeterangan= $jabatan_proyek->getField('KETERANGAN');
}
...
$(function(){
	$('#ff').form({
		url:'<?=base_url()?>jabatan_proyek_json/add',
		onSubmit:function(){
...
<body class="bg-kanan-full">
	<div id="judul-popup">Tambah Jabatan Proyek</div>
	<div id="konten">
    	<div id="popup-tabel2">
            <form id="ff" method="post" novalidate>
                    ...
                    <thead>
                        <tr>           
                             <td>Nama</td><td>:</td>
                             <td>
                             <input type="text" class="easyui-validatebox" name="reqNama" value="<?=$reqNama?>" style="width:40%">
                            </td>			
                        </tr>
                        <!--<tr>
