...
$this->load->model('TingkatKesulitan');

$tingkat_kesulitan = new TingkatKesulitan();
...
{
	$reqMode = "update";	
	$tingkat_kesulitan->selectByParams(array('TINGKAT_KESULITAN_ID'=>$reqId), -1, -1);
	$tingkat_kesulitan->firstRow();

	$reqNama = $tingkat_kesulitan->getField("NAMA");
	$reqKeterangan = $tingkat_kesulitan->getField("KETERANGAN");
...
$(function(){
	$('#ff').form({
		url:'<?=base_url()?>tingkat_kesulitan_json/add',
		onSubmit:function(){
...
<body class="bg-kanan-full">
	<div id="judul-popup">Tambah Tingkat Kesulitan</div>
	<div id="konten">
    	<div id="popup-tabel2">
