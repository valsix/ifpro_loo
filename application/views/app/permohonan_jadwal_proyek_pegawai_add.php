...
else if(varItem == 'permohonan_jadwal_proyek_pegawai_add_anggota'){
	$("#permohonan_jadwal_proyek_pegawai_add_anggota").addClass("aktif");
	$('#permohonan_jadwal_proyek_pegawai_add_anggota').css({'background-position': '0 -27px'});
	mainFramePop.location.href='app/loadUrl/app/permohonan_jadwal_proyek_pegawai_add_anggota/?reqId=<?=$reqId?>';
	document.getElementById('trdetil').style.display = 'none';	
}
return true;
}
	...
	<div id="wrapper" class="bg-kiri-popup" style="overflow:hidden;">
        ...
        <nav class="navbar navbar-default navbar-static-top popup-atas" role="navigation" style="margin-bottom: 0;">
            <div class="navbar-header navbar-header-popup">
                ...
                <a class="navbar-brand">Data Proyek</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        <li style="border:none;">
                            ...
                            <div id="menu-kiri">
                                ...
                                <div><a id="permohonan_jadwal_proyek_pegawai_add_anggota" onClick="executeOnClick('permohonan_jadwal_proyek_pegawai_add_anggota');">Anggota Proyek</a></div>
                            </div>
                        </li>
                    </ul>
                </div>
