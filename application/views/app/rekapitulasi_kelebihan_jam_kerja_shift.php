...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>rekapitulasi_kelebihan_jam_kerja_shift_json/json/?reqTahun=<?=$reqTahun?>&reqBulan=<?=$reqBulan?>",			  
			...
			/* Click event handler */
			  ...
			  $("#reqBulan, #reqTahun").change(function() { 
				 oTable.fnReloadAjax("<?=base_url()?>rekapitulasi_kelebihan_jam_kerja_shift_json/json/?reqTahun=" +$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val());				 	 
			  });
...
<div id="wadah">
    <div class="judul-halaman">Rekapitulasi Kelebihan Jam Kerja Shift</div>
    <div id="bluemenu" class="bluetabs" style="background:url(<?=base_url()?>css/media/bluetab.gif)">    
        <ul>
			<li>
                <a href="#" id="btnExport" title="Export Excel"> Export Excel</a>     
            </li>        
        </ul>
    </div>
    ...
    <thead>
            <tr>
                    ...
                    <th width="50px">Jam Kerja</th>
                    <th width="50px">Normal</th>
                    <th width="50px">Kelebihan/Kekurangan</th> 
            </tr>
    </thead>
    </table> 
</div>
