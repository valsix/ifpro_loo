...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>permohonan_shift_json/json_verifikator",		  
			...
			/* Click event handler */
			  ...
			  $("#example tbody").click(function(event) {
					  ...
					  anSelectedPeriode = element[1];
					  anSelectedPublish = element[3];
			  });
			  
			  $('#btnAdd').on('click', function () {
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_jadwal_shift_add/");
			   ...
			   $('#btnEdit').on('click', function () {
				...
				if(anSelectedPublish == "" || anSelectedPublish == "0" || anSelectedPublish == "P")	  
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_jadwal_shift_add/?reqPeriode="+anSelectedPeriode+"&reqId="+anSelectedId+"&reqMode=update");
				else
			  ...
			  $("#reqStatus").change(function() { 			  
				 oTable.fnReloadAjax("<?=base_url()?>permohonan_shift_json/json_verifikator/?reqStatus="+ $("#reqStatus").val());				 	 
			  });
		});
</script>
...
<div id="wadah">
    <div class="judul-halaman">Permohonan Jadwal Shift</div>
