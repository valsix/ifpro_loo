...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>permohonan_ganti_jadwal_json/json",		  
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_ganti_shift_add/");
			   ...
			   $('#btnEdit').on('click', function () {
				...
				if(anSelectedPublish == "" || anSelectedPublish == "0")	  
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_ganti_shift_add/?reqId="+anSelectedId+"&reqMode=update");
				else
			  ...
			  $('#btnLihat').on('click', function () {
				  ...
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_ganti_shift_add/?reqId="+anSelectedId+"&reqMode=view");
			   ...
			   $('#btnDelete').on('click', function () {
					...
					$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
						if (r){
							$.getJSON("<?=base_url()?>permohonan_ganti_jadwal_json/delete/?reqId="+anSelectedId,
							  function(data){
									  $.messager.alert('Info', data.PESAN, 'info');
									  oTable.fnReloadAjax("<?=base_url()?>permohonan_ganti_jadwal_json/json/?reqStatus=" +$("#reqStatus").val());
							});
...
<div id="wadah">
    <div class="judul-halaman">Permohonan Ganti Shift</div>
    ...
    <thead>
        <tr>
            ...
            <th width="100px">Jenis Pergantian</th>
