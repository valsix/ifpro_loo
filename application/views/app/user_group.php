...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>user_group_json/json",			  
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/user_group_add");
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/user_group_add/?reqId="+anSelectedId);
			  ...
			  $('#btnDelete').on('click', function () {
					...
					$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
						if (r){
							$.getJSON("<?=base_url()?>user_group_json/delete/"+anSelectedId,
							  function(data){
									  $.messager.alert('Info', data.PESAN, 'info');
									  oTable.fnReloadAjax("<?=base_url()?>user_group_json/json");
							});
...
<div id="wadah">
    <div class="judul-halaman">Data Master User Group</div>
    ...
    <thead>
    	<tr>
            ...
            <th width="100px" style="text-align:center">Akses Master</th> 
            <th width="100px" style="text-align:center">Akses Laporan</th> 
            <th width="100px" style="text-align:center">Akses Proses Rekap</th>    
            <th width="100px" style="text-align:center">Akses Rekapitulasi</th>   
            <th width="100px" style="text-align:center">Akses Seluruh Unit</th>                            
        </tr>
    </thead>
    </table> 
</div>
