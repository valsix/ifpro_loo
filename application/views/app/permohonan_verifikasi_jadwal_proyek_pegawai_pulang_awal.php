...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>permohonan_proyek_json/json_pegawai_pulang_awal_verifikator",		  
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
			   ...
			   $('#btnEdit').on('click', function () {
				  ...
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_verifikasi_jadwal_proyek_pegawai_pulang_awal_add/?reqMode=update&reqId="+anSelectedId);
			  ...
			  $('#btnLihat').on('click', function () {
				  ...
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_verifikasi_jadwal_proyek_pegawai_pulang_awal_add/?reqId="+anSelectedId+"&reqMode=viewuser");
			...
			$('#btnPosting').on('click', function () {
			  ...
			  $("#reqStatus").change(function() { 			  
				 oTable.fnReloadAjax("<?=base_url()?>permohonan_proyek_json/json_pegawai_pulang_awal_verifikator/?reqStatus="+$("#reqStatus").val());				 	 
			  });
		});
</script>
...
<div id="wadah">
    <div class="judul-halaman">Data Anggota Proyek Pulang Awal</div>
    ...
    <thead>
        <tr>
            ...
            <th width="200px">Approval</th>
            <th width="250px">Approval Lainnya</th>
        </tr>
    </thead>
    </table> 
</div>
