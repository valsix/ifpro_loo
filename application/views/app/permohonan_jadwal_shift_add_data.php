...
$permohonan_shift_approval = new PermohonanShift();
...
$permohonan_shift->selectByParamsApproval($this->ID, array('PERMOHONAN_SHIFT_ID'=>$reqId), -1, -1);
$permohonan_shift->firstRow();

$reqApprovalKe= $permohonan_shift->getField('APPROVAL_KE'); 
$reqPegawaiId= $permohonan_shift->getField('PEGAWAI_ID');
$reqNamaPegawai= $permohonan_shift->getField('NAMA_PEGAWAI');
$reqJabatan= $permohonan_shift->getField('JABATAN');
$reqNamaCabang= $permohonan_shift->getField('NAMA_CABANG');
$reqDepartemen= $permohonan_shift->getField('DEPARTEMEN');
$reqSubDepartemen= $permohonan_shift->getField('SUB_DEPARTEMEN');
$reqTahun= $permohonan_shift->getField('TAHUN');
$reqNomor= $permohonan_shift->getField('NOMOR');
$reqTanggal= $permohonan_shift->getField('TANGGAL');
$reqApproval= $permohonan_shift->getField('APPROVAL');
$reqApprovalKeterangan= $permohonan_shift->getField('APPROVAL_KETERANGAN');
$reqAlasanTolak= $permohonan_shift->getField('ALASAN_TOLAK');
...
$(function(){
	$('#ff').form({
		url:'<?=base_url()?>permohonan_shift_json/approval_verifikator',
		onSubmit:function(){
	...
	<div id="konten">
    	<div id="popup-tabel2">
            ...
            <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="reqAlasan" id="reqAlasan">
                                    ...
                                    <option value="T" <? if($reqAlasan == 'T') { ?> selected="selected" <? } ?>>Perlu Revisi</option>
                                </select>
                            </td>
                        </tr>
                    ...
                    <?
                    if ($reqMode == "view" || $reqMode == "viewuser")
                    { }
                    else 
                    {
                    ?>
