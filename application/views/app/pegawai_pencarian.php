...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>pegawai_pencarian_json/json/",
			...
			/* Click event handler */
			  ...
			  $('#btnPilih').live('click', function () {
				  if(anSelectedData == "")
					  return false;		
				  parent.OptionSet(anSelectedId, anSelectedNRP, anSelectedNama, anSelectedJabatan, anSelectedLamaCuti);	
