...
{
	$reqMode = "update";	
	$pegawai_proyek->selectByParams(array('PEGAWAI_PROYEK_ID'=>$reqId), -1, -1);
	$pegawai_proyek->firstRow();
	
	$reqNamaPegawai = $pegawai_proyek->getField('NAMA_PEGAWAI');
	$reqPegawaiId = $pegawai_proyek->getField('PEGAWAI_ID');
	$reqJabatanProyekId = $pegawai_proyek->getField('JABATAN_PROYEK_ID');
}
...
$(function(){
	$('#ff').form({
		url:'<?=base_url()?>pegawai_proyek_json/add',
		onSubmit:function(){
...
<body class="bg-kanan-full" onLoad="setValue();">
	<div id="judul-popup">Tambah Pegawai Proyek</div>
	<div id="konten">
    	<div id="popup-tabel2">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="easyui-combobox" id="reqJabatanProyekId" name="reqJabatanProyekId" style="width:350px;" data-options="
                                        ...
                                        valueField:'value', 
                                        textField:'text'
                                    " value="<?=$reqJabatanProyekId?>" required>
                            </td>
                        </tr>
                    </table>
                    </thead>
