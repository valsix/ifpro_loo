...
{
	$permohonan_lembur->selectByParamsApproval($this->ID, array("PERMOHONAN_LEMBUR_ID" => $reqId));
	...
	$reqApprovalKe = $permohonan_lembur->getField("APPROVAL_KE");
}
    	...
    	<div id="popup-tabel2">
            <form id="ff" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <thead>
                        ...
                        ?>
                        <tr>
                        	<th colspan="3">Approval <?=$permohonan_lembur->getField("NAMA_APPROVAL1")?></th>
                        </tr>
                        <tr>
                            <td>Persetujuan</td>
                            <td>:</td>
                            <td>
                                <?=$permohonan_lembur->getField("APPROVAL1")?>
                            </td>
                        </tr>
                        <?
                            if ($permohonan_lembur->getField("APPROVAL1") == "Ditolak")
							{
							?>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <?=$permohonan_lembur->getField("ALASAN_TOLAK1")?>
                                    </td>
                                </tr>
                        <?
							}
						?>
                        <tr>
                        	<th colspan="3">Approval <?=$permohonan_lembur->getField("NAMA_APPROVAL2")?></th>
                        </tr>
                        <tr>
                            <td>Persetujuan</td>
                            <td>:</td>
                            <td>
                                <?=$permohonan_lembur->getField("APPROVAL2")?>
                            </td>
                        </tr>
                        <?
                            if ($permohonan_lembur->getField("APPROVAL2") == "Ditolak")
							{
							?>
                                <tr>
                                    <td>Alasan Penolakan</td>
                                    <td>:</td>
                                    <td>
                                        <?=$permohonan_lembur->getField("ALASAN_TOLAK2")?>
                                    </td>
                                </tr>
                        <?
							}
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <?=$permohonan_lembur->getField("STATUS_APPROVAL")?>&nbsp;<?=$permohonan_lembur->getField("ALASAN_TOLAK")?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <?=$permohonan_lembur->getField("STATUS_APPROVAL_LAIN")?>
                            </td>
                        </tr>
                        <?
						} 
