    ...
    <div id="bluemenu" class="bluetabs" style="background:url(<?=base_url()?>css/media/bluetab.gif)">    
        <ul>
			<li>
                ...
                -->
                <a href="#" id="btnPilih" title="Pilih"><img src="<?=base_url()?>/images/icon-edit.png" /> Pilih </a>
                <!--<a href="<?=base_url()?>app/loadUrl/app/cabang_add/?reqSource=proyek" id="btnAdd" title="Tambah Lokasi"><img src="<?=base_url()?>/images/icon-tambah.png" /> Tambah Lokasi </a>-->
            </li>        
           <!-- <li>
