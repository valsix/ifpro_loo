...
$fname = tempnam("/tmp", "import_cuti_besar.xls");
...
header("Content-Type: application/x-msexcel; name=\"import_cuti_besar_import_template.xls\"");
header("Content-Disposition: inline; filename=\"import_cuti_besar_import_template.xls\"");
$fh=fopen($fname, "rb");
fpassthru($fh);
unlink($fname);
?>