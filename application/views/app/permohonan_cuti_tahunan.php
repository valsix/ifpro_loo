...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>permohonan_cuti_tahunan_json/json",		  
...
<div id="wadah">
    <div class="judul-halaman">Permohonan Cuti Tahunan</div>
    ...
    <thead>
        <tr>
            ...
            <th width="100px">Awal</th>
            <th width="100px">Akhir</th>
