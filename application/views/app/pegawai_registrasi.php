...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>pegawai_registrasi_json/json",			  
			...
			/* Click event handler */
			  ...
			  $("#example tbody").click(function(event) {
					  ...
					  anSelectedPegawaiId = element[1];
			  });
			  
			  $('#btnAdd').on('click', function () {
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/jam_masuk_add");
			  ...
			  $('#btnEdit').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/jam_masuk_add/?reqId="+anSelectedId);
			  ...
			  $('#btnLihat').on('click', function () {
				  if(anSelectedData == "")
					  return false;				
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/pegawai_registrasi_add/?reqId="+anSelectedId);
			  ...
			  $('#btnDelete').on('click', function () {
					...
					$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
						if (r){
							$.getJSON("<?=base_url()?>pegawai_registrasi_json/delete/?reqId="+anSelectedId+"&reqPegawaiId="+anSelectedPegawaiId,
							  function(data){
									  $.messager.alert('Info', data.PESAN, 'info');
									  oTable.fnReloadAjax("<?=base_url()?>pegawai_registrasi_json/json");
							});
			  ...
			  $('#btnReset').on('click', function () {
					...
					$.messager.defaults.ok = 'Ya';
					  ...
					  $.messager.confirm('Konfirmasi', 'Reset Kode Verifikasi data terpilih ?',function(r){
						if (r){		
								...
								$.getJSON( "<?=base_url()?>pegawai_registrasi_json/reset_verifikasi/?reqId="+anSelectedId, function( data ) {
					...
					// $.messager.confirm('Konfirmasi',"Reset Kode Verifikasi data terpilih?",function(r){
					// 	if (r){
					// 		$.getJSON("<?=base_url()?>pegawai_registrasi_json/reset_verifikasi/?reqId="+anSelectedId,
					// 		  function(data){
					// 				  $.messager.alert('Info', data.PESAN, 'info');
					// 				  oTable.fnReloadAjax("<?=base_url()?>pegawai_registrasi_json/json");
					// 		});
...
<div id="wadah">
    <div class="judul-halaman">Data Registrasi Pegawai</div>
    <div id="bluemenu" class="bluetabs" style="background:url(<?=base_url()?>css/media/bluetab.gif)">    
        <ul>
			<li>
                ...
                <!-- <a href="#" id="btnLihat" title="Lihat Detil"><img src="<?=base_url()?>images/icon-lihat.png" /> Lihat Detil</a> -->
                <a href="#" id="btnDelete" title="Hapus"><img src="<?=base_url()?>images/icon-hapus.png" /> Hapus</a>
                <!-- <a href="#" id="btnReset" title="Hapus"><img src="<?=base_url()?>images/icon-sinkronisasi.png" /> Reset Kode Verifikasi</a>         -->
            </li>        
        </ul>
    </div>
