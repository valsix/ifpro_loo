        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			...
			/* Click event handler */
			  ...
			  $('#btnCetakPeriode').on('click', function () {
				  ...
				  newWindow = window.open('<?=base_url()?>app/loadUrl/app/rekapitulasi_kehadiran_proyek_pegawai_periode_cetak.php?reqPermohonanProyekId=<?=$reqPermohonanProyekId?>&reqPeriode=<?=$reqPeriode?>&reqAwal=<?=$reqAwal?>&reqAkhir=<?=$reqAkhir?>', 'Cetak');
				  newWindow.focus();
			  });
			  ...
			  $('#btnCetakProyek').on('click', function () {
				  ...
				  newWindow = window.open('<?=base_url()?>app/loadUrl/app/rekapitulasi_kehadiran_proyek_pegawai_proyek_cetak.php?reqPermohonanProyekId=<?=$reqPermohonanProyekId?>&reqPeriode=<?=$reqPeriode?>', 'Cetak');
				  newWindow.focus();
			  });
...
<div id="wadah">
    <div class="judul-halaman">Rekapitulasi Kehadiran Pegawai Proyek : <?=$reqProyek?></div>
