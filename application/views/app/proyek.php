...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>permohonan_proyek_json/json_pencarian_ellipse",			  
			...
			/* Click event handler */
			  ...
			  $('#btnSinkronisasi').on('click', function () {
					...
					if(confirm("Apakah anda yakin untuk memperbarui data proyek ?"))
					{
						var win = $.messager.progress({
							title:'Proses generate data pegawai.',
							msg:'Proses data...'
						});									
						var jqxhr = $.get("<?=base_url()?>sinkronisasi_pegawai_json/prosesProyek/", function(data) {
							
							oTable.fnReloadAjax("<?=base_url()?>permohonan_proyek_json/json_pencarian_ellipse/");
...
<div id="wadah">
    <div class="judul-halaman">Data Proyek Ellipse</div>
