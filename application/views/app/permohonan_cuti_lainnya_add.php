...
else
{
	...
	$reqLampiran= $permohonan_cuti_bersalin->getField("LAMPIRAN");
    $reqTanggalHPL= $permohonan_cuti_bersalin->getField("TANGGAL_HPL");
}
...
<body class="bg-kanan-full">
	<div id="judul-popup">Permohonan Cuti Lainnya</div>
	<div id="konten">
    	<div id="popup-tabel2">
                        ...
                        <tr>
                            ...
                            <td>
								...
								else
								{
									...
									{
									?>
										<img src="<?=base_url()?>images/icon-download.png" /> <a href="<?=base_url()?>uploads/<?=$arrDokumen[$i]?>" target="_blank">File <?=($i+1)?></a><input type="hidden" name="reqLampiranTemp[]" value="<?=$arrDokumen[$i]?>" /> <br />
									<?
									}
								}
								?>
