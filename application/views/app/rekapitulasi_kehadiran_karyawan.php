...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>rekapitulasi_kehadiran_karyawan_json/json/?reqTahun=<?=$reqTahun?>&reqBulan=<?=$reqBulan?>",			  
			...
			/* Click event handler */
			  ...
			  $("#reqBulan, #reqTahun").change(function() { 
				 oTable.fnReloadAjax("<?=base_url()?>rekapitulasi_kehadiran_karyawan_json/json/?reqTahun=" +$("#reqTahun").val()+"&reqBulan="+$("#reqBulan").val());				 	 
			  });
...
<div id="wadah">
    <div class="judul-halaman">Rekapitulasi Kehadiran Karyawan</div>
    ...
    <thead>
            <tr>
                ...
                <th width="20px" colspan="7" style="text-align:center">Cuti</th>
                <th width="20px" colspan="3" style="text-align:center">Dinas</th>
