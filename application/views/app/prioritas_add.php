...
{
	$reqMode = "update";	
	$prioritas->selectByParams(array('PRIORITAS_ID'=>$reqId), -1, -1);
	$prioritas->firstRow();

	$reqNama= $prioritas->getField('NAMA');
	$reqKeterangan= $prioritas->getField('KETERANGAN');
}
...
$(function(){
	$('#ff').form({
		url:'<?=base_url()?>prioritas_json/add',
		onSubmit:function(){
...
<body class="bg-kanan-full">
	<div id="judul-popup">Tambah Prioritas</div>
	<div id="konten">
    	<div id="popup-tabel2">
