...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>permohonan_proyek_perubahan_json/json_verifikator",		  
			...
			/* Click event handler */
			  ...
			  $('#btnAdd').on('click', function () {
			   ...
			   $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedPublish == "" || anSelectedPublish == "0" || anSelectedPublish == "P")
					  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_verifikasi_perubahan_jadwal_proyek_add/?reqId="+anSelectedId+"&reqPermohoananProyekPerubahanId="+anSelectedPerubahanId);
				  else
			  ...
			  $('#reqEditJadwal').on('click', function () {
				  ...
				  */
					  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_perubahan_jadwal_proyek_add/?reqMode=update&reqId="+anSelectedId);
				  /*
				  else
				  	  return false;
				  */
			  ...
			  $('#btnLihat').on('click', function () {
				  ...
				  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_verifikasi_perubahan_jadwal_proyek_add/?reqId="+anSelectedId+"&reqPermohoananProyekPerubahanId="+anSelectedPerubahanId+"&reqMode=viewuser");
			  ...
			  $("#reqStatus").change(function() { 			  
				 oTable.fnReloadAjax("<?=base_url()?>permohonan_proyek_perubahan_json/json_verifikator/?reqStatus="+$("#reqStatus").val());				 	 
			  });
		});
</script>
...
<div id="wadah">
    ...
    <thead>
        <tr>
            ...
            <th width="150px" rowspan="2">Nama Lokasi</th>
            <th width="100px" rowspan="2">Nomor-WO</th>
            <th width="100px" rowspan="2">Nama Proyek</th>
            <th width="100px" rowspan="2">Pegawai PM</th>
            <th width="100px" rowspan="2">Tanggal</th>
            <th width="100px" rowspan="2">Tanggal Awal</th>
            <th width="100px" colspan="2" style="text-align:center">Tanggal Akhir</th>
            <th width="100px" rowspan="2">Approval</th>
            <th width="150px" rowspan="2">Approval Lainnya</th>
        </tr>
        <tr>
        	<th>Sebelum</th>
        	<th>Sesudah</th>
