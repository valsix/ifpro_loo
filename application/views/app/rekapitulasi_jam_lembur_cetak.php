...
$fname = tempnam("/tmp", "cetak_jam_lembur_rekap.xls");
...
$absensi_rekap->selectByParamsRekapJamLembur(array(), -1, -1, $statement, $periode, " ORDER BY NAMA ASC");
...
$worksheet->write(1, 14, "REKAP JAM LEMBUR BULAN ".strtoupper(getNamePeriode($periode)), $text_format);
...
header("Content-Type: application/x-msexcel; name=\"cetak_jam_lembur_rekap.xls\"");
header("Content-Disposition: inline; filename=\"cetak_jam_lembur_rekap.xls\"");
$fh=fopen($fname, "rb");
fpassthru($fh);
unlink($fname);
?>