...
$permohonan_keandalan->selectByParamsApproval($this->ID, array('PERMOHONAN_KEANDALAN_ID'=>$reqId), -1, -1);
$permohonan_keandalan->firstRow();

$reqApprovalKe = $permohonan_keandalan->getField('APPROVAL_KE');
$reqNamaPegawai= $permohonan_keandalan->getField('NAMA_PEGAWAI');
$reqJabatan= $permohonan_keandalan->getField('JABATAN');
$reqNamaCabang= $permohonan_keandalan->getField('NAMA_CABANG');
$reqDepartemen= $permohonan_keandalan->getField('DEPARTEMEN');
$reqSubDepartemen= $permohonan_keandalan->getField('SUB_DEPARTEMEN');
$reqTahun= $permohonan_keandalan->getField('TAHUN');
$reqNomor= $permohonan_keandalan->getField('NOMOR');
$reqTanggal= $permohonan_keandalan->getField('TANGGAL');
$reqApproval= $permohonan_keandalan->getField('APPROVAL');
$reqApprovalKeterangan= $permohonan_keandalan->getField('APPROVAL_KETERANGAN');
$reqAlasanTolak= $permohonan_keandalan->getField('ALASAN_TOLAK');
...
$(function(){
	$('#ff').form({
		url:'<?=base_url()?>permohonan_keandalan_json/approval',
		onSubmit:function(){
...
<body class="bg-kanan-full" onload="AlasanTolak()">
	<div id="judul-popup">Data Permohonan</div>
	<div id="konten">
    	<div id="popup-tabel2">
            ...
            <table class="table">
                    <thead>
                        ...
                        ?>
                        <tr>
                        	<th colspan="3">Approval <?=$permohonan_keandalan->getField("NAMA_APPROVAL1")?></th>
                        </tr>
                        <tr>
                            <td>Persetujuan</td>
                            <td>:</td>
                            <td>
                                <?=$permohonan_keandalan->getField("APPROVAL1")?>
                            </td>
                        </tr>
                        <?
                            if ($permohonan_keandalan->getField("APPROVAL1") == "Ditolak")
							{
							?>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <?=$permohonan_keandalan->getField("ALASAN_TOLAK1")?>
                                    </td>
                                </tr>
                        <?
							}
						?>
                        <tr>
                        	<th colspan="3">Approval <?=$permohonan_keandalan->getField("NAMA_APPROVAL2")?></th>
                        </tr>
                        <tr>
                            <td>Persetujuan</td>
                            <td>:</td>
                            <td>
                                <?=$permohonan_keandalan->getField("APPROVAL2")?>
                            </td>
                        </tr>
                        <?
                            if ($permohonan_keandalan->getField("APPROVAL2") == "Ditolak")
							{
							?>
                                <tr>
                                    <td>Alasan Penolakan</td>
                                    <td>:</td>
                                    <td>
                                        <?=$permohonan_keandalan->getField("ALASAN_TOLAK2")?>
                                    </td>
                                </tr>
                        <?
							}
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <?=$permohonan_keandalan->getField("STATUS_APPROVAL")?>&nbsp;<?=$permohonan_keandalan->getField("ALASAN_TOLAK")?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <?=$permohonan_keandalan->getField("STATUS_APPROVAL_LAIN")?>
                            </td>
                        </tr>
                        <?
						} 
