...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).ready( function () {
        ...
        oTable = $('#example').dataTable({ bJQueryUI: true,"iDisplayLength": 500,
			  ...
			  "bProcessing": true,
			  "bServerSide": true,		
			  "sAjaxSource": "<?=base_url()?>permohonan_proyek_json/json",		  
			  ...
			  $('#btnAdd').on('click', function () {
			   ...
			   $('#btnEdit').on('click', function () {
				  ...
				  if(anSelectedApproval1 === 'Y' || anSelectedApproval2 === 'Y')
					  ...
					  window.parent.openPopup("<?=base_url()?>app/loadUrl/app/permohonan_jadwal_proyek_add_data/?reqId="+anSelectedId);
			  ...
			  $('#btnLihat').on('click', function () {
			   ...
			   $('#btnDelete').on('click', function () {
					...
					$.messager.confirm('Konfirmasi',"Hapus data terpilih?",function(r){
						if (r){
							$.getJSON("<?=base_url()?>permohonan_proyek_json/delete/?reqId="+anSelectedId,
							  function(data){
