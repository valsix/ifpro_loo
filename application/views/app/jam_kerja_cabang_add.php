...
$this->load->model('JamKerjaCabang');

$jam_kerja_cabang = new JamKerjaCabang();
...
{
    $reqMode = "update";    
    $jam_kerja_cabang->selectByParams(array('JAM_KERJA_CABANG_ID'=>$reqId), -1, -1);
    $jam_kerja_cabang->firstRow();
    
    $reqCabangId     = $jam_kerja_cabang->getField('CABANG_ID');
    $reqJamAwal        = $jam_kerja_cabang->getField('JAM_AWAL');
    $reqJamAkhir       = $jam_kerja_cabang->getField('JAM_AKHIR');
    $reqJumatAwal      = $jam_kerja_cabang->getField('JUMAT_AWAL');
    $reqJumatAkhir     = $jam_kerja_cabang->getField('JUMAT_AKHIR');
    $reqIstirahatBiasa = $jam_kerja_cabang->getField('ISTIRAHAT_BIASA');
    $reqIstirahatJumat = $jam_kerja_cabang->getField('ISTIRAHAT_JUMAT');
	
    $reqJamAwalToleransi        = $jam_kerja_cabang->getField('TERLAMBAT_AWAL');
    $reqJamAkhirToleransi       = $jam_kerja_cabang->getField('TERLAMBAT_AKHIR');
    $reqJumatAwalToleransi      = $jam_kerja_cabang->getField('TERLAMBAT_AWAL_JUMAT');
    $reqJumatAkhirToleransi     = $jam_kerja_cabang->getField('TERLAMBAT_AKHIR_JUMAT');
...
<body class="bg-kanan-full">
    <div id="judul-popup">Tambah Jam Kerja Regular</div>
    <div id="konten">
        <div id="popup-tabel2">
            <form id="ff" method="post" novalidate>
                    ...
                    <thead>
                        ...
                        <tr>           
                             <td>Jam Kerja</td><td>:</td>
                             <td>
                                Masuk <input class="easyui-timespinner" name="reqJumatAwal" id="reqJumatAwal" data-options="max:'23:59'" required="true" style="width:70px;" maxlength="5" value="<?=$reqJumatAwal?>" onkeydown="return format_menit(event,'reqJumatAwal');" />
                                <?php /*?><input  id="reqJamAwal" name="reqJamAwal" class="easyui-validatebox" required="true" style="width:40px" type="text" value="<?=$tempJamAwal?>" maxlength="5" onkeydown="return format_menit(event,'reqJamAwal');"/><?php */?>
                                Pulang
                        ...
                        <tr>           
                             <td>Toleransi Jam Kerja</td><td>:</td>
                             <td>
                                Masuk <input class="easyui-timespinner" name="reqJumatAwalToleransi" id="reqJumatAwalToleransi" data-options="max:'23:59'" required="true" style="width:70px;" maxlength="5" value="<?=$reqJumatAwalToleransi?>" onkeydown="return format_menit(event,'reqJumatAwalToleransi');" />
                                <?php /*?><input  id="reqJamAwal" name="reqJamAwal" class="easyui-validatebox" required="true" style="width:40px" type="text" value="<?=$tempJamAwal?>" maxlength="5" onkeydown="return format_menit(event,'reqJamAwal');"/><?php */?>
                                Pulang
