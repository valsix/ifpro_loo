...
! function(n) {
    ...
    var s = function(e, t) {
        this.id = ++R.FE.ID;
        var n = {};
        t && t.documentReady && (n.toolbarButtons = ["fullscreen", "undo", "redo", "getPDF", "print", "|", "bold", "italic", "underline", "color", "clearFormatting", "|", "alignLeft", "alignCenter", "alignRight", "alignJustify", "|", "formatOL", "formatUL", "indent", "outdent", "-", "paragraphFormat", "|", "fontFamily", "|", "fontSize", "|", "insertLink", "insertImage", "quote"], n.paragraphFormatSelection = !0, n.fontFamilySelection = !0, n.fontSizeSelection = !0, n.placeholderText = "Type something", n.quickInsertEnabled = !1, n.charCounterCount = !1), this.opts = R.extend(!0, {}, R.extend({}, s.DEFAULTS, n, "object" == typeof t && t));
        var r = JSON.stringify(this.opts);
        R.FE.OPTS_MAPPING[r] = R.FE.OPTS_MAPPING[r] || this.id, this.sid = R.FE.OPTS_MAPPING[r], R.FE.SHARED[this.sid] = R.FE.SHARED[this.sid] || {}, this.shared = R.FE.SHARED[this.sid], this.shared.count = (this.shared.count || 0) + 1, this.$oel = R(e), this.$oel.data("froala.editor", this), this.o_doc = e.ownerDocument, this.o_win = "defaultView" in this.o_doc ? this.o_doc.defaultView : this.o_doc.parentWindow;
        var o = R(this.o_win).scrollTop();
        this.$oel.on("froala.doInit", R.proxy(function() {
            this.$oel.off("froala.doInit"), this.doc = this.$el.get(0).ownerDocument, this.win = "defaultView" in this.doc ? this.doc.defaultView : this.doc.parentWindow, this.$doc = R(this.doc), this.$win = R(this.win), this.opts.pluginsEnabled || (this.opts.pluginsEnabled = Object.keys(R.FE.PLUGINS)), this.opts.initOnClick ? (this.load(R.FE.MODULES), this.$el.on("touchstart.init", function() {
            ...
            }), this.$el.on("mousedown.init touchend.init dragenter.init focus.init", R.proxy(function(e) {
                ...
                if (1 === e.which || !e.which) {
                    ...
                    t && "IMG" == t.tagName && R(t).trigger("mousedown"), "undefined" == typeof this.ul && this.destroy(), "touchend" == e.type && this.image && e.originalEvent && e.originalEvent.target && R(e.originalEvent.target).is("img") && setTimeout(R.proxy(function() {
                        this.image.edit(R(e.originalEvent.target))
                    }, this), 100), this.ready = !0, this.events.trigger("initialized")
                }
            }, this)), this.events.trigger("initializationDelayed")) : (this.load(R.FE.MODULES), this.load(R.FE.PLUGINS), R(this.o_win).scrollTop(o), "undefined" == typeof this.ul && this.destroy(), this.ready = !0, this.events.trigger("initialized"))
        }, this)), this._init()
    };
    s.DEFAULTS = {
        initOnClick: !1,
        ...
        if ("string" == typeof o) {
            ...
            return this.each(function() {
                var e, t, n = R(this).data("froala.editor");
                if (!n) return console.warn("Editor should be initialized before calling the " + o + " method.");
                if (0 < o.indexOf(".") && n[o.split(".")[0]] ? (n[o.split(".")[0]] && (e = n[o.split(".")[0]]), t = o.split(".")[1]) : (e = n, t = o.split(".")[0]), !e[t]) return R.error("Method " + o + " does not exist in Froala Editor.");
    ...
    }, R.fn.froalaEditor.Constructor = s, R.FroalaEditor = s, R.FE = s, R.FE.XS = 0, R.FE.SM = 1, R.FE.MD = 2, R.FE.LG = 3;
    R.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", R.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", R.FE.LinkRegExTLD = "((" + R.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", R.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + R.FE.LinkRegExCommon + ")", R.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + R.FE.LinkRegExCommon + ")", R.FE.LinkRegExWWW = "(www\\." + R.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", R.FE.LinkRegEx = "(" + R.FE.LinkRegExTLD + "|" + R.FE.LinkRegExHTTP + "|" + R.FE.LinkRegExWWW + "|" + R.FE.LinkRegExAuth + ")" + R.FE.LinkRegExEnd, R.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], R.FE.MAIL_REGEX = /.+@.+\..+/i, R.FE.MODULES.helpers = function(i) {
        function e() {
            var e, t, n = {},
        ...
        return {
            ...
            sanitizeURL: function(e) {
                return /^(https?:|ftps?:|)\/\//i.test(e) ? e : /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ? e : new RegExp("^(" + R.FE.LinkProtocols.join("|") + "):\\/\\/", "i").test(e) ? e : e = encodeURIComponent(e).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/gi, "mailto:").replace(/file%3A/gi, "file:").replace(/sms%3A/gi, "sms:").replace(/tel%3A/gi, "tel:").replace(/notes%3A/gi, "notes:").replace(/data%3Aimage/gi, "data:image").replace(/blob%3A/gi, "blob:").replace(/%3A(\d)/gi, ":$1").replace(/webkit-fake-url%3A/gi, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/&amp;/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@").replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/%7B/g, "{").replace(/%7D/g, "}")
            },
            isArray: function(e) {
            ...
            isURL: function(e) {
                return !!/^(https?:|ftps?:|)\/\//i.test(e) && (e = String(e).replace(/</g, "%3C").replace(/>/g, "%3E").replace(/"/g, "%22").replace(/ /g, "%20"), new RegExp("^" + R.FE.LinkRegExHTTP + R.FE.LinkRegExEnd + "$", "gi").test(e))
            },
            getAlignment: function(e) {
                var t = (e.css("text-align") || "").replace(/-(.*)-/g, "");
                if (["left", "right", "justify", "center"].indexOf(t) < 0) {
                    if (!s) {
                        var n = R('<div dir="' + ("rtl" == i.opts.direction ? "rtl" : "auto") + '" style="text-align: ' + i.$el.css("text-align") + '; position: fixed; left: -3000px;"><span id="s1">.</span><span id="s2">.</span></div>');
        ...
        return {
            ...
            isEmpty: function(e, t) {
                ...
                return !(e.querySelectorAll(R.FE.VOID_ELEMENTS.join(",")).length - e.querySelectorAll("br").length || e.querySelector(a.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)") || 1 < e.querySelectorAll(R.FE.BLOCK_TAGS.join(",")).length || e.querySelector(a.opts.htmlDoNotWrapTags.join(":not(.fr-marker),") + ":not(.fr-marker)"))
            },
            ...
            deepestParent: function(e, t, n) {
                if (void 0 === t && (t = []), void 0 === n && (n = !0), t.push(a.el), 0 <= t.indexOf(e.parentNode) || e.parentNode && a.node.hasClass(e.parentNode, "fr-inner") || e.parentNode && 0 <= R.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) && n) return null;
                for (; t.indexOf(e.parentNode) < 0 && e.parentNode && !a.node.hasClass(e.parentNode, "fr-inner") && (R.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) < 0 || !n) && (!l(e) || l(e.parentNode)) && (!l(e) || !l(e.parentNode) || !n);) e = e.parentNode;
                return e
            },
            rawAttributes: d,
            attributes: t,
    ...
    }, R.FE.INVISIBLE_SPACE = "&#8203;", R.FE.START_MARKER = '<span class="fr-marker" data-id="0" data-type="true" style="display: none; line-height: 0;">' + R.FE.INVISIBLE_SPACE + "</span>", R.FE.END_MARKER = '<span class="fr-marker" data-id="0" data-type="false" style="display: none; line-height: 0;">' + R.FE.INVISIBLE_SPACE + "</span>", R.FE.MARKERS = R.FE.START_MARKER + R.FE.END_MARKER, R.FE.MODULES.markers = function(d) {
        function l() {
            if (!d.$wp) return null;
            try {
                var e = d.selection.ranges(0),
                    t = e.commonAncestorContainer;
                if (d.core.isEmpty() && t.textContent !== R("<span>").html(R.FE.INVISIBLE_SPACE).text()) return d.selection.setAtStart(d.el), d.$el.find(".fr-marker:first").replaceWith('<span class="fr-single-marker" style="display: none; line-height: 0;">' + R.FE.INVISIBLE_SPACE + "</span>"), d.$el.find(".fr-marker").remove(), d.$el.find(".fr-single-marker").removeClass("fr-single-marker").addClass("fr-marker").get(0);
        ...
        return {
            place: function(e, t, n) {
                ...
                try {
                    var a = e.cloneRange();
                    if (a.collapse(t), a.insertNode(R('<span class="fr-marker" data-id="' + n + '" data-type="' + t + '" style="display: ' + (d.browser.safari ? "none" : "inline-block") + '; line-height: 0;">' + R.FE.INVISIBLE_SPACE + "</span>", d.doc)[0]), !0 === t)
                    ...
                    if (!1 === t && !e.collapsed) {
                        if ((i = (r = d.$el.find('span.fr-marker[data-type="false"][data-id="' + n + '"]').get(0)).previousSibling) && i.nodeType === Node.ELEMENT_NODE && d.node.isBlock(i) && "HR" !== i.tagName) {
                            ...
                            R(i).append(R(r))
                        }(r.parentNode && 0 <= ["TD", "TH"].indexOf(r.parentNode.tagName) || !r.previousSibling && d.node.isBlock(r.parentElement)) && r.parentNode.previousSibling && !r.previousSibling && R(r.parentNode.previousSibling).append(r)
                    }
            ...
            split: function() {
                ...
                if (t || (t = d.node.blockParent(e)) && "LI" != t.tagName && (t = null), t)
                    if (d.node.isBlock(t) && d.node.isEmpty(t)) "LI" != t.tagName || t.parentNode.firstElementChild != t || d.node.isEmpty(t.parentNode) ? R(t).replaceWith('<span class="fr-marker"></span>') : R(t).append('<span class="fr-marker"></span>');
            ...
            if (S.$wp) {
                ...
                for (t = 0; t < n.length; t++)
                    if (n[t].startContainer !== S.doc || S.browser.msie) {
                        ...
                        if (void 0 !== i && i || !o || (R(".fr-marker").remove(), S.selection.setAtEnd(S.el)), S.el.normalize(), S.browser.safari && !o) try {
                    ...
                    try {
                        ...
                        if (o.nextSibling == a || a.nextSibling == o) {
                            ...
                            if (m && m.nodeType == Node.TEXT_NODE)
                                for (; m && m.previousSibling && m.previousSibling.nodeType == Node.TEXT_NODE;) m.previousSibling.textContent = m.previousSibling.textContent + m.textContent, m = m.previousSibling, R(m.nextSibling).remove();
        ...
        function A(e, t, n) {
            var r, o = e.previousSibling,
                i = e.nextSibling;
            return o && i && o.nodeType == Node.TEXT_NODE && i.nodeType == Node.TEXT_NODE ? (r = o.textContent.length, n ? (i.textContent = o.textContent + i.textContent, R(o).remove(), R(e).remove(), S.opts.htmlUntouched || S.spaces.normalize(i), function() {
                t.setStart(i, r)
            }) : (o.textContent = o.textContent + i.textContent, R(i).remove(), R(e).remove(), S.opts.htmlUntouched || S.spaces.normalize(o), function() {
                t.setEnd(o, r)
        ...
        return {
                ...
                try {
                    if (e.rangeCount) {
                        ...
                        if (r.nodeType == Node.TEXT_NODE && n.startOffset == (r.textContent || "").length && r.nextSibling && (r = r.nextSibling), r.nodeType == Node.ELEMENT_NODE) {
                            ...
                            !o && 0 < r.childNodes.length && R(r.childNodes[0]).text().replace(/\u200B/g, "") === s().replace(/\u200B/g, "") && ["BR", "IMG", "HR"].indexOf(r.childNodes[0].tagName) < 0 && (r = r.childNodes[0])
                        }
            ...
            remove: function() {
                ...
                for (t = 0; t < o.length; t++)
                    for (var i = o[t]; !(n(i) || S.node.isBlock(i.parentNode) || S.$el.is(i.parentNode) || S.node.hasClass(i.parentNode, "fr-inner"));) R(i.parentNode).before(i);
                ...
                if (function() {
                        for (var e = S.$el.find(".fr-marker"), t = 0; t < e.length; t++)
                            if (R(e[t]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length) return !1;
                        return !0
                    }()) {
                    ! function e(t, n) {
                        var r = S.node.contents(t.get(0));
                        0 <= ["TD", "TH"].indexOf(t.get(0).tagName) && 1 == t.find(".fr-marker").length && (S.node.hasClass(r[0], "fr-marker") || "BR" == r[0].tagName && S.node.hasClass(r[0].nextElementSibling, "fr-marker")) && t.attr("data-del-cell", !0);
                        for (var o = 0; o < r.length; o++) {
                            var i = r[o];
                            S.node.hasClass(i, "fr-marker") ? n = (n + 1) % 2 : n ? 0 < R(i).find(".fr-marker").length ? n = e(R(i), n) : ["TD", "TH"].indexOf(i.tagName) < 0 && !S.node.hasClass(i, "fr-inner") ? !S.opts.keepFormatOnDelete || 0 < S.$el.find("[data-first]").length || S.node.isVoid(i) ? R(i).remove() : $(i) : S.node.hasClass(i, "fr-inner") ? 0 === R(i).find(".fr-inner").length ? R(i).html("<br>") : R(i).find(".fr-inner").filter(O).html("<br>") : (R(i).empty(), R(i).attr("data-del-cell", !0)) : 0 < R(i).find(".fr-marker").length && (n = e(R(i), n))
                        }
                        return n
                    }(S.$el, 0);
                            ...
                            if (f) {
                                if (d && (!c || c != f)) {
                                    ...
                                    if (p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (g = !(p = null)), u && 0 <= ["UL", "OL"].indexOf(u.tagName) && (h = !(u = null)), R(d).after(f), p != u)
                                        if (null != p || g)
                                            if (null != u || h || 0 !== R(p).parentsUntil(S.$el, "table").length) p && u && 0 === R(p).parentsUntil(S.$el, "table").length && 0 === R(u).parentsUntil(S.$el, "table").length && 0 === R(p).find(u).length && 0 === R(u).find(p).length && (R(p).append(R(u).html()), R(u).remove());
                                            else {
        ...
        function o(e) {
            ...
            var t, n = p.node.contents(e),
                r = [];
            for (t = 0; t < n.length; t++) n[t].nodeType != Node.ELEMENT_NODE || p.node.isVoid(n[t]) ? n[t].nodeType == Node.TEXT_NODE && (n[t].textContent = n[t].textContent.replace(/\u200b/g, "")) : n[t].textContent.replace(/\u200b/g, "").length != n[t].textContent.length && o(n[t]);
        ...
        function c(e, t, n) {
            ...
            var i = function(e, t, n) {
                if (p.opts.fullPage) {
                    ...
                    return t = null == t ? p.html.extractNode(n, "head") || "<title></title>" : t, r + "<html" + o + "><head" + l(p.html.extractNodeAttrs(n, "head")) + ">" + t + "</head><body" + l(p.html.extractNodeAttrs(n, "body")) + ">" + e + "</body></html>"
                }
                return e
            }(r, o, e);
        ...
        return {
            ...
            html: function(e, t, n, r) {
                ...
                var o, i = R.merge([], p.opts.htmlAllowedTags);
                ...
                return a.push("data-fr-.*"), a.push("fr-.*"), u = new RegExp("^" + i.join("$|^") + "$", "gi"), h = new RegExp("^" + a.join("$|^") + "$", "gi"), g = new RegExp("^" + p.opts.htmlRemoveTags.join("$|^") + "$", "gi"), m = p.opts.htmlAllowedStyleProps.length ? new RegExp("((^|;|\\s)" + p.opts.htmlAllowedStyleProps.join(":.+?(?=;|$))|((^|;|\\s)") + ":.+?(?=(;)|$))", "gi") : null, e = c(e, f, !0)
            },
            toHTML5: function() {
            ...
            lists: function() {
                ...
                function() {
                    for (var e = p.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++)
                        for (var n = p.node.contents(e[t]), r = null, o = n.length - 1; 0 <= o; o--) "LI" != n[o].tagName && "UL" != n[o].tagName && "OL" != n[o].tagName ? (r || (r = R("<li>")).insertBefore(n[o]), r.prepend(n[o])) : r = null
                }(),
                function() {
                    var e, t, n;
                    do {
    ...
    }, R.FE.UNICODE_NBSP = String.fromCharCode(160), R.FE.VOID_ELEMENTS = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"], R.FE.BLOCK_TAGS = ["address", "article", "aside", "audio", "blockquote", "canvas", "details", "dd", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "hr", "li", "main", "nav", "noscript", "ol", "output", "p", "pre", "section", "table", "tbody", "td", "tfoot", "th", "thead", "tr", "ul", "video"], R.extend(R.FE.DEFAULTS, {
        ...
        function e(e) {
            var t, n, r = R.merge([], R.FE.VOID_ELEMENTS);
        ...
        function d(e) {
            ...
            if (t && (F.node.isBlock(t) || F.node.isElement(t)) && ["TD", "TH"].indexOf(t.tagName) < 0) {
                ...
                if (r) return !1;
                n && t && "BR" != n.tagName && !F.node.isBlock(n) && !r && 0 < t.textContent.replace(/\u200B/g, "").length && 0 < n.textContent.length && !F.node.hasClass(n, "fr-marker") && (F.el == t && !r && F.opts.enter == R.FE.ENTER_BR && F.browser.msie || e.parentNode.removeChild(e))
        ...
        return {
            ...
            fillEmptyBlocks: function(e) {
                ...
                for (var n = 0; n < t.length; n++) {
                    var r = t[n];
                    "false" === r.getAttribute("contenteditable") || r.querySelector(F.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)") || F.node.isVoid(r) || "TABLE" == r.tagName || "TBODY" == r.tagName || "TR" == r.tagName || "UL" == r.tagName || "OL" == r.tagName || r.querySelector("br") || r.appendChild(F.doc.createElement("br"))
                }
            ...
            set: function(e) {
                ...
                if (F.opts.fullPage) {
                    var i = g(o, "body") || (0 <= o.indexOf("<body") ? "" : o),
                        ...
                        l = h(o, "head"),
                        d = R("<div>").append(s).contents().each(function() {
                    ...
                    s = R("<div>").append(s).contents().map(function() {
            ...
            getSelected: function() {
                var e, t, n = function(e, t) {
                        for (; t && (t.nodeType == Node.TEXT_NODE || !F.node.isBlock(t)) && !F.node.isElement(t) && !F.node.hasClass(t, "fr-inner");) t && t.nodeType != Node.TEXT_NODE && R(e).wrapInner(F.node.openTagString(t) + F.node.closeTagString(t)), t = t.parentNode;
            ...
            unwrap: function() {
                F.$el.find("div.fr-temp-div").each(function() {
                    this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && R(this).before("<br>"), R(this).attr("data-empty") || !this.nextSibling || F.node.isBlock(this.nextSibling) && !R(this.nextSibling).hasClass("fr-temp-div") ? R(this).replaceWith(R(this).html()) : R(this).replaceWith(R(this).html() + "<br>")
        ...
        language: null
    }), R.FE.LANGUAGE = {}, R.FE.MODULES.language = function(e) {
        var t;
        return {
            _init: function() {
        ...
        return {
            _init: function() {
                if (R.FE.INSTANCES.push(d), d.drag_support = {
        ...
        return {
            _startEnter: function(e) {
                ...
                if (m.node.isEmpty(n, !0) && r) {
                    for (var a = "", s = "", l = e.parentNode; !m.node.isList(l) && l.parentNode && ("LI" !== l.parentNode.tagName || l.parentNode === n);) a = m.node.openTagString(l) + a, s += m.node.closeTagString(l), l = l.parentNode;
                    a = m.node.openTagString(l) + a, s += m.node.closeTagString(l);
                    var d = "";
                    for (d = l.parentNode && "LI" == l.parentNode.tagName ? s + "<li>" + R.FE.MARKERS + "<br>" + a : i ? s + "<" + i + ">" + R.FE.MARKERS + "<br></" + i + ">" + a : s + R.FE.MARKERS + "<br>" + a;
                    ...
                    for (var f, p = "<br>", u = e.parentNode; u && "LI" != u.tagName;) R(u).is("span.fr-emoticon") || (f = "A" == u.tagName && m.cursor.isAtStart(e, u) ? "fr-to-remove" : "", p = m.node.openTagString(R(u).clone().addClass(f).get(0)) + p + m.node.closeTagString(u)), u = u.parentNode;
                ...
                } else(t = v(n)).parentNode && "LI" == t.parentNode.tagName ? r ? R(t.parentNode).before(m.node.openTagString(n) + R.FE.MARKERS + "<br></li>") : R(t.parentNode).after(m.node.openTagString(n) + R.FE.MARKERS + "<br></li>") : i ? R(t).before("<" + i + ">" + R.FE.MARKERS + "<br></" + i + ">") : R(t).before(R.FE.MARKERS + "<br>"), R(n).remove()
            },
            ...
            _backspace: function(e) {
                ...
                if (n) {
                    ...
                    r.length && "BR" == r[r.length - 1].tagName && R(r[r.length - 1]).remove(), R(t).find(m.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                    ...
                    if (R(e).replaceWith(R.FE.MARKERS), a.parentNode && "LI" == a.parentNode.tagName) {
                        ...
                        m.node.isBlock(s) ? (R(t).find(m.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                            this.parentNode == t && R(this).replaceWith(R(this).html() + (m.node.isEmpty(this) ? "" : "<br>"))
                        }), R(s).append(R(t).html())) : R(a).before(R(t).html())
                    } else {
            ...
            _del: function(e) {
                var t, n = E(e),
                    r = n.nextSibling;
                if (r) {
                    (t = m.node.contents(r)).length && "BR" == t[0].tagName && R(t[0]).remove(), R(r).find(m.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                    ...
                    if (s == m.el) return !1;
                    if (s = s.nextSibling, m.node.isBlock(s)) R.FE.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (R(e).replaceWith(R.FE.MARKERS), (t = m.node.contents(n)).length && "BR" == t[t.length - 1].tagName && R(t[t.length - 1]).remove(), R(n).append(R(s).html()), R(s).remove());
                    else
                        for ((t = m.node.contents(n)).length && "BR" == t[t.length - 1].tagName && R(t[t.length - 1]).remove(), R(e).replaceWith(R.FE.MARKERS); s && !m.node.isBlock(s) && "BR" != s.tagName;) R(n).append(R(s)), s = s.nextSibling
                }
            }
        }
    }, R.FE.NO_DELETE_TAGS = ["TH", "TD", "TR", "TABLE", "FORM"], R.FE.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI", "DL", "DT", "FORM"], R.FE.MODULES.cursor = function(u) {
        function i(e) {
        ...
        function c(e) {
            ...
            if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType == Node.TEXT_NODE) {
                    ...
                    if (u.opts.tabSpaces && r.length >= u.opts.tabSpaces) 0 === r.substr(r.length - u.opts.tabSpaces, r.length - 1).replace(/ /g, "").replace(new RegExp(R.FE.UNICODE_NBSP, "g"), "").length && (o = r.length - u.opts.tabSpaces + 1);
                    n.textContent = r.substring(0, o - d(r)), u.opts.htmlUntouched && !e.nextSibling && n.textContent.length && " " === n.textContent[n.textContent.length - 1] && (n.textContent = n.textContent.substring(0, n.textContent.length - 1) + R.FE.UNICODE_NBSP);
                ...
                } else u.node.isDeletable(n) ? (R(n).after(R.FE.MARKERS), R(n).remove()) : e.nextSibling && "BR" == e.nextSibling.tagName && u.node.isVoid(n) && "BR" != n.tagName ? (R(e.nextSibling).remove(), R(e).replaceWith(R.FE.MARKERS)) : !1 !== u.events.trigger("node.remove", [R(n)]) && (R(n).after(R.FE.MARKERS), R(n).remove())
                ...
                for (u.node.isList(n) && (n = R(n).find("li:last").get(0)), (t = u.node.contents(n)) && "BR" == t[t.length - 1].tagName && R(t[t.length - 1]).remove(), t = u.node.contents(n); t && u.node.isBlock(t[t.length - 1]);) n = t[t.length - 1], t = u.node.contents(n);
                ...
                if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && i && R.FE.NO_DELETE_TAGS.indexOf(i.tagName) < 0)
                    ...
                    if (u.node.isList(i))
                        if (u.node.isEmpty(n, !0)) R(n).remove(), R(i).find("li:first").prepend(R.FE.MARKERS);
                            ...
                            "BLOCKQUOTE" == n.tagName && (o = u.node.contents(n)).length && u.node.isBlock(o[o.length - 1]) && (n = o[o.length - 1]), 0 === a.find("ul, ol").length && (R(e).replaceWith(R.FE.MARKERS), a.find(u.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                                this.parentNode == a.get(0) && R(this).replaceWith(R(this).html() + (u.node.isEmpty(this) ? "" : "<br>"))
                            }), R(n).append(u.node.contents(a.get(0))), a.remove(), 0 === R(i).find("li").length && R(i).remove())
                        }
                else {
        ...
        function n(e) {
            ...
            if (!u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                n.nodeType == Node.TEXT_NODE ? (R(n).before(R.FE.MARKERS), n.textContent.length && (n.textContent = n.textContent.substring(d(n.textContent, !0), n.textContent.length))) : u.node.isDeletable(n) ? (R(n).before(R.FE.MARKERS), R(n).remove()) : !1 !== u.events.trigger("node.remove", [R(n)]) && (R(n).before(R.FE.MARKERS), R(n).remove()), R(e).remove()
            } else if (R.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n)))
                if (u.node.isDeletable(n)) R(e).replaceWith(R.FE.MARKERS), R(n).remove();
        ...
        function p(e, t, n) {
            ...
            if (o && "BLOCKQUOTE" == o.tagName) return h(e, o) ? (r = u.html.defaultTag(), t ? R(e).replaceWith("<br>" + R.FE.MARKERS) : r ? R(o).after("<" + r + ">" + R.FE.MARKERS + "<br></" + r + ">") : R(o).after(R.FE.MARKERS + "<br>"), R(e).remove()) : m(e, t, n), !1;
            if (null == o)(r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? R(e).replaceWith("<" + r + ">" + R.FE.MARKERS + "<br></" + r + ">") : !e.previousSibling || R(e.previousSibling).is("br") || e.nextSibling ? R(e).replaceWith("<br>" + R.FE.MARKERS) : R(e).replaceWith("<br>" + R.FE.MARKERS + "<br>");
            else {
                var i = e,
                    a = "";
                ...
                a = l + a + d + (e.parentNode == o && u.node.isBlock(o) ? "" : R.FE.INVISIBLE_SPACE) + R.FE.MARKERS, u.node.isBlock(o) && !R(o).find("*:last").is("br") && R(o).append("<br/>"), R(e).after('<span id="fr-break"></span>'), R(e).remove(), o.nextSibling && !u.node.isBlock(o.nextSibling) || u.node.isBlock(o) || R(o).after("<br>"), s = (s = !t && u.node.isBlock(o) ? u.node.openTagString(o) + R(o).html() + f : u.node.openTagString(o) + R(o).html() + u.node.closeTagString(o)).replace(/<span id="fr-break"><\/span>/g, a), R(o).replaceWith(s)
            }
        }

        function m(e, t, n) {
            var r = u.node.deepestParent(e, [], !n);
            if (null == r) u.html.defaultTag() && e.parentNode === u.el ? R(e).replaceWith("<" + u.html.defaultTag() + ">" + R.FE.MARKERS + "<br></" + u.html.defaultTag() + ">") : (e.nextSibling && !u.node.isBlock(e.nextSibling) || R(e).after("<br>"), R(e).replaceWith("<br>" + R.FE.MARKERS));
            else if (e.previousSibling && "IMG" == e.previousSibling.tagName || e.nextSibling && "IMG" == e.nextSibling.tagName) R(e).replaceWith("<" + u.html.defaultTag() + ">" + R.FE.MARKERS + "<br></" + u.html.defaultTag() + ">");
            else {
                var o = e,
                    i = "";
                ...
                if ("BLOCKQUOTE" == r.tagName)
                    if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" == e.nextSibling.tagName && (R(e.nextSibling).after(e), e.nextSibling && "BR" == e.nextSibling.tagName && R(e.nextSibling).remove()), t) i = a + i + R.FE.MARKERS + s;
                    else {
        ...
        return {
            enter: function(t) {
                ...
                u.el.normalize();
                var o = !1;
                0 < R(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (o = !0), R(n).parentsUntil(u.$el, "TD, TH").length && (o = !1), i(n) ? !s(n) || t || o || 0 !== R(n).parentsUntil("LI", ".fr-img-caption").length ? p(n, t, o) : u.cursorLists._endEnter(n) : a(n) ? !s(n) || t || o || 0 !== R(n).parentsUntil("LI", ".fr-img-caption").length ? function e(t, n, r) {
                    ...
                    if (null == i)(o = u.html.defaultTag()) && u.node.isElement(t.parentNode) ? R(t).replaceWith("<" + o + ">" + R.FE.MARKERS + "<br></" + o + ">") : R(t).replaceWith("<br>" + R.FE.MARKERS);
                        ...
                        if (u.node.isBlock(i))
                            if ("PRE" == i.tagName && (n = !0), n) R(t).remove(), R(i).prepend("<br>" + R.FE.MARKERS);
                                ...
                                if (t.nextSibling && "IMG" == t.nextSibling.tagName || t.nextSibling && t.nextSibling.nextElementSibling && "IMG" == t.nextSibling.nextElementSibling) R(t).replaceWith("<" + u.html.defaultTag() + ">" + R.FE.MARKERS + "<br></" + u.html.defaultTag() + ">");
                ...
                }(n, t, o) : u.cursorLists._startEnter(n) : !s(n) || t || o || 0 !== R(n).parentsUntil("LI", ".fr-img-caption").length ? m(n, t, o) : u.cursorLists._middleEnter(n), u.$el.find(".fr-to-remove").each(function() {
            ...
            backspace: function() {
                ...
                return i(t) ? s(t) && g(t, R(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : e = c(t) : a(t) ? s(t) && g(t, R(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : function(e) {
                    for (var t = 0 < R(e).parentsUntil(u.$el, "BLOCKQUOTE").length, n = u.node.deepestParent(e, [], !t), r = n; n && !n.previousSibling && "BLOCKQUOTE" != n.tagName && n.parentElement != u.el && !u.node.hasClass(n.parentElement, "fr-inner") && R.FE.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;) n = n.parentElement;
                    if (n && "BLOCKQUOTE" == n.tagName) {
                    ...
                    if (null !== n) {
                        ...
                        if (u.node.isBlock(n) && u.node.isEditable(n))
                            if (a && R.FE.NO_DELETE_TAGS.indexOf(a.tagName) < 0) {
                                if (u.node.isDeletable(a) || !u.node.isEditable(a)) R(a).remove(), R(e).replaceWith(R.FE.MARKERS);
                                    ...
                                    if (u.node.isBlock(a))
                                        if (u.node.isEmpty(a) && !u.node.isList(a)) R(a).remove(), R(e).after(u.opts.keepFormatOnDelete ? R.FE.INVISIBLE_SPACE : "");
                                            ...
                                            if (u.node.isList(a) && (a = R(a).find("li:last").get(0)), (i = u.node.contents(a)).length && "BR" == i[i.length - 1].tagName && R(i[i.length - 1]).remove(), "BLOCKQUOTE" == a.tagName && "BLOCKQUOTE" != n.tagName)
                                ...
                                else R(e).replaceWith(R.FE.MARKERS), "BLOCKQUOTE" == n.tagName && a.nodeType == Node.ELEMENT_NODE ? R(a).remove() : (R(a).after(u.node.isEmpty(n) ? "" : R(n).html()), R(n).remove(), "BR" == a.tagName && R(a).remove())
                            } else a || (n && "BLOCKQUOTE" === n.tagName && 0 === R(n).text().replace(/\u200B/g, "").length ? R(n).remove() : u.node.isEmpty(n) && n.parentNode && u.node.isEditable(n.parentNode) && n.parentNode != u.el && R(n.parentNode).remove())
                    }
                }(t) : e = c(t), R(t).remove(), f(), u.html.fillEmptyBlocks(!0), u.opts.htmlUntouched || (u.html.cleanEmptyTags(), u.clean.lists(), u.spaces.normalizeAroundCursor()), u.selection.restore(), e
            },
            del: function() {
    ...
    }, R.FE.ENTER_P = 0, R.FE.ENTER_DIV = 1, R.FE.ENTER_BR = 2, R.FE.KEYCODE = {
        BACKSPACE: 8,
        TAB: 9,
        ENTER: 13,
        SHIFT: 16,
        ...
        function a(e) {
            ...
            n == R.FE.KEYCODE.ENTER ? e.shiftKey ? ((i = e).preventDefault(), i.stopPropagation(), l.opts.multiLine && (l.selection.isCollapsed() || l.selection.remove(), l.cursor.enter(!0))) : (o = e, l.opts.multiLine ? (l.helpers.isIOS() || (o.preventDefault(), o.stopPropagation()), l.selection.isCollapsed() || l.selection.remove(), l.cursor.enter()) : (o.preventDefault(), o.stopPropagation())) : n === R.FE.KEYCODE.BACKSPACE && (e.metaKey || e.ctrlKey) ? setTimeout(function() {
                l.events.disableBlur(), l.events.focus()
            }, 0) : n != R.FE.KEYCODE.BACKSPACE || g(e) || e.altKey ? n != R.FE.KEYCODE.DELETE || g(e) || e.altKey || e.shiftKey ? n == R.FE.KEYCODE.SPACE ? function(e) {
                var t = l.selection.element();
                if (!l.helpers.isMobile() && t && "A" == t.tagName) {
                    ...
                    if (n) {
                        ...
                        !n.nextSibling && n.parentNode && "A" == n.parentNode.tagName ? (n.parentNode.insertAdjacentHTML("afterend", "&nbsp;" + R.FE.MARKERS), n.parentNode.removeChild(n)) : (r && r.nodeType == Node.TEXT_NODE && 1 == r.textContent.length && 160 == r.textContent.charCodeAt(0) ? r.textContent = r.textContent + " " : n.insertAdjacentHTML("beforebegin", "&nbsp;"), n.outerHTML = R.FE.MARKERS), l.selection.restore()
                    }
                }
            }(e) : n == R.FE.KEYCODE.TAB ? function(e) {
            ...
            }(e) : g(e) || !m(e.which) || l.selection.isCollapsed() || e.ctrlKey || e.altKey || l.selection.remove() : l.placeholder.isVisible() ? (l.opts.keepFormatOnDelete || f(), e.preventDefault(), e.stopPropagation()) : ((r = e).preventDefault(), r.stopPropagation(), "" === l.selection.text() && "IMG" != l.selection.element().tagName ? l.cursor.del() : l.selection.remove(), l.placeholder.refresh()) : l.placeholder.isVisible() ? (l.opts.keepFormatOnDelete || f(), e.preventDefault(), e.stopPropagation()) : function(e) {
                if (l.selection.isCollapsed())
        ...
        function u(e) {
            ...
            if (e && !l.helpers.isIOS() && (e.which == R.FE.KEYCODE.ENTER || e.which == R.FE.KEYCODE.BACKSPACE || 37 <= e.which && e.which <= 40 && !l.browser.msie)) try {
                s()
            } catch (n) {}
            p()
        }
        ...
        function b(e) {
            ...
            try {
                return 0 === (e.textContent || "").length && !R(e).find("> br").length || e.childNodes && 1 == e.childNodes.length && e.childNodes[0].getAttribute && ("false" == e.childNodes[0].getAttribute("contenteditable") || l.node.hasClass(e.childNodes[0], "fr-img-caption"))
            } catch (t) {
                return !1
            }
        }
        ...
        function S(e) {
            ...
            return r && "TR" == r.tagName && R(r).attr("contenteditable") == undefined && (r = R(r).closest("table").length && R(r).closest("table")[0]), !l.node.isEditable(e.target) || r && "false" == R(r).attr("contenteditable") ? l.toolbar.disable() : l.toolbar.enable(), !(!e.target || e.target === l.el) || (0 === t.length || void(t[0].offsetHeight + t[0].offsetTop <= e.offsetY ? b(t[t.length - 1]) && (n ? l.$el.append("<" + n + ">" + R.FE.MARKERS + "<br></" + n + ">") : l.$el.append(R.FE.MARKERS + "<br>"), l.selection.restore(), s()) : e.offsetY <= 10 && b(t[0]) && (n ? l.$el.prepend("<" + n + ">" + R.FE.MARKERS + "<br></" + n + ">") : l.$el.prepend(R.FE.MARKERS + "<br>"), l.selection.restore(), s())))
        }
        ...
        return {
            ...
            exec: function(e, t) {
                var n = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                    r = e.which,
                    o = !1;
                return r != R.FE.KEYCODE.TAB || n || e.shiftKey || e.altKey ? r != R.FE.KEYCODE.ARROW_RIGHT || n || e.shiftKey || e.altKey ? r != R.FE.KEYCODE.TAB || n || !e.shiftKey || e.altKey ? r != R.FE.KEYCODE.ARROW_LEFT || n || e.shiftKey || e.altKey ? r != R.FE.KEYCODE.ARROW_UP || n || e.shiftKey || e.altKey ? r != R.FE.KEYCODE.ARROW_DOWN || n || e.shiftKey || e.altKey ? r != R.FE.KEYCODE.ENTER && r != R.FE.KEYCODE.SPACE || n || e.shiftKey || e.altKey ? r != R.FE.KEYCODE.ESC || n || e.shiftKey || e.altKey ? r != R.FE.KEYCODE.F10 || n || e.shiftKey || !e.altKey || (o = l()) : o = function(e) {
                    if (f.shared.$f_el) {
                        var t = d();
        ...
        function E(e, t, n) {
            ...
            if (e) {
                ...
                if (e) {
                    ...
                    (r = S(e)) && (0 <= ["strong", "em"].indexOf(t) || "span" === t && n.hasOwnProperty("style")) && ("span" === t ? (o = (a = n.style.replace(/\;$/, "").split(":"))[0].trim(), i = a[1].trim()) : (o = a[t].prop, i = a[t].val), "background-color" !== o && (R(r).css(o, i), function(e, t) {
        ...
        function v(e, t, n, r) {
            if (!r) {
                var o = !1;
                if (!0 === e.data("type"))
                    for (; m.node.isFirstSibling(e.get(0)) && !e.parent().is(m.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().before(e), o = !0;
                else if (!1 === e.data("type"))
                    for (; m.node.isLastSibling(e.get(0)) && !e.parent().is(m.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().after(e), o = !0;
                if (o) return !0
            }
            if (e.parents(t).length || void 0 === t) {
                ...
                return e.replaceWith('<span id="mark"></span>'), i = l.html().replace(/<span id="mark"><\/span>/, a + m.node.closeTagString(l.get(0)) + s + d + a + m.node.openTagString(l.get(0)) + s), l.replaceWith(m.node.openTagString(l.get(0)) + i + m.node.closeTagString(l.get(0))), !0
            }
            return !1
        }
        ...
        function r(t, n) {
            ...
            for (var o = !0; o;) {
                ...
                for (var i, a = m.node.contents(t.get(0)), s = {
                        strong: {
                            prop: "font-weight",
                            val: "bold"
                        },
                    ...
                    if ("false" !== d.isContentEditable && 0 != d.isContentEditable)
                        ...
                        if ((i = "LI" === d.tagName ? d : R(d).parentsUntil(m.$el, "li").get(0)) && (void 0 === r || 0 <= ["strong", "em"].indexOf(r)) && (r ? R(i).css(s[r].prop, "") : i.style = ""), 0 < R(d).find(".fr-marker").length) n = e(R(d), n, r, o);
                        else {
                            for (var c = R(d).find(r || "*:not(br)"), f = c.length - 1; 0 <= f; f--) {
                                var p = c[f];
                                (i = "LI" === p.tagName ? p : R(p).parentsUntil(m.$el, "li").get(0)) && (!r || 0 <= ["strong", "em"].indexOf(r)) && (r ? R(i).css(s[r].prop, "") : i.style = ""), m.node.isBlock(p) || m.node.isVoid(p) || void 0 !== r && !g(p, u(r, o)) ? m.node.isBlock(p) && void 0 === r && "TABLE" != d.tagName && m.node.clearAttributes(p) : m.node.hasClass(p, "fr-clone") || (p.outerHTML = p.innerHTML)
                            }
                            void 0 === r && d.nodeType == Node.ELEMENT_NODE && !m.node.isVoid(d) || g(d, u(r, o)) ? m.node.isBlock(d) ? void 0 === r && d.nodeType == Node.ELEMENT_NODE && m.node.isBlock(d) && "TABLE" != d.tagName && m.node.clearAttributes(d) : m.node.hasClass(d, "fr-clone") || (d.outerHTML = d.innerHTML) : void 0 === r && d.nodeType == Node.ELEMENT_NODE && m.node.isBlock(d) && "TABLE" != d.tagName && m.node.clearAttributes(d)
                        }
                    else 0 < R(d).find(".fr-marker").length && (n = e(R(d), n, r, o))
                }
                return n
            }(m.$el, 0, t, n), r || (m.$el.find(".fr-marker").remove(), m.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")), r && m.$el.find(".fr-marker").before(R.FE.INVISIBLE_SPACE).after(R.FE.INVISIBLE_SPACE), !m.selection.text() && R(m.selection.blocks()[0]).each(function(e, t) {
            ...
            if (m.selection.isCollapsed()) {
                ...
                if (m.node.openTagString(c.get(0)) == '<span style="' + e + ": " + c.css(e) + ';">') {
                    if (m.node.isEmpty(c.get(0))) d = R('<span style="' + e + ": " + t + ';">' + R.FE.INVISIBLE_SPACE + R.FE.MARKERS + "</span>"), c.replaceWith(d);
                        ...
                        var f = {};
                        f["style*"] = e + ":", v(r, "span", f, !0), r = m.$el.find(".fr-marker"), t ? (d = R('<span style="' + e + ": " + t + ';">' + R.FE.INVISIBLE_SPACE + R.FE.MARKERS + "</span>"), r.replaceWith(d)) : r.replaceWith(R.FE.INVISIBLE_SPACE + R.FE.MARKERS)
                    }
                ...
                for (t && (g.style = e + ": " + t + ";"), E(u, "span", g), m.$el.find(".fr-marker + .fr-unprocessed").each(function() {
                    ...
                    for (i = d.find("span"), o && "background-color" !== e && (o.normalize(), i = R(o).find("span:not(.fr-unprocessed)")), n = i.length - 1; 0 <= n; n--) a = i[n], s = e, l = void 0, (l = R(a)).css(s, ""), "" === l.attr("style") && l.replaceWith(l.html());
                    b(d, e, t)
                }
            }! function() {
                var e;
                for (; 0 < m.$el.find(".fr-split:empty").length;) m.$el.find(".fr-split:empty").remove();
                m.$el.find(".fr-split").removeClass("fr-split"), m.$el.find('[style=""]').removeAttr("style"), m.$el.find('[class=""]').removeAttr("class"), m.html.cleanEmptyTags(), R(m.$el.find("span").get().reverse()).each(function() {
        ...
        function b(e, t, n) {
            var r, o, i, a = e.parentsUntil(m.$el, "span[style]"),
                s = [];
            for (r = a.length - 1; 0 <= r; r--) o = a[r], i = t, 0 === R(o).attr("style").indexOf(i + ":") || 0 <= R(o).attr("style").indexOf(";" + i + ":") || 0 <= R(o).attr("style").indexOf("; " + i + ":") || s.push(a[r]);
            if ((a = a.not(s)).length) {
                for (var l = "", d = "", c = "", f = "", p = e.get(0); p = p.parentNode, R(p).addClass("fr-split"), l += m.node.closeTagString(p), d = m.node.openTagString(R(p).clone().addClass("fr-split").get(0)) + d, a.get(0) != p && (c += m.node.closeTagString(p), f = m.node.openTagString(R(p).clone().addClass("fr-split").get(0)) + f), a.get(0) != p;);
                var u = l + m.node.openTagString(R(a.get(0)).clone().css(t, n || "").get(0)) + f + e.css(t, "").get(0).outerHTML + c + "</span>" + d;
                e.replaceWith('<span id="fr-break"></span>');
                var g = a.get(0).outerHTML;
                R(a.get(0)).replaceWith(g.replace(/<span id="fr-break"><\/span>/g, function() {
                    return u
                }))
            }
        }
        ...
        function S(e) {
            ...
            if (t = "LI" === e.tagName ? e : R(e).parentsUntil(m.$el, "li").get(0)) {
                ...
                if (a.atStart && !a.atEnd && (n = R(t).find(".fr-marker[data-type=false]").get(0), r = R(n).parentsUntil(m.$el, "li").get(0), o = R(n).parent().get(0), (i = n.nextSibling) && (0 <= ["UL", "OL"].indexOf(i.tagName) || i.isSameNode(o.lastChild) && m.node.isVoid(i)) || !r.isSameNode(t) || !i && ("LI" === o.tagName || !o.nextSibling || 0 <= ["UL", "OL"].indexOf(o.nextSibling.tagName) || m.node.isVoid(o.nextSibling)))) return t
            }
        }
        return {
            is: o,
        ...
        var i = {
            ...
            insertHR: function() {
                ...
                n.prev().is("hr") ? t = a.selection.setAfter(n.get(0), !1) : n.next().is("hr") ? t = a.selection.setBefore(n.get(0), !1) : a.selection.setAfter(n.get(0), !1) || a.selection.setBefore(n.get(0), !1), t || void 0 === t || (e = o(e = R.FE.MARKERS + "<br>"), n.after(e)), a.selection.restore()
            },
        ...
        function t(e, t) {
            if (!1 !== a.events.trigger("commands.before", R.merge([e], t || []))) {
                var n = R.FE.COMMANDS[e] && R.FE.COMMANDS[e].callback || i[e],
                    r = !0,
                    o = !1;
                R.FE.COMMANDS[e] && ("undefined" != typeof R.FE.COMMANDS[e].focus && (r = R.FE.COMMANDS[e].focus), "undefined" != typeof R.FE.COMMANDS[e].accessibilityFocus && (o = R.FE.COMMANDS[e].accessibilityFocus)), (!a.core.hasFocus() && r && !a.popups.areVisible() || !a.core.hasFocus() && o && a.accessibility.hasFocus()) && a.events.focus(!0), R.FE.COMMANDS[e] && !1 !== R.FE.COMMANDS[e].undo && (a.$el.find(".fr-marker").length && (a.events.disableBlur(), a.selection.restore()), a.undo.saveStep()), n && n.apply(a, R.merge([e], t || [])), a.events.trigger("commands.after", R.merge([e], t || [])), R.FE.COMMANDS[e] && !1 !== R.FE.COMMANDS[e].undo && a.undo.saveStep()
            }
        }
            ...
            _init: function() {
                a.events.on("keydown", function(e) {
                    ...
                    if (t && "HR" == t.tagName)
                        ...
                        } else if ((e.which == R.FE.KEYCODE.ARROW_RIGHT || e.which == R.FE.KEYCODE.ARROW_DOWN) && t.nextSibling) return a.node.isBlock(t.nextSibling) ? a.selection.setAtStart(t.nextSibling) : R(t).after(R.FE.MARKERS), a.selection.restore(), !1
        ...
        function e(e) {
            ...
            n(t, R("<div>").html(t).text()), "cut" == e.type && (O.undo.saveStep(), setTimeout(function() {
        ...
        function t(e) {
            ...
            if (O.$win.scrollTop(), e && e.clipboardData && e.clipboardData.getData) {
                ...
                if (O.helpers.isArray(n))
                    for (var r = 0; r < n.length; r++) t += n[r] + ";";
                else t = n;
                if (w = "", /text\/rtf/.test(t) && (a = e.clipboardData.getData("text/rtf")), /text\/html/.test(t) && !O.browser.safari ? w = e.clipboardData.getData("text/html") : /text\/rtf/.test(t) && O.browser.safari ? w = a : /public.rtf/.test(t) && O.browser.safari && (w = e.clipboardData.getData("text/rtf")), "" !== w) return s(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1;
                w = null
            }
            return function() {
                O.selection.save(), O.events.disableBlur(), w = null, o ? (o.html(""), O.browser.edge && O.opts.iframe && O.$el.append(o)) : (o = R('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1"></div>'), O.browser.webkit || O.browser.mozilla ? (o.css("top", O.$sc.scrollTop()), O.$el.after(o)) : O.browser.edge && O.opts.iframe ? O.$el.append(o) : O.$box.after(o), O.events.on("destroy", function() {
                    o.remove()
                }));
                var e;
        ...
        function r(e) {
            if (e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData) {
                ...
                if (w = "", /text\/rtf/.test(t) && (a = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? w = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && O.browser.safari ? w = a : /text\/plain/.test(t) && !this.browser.mozilla && (w = O.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== w) {
                    ...
                    if (O.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"), O.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"), O.selection.restore(), O.selection.remove(), O.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"), !1 !== o) {
        ...
        function s() {
            O.opts.iframe && O.$el.attr("contenteditable", "true"), O.browser.edge && O.opts.iframe && O.$box.after(o), F || (O.keys.forceUndo(), F = O.snapshot.get()), w || (w = o.get(0).innerHTML, O.selection.restore(), O.events.enableBlur());
        ...
        function l(r, e, t, n) {
            ...
            if (!e)
                if (f = function(e) {
                        ...
                        return !(!t || R("<div>").html(e).text().replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") != t.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, ""))
                    }(r), p = function() {
                        var e = null;
                        try {
                            e = O.win.localStorage.getItem("fr-dragged-content-text")
                        } catch (t) {}
                        return !(!e || R("<div>").html(w).text().replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") != e.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, ""))
                    }(), f && (r = O.win.localStorage.getItem("fr-copied-html")), p && (f = !0, r = O.win.localStorage.getItem("fr-dragged-content-html")), f) r = O.clean.html(r, O.opts.pasteDeniedTags, O.opts.pasteDeniedAttrs);
                else {
                    var u = O.opts.htmlAllowedStyleProps;
                    O.opts.htmlAllowedStyleProps = O.opts.pasteAllowedStyleProps, O.opts.htmlAllowComments = !1, r = (r = (r = r.replace(/<span class="Apple-tab-span">\s*<\/span>/g, k(O.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function(e, t) {
                        return k(t.length * (O.opts.tabSpaces || 4))
                    })).replace(/\t/g, k(O.opts.tabSpaces || 4)), r = O.clean.html(r, O.opts.pasteDeniedTags, O.opts.pasteDeniedAttrs), O.opts.htmlAllowedStyleProps = u, O.opts.htmlAllowComments = !0, r = (r = (r = D(r)).replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, "")
                }! e || O.wordPaste && t || (0 === (r = r.replace(/^\n*/g, "").replace(/^ /g, "")).indexOf("<colgroup>") && (r = "<table>" + r + "</table>"), r = D(r = function(e) {
                var t;
                ...
                for (e = (e = (e = e.replace(/&nbsp;/gi, " ")).replace(/<td([^>]*)><\/td>/g, "<td$1><br></td>")).replace(/<th([^>]*)><\/th>/g, "<th$1><br></th>");
                    (e = (n = e).replace(/<[^\/>][^>]*><\/[^>]+>/gi, "")) != n;);
                e = (e = e.replace(/<lilevel([^1])([^>]*)>/gi, '<li data-indent="true"$2>')).replace(/<lilevel1([^>]*)>/gi, "<li$1>"), e = (e = (e = O.clean.html(e, O.opts.pasteDeniedTags, O.opts.pasteDeniedAttrs)).replace(/<a>(.[^<]+)<\/a>/gi, "$1")).replace(/<br> */g, "<br>");
            ...
            }(r))), O.opts.pastePlain && !p && (r = function(e) {
                var t, n = null,
            ...
            if ("string" == typeof g && (r = g), "" !== r) {
                ...
                else if (O.opts.enter == R.FE.ENTER_DIV)
                    for (o = (i = h.getElementsByTagName("p")).length - 1; 0 <= o; o--) 0 === (a = i[o]).attributes.length && (a.outerHTML = "<div>" + a.innerHTML + "</div>");
                ...
                r = h.innerHTML, f && (r = function(e) {
                    var t, n = O.o_doc.createElement("div");
                    n.innerHTML = e;
        ...
        function D(e) {
            ...
            for (var r = d(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length;) {
                var o = r[r.length - 1];
                if (O.html.defaultTag() && "div" != O.html.defaultTag()) o.querySelector(O.html.blockTagsQuery()) ? o.outerHTML = o.innerHTML : o.outerHTML = "<" + O.html.defaultTag() + ">" + o.innerHTML + "</" + O.html.defaultTag() + ">";
                else {
        ...
        return {
            _init: function() {
                O.el.addEventListener("copy", e), O.el.addEventListener("cut", e), O.el.addEventListener("paste", t, {
                    capture: !0
                }), O.events.on("drop", r), O.browser.msie && O.browser.version < 11 && (O.events.on("mouseup", function(e) {
                    2 == e.button && (setTimeout(function() {
                        i = !1
                    }, 50), i = !0)
                }, !0), O.events.on("beforepaste", t)), O.events.on("dragstart", c, !0), O.events.on("destroy", f)
            },
        ...
        shortcutsEnabled: [],
        shortcutsHint: !0
    }), R.FE.SHORTCUTS_MAP = {}, R.FE.RegisterShortcut = function(e, t, n, r, o, i) {
        R.FE.SHORTCUTS_MAP[(o ? "^" : "") + (i ? "@" : "") + e] = {
            cmd: t,
            val: n,
            letter: r,
            shift: o,
            option: i
        }, R.FE.DEFAULTS.shortcutsEnabled.push(t)
    }, R.FE.RegisterShortcut(R.FE.KEYCODE.E, "show", null, "E", !1, !1), R.FE.RegisterShortcut(R.FE.KEYCODE.B, "bold", null, "B", !1, !1), R.FE.RegisterShortcut(R.FE.KEYCODE.I, "italic", null, "I", !1, !1), R.FE.RegisterShortcut(R.FE.KEYCODE.U, "underline", null, "U", !1, !1), R.FE.RegisterShortcut(R.FE.KEYCODE.S, "strikeThrough", null, "S", !1, !1), R.FE.RegisterShortcut(R.FE.KEYCODE.CLOSE_SQUARE_BRACKET, "indent", null, "]", !1, !1), R.FE.RegisterShortcut(R.FE.KEYCODE.OPEN_SQUARE_BRACKET, "outdent", null, "[", !1, !1), R.FE.RegisterShortcut(R.FE.KEYCODE.Z, "undo", null, "Z", !1, !1), R.FE.RegisterShortcut(R.FE.KEYCODE.Z, "redo", null, "Z", !0, !1), R.FE.RegisterShortcut(R.FE.KEYCODE.Y, "redo", null, "Y", !1, !1), R.FE.MODULES.shortcuts = function(l) {
        var r = null;
        var d = !1;
        ...
        function e(e) {
            ...
            if (o && "TR" == o.tagName && R(o).attr("contenteditable") == undefined && (o = o.closest("table")), n && R.FE.SHORTCUTS_MAP[r] && (!o || "false" != R(o).attr("contenteditable"))) {
                ...
                if (i && 0 <= l.opts.shortcutsEnabled.indexOf(i)) {
                    var a, s = R.FE.SHORTCUTS_MAP[r].val;
                    if (i && !s ? a = l.$tb.find('.fr-command[data-cmd="' + i + '"]') : i && s && (a = l.$tb.find('.fr-command[data-cmd="' + i + '"][data-param1="' + s + '"]')), a.length) return e.preventDefault(), e.stopPropagation(), a.parents(".fr-toolbar").data("instance", l), "keydown" == e.type && (l.button.exec(a), d = !0), !1;
        ...
        return {
            ...
            get: function(e) {
                ...
                if (!r)
                    for (var t in r = {}, R.FE.SHORTCUTS_MAP) R.FE.SHORTCUTS_MAP.hasOwnProperty(t) && 0 <= l.opts.shortcutsEnabled.indexOf(R.FE.SHORTCUTS_MAP[t].cmd) && (r[R.FE.SHORTCUTS_MAP[t].cmd + "." + (R.FE.SHORTCUTS_MAP[t].val || "")] = {
                        shift: R.FE.SHORTCUTS_MAP[t].shift,
                        option: R.FE.SHORTCUTS_MAP[t].option,
                        letter: R.FE.SHORTCUTS_MAP[t].letter
                    });
                var n = r[e];
        ...
        return {
            create: function(n) {
                ...
                if (void 0 !== r) {
                    ...
                    t && t.apply && (t = t.apply(o)), r.FA5NAME || (r.FA5NAME = r.NAME), t && (t = R.FE.ICON_TEMPLATES[t]) && (e = t.replace(/\[([a-zA-Z0-9]*)\]/g, function(e, t) {
        ...
        function i(e, t) {
            ...
            o.$tooltip || o.opts.tooltips && !o.helpers.isMobile() && (o.shared.$tooltip ? o.$tooltip = o.shared.$tooltip : (o.shared.$tooltip = R('<div class="fr-tooltip"></div>'), o.$tooltip = o.shared.$tooltip, o.opts.theme && o.$tooltip.addClass(o.opts.theme + "-theme"), R(o.o_doc).find("body:first").append(o.$tooltip)), o.events.on("shared.destroy", function() {
            ...
            n < 0 && (n = 0), n + o.$tooltip.outerWidth() > R(o.o_win).width() && (n = R(o.o_win).width() - o.$tooltip.outerWidth()), void 0 === t && (t = o.opts.toolbarBottom), e.offset().top - R(window).scrollTop() + e.outerHeight() + 10 >= R(window).height() && (t = !0);
            var r = t ? e.offset().top - o.$tooltip.height() : e.offset().top + e.outerHeight();
            o.$tooltip.css("position", ""), o.$tooltip.css("left", n), o.$tooltip.css("top", Math.ceil(r)), "static" != R(o.o_doc).find("body:first").css("position") ? (o.$tooltip.css("margin-left", -R(o.o_doc).find("body:first").offset().left), o.$tooltip.css("margin-top", -R(o.o_doc).find("body:first").offset().top)) : (o.$tooltip.css("margin-left", ""), o.$tooltip.css("margin-top", ""))
        }
        return {
            hide: r,
            to: i,
        ...
        function t(e) {
            ...
            u.node.hasClass(e.get(0), "fr-dropdown") ? function(e) {
                ...
                if (o.helpers.isIOS() && !o.el.querySelector(".fr-marker") && (o.selection.save(), o.selection.clear(), o.selection.restore()), !n) {
                    var i = e.data("cmd");
                    t.find(".fr-command").removeClass("fr-active").attr("aria-selected", !1), R.FE.COMMANDS[i] && R.FE.COMMANDS[i].refreshOnShow && R.FE.COMMANDS[i].refreshOnShow.apply(o, [e, t]), t.css("left", e.offset().left - e.parent().offset().left - ("rtl" == u.opts.direction ? t.width() - e.outerWidth() : 0)), t.addClass("test-height");
                    var a = t.outerHeight();
                    t.removeClass("test-height"), t.css("top", "").css("bottom", ""), (u.opts.toolbarBottom ? e.offset().top < a : t.offset().top + e.outerHeight() + a < R(u.o_doc).height() || u.$el.offset().top - u.$tb.height() < a) ? (t.css("top", e.position().top + e.outerHeight()), t.css("margin-bottom", "5px")) : t.css("bottom", e.parents(".fr-popup, .fr-toolbar").first().height() - e.position().top)
                }
            ...
            }(e) : (r(e), R.FE.COMMANDS[e.data("cmd")] && !1 !== R.FE.COMMANDS[e.data("cmd")].refreshAfterCallback && t.button.bulkRefresh())
        }
        ...
        function e(o) {
            ...
            setTimeout(function() {
                for (var e = i.selection.inEditor() && i.core.hasFocus(), t = 0; t < o.length; t++) {
                    var n = R(o[t]),
                        r = n.data("cmd");
                    0 === n.parents(".fr-popup").length ? e || R.FE.COMMANDS[r] && R.FE.COMMANDS[r].forcedRefresh ? i.button.refresh(n) : u.node.hasClass(n.get(0), "fr-dropdown") || (n.removeClass("fr-active"), n.attr("aria-pressed") && n.attr("aria-pressed", !1)) : n.parents(".fr-popup").is(":visible") && i.button.refresh(n)
                }
            }, 0)
        }
        ...
        return {
            ...
            bindCommands: function(t, e) {
                ...
                u.events.$on(R(r), u._mouseup + " resize keydown", o, !0), u.opts.iframe && u.events.$on(u.$win, u._mouseup, o, !0), u.node.hasClass(t.get(0), "fr-popup") ? R.merge(s, t.find(".fr-btn").toArray()) : R.merge(a, t.find(".fr-btn").toArray()), u.tooltip.bind(t, ".fr-btn, .fr-title", e)
            },
            refresh: function(e) {
                var t, n = e.parents(".fr-popup, .fr-toolbar").data("instance") || u,
                    r = e.data("cmd");
                u.node.hasClass(e.get(0), "fr-dropdown") ? t = e.next() : (e.removeClass("fr-active"), e.attr("aria-pressed") && e.attr("aria-pressed", !1)), R.FE.COMMANDS[r] && R.FE.COMMANDS[r].refresh ? R.FE.COMMANDS[r].refresh.apply(n, [e, t]) : u.refresh[r] && n.refresh[r](e, t)
            },
            bulkRefresh: n,
            exec: r,
            click: t,
        ...
        return {
            ...
            create: function(n, e, t) {
                if (l.shared.$overlay || (l.shared.$overlay = R('<div class="fr-overlay">').appendTo("body:first")), s = l.shared.$overlay, l.opts.theme && s.addClass(l.opts.theme + "-theme"), !d[n]) {
                    var r = (o = e, i = t, a = '<div tabIndex="-1" class="fr-modal' + (l.opts.theme ? " " + l.opts.theme + "-theme" : "") + '"><div class="fr-modal-wrapper">', a += '<div class="fr-modal-head">' + o + '<span title="' + l.language.translate("Cancel") + '" class="fr-modal-close">&times;</span></div>', a += '<div tabIndex="-1" class="fr-modal-body">' + i + "</div>", R(a += "</div></div>"));
                    d[n] = {
                        $modal: r,
                        ...
                        var t = e.which;
                        return t == R.FE.KEYCODE.ESC ? (c(n), l.accessibility.focusModalButton(r), !1) : !(!R(e.target).is("input[type=text], textarea") && t != R.FE.KEYCODE.ARROW_UP && t != R.FE.KEYCODE.ARROW_DOWN && !l.keys.isBrowserAction(e) && (e.preventDefault(), e.stopPropagation(), 1))
                    }, !0), c(n, !0)
                }
                var o, i, a;
                return d[n]
            ...
            show: function(e) {
                if (d[e]) {
                    var t = d[e].$modal;
                    t.data("instance", l), t.show(), s.show(), R(l.o_doc).find("body:first").addClass("prevent-scroll"), l.helpers.isMobile() && R(l.o_doc).find("body:first").addClass("fr-mobile"), t.addClass("fr-active"), l.accessibility.focusModal(t)
                }
            },
            hide: c,
            resize: function(e) {
        ...
        function o(e, t) {
            ...
            return o ? (n = R('<div class="fr-popup' + (c.helpers.isMobile() ? " fr-mobile" : " fr-desktop") + (c.opts.toolbarInline ? " fr-inline" : "") + '"><span class="fr-arrow"></span>' + o + "</div>"), c.opts.theme && n.addClass(c.opts.theme + "-theme"), 1 < c.opts.zIndex && (c.opts.editInPopup ? n.css("z-index", c.opts.zIndex + 2) : c.$tb.css("z-index", c.opts.zIndex + 2)), "auto" != c.opts.direction && n.removeClass("fr-ltr fr-rtl").addClass("fr-" + c.opts.direction), n.find("input, textarea").attr("dir", c.opts.direction).attr("disabled", "disabled"), (r = R("body:first")).append(n), n.data("container", r), f[e] = n, c.button.bindCommands(n, !1), n) : (n = R('<div class="fr-popup fr-empty"></div>'), (r = R("body:first")).append(n), n.data("container", r), f[e] = n)
        }
        ...
        function E(r) {
            ...
            return {
                ...
                _editorKeydown: function(e) {
                    var t = o.data("instance") || c;
                    t.keys.ctrlKey(e) || e.which == R.FE.KEYCODE.ALT || e.which == R.FE.KEYCODE.ESC || (u(r) && o.find(".fr-back:visible").length ? t.button.exec(o.find(".fr-back:visible:first")) : e.which != R.FE.KEYCODE.ALT && t.popups.hide(r))
                },
                _preventFocus: function(e) {
                    var t = o.data("instance") || c,
                        n = e.originalEvent ? e.originalEvent.target || e.originalEvent.originalTarget : null;
                    "mouseup" == e.type || R(n).is(":focus") || t.events.disableBlur(), "mouseup" != e.type || R(n).hasClass("fr-command") || 0 < R(n).parents(".fr-command").length || R(n).hasClass("fr-dropdown-content") || c.button.hideActiveDropdowns(o), (c.browser.safari || c.browser.mozilla) && "mousedown" == e.type && R(n).is("input[type=file]") && t.events.disableBlur();
                ...
                _doPlaceholder: function() {
                    0 === R(this).next().length && R(this).attr("placeholder") && R(this).after('<label for="' + R(this).attr("id") + '">' + R(this).attr("placeholder") + "</label>"), R(this).toggleClass("fr-not-empty", "" !== R(this).val())
                },
        ...
        return c.shared.exit_flag = !1, {
            _init: function() {
                c.events.on("shared.destroy", e, !0), c.events.on("window.mousedown", t), c.events.on("window.touchmove", m), c.events.$on(R(c.o_win), "scroll", m), c.events.on("mousedown", function(e) {
            ...
            create: function(e, t) {
                ...
                }, !0), c.events.$on(R(c.o_win), "resize", r._windowResize, !0), n
            },
            get: function(e) {
                var t = f[e];
            ...
            show: function(e, t, n, r) {
                ...
                s = e, (l = d).is(":visible") || (l = c.$sc), 0 === l.find([f[s]]).length && l.append(f[s]), c.opts.toolbarInline && d && c.$tb && d.get(0) == c.$tb.get(0) && (p(e, c.$sc), n = c.$tb.offset().top - c.helpers.getPX(c.$tb.css("margin-top")), t = c.$tb.offset().left + c.$tb.outerWidth() / 2 + (parseFloat(c.$tb.find(".fr-arrow").css("margin-left")) || 0) + c.$tb.find(".fr-arrow").outerWidth() / 2, c.node.hasClass(c.$tb.get(0), "fr-above") && n && (n += c.$tb.outerHeight()), r = 0), d = f[e].data("container"), !c.opts.iframe || r || a || (t && (t -= c.$iframe.offset().left), n && (n -= c.$iframe.offset().top)), d.is(c.$tb) ? c.$tb.css("zIndex", (c.opts.zIndex || 1) + 4) : f[e].css("zIndex", (c.opts.zIndex || 1) + 4), t && (t -= i / 2), c.opts.toolbarBottom && d && c.$tb && d.get(0) == c.$tb.get(0) && f[e].outerHeight() < c.$tb.offset().top ? (f[e].addClass("fr-above"), n && (n -= f[e].outerHeight())) : f[e].css("margin-bottom", "5px"), f[e].removeClass("fr-active"), c.position.at(t, n, f[e], r || 0), f[e].addClass("fr-active"), a || c.accessibility.focusPopup(f[e]), c.opts.toolbarInline && c.toolbar.hide(), c.events.trigger("popups.show." + e), E(e)._repositionPopup(), m()
            },
            hide: n,
            onHide: function(e, t) {
        ...
        function o() {
            ...
            if (0 === e.top && 0 === e.left && 0 === e.width || 0 === e.height) {
                ...
                var r = n.offset(),
                    o = n.outerHeight();
                n.css("display", "none"), n.css("line-height", 0), (e = {}).left = r && r.left, e.width = 0, e.height = o, e.top = r && r.top - (v.opts.iframe ? 0 : v.helpers.scrollTop()), e.right = 1, e.bottom = 1, e.ok = !0, t && v.selection.restore()
            }
            return e
        }
        ...
        function i(e, t, n, r) {
            ...
            !o || "BODY" === o.get(0).tagName && "static" == o.css("position") || ("relative" === o.css("position") && (e && (e -= o.offset().left), t && (t -= o.offset().top)), "BODY" != o.get(0).tagName ? (e && (e += o.get(0).scrollLeft), t && (t += o.get(0).scrollTop)) : "absolute" == o.css("position") && (e && (e += o.position().left), t && (t += o.position().top))), v.opts.iframe && o && v.$tb && o.get(0) != v.$tb.get(0) && (e && (e += v.$iframe.offset().left), t && (t += v.$iframe.offset().top));
            var i, a, s, l, d = (a = e, s = (i = n).outerWidth(!0), l = i.parent().offset().left, v.$sc.is("BODY") || "relative" === v.$sc.css("position") || (l -= v.$sc.offset().left, v.$sc.is(i.parent()) && (l -= v.$sc.offset().left)), i.parent().get(0) == v.$sc.get(0) && (l -= i.parent().position().left), l + a + s > v.$sc.get(0).clientWidth - 10 && (a = v.$sc.get(0).clientWidth - s - l - 10), a < 0 && (a = 10), a);
            if (e) {
                n.css("left", d);
            ...
            _init: function() {
                ! function() {
                    if (v._stickyElements = [], v.helpers.isIOS()) {
                        ...
                        t(), v.events.$on(R(v.o_win), "scroll", function() {
                            if (v.core.hasFocus())
                    ...
                    } else "body" !== v.opts.scrollableContainer && v.events.$on(R(v.opts.scrollableContainer), "scroll", e, !0), v.events.$on(R(v.o_win), "scroll", e, !0), v.events.$on(R(v.o_win), "resize", e, !0), v.events.on("initialized", e), v.events.on("focus", e), v.events.$on(R(v.o_win), "resize", "textarea", e, !0);
    ...
    }), R.FE.TOOLBAR_BUTTONS = ["fullscreen", "bold", "italic", "underline", "strikeThrough", "subscript", "superscript", "|", "fontFamily", "fontSize", "color", "inlineClass", "inlineStyle", "paragraphStyle", "lineHeight", "|", "paragraphFormat", "align", "formatOL", "formatUL", "outdent", "indent", "quote", "-", "insertLink", "insertImage", "insertVideo", "embedly", "insertFile", "insertTable", "|", "emoticons", "fontAwesome", "specialCharacters", "insertHR", "selectAll", "clearFormatting", "|", "print", "getPDF", "spellChecker", "help", "html", "|", "undo", "redo"], R.FE.TOOLBAR_BUTTONS_MD = null, R.FE.TOOLBAR_BUTTONS_SM = ["bold", "italic", "underline", "|", "fontFamily", "fontSize", "insertLink", "insertImage", "table", "|", "undo", "redo"], R.FE.TOOLBAR_BUTTONS_XS = ["bold", "italic", "fontFamily", "fontSize", "|", "undo", "redo"], R.FE.MODULES.toolbar = function(o) {
        var r = [];
        ...
        function t(e, t) {
            setTimeout(function() {
                if ((!e || e.which != R.FE.KEYCODE.ESC) && o.selection.inEditor() && o.core.hasFocus() && !o.popups.areVisible() && "false" != R(o.selection.blocks()[0]).closest("table").attr("contenteditable") && (o.opts.toolbarVisibleWithoutSelection || !o.selection.isCollapsed() && !o.keys.isIME() || t)) {
        ...
        function p() {
            o.opts.theme && o.$tb.addClass(o.opts.theme + "-theme"), 1 < o.opts.zIndex && o.$tb.css("z-index", o.opts.zIndex + 1), "auto" != o.opts.direction && o.$tb.removeClass("fr-ltr fr-rtl").addClass("fr-" + o.opts.direction), o.helpers.isMobile() ? o.$tb.addClass("fr-mobile") : o.$tb.addClass("fr-desktop"), o.opts.toolbarContainer ? (o.opts.toolbarInline && (d(), n()), o.opts.toolbarBottom ? o.$tb.addClass("fr-bottom") : o.$tb.addClass("fr-top")) : o.opts.toolbarInline ? (o.$sc.append(o.$tb), o.$tb.data("container", o.$sc), o.$tb.addClass("fr-inline"), o.$tb.prepend('<span class="fr-arrow"></span>'), d(), o.opts.toolbarBottom = !1) : (o.opts.toolbarBottom && !o.helpers.isIOS() ? (o.$box.append(o.$tb), o.$tb.addClass("fr-bottom"), o.$box.addClass("fr-bottom")) : (o.opts.toolbarBottom = !1, o.$box.prepend(o.$tb), o.$tb.addClass("fr-top"), o.$box.addClass("fr-top")), o.$tb.addClass("fr-basic"), o.opts.toolbarSticky && (o.opts.toolbarStickyOffset && (o.opts.toolbarBottom ? o.$tb.css("bottom", o.opts.toolbarStickyOffset) : o.$tb.css("top", o.opts.toolbarStickyOffset)), o.position.addSticky(o.$tb))),
                ...
                }(), o.events.$on(R(o.o_win), "resize", e), o.events.$on(R(o.o_win), "orientationchange", e), o.accessibility.registerToolbar(o.$tb), o.events.$on(o.$tb, o._mousedown + " " + o._mouseup, function(e) {
        ...
        return {
            _init: function() {
                ...
                o.opts.toolbarContainer ? (o.shared.$tb ? (o.$tb = o.shared.$tb, o.opts.toolbarInline && d()) : (o.shared.$tb = R('<div class="fr-toolbar"></div>'), o.$tb = o.shared.$tb, R(o.opts.toolbarContainer).append(o.$tb), p(), o.$tb.data("instance", o)), o.opts.toolbarInline ? o.$box.addClass("fr-inline") : o.$box.addClass("fr-basic"), o.events.on("focus", function() {
                    o.$tb.data("instance", o)
                }, !0), o.opts.toolbarInline = !1) : o.opts.toolbarInline ? (o.$box.addClass("fr-inline"), o.shared.$tb ? (o.$tb = o.shared.$tb, d(), o.button.bindCommands(o.$tb)) : (o.shared.$tb = R('<div class="fr-toolbar"></div>'), o.$tb = o.shared.$tb, p())) : (o.$box.addClass("fr-basic"), o.$tb = R('<div class="fr-toolbar"></div>'), p(), o.$tb.data("instance", o)), o.events.on("destroy", f, !0), o.events.on(o.opts.toolbarInline || o.opts.toolbarContainer ? "shared.destroy" : "destroy", c, !0)
            },
            hide: n,
            show: function() {
