/*!
 * froala_editor (https://www./wysiwyg-editor)
...
! function(n) {
    ...
    var s = function(e, t) {
        this.id = ++Te.FE.ID;
        var n = {};
        t && t.documentReady && (n.toolbarButtons = ["fullscreen", "undo", "redo", "getPDF", "print", "|", "bold", "italic", "underline", "color", "clearFormatting", "|", "alignLeft", "alignCenter", "alignRight", "alignJustify", "|", "formatOL", "formatUL", "indent", "outdent", "-", "paragraphFormat", "|", "fontFamily", "|", "fontSize", "|", "insertLink", "insertImage", "quote"], n.paragraphFormatSelection = !0, n.fontFamilySelection = !0, n.fontSizeSelection = !0, n.placeholderText = "Type something", n.quickInsertEnabled = !1, n.charCounterCount = !1), this.opts = Te.extend(!0, {}, Te.extend({}, s.DEFAULTS, n, "object" == typeof t && t));
        var r = JSON.stringify(this.opts);
        Te.FE.OPTS_MAPPING[r] = Te.FE.OPTS_MAPPING[r] || this.id, this.sid = Te.FE.OPTS_MAPPING[r], Te.FE.SHARED[this.sid] = Te.FE.SHARED[this.sid] || {}, this.shared = Te.FE.SHARED[this.sid], this.shared.count = (this.shared.count || 0) + 1, this.$oel = Te(e), this.$oel.data("froala.editor", this), this.o_doc = e.ownerDocument, this.o_win = "defaultView" in this.o_doc ? this.o_doc.defaultView : this.o_doc.parentWindow;
        var i = Te(this.o_win).scrollTop();
        this.$oel.on("froala.doInit", Te.proxy(function() {
            this.$oel.off("froala.doInit"), this.doc = this.$el.get(0).ownerDocument, this.win = "defaultView" in this.doc ? this.doc.defaultView : this.doc.parentWindow, this.$doc = Te(this.doc), this.$win = Te(this.win), this.opts.pluginsEnabled || (this.opts.pluginsEnabled = Object.keys(Te.FE.PLUGINS)), this.opts.initOnClick ? (this.load(Te.FE.MODULES), this.$el.on("touchstart.init", function() {
                Te(this).data("touched", !0)
            }), this.$el.on("touchmove.init", function() {
                Te(this).removeData("touched")
            }), this.$el.on("mousedown.init touchend.init dragenter.init focus.init", Te.proxy(function(e) {
                if ("touchend" == e.type && !this.$el.data("touched")) return !0;
                if (1 === e.which || !e.which) {
                    this.$el.off("mousedown.init touchstart.init touchmove.init touchend.init dragenter.init focus.init"), this.load(Te.FE.MODULES), this.load(Te.FE.PLUGINS);
                    var t = e.originalEvent && e.originalEvent.originalTarget;
                    t && "IMG" == t.tagName && Te(t).trigger("mousedown"), "undefined" == typeof this.ul && this.destroy(), "touchend" == e.type && this.image && e.originalEvent && e.originalEvent.target && Te(e.originalEvent.target).is("img") && setTimeout(Te.proxy(function() {
                        this.image.edit(Te(e.originalEvent.target))
                    }, this), 100), this.ready = !0, this.events.trigger("initialized")
                }
            }, this)), this.events.trigger("initializationDelayed")) : (this.load(Te.FE.MODULES), this.load(Te.FE.PLUGINS), Te(this.o_win).scrollTop(i), "undefined" == typeof this.ul && this.destroy(), this.ready = !0, this.events.trigger("initialized"))
        }, this)), this._init()
    };
    s.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, s.MODULES = {}, s.PLUGINS = {}, s.VERSION = "2.9.8", s.INSTANCES = [], s.OPTS_MAPPING = {}, s.SHARED = {}, s.ID = 0, s.prototype._init = function() {
        ...
        for (var t in e)
            if (e.hasOwnProperty(t)) {
                if (this[t]) continue;
                if (Te.FE.PLUGINS[t] && this.opts.pluginsEnabled.indexOf(t) < 0) continue;
        ...
        if (this.opts.iframe && (this.events.disableBlur(), this.win.focus(), this.events.enableBlur()), this.events.trigger("destroy", [], !0), this.events.trigger("shared.destroy", undefined, !0), 0 === this.shared.count) {
            for (var t in this.shared) this.shared.hasOwnProperty(t) && (this.shared[t], Te.FE.SHARED[this.sid][t] = null);
            delete Te.FE.SHARED[this.sid]
        }
        this.$oel.parents("form").off("." + this.id), this.$oel.off("click.popup"), this.$oel.removeData("froala.editor"), this.$oel.off("froalaEditor"), this.core.destroy(e), Te.FE.INSTANCES.splice(Te.FE.INSTANCES.indexOf(this), 1)
    }, Te.fn.froalaEditor = function(i) {
        for (var a = [], e = 0; e < arguments.length; e++) a.push(arguments[e]);
        if ("string" == typeof i) {
            var o = [];
            return this.each(function() {
                var e, t, n = Te(this).data("froala.editor");
                if (!n) return console.warn("Editor should be initialized before calling the " + i + " method.");
                if (0 < i.indexOf(".") && n[i.split(".")[0]] ? (n[i.split(".")[0]] && (e = n[i.split(".")[0]]), t = i.split(".")[1]) : (e = n, t = i.split(".")[0]), !e[t]) return Te.error("Method " + i + " does not exist in Froala Editor.");
                var r = e[t].apply(n, a.slice(1));
                r === undefined ? o.push(this) : 0 === o.length && o.push(r)
            }), 1 == o.length ? o[0] : o
        }
        if ("object" == typeof i || !i) return this.each(function() {
            if (!Te(this).data("froala.editor")) {
                new s(this, i)
            }
        })
    }, Te.fn.froalaEditor.Constructor = s, Te.FroalaEditor = s, Te.FE = s, Te.FE.XS = 0, Te.FE.SM = 1, Te.FE.MD = 2, Te.FE.LG = 3;
    Te.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", Te.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", Te.FE.LinkRegExTLD = "((" + Te.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", Te.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + Te.FE.LinkRegExCommon + ")", Te.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + Te.FE.LinkRegExCommon + ")", Te.FE.LinkRegExWWW = "(www\\." + Te.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", Te.FE.LinkRegEx = "(" + Te.FE.LinkRegExTLD + "|" + Te.FE.LinkRegExHTTP + "|" + Te.FE.LinkRegExWWW + "|" + Te.FE.LinkRegExAuth + ")" + Te.FE.LinkRegExEnd, Te.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], Te.FE.MAIL_REGEX = /.+@.+\..+/i, Te.FE.MODULES.helpers = function(a) {
        function e() {
            var e, t, n = {},
        ...
        return {
            ...
            isEmail: function(e) {
                return !/^(https?:|ftps?:|)\/\//i.test(e) && Te.FE.MAIL_REGEX.test(e)
            },
            ...
            getPX: o,
            screenSize: function() {
                var e = Te('<div class="fr-visibility-helper"></div>').appendTo("body:first");
                try {
            ...
            sanitizeURL: function(e) {
                return /^(https?:|ftps?:|)\/\//i.test(e) ? e : /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ? e : new RegExp("^(" + Te.FE.LinkProtocols.join("|") + "):\\/\\/", "i").test(e) ? e : e = encodeURIComponent(e).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/gi, "mailto:").replace(/file%3A/gi, "file:").replace(/sms%3A/gi, "sms:").replace(/tel%3A/gi, "tel:").replace(/notes%3A/gi, "notes:").replace(/data%3Aimage/gi, "data:image").replace(/blob%3A/gi, "blob:").replace(/%3A(\d)/gi, ":$1").replace(/webkit-fake-url%3A/gi, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/&amp;/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@").replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/%7B/g, "{").replace(/%7D/g, "}")
            },
            isArray: function(e) {
            ...
            isURL: function(e) {
                return !!/^(https?:|ftps?:|)\/\//i.test(e) && (e = String(e).replace(/</g, "%3C").replace(/>/g, "%3E").replace(/"/g, "%22").replace(/ /g, "%20"), new RegExp("^" + Te.FE.LinkRegExHTTP + Te.FE.LinkRegExEnd + "$", "gi").test(e))
            },
            getAlignment: function(e) {
                var t = (e.css("text-align") || "").replace(/-(.*)-/g, "");
                if (["left", "right", "justify", "center"].indexOf(t) < 0) {
                    if (!s) {
                        var n = Te('<div dir="' + ("rtl" == a.opts.direction ? "rtl" : "auto") + '" style="text-align: ' + a.$el.css("text-align") + '; position: fixed; left: -3000px;"><span id="s1">.</span><span id="s2">.</span></div>');
                        Te("body:first").append(n);
    ...
    }, Te.FE.MODULES.events = function(l) {
        var e, o = {};
        ...
        function n(e) {
            ...
            if (l.selection.info(l.el).atStart && l.selection.isCollapsed() && null != l.html.defaultTag()) {
                ...
                if (r && !l.node.blockParent(r)) {
                    ...
                    i && (Te(i).prepend(Te.FE.MARKERS), l.selection.restore())
                } else r && Te(r).remove()
            }
        }
        var r = !1;
        ...
        function f(e, t, n, r, i) {
            ...
            var a, o = i ? l.shared.$_events : c,
                s = i ? l.sid : l.id;
            a = r, r = function() {
                if (!l.destroying) return a.apply(this, arguments)
        ...
        function u(e, t, n) {
            if (!l.edit.isDisabled() || n) {
                ...
                return !1 !== (i = l.$oel.triggerHandler("froalaEditor." + e, Te.merge([l], t || []))) && i
            }
        }
        ...
        return {
            _init: function() {
                l.shared.$_events = l.shared.$_events || [], l.shared._events = {}, l.helpers.isMobile() ? (l._mousedown = "touchstart", l._mouseup = "touchend", l._move = "touchmove", l._mousemove = "touchmove") : (l._mousedown = "mousedown", l._mouseup = "mouseup", l._move = "", l._mousemove = "mousemove"), t(l.$el, "click mouseup mousedown touchstart touchend dragenter dragover dragleave dragend drop dragstart", function(e) {
                    ...
                    for (var e = 0; e < Te.FE.INSTANCES.length; e++) Te.FE.INSTANCES[e] != l && Te.FE.INSTANCES[e].popups && Te.FE.INSTANCES[e].popups.areVisible() && Te.FE.INSTANCES[e].$el.find(".fr-marker").remove()
            ...
            bindClick: function(e, t, n) {
                f(e, l._mousedown, t, function(e) {
                    ...
                    Te(this).hasClass("fr-options") && Te(this).prev(".fr-btn").addClass("fr-btn-hover"), Te(this).next(".fr-btn").hasClass("fr-options") && Te(this).next(".fr-btn").addClass("fr-btn-hover")
                }), f(e, "mouseleave", t, function() {
                    Te(this).hasClass("fr-options") && Te(this).prev(".fr-btn").removeClass("fr-btn-hover"), Te(this).next(".fr-btn").hasClass("fr-options") && Te(this).next(".fr-btn").removeClass("fr-btn-hover")
                })
            },
            disableBlur: s,
            enableBlur: a,
            ...
            chainTrigger: function(e, t, n) {
                if (!l.edit.isDisabled() || n) {
                    ...
                    return void 0 !== (i = l.$oel.triggerHandler("froalaEditor." + e, Te.merge([l], [t]))) && (t = i), t
                }
            },
            $on: f,
            $off: function() {
    ...
    }, Te.FE.MODULES.node = function(o) {
        function s(e) {
            return e && "IFRAME" != e.tagName ? Array.prototype.slice.call(e.childNodes || []) : []
        }

        function l(e) {
            return !!e && (e.nodeType == Node.ELEMENT_NODE && 0 <= Te.FE.BLOCK_TAGS.indexOf(e.tagName.toLowerCase()))
        }
        ...
        return {
            ...
            isEmpty: function(e, t) {
                ...
                return !(e.querySelectorAll(Te.FE.VOID_ELEMENTS.join(",")).length - e.querySelectorAll("br").length || e.querySelector(o.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)") || 1 < e.querySelectorAll(Te.FE.BLOCK_TAGS.join(",")).length || e.querySelector(o.opts.htmlDoNotWrapTags.join(":not(.fr-marker),") + ":not(.fr-marker)"))
            },
            ...
            deepestParent: function(e, t, n) {
                if (void 0 === t && (t = []), void 0 === n && (n = !0), t.push(o.el), 0 <= t.indexOf(e.parentNode) || e.parentNode && o.node.hasClass(e.parentNode, "fr-inner") || e.parentNode && 0 <= Te.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) && n) return null;
                for (; t.indexOf(e.parentNode) < 0 && e.parentNode && !o.node.hasClass(e.parentNode, "fr-inner") && (Te.FE.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) < 0 || !n) && (!l(e) || l(e.parentNode)) && (!l(e) || !l(e.parentNode) || !n);) e = e.parentNode;
                return e
            },
            rawAttributes: d,
            attributes: t,
            ...
            contents: s,
            isVoid: function(e) {
                return e && e.nodeType == Node.ELEMENT_NODE && 0 <= Te.FE.VOID_ELEMENTS.indexOf((e.tagName || "").toLowerCase())
            },
            hasFocus: function(e) {
            ...
            hasClass: function(e, t) {
                return e instanceof Te && (e = e.get(0)), e && e.classList && e.classList.contains(t)
            },
            filter: function(e) {
    ...
    }, Te.FE.INVISIBLE_SPACE = "&#8203;", Te.FE.START_MARKER = '<span class="fr-marker" data-id="0" data-type="true" style="display: none; line-height: 0;">' + Te.FE.INVISIBLE_SPACE + "</span>", Te.FE.END_MARKER = '<span class="fr-marker" data-id="0" data-type="false" style="display: none; line-height: 0;">' + Te.FE.INVISIBLE_SPACE + "</span>", Te.FE.MARKERS = Te.FE.START_MARKER + Te.FE.END_MARKER, Te.FE.MODULES.markers = function(d) {
        function l() {
            if (!d.$wp) return null;
            try {
                var e = d.selection.ranges(0),
                    t = e.commonAncestorContainer;
                if (d.core.isEmpty() && t.textContent !== Te("<span>").html(Te.FE.INVISIBLE_SPACE).text()) return d.selection.setAtStart(d.el), d.$el.find(".fr-marker:first").replaceWith('<span class="fr-single-marker" style="display: none; line-height: 0;">' + Te.FE.INVISIBLE_SPACE + "</span>"), d.$el.find(".fr-marker").remove(), d.$el.find(".fr-single-marker").removeClass("fr-single-marker").addClass("fr-marker").get(0);
                if (t != d.el && 0 === d.$el.find(t).length) return null;
                var n = e.cloneRange(),
                    r = e.cloneRange();
                n.collapse(!0);
                var i = Te('<span class="fr-marker" style="display: none; line-height: 0;">' + Te.FE.INVISIBLE_SPACE + "</span>", d.doc)[0];
                if (n.insertNode(i), i = d.$el.find("span.fr-marker").get(0)) {
                    for (var a = i.nextSibling; a && a.nodeType === Node.TEXT_NODE && 0 === a.textContent.length;) Te(a).remove(), a = d.$el.find("span.fr-marker").get(0).nextSibling;
        ...
        return {
            place: function(e, t, n) {
                ...
                try {
                    var o = e.cloneRange();
                    if (o.collapse(t), o.insertNode(Te('<span class="fr-marker" data-id="' + n + '" data-type="' + t + '" style="display: ' + (d.browser.safari ? "none" : "inline-block") + '; line-height: 0;">' + Te.FE.INVISIBLE_SPACE + "</span>", d.doc)[0]), !0 === t)
                        for (a = (r = d.$el.find('span.fr-marker[data-type="true"][data-id="' + n + '"]').get(0)).nextSibling; a && a.nodeType === Node.TEXT_NODE && 0 === a.textContent.length;) Te(a).remove(), a = r.nextSibling;
                    if (!0 === t && !e.collapsed) {
                        for (; !d.node.isElement(r.parentNode) && !a;) Te(r.parentNode).after(r), a = r.nextSibling;
                    ...
                    if (!1 === t && !e.collapsed) {
                        if ((a = (r = d.$el.find('span.fr-marker[data-type="false"][data-id="' + n + '"]').get(0)).previousSibling) && a.nodeType === Node.ELEMENT_NODE && d.node.isBlock(a) && "HR" !== a.tagName) {
                            ...
                            Te(a).append(Te(r))
                        }(r.parentNode && 0 <= ["TD", "TH"].indexOf(r.parentNode.tagName) || !r.previousSibling && d.node.isBlock(r.parentElement)) && r.parentNode.previousSibling && !r.previousSibling && Te(r.parentNode.previousSibling).append(r)
                    }
            ...
            split: function() {
                ...
                if (t || (t = d.node.blockParent(e)) && "LI" != t.tagName && (t = null), t)
                    if (d.node.isBlock(t) && d.node.isEmpty(t)) "LI" != t.tagName || t.parentNode.firstElementChild != t || d.node.isEmpty(t.parentNode) ? Te(t).replaceWith('<span class="fr-marker"></span>') : Te(t).append('<span class="fr-marker"></span>');
                    else if (d.cursor.isAtStart(e, t)) Te(t).before('<span class="fr-marker"></span>'), Te(e).remove();
                else if (d.cursor.isAtEnd(e, t)) Te(t).after('<span class="fr-marker"></span>'), Te(e).remove();
                else {
                    ...
                    var a = d.node.openTagString(t) + Te(t).html() + d.node.closeTagString(t);
                    a = a.replace(/<span id="fr-break"><\/span>/g, r + '<span class="fr-marker"></span>' + i), Te(t).replaceWith(a)
                }
    ...
    }, Te.FE.MODULES.selection = function(T) {
        function s() {
            var e = "";
            ...
            if (T.$wp) {
                ...
                for (t = 0; t < n.length; t++)
                    if (n[t].startContainer !== T.doc || T.browser.msie) {
                        ...
                        if (void 0 !== a && a || !i || (Te(".fr-marker").remove(), T.selection.setAtEnd(T.el)), T.el.normalize(), T.browser.safari && !i) try {
        ...
        function R() {
            ...
            for (e = 0; e < t.length; e++) {
                ...
                if (0 < o.length) {
                    o = o[0];
                    try {
                        for (var l, d = !1, c = i.nextSibling; c && c.nodeType == Node.TEXT_NODE && 0 === c.textContent.length;) c = (l = c).nextSibling, Te(l).remove();
                        for (var f, p, u = o.nextSibling; u && u.nodeType == Node.TEXT_NODE && 0 === u.textContent.length;) u = (l = u).nextSibling, Te(l).remove();
                        if (i.nextSibling == o || o.nextSibling == i) {
                            for (var h = i.nextSibling == o ? i : o, g = h == i ? o : i, m = h.previousSibling; m && m.nodeType == Node.TEXT_NODE && 0 === m.length;) m = (l = m).previousSibling, Te(l).remove();
                            if (m && m.nodeType == Node.TEXT_NODE)
                                for (; m && m.previousSibling && m.previousSibling.nodeType == Node.TEXT_NODE;) m.previousSibling.textContent = m.previousSibling.textContent + m.textContent, m = m.previousSibling, Te(m.nextSibling).remove();
                            for (var v = g.nextSibling; v && v.nodeType == Node.TEXT_NODE && 0 === v.length;) v = (l = v).nextSibling, Te(l).remove();
                            if (v && v.nodeType == Node.TEXT_NODE)
                                for (; v && v.nextSibling && v.nextSibling.nodeType == Node.TEXT_NODE;) v.nextSibling.textContent = v.textContent + v.nextSibling.textContent, v = v.nextSibling, Te(v.previousSibling).remove();
                            if (m && (T.node.isVoid(m) || T.node.isBlock(m)) && (m = null), v && (T.node.isVoid(v) || T.node.isBlock(v)) && (v = null), m && v && m.nodeType == Node.TEXT_NODE && v.nodeType == Node.TEXT_NODE) {
                                Te(i).remove(), Te(o).remove();
                                var E = m.textContent.length;
                                m.textContent = m.textContent + v.textContent, Te(v).remove(), T.opts.htmlUntouched || T.spaces.normalize(m), a.setStart(m, E), a.setEnd(m, E), d = !0
                        ...
                        if (!d)(T.browser.chrome || T.browser.edge) && i.nextSibling == o ? (f = y(o, a, !0) || a.setStartAfter(o), p = y(i, a, !1) || a.setEndBefore(i)) : (i.previousSibling == o && (o = (i = o).nextSibling), o.nextSibling && "BR" === o.nextSibling.tagName || !o.nextSibling && T.node.isBlock(i.previousSibling) || i.previousSibling && "BR" == i.previousSibling.tagName || (i.style.display = "inline", o.style.display = "inline", s = Te(T.doc.createTextNode("\u200b"))), f = y(i, a, !0) || Te(i).before(s) && a.setStartBefore(i), p = y(o, a, !1) || Te(o).after(s) && a.setEndAfter(o)), "function" == typeof f && f(), "function" == typeof p && p()
                    } catch (b) {
        ...
        function y(e, t, n) {
            var r, i = e.previousSibling,
                a = e.nextSibling;
            return i && a && i.nodeType == Node.TEXT_NODE && a.nodeType == Node.TEXT_NODE ? (r = i.textContent.length, n ? (a.textContent = i.textContent + a.textContent, Te(i).remove(), Te(e).remove(), T.opts.htmlUntouched || T.spaces.normalize(a), function() {
                t.setStart(a, r)
            }) : (i.textContent = i.textContent + a.textContent, Te(a).remove(), Te(e).remove(), T.opts.htmlUntouched || T.spaces.normalize(i), function() {
                t.setEnd(i, r)
        ...
        function _(e, t) {
            void 0 === t && (t = !0);
            var n = Te(e).html();
            n && n.replace(/\u200b/g, "").length != n.length && Te(e).html(n.replace(/\u200b/g, ""));
            for (var r = T.node.contents(e), i = 0; i < r.length; i++) r[i].nodeType != Node.ELEMENT_NODE ? Te(r[i]).remove() : (_(r[i], 0 === i), 0 === i && (t = !1));
            e.nodeType == Node.TEXT_NODE ? Te(e).replaceWith('<span data-first="true" data-text="true"></span>') : t && Te(e).attr("data-first", !0)
        }

        function N() {
            return 0 === Te(this).find("fr-inner").length
        }
        ...
        function r(e, t) {
            ...
            e.innerHTML = Te.FE.MARKERS + e.innerHTML
        }
        ...
        function a(e, t) {
            ...
            for (r.setAttribute("id", "fr-sel-markers"), r.innerHTML = Te.FE.MARKERS; e.parentNode && T.opts.htmlAllowedEmptyTags && 0 <= T.opts.htmlAllowedEmptyTags.indexOf(e.tagName.toLowerCase());) e = e.parentNode;
            e.appendChild(r);
        ...
        return {
                ...
                try {
                    if (e.rangeCount) {
                        ...
                        if (r.nodeType == Node.TEXT_NODE && n.startOffset == (r.textContent || "").length && r.nextSibling && (r = r.nextSibling), r.nodeType == Node.ELEMENT_NODE) {
                            ...
                            !i && 0 < r.childNodes.length && Te(r.childNodes[0]).text().replace(/\u200B/g, "") === s().replace(/\u200B/g, "") && ["BR", "IMG", "HR"].indexOf(r.childNodes[0].tagName) < 0 && (r = r.childNodes[0])
                        }
            ...
            isFull: function() {
                ...
                for (e = 0; e < t.length; e++) t[e].nextSibling && (t[e].innerHTML = '<span class="fr-mk">' + Te.FE.INVISIBLE_SPACE + "</span>" + t[e].innerHTML);
                var n = !1,
                    r = i(T.el);
            ...
            remove: function() {
                ...
                var n = function(e) {
                        for (var t = e.previousSibling; t && t.nodeType == Node.TEXT_NODE && 0 === t.textContent.length;) {
                            var n = t;
                            t = t.previousSibling, Te(n).remove()
                        }
                        return t
                    },
                    r = function(e) {
                        for (var t = e.nextSibling; t && t.nodeType == Node.TEXT_NODE && 0 === t.textContent.length;) {
                            var n = t;
                            t = t.nextSibling, Te(n).remove()
                        }
                        return t
                    },
                    i = T.$el.find('.fr-marker[data-type="true"]');
                for (t = 0; t < i.length; t++)
                    for (var a = i[t]; !(n(a) || T.node.isBlock(a.parentNode) || T.$el.is(a.parentNode) || T.node.hasClass(a.parentNode, "fr-inner"));) Te(a.parentNode).before(a);
                var o = T.$el.find('.fr-marker[data-type="false"]');
                for (t = 0; t < o.length; t++) {
                    for (var s = o[t]; !(r(s) || T.node.isBlock(s.parentNode) || T.$el.is(s.parentNode) || T.node.hasClass(s.parentNode, "fr-inner"));) Te(s.parentNode).after(s);
                    s.parentNode && T.node.isBlock(s.parentNode) && T.node.isEmpty(s.parentNode) && !T.$el.is(s.parentNode) && !T.node.hasClass(s.parentNode, "fr-inner") && T.opts.keepFormatOnDelete && Te(s.parentNode).after(s)
                }
                if (function() {
                        for (var e = T.$el.find(".fr-marker"), t = 0; t < e.length; t++)
                            if (Te(e[t]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length) return !1;
                        return !0
                    }()) {
                    ! function e(t, n) {
                        var r = T.node.contents(t.get(0));
                        0 <= ["TD", "TH"].indexOf(t.get(0).tagName) && 1 == t.find(".fr-marker").length && (T.node.hasClass(r[0], "fr-marker") || "BR" == r[0].tagName && T.node.hasClass(r[0].nextElementSibling, "fr-marker")) && t.attr("data-del-cell", !0);
                        for (var i = 0; i < r.length; i++) {
                            var a = r[i];
                            T.node.hasClass(a, "fr-marker") ? n = (n + 1) % 2 : n ? 0 < Te(a).find(".fr-marker").length ? n = e(Te(a), n) : ["TD", "TH"].indexOf(a.tagName) < 0 && !T.node.hasClass(a, "fr-inner") ? !T.opts.keepFormatOnDelete || 0 < T.$el.find("[data-first]").length || T.node.isVoid(a) ? Te(a).remove() : _(a) : T.node.hasClass(a, "fr-inner") ? 0 === Te(a).find(".fr-inner").length ? Te(a).html("<br>") : Te(a).find(".fr-inner").filter(N).html("<br>") : (Te(a).empty(), Te(a).attr("data-del-cell", !0)) : 0 < Te(a).find(".fr-marker").length && (n = e(Te(a), n))
                        }
                        return n
                    }(T.$el, 0);
                    var l = T.$el.find('[data-first="true"]');
                    if (l.length) T.$el.find(".fr-marker").remove(), l.append(Te.FE.INVISIBLE_SPACE + Te.FE.MARKERS).removeAttr("data-first"), l.attr("data-text") && l.replaceWith(l.html());
                    else
                        for (T.$el.find("table").filter(function() {
                                return 0 < Te(this).find("[data-del-cell]").length && Te(this).find("[data-del-cell]").length == Te(this).find("td, th").length
                            }).remove(), T.$el.find("[data-del-cell]").removeAttr("data-del-cell"), i = T.$el.find('.fr-marker[data-type="true"]'), t = 0; t < i.length; t++) {
                            var d = i[t],
                                c = d.nextSibling,
                                f = T.$el.find('.fr-marker[data-type="false"][data-id="' + Te(d).data("id") + '"]').get(0);
                            if (f) {
                                if (d && (!c || c != f)) {
                                    var p = T.node.blockParent(d),
                                        ...
                                        h = !1,
                                        g = !1;
                                    if (p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (h = !(p = null)), u && 0 <= ["UL", "OL"].indexOf(u.tagName) && (g = !(u = null)), Te(d).after(f), p != u)
                                        if (null != p || h)
                                            if (null != u || g || 0 !== Te(p).parentsUntil(T.$el, "table").length) p && u && 0 === Te(p).parentsUntil(T.$el, "table").length && 0 === Te(u).parentsUntil(T.$el, "table").length && 0 === Te(p).find(u).length && 0 === Te(u).find(p).length && (Te(p).append(Te(u).html()), Te(u).remove());
                                            else {
                                                ...
                                                c && "BR" == c.tagName && Te(c).remove()
                                            }
                                    else {
                                        var v = T.node.deepestParent(d);
                                        v ? (Te(v).after(Te(u).html()), Te(u).remove()) : 0 === Te(u).parentsUntil(T.$el, "table").length && (Te(d).next().after(Te(u).html()), Te(u).remove())
                                    }
                                }
                            } else f = Te(d).clone().attr("data-type", !1), Te(d).after(f)
                        }
                }
            ...
            blocks: function() {
                ...
                for (e = t.length - 1; 0 < e; e--) Te(t[e]).find(t).length && t.splice(e, 1);
                return t
            },
            info: i,
            setAtEnd: a,
            ...
            setBefore: function(e, t) {
                ...
                return n ? (T.node.isBlock(n) ? a(n) : "BR" == n.tagName ? Te(n).before(Te.FE.MARKERS) : Te(n).after(Te.FE.MARKERS), !0) : !!t && (T.node.isBlock(e) ? r(e) : Te(e).before(Te.FE.MARKERS), !0)
            },
            setAfter: function(e, t) {
                void 0 === t && (t = !0);
                for (var n = e.nextSibling; n && n.nodeType == Node.TEXT_NODE && 0 === n.textContent.length;) n = n.nextSibling;
                return n ? (T.node.isBlock(n) ? r(n) : Te(n).before(Te.FE.MARKERS), !0) : !!t && (T.node.isBlock(e) ? a(e) : Te(e).after(Te.FE.MARKERS), !0)
            },
            rangeElement: f
        }
    }, Te.extend(Te.FE.DEFAULTS, {
        ...
        I: "EM",
        STRIKE: "S"
    }, Te.FE.MODULES.clean = function(p) {
        var u, h, g, m;

        function i(e) {
            if (e.nodeType == Node.ELEMENT_NODE && e.getAttribute("class") && 0 <= e.getAttribute("class").indexOf("fr-marker")) return !1;
            var t, n = p.node.contents(e),
                r = [];
            for (t = 0; t < n.length; t++) n[t].nodeType != Node.ELEMENT_NODE || p.node.isVoid(n[t]) ? n[t].nodeType == Node.TEXT_NODE && (n[t].textContent = n[t].textContent.replace(/\u200b/g, "")) : n[t].textContent.replace(/\u200b/g, "").length != n[t].textContent.length && i(n[t]);
        ...
        function s(e, t) {
            ...
            return p.node.openTagString(e) + a + p.node.closeTagString(e)
        }
        var o = [];
        ...
        function l(e) {
            ...
            for (t in e)
                if (e.hasOwnProperty(t)) {
                    var n = t.match(g),
                        r = null;
                    "style" == t && p.opts.htmlAllowedStyleProps.length && (r = e[t].match(m)), n && r ? e[t] = v(r.join(";")) : n && ("style" != t || r) || delete e[t]
        ...
        function d(e, t) {
            ...
            var i = "";
            if (r) {
                var a = p.node.contents(r);
                for (n = 0; n < a.length; n++) t(a[n]);
                for (a = p.node.contents(r), n = 0; n < a.length; n++) i += s(a[n])
            }
            return i
        }
        ...
        function c(e, t, n) {
            ...
            var r = e = e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, function(e) {
                ...
                }).replace(/<meta((?:[\w\W]*?)) http-equiv="/g, '<meta$1 data-fr-http-equiv="').replace(/<img((?:[\w\W]*?)) src="/g, '<img$1 data-fr-src="').replace(/<video((?:[\w\W]*?)) src="/g, '<video$1 data-fr-src="'),
                i = null;
            p.opts.fullPage && (r = p.html.extractNode(e, "body") || (0 <= e.indexOf("<body") ? "" : e), n && (i = p.html.extractNode(e, "head") || "")), r = d(r, t), i && (i = d(i, t));
            var a = function(e, t, n) {
                if (p.opts.fullPage) {
                    var r = p.html.extractDoctype(n),
                        i = l(p.html.extractNodeAttrs(n, "html"));
                    return t = null == t ? p.html.extractNode(n, "head") || "<title></title>" : t, r + "<html" + i + "><head" + l(p.html.extractNodeAttrs(n, "head")) + ">" + t + "</head><body" + l(p.html.extractNodeAttrs(n, "body")) + ">" + e + "</body></html>"
                }
                return e
            }(r, i, e);
            return a.replace(/\[FROALA\.EDITOR\.SCRIPT ([\d]*)\]/gi, function(e, t) {
                return 0 <= p.opts.htmlRemoveTags.indexOf("script") ? "" : o[parseInt(t, 10)]
            }).replace(/\[FROALA\.EDITOR\.NOSCRIPT ([\d]*)\]/gi, function(e, t) {
                return 0 <= p.opts.htmlRemoveTags.indexOf("noscript") ? "" : o[parseInt(t, 10)].replace(/\&lt;/g, "<").replace(/\&gt;/g, ">")
            }).replace(/<img((?:[\w\W]*?)) data-fr-src="/g, '<img$1 src="').replace(/<video((?:[\w\W]*?)) data-fr-src="/g, '<video$1 src="')
        }
        ...
        function f(e) {
            ...
            ! function(e) {
                ...
                if (e.nodeType == Node.ELEMENT_NODE && Te.FE.HTML5Map[e.tagName] && "" === p.node.attributes(e)) {
                    var r = Te.FE.HTML5Map[e.tagName],
                        i = "<" + r + ">" + e.innerHTML + "</" + r + ">";
                ...
                if (p.opts.htmlAllowComments || e.nodeType != Node.COMMENT_NODE)
                    if (e.tagName && e.tagName.match(h)) e.parentNode.removeChild(e);
                    else if (e.tagName && !e.tagName.match(u)) {
                    if ("svg" === e.tagName) e.parentNode.removeChild(e);
                    else if (!p.browser.safari || "path" != e.tagName || !e.parentNode || "svg" != e.parentNode.tagName) try {
                    ...
                    if (a)
                        for (var o = a.length - 1; 0 <= o; o--) {
                            var s = a[o],
                                ...
                                d = l.match(g),
                                c = null;
                            "style" == l && p.opts.htmlAllowedStyleProps.length && (c = s.value.match(m)), d && c ? s.value = v(c.join(";")) : d && ("style" != l || c) || e.removeAttribute(l)
                        }
        ...
        return {
            _init: function() {
                p.opts.fullPage && Te.merge(p.opts.htmlAllowedTags, ["head", "title", "style", "link", "base", "body", "html", "meta"])
            },
            html: function(e, t, n, r) {
                void 0 === t && (t = []), void 0 === n && (n = []), void 0 === r && (r = !1);
                var i, a = Te.merge([], p.opts.htmlAllowedTags);
                for (i = 0; i < t.length; i++) 0 <= a.indexOf(t[i]) && a.splice(a.indexOf(t[i]), 1);
                var o = Te.merge([], p.opts.htmlAllowedAttrs);
                for (i = 0; i < n.length; i++) 0 <= o.indexOf(n[i]) && o.splice(o.indexOf(n[i]), 1);
                return o.push("data-fr-.*"), o.push("fr-.*"), u = new RegExp("^" + a.join("$|^") + "$", "gi"), g = new RegExp("^" + o.join("$|^") + "$", "gi"), h = new RegExp("^" + p.opts.htmlRemoveTags.join("$|^") + "$", "gi"), m = p.opts.htmlAllowedStyleProps.length ? new RegExp("((^|;|\\s)" + p.opts.htmlAllowedStyleProps.join(":.+?(?=;|$))|((^|;|\\s)") + ":.+?(?=(;)|$))", "gi") : null, e = c(e, f, !0)
            },
            toHTML5: function() {
                var e = p.el.querySelectorAll(Object.keys(Te.FE.HTML5Map).join(","));
                if (e.length) {
                    var t = !1;
                    p.el.querySelector(".fr-marker") || (p.selection.save(), t = !0);
                    for (var n = 0; n < e.length; n++) "" === p.node.attributes(e[n]) && Te(e[n]).replaceWith("<" + Te.FE.HTML5Map[e[n].tagName] + ">" + e[n].innerHTML + "</" + Te.FE.HTML5Map[e[n].tagName] + ">");
                ...
                ! function() {
                    for (var e = p.el.querySelectorAll("tr"), t = 0; t < e.length; t++) {
                        for (var n = e[t].children, r = !0, i = 0; i < n.length; i++)
                            ...
                            var o = a;
                            "THEAD" != o.tagName && (o = p.doc.createElement("THEAD"), a.insertBefore(o, a.firstChild)), o.appendChild(e[t])
                        }
                    }
                }()
            },
            lists: function() {
                ! function() {
                    ...
                    do {
                        ...
                        t = [];
                        for (var a = p.el.querySelectorAll("li"), o = 0; o < a.length; o++) e = a[o], p.node.isList(e.parentNode) || t.push(a[o])
                    } while (0 < t.length)
                }(),
                function() {
                    for (var e = p.el.querySelectorAll("ol + ol, ul + ul"), t = 0; t < e.length; t++) {
                        ...
                        if (p.node.isList(n.previousSibling) && p.node.openTagString(n) == p.node.openTagString(n.previousSibling)) {
                            for (var r = p.node.contents(n), i = 0; i < r.length; i++) n.previousSibling.appendChild(r[i]);
                ...
                function() {
                    for (var e = p.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++)
                        for (var n = p.node.contents(e[t]), r = null, i = n.length - 1; 0 <= i; i--) "LI" != n[i].tagName && "UL" != n[i].tagName && "OL" != n[i].tagName ? (r || (r = Te("<li>")).insertBefore(n[i]), r.prepend(n[i])) : r = null
                }(),
                function() {
                    var e, t, n;
                    do {
                        ...
                        var i = p.el.querySelectorAll("ul, ol");
                ...
                function() {
                    for (var e = p.el.querySelectorAll("ul > ul, ol > ol, ul > ol, ol > ul"), t = 0; t < e.length; t++) {
                        var n = e[t],
                            r = n.previousSibling;
                        r && ("LI" == r.tagName ? r.appendChild(n) : Te(n).wrap("<li></li>"))
                    }
                }(),
                function() {
                ...
                function() {
                    for (var e = p.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
                        var n = e[t];
                        if (p.node.isFirstSibling(n)) Te(n).before("<br/>");
        ...
        function l(e, t) {
            if (void 0 !== e && e || (e = d.el), void 0 === t && (t = !1), !e.getAttribute || "false" != e.getAttribute("contenteditable"))
                ...
                for (var n = d.doc.createTreeWalker(e, NodeFilter.SHOW_TEXT, d.node.filter(function(e) {
        ...
        return {
            ...
            normalizeAroundCursor: function() {
                for (var e = [], t = d.el.querySelectorAll(".fr-marker"), n = 0; n < t.length; n++) {
                    for (var r = null, i = d.node.blockParent(t[n]), a = (r = i || t[n]).nextSibling, o = r.previousSibling; a && "BR" == a.tagName;) a = a.nextSibling;
    ...
    }, Te.FE.UNICODE_NBSP = String.fromCharCode(160), Te.FE.VOID_ELEMENTS = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"], Te.FE.BLOCK_TAGS = ["address", "article", "aside", "audio", "blockquote", "canvas", "details", "dd", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "hr", "li", "main", "nav", "noscript", "ol", "output", "p", "pre", "section", "table", "tbody", "td", "tfoot", "th", "thead", "tr", "ul", "video"], Te.extend(Te.FE.DEFAULTS, {
    ...
    }), Te.FE.MODULES.html = function(w) {
        function c() {
            return w.opts.enter == Te.FE.ENTER_P ? "p" : w.opts.enter == Te.FE.ENTER_DIV ? "div" : w.opts.enter == Te.FE.ENTER_BR ? null : void 0
        }
        ...
        function a(e) {
            var t, n = [],
                r = [];
            if (e) {
                var i = w.el.querySelectorAll(".fr-marker");
                for (t = 0; t < i.length; t++) {
                    var a = w.node.blockParent(i[t]) || i[t];
                    if (a) {
                        var o = a.nextSibling,
                            s = a.previousSibling;
                        a && r.indexOf(a) < 0 && w.node.isBlock(a) && r.push(a), s && w.node.isBlock(s) && r.indexOf(s) < 0 && r.push(s), o && w.node.isBlock(o) && r.indexOf(o) < 0 && r.push(o)
                    }
                }
            } else r = w.el.querySelectorAll(p());
            var l = p();
            for (l += "," + Te.FE.VOID_ELEMENTS.join(","), l += ", .fr-inner", l += "," + w.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)", t = r.length - 1; 0 <= t; t--)
                if (!(r[t].textContent && 0 < r[t].textContent.replace(/\u200B|\n/g, "").length || 0 < r[t].querySelectorAll(l).length)) {
                    for (var d = w.node.contents(r[t]), c = !1, f = 0; f < d.length; f++)
        ...
        function p() {
            return Te.FE.BLOCK_TAGS.join(", ")
        }

        function e(e) {
            var t, n, r = Te.merge([], Te.FE.VOID_ELEMENTS);
            r = Te.merge(r, w.opts.htmlAllowedEmptyTags), r = void 0 === e ? Te.merge(r, Te.FE.BLOCK_TAGS) : Te.merge(r, Te.FE.NO_DELETE_TAGS), t = w.el.querySelectorAll("*:empty:not(" + r.join("):not(") + "):not(.fr-marker)");
            do {
                n = !1;
                for (var i = 0; i < t.length; i++) 0 !== t[i].attributes.length && void 0 === t[i].getAttribute("href") || (t[i].parentNode.removeChild(t[i]), n = !0);
                t = w.el.querySelectorAll("*:empty:not(" + r.join("):not(") + "):not(.fr-marker)")
            } while (t.length && n)
        }
        ...
        function o(e, t) {
            var n = c();
            if (t && (n = "div"), n) {
                for (var r = w.doc.createDocumentFragment(), i = null, a = !1, o = e.firstChild, s = !1; o;) {
                    var l = o.nextSibling;
                    if (o.nodeType == Node.ELEMENT_NODE && (w.node.isBlock(o) || 0 <= w.opts.htmlDoNotWrapTags.indexOf(o.tagName.toLowerCase()) && !w.node.hasClass(o, "fr-marker"))) i = null, r.appendChild(o.cloneNode(!0));
                    else if (o.nodeType != Node.ELEMENT_NODE && o.nodeType != Node.TEXT_NODE) i = null, r.appendChild(o.cloneNode(!0));
                    else if ("BR" == o.tagName) null == i ? (i = w.doc.createElement(n), s = !0, t && (i.setAttribute("class", "fr-temp-div"), i.setAttribute("data-empty", !0)), i.appendChild(o.cloneNode(!0)), r.appendChild(i)) : !1 === a && (i.appendChild(w.doc.createElement("br")), t && (i.setAttribute("class", "fr-temp-div"), i.setAttribute("data-empty", !0))), i = null;
                    else {
                        var d = o.textContent;
                        o.nodeType !== Node.TEXT_NODE || 0 < d.replace(/\n/g, "").replace(/(^ *)|( *$)/g, "").length || d.replace(/(^ *)|( *$)/g, "").length && d.indexOf("\n") < 0 ? (null == i && (i = w.doc.createElement(n), s = !0, t && i.setAttribute("class", "fr-temp-div"), r.appendChild(i), a = !1), i.appendChild(o.cloneNode(!0)), a || w.node.hasClass(o, "fr-marker") || o.nodeType == Node.TEXT_NODE && 0 === d.replace(/ /g, "").length || (a = !0)) : s = !0
                    }
                    o = l
                }
        ...
        function t(e, t, n, r, i) {
            ...
            var a = w.$wp.scrollTop();
            o(w.el, e), r && l(w.el.querySelectorAll(".fr-inner"), e), t && l(w.el.querySelectorAll("td, th"), e), n && l(w.el.querySelectorAll("blockquote"), e), i && l(w.el.querySelectorAll("li"), e), a != w.$wp.scrollTop() && w.$wp.scrollTop(a)
        }
                ...
                if (!s(n.parentNode, !0)) {
                    ...
                    if (r) {
                        var a = n.previousSibling,
                            o = n.nextSibling;
                        a && o && " " == i ? i = w.node.isBlock(a) && w.node.isBlock(o) ? "" : " " : (a || (i = i.replace(/^ */, "")), o || (i = i.replace(/ *$/, "")))
                    }
                    n.textContent = i
                }
            }
        ...
        function d(e) {
            ...
            if (t && (w.node.isBlock(t) || w.node.isElement(t)) && ["TD", "TH"].indexOf(t.tagName) < 0) {
                ...
                if (r) return !1;
                n && t && "BR" != n.tagName && !w.node.isBlock(n) && !r && 0 < t.textContent.replace(/\u200B/g, "").length && 0 < n.textContent.length && !w.node.hasClass(n, "fr-marker") && (w.el == t && !r && w.opts.enter == Te.FE.ENTER_BR && w.browser.msie || e.parentNode.removeChild(e))
            } else !t || w.node.isBlock(t) || w.node.isElement(t) || e.previousSibling || e.nextSibling || !w.node.isDeletable(e.parentNode) || d(e.parentNode)
        }

        function u() {
            w.opts.htmlUntouched || (e(), t(), n(), w.spaces.normalize(null, !0), w.html.fillEmptyBlocks(), w.clean.lists(), w.clean.tables(), w.clean.toHTML5(), w.html.cleanBRs()), w.selection.restore(), i(), w.placeholder.refresh()
        }

        function i() {
            w.node.isEmpty(w.el) && (null != c() ? w.el.querySelector(p()) || w.el.querySelector(w.opts.htmlDoNotWrapTags.join(":not(.fr-marker),") + ":not(.fr-marker)") || (w.core.hasFocus() ? (w.$el.html("<" + c() + ">" + Te.FE.MARKERS + "<br/></" + c() + ">"), w.selection.restore()) : w.$el.html("<" + c() + "><br/></" + c() + ">")) : w.el.querySelector("*:not(.fr-marker):not(br)") || (w.core.hasFocus() ? (w.$el.html(Te.FE.MARKERS + "<br/>"), w.selection.restore()) : w.$el.html("<br/>")))
        }
        ...
        function E(e) {
            ...
            if ((w.el.textContent.match(/\u200B/g) || []).length - w.el.querySelectorAll(".fr-marker").length == i) return !1;
            do {
                ...
                for (var a = 0; a < n.length; a++) {
                    ...
                    if (t != o) {
                        var s = o.textContent;
                        0 === o.children.length && 1 === s.length && 8203 == s.charCodeAt(0) && "TD" !== o.tagName && (Te(o).remove(), r = !0)
                    }
                }
            } while (r)
        }
        return {
            ...
            emptyBlockTagsQuery: function() {
                return Te.FE.BLOCK_TAGS.join(":empty, ") + ":empty"
            },
            blockTagsQuery: p,
            fillEmptyBlocks: function(e) {
                var t = a(e);
                w.node.isEmpty(w.el) && w.opts.enter === Te.FE.ENTER_BR && t.push(w.el);
                for (var n = 0; n < t.length; n++) {
                    var r = t[n];
                    "false" === r.getAttribute("contenteditable") || r.querySelector(w.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)") || w.node.isVoid(r) || "TABLE" == r.tagName || "TBODY" == r.tagName || "TR" == r.tagName || "UL" == r.tagName || "OL" == r.tagName || r.querySelector("br") || r.appendChild(w.doc.createElement("br"))
                }
                if (w.browser.msie && w.opts.enter == Te.FE.ENTER_BR) {
                    var i = w.node.contents(w.el);
                    i.length && i[i.length - 1].nodeType == Node.TEXT_NODE && w.$el.append("<br>")
                }
            },
            cleanEmptyTags: e,
            cleanWhiteTags: E,
            cleanBlankSpaces: n,
            blocks: function() {
                return w.$el.get(0).querySelectorAll(p())
            },
            getDoctype: O,
            set: function(e) {
                var t, n, r, i = w.clean.html((e || "").trim(), [], [], w.opts.fullPage);
                if (w.opts.fullPage) {
                    var a = h(i, "body") || (0 <= i.indexOf("<body") ? "" : i),
                        o = g(i, "body"),
                        s = h(i, "head") || "<title></title>",
                        l = g(i, "head"),
                        d = Te("<div>").append(s).contents().each(function() {
                    ...
                    s = Te("<div>").append(s).contents().map(function() {
                    ...
                    var c = m(i),
                        f = g(i, "html");
                    v(w.$el, d + "\n" + a), w.node.clearAttributes(w.el), w.$el.attr(o), w.$el.addClass("fr-view"), w.$el.attr("spellcheck", w.opts.spellcheck), w.$el.attr("dir", w.opts.direction), v(w.$head, s), w.node.clearAttributes(w.$head.get(0)), w.$head.attr(l), w.node.clearAttributes(w.$html.get(0)), w.$html.attr(f), w.iframe_document.doctype.parentNode.replaceChild((t = c, n = w.iframe_document, (r = t.match(/<!DOCTYPE ?([^ ]*) ?([^ ]*) ?"?([^"]*)"? ?"?([^"]*)"?>/i)) ? n.implementation.createDocumentType(r[1], r[3], r[4]) : n.implementation.createDocumentType("html")), w.iframe_document.doctype)
                } else v(w.$el, i);
                var p = w.edit.isDisabled();
                w.edit.on(), w.core.injectStyle(w.opts.iframeDefaultStyle + w.opts.iframeStyle), u(), w.opts.useClasses || (w.$el.find("[fr-original-class]").each(function() {
                ...
                })), p && w.edit.off(), w.events.trigger("html.set")
            },
            get: function(e, t) {
                ...
                var r, i, a = [],
                    o = {},
                    s = [],
                    l = w.el.querySelectorAll("input, textarea");
                for (r = 0; r < l.length; r++) l[r].setAttribute("value", l[r].value);
                if (!w.opts.useClasses && !t) {
                    var d = new RegExp("^" + w.opts.htmlIgnoreCSSProperties.join("$|^") + "$", "gi");
                    for (r = 0; r < w.doc.styleSheets.length; r++) {
                        var c, f = 0;
                        try {
                            c = w.doc.styleSheets[r].cssRules, w.doc.styleSheets[r].ownerNode && "STYLE" == w.doc.styleSheets[r].ownerNode.nodeType && (f = 1)
                        } catch (x) {}
                        if (c)
                ...
                if (w.node.isEmpty(w.el)) w.opts.fullPage && (n = O(w.iframe_document), n += "<html" + w.node.attributes(w.$html.get(0)) + ">" + w.$html.find("head").get(0).outerHTML + "<body></body></html>");
                else if (void 0 === e && (e = !1), w.opts.fullPage) {
                    n = O(w.iframe_document), w.$el.removeClass("fr-view");
                    var y = w.opts.heightMin,
                        L = w.opts.height,
                        _ = w.opts.heightMax;
                    w.opts.heightMin = null, w.opts.height = null, w.opts.heightMax = null, w.size.refresh(), n += "<html" + w.node.attributes(w.$html.get(0)) + ">" + w.$html.html() + "</html>", w.opts.heightMin = y, w.opts.height = L, w.opts.heightMax = _, w.size.refresh(), w.$el.addClass("fr-view")
                } else n = w.$el.html();
                if (!w.opts.useClasses && !t)
            ...
            insert: function(e, t, n) {
                var r, i, a;
                if (w.selection.isCollapsed() || w.selection.remove(), r = t ? e : w.clean.html(e), e.indexOf('class="fr-marker"') < 0 && (i = r, (a = w.doc.createElement("div")).innerHTML = i, w.selection.setAtEnd(a, !0), r = a.innerHTML), w.node.isEmpty(w.el) && !w.opts.keepFormatOnDelete && f(r)) w.el.innerHTML = r;
                else {
                    var o = w.markers.insert();
                    if (o) {
                        w.node.isLastSibling(o) && Te(o).parent().hasClass("fr-deletable") && Te(o).insertAfter(Te(o).parent());
                        var s = w.node.blockParent(o);
                        if ((f(r) || n) && (w.node.deepestParent(o) || s && "LI" == s.tagName)) {
                            if (s && "LI" == s.tagName && (r = function(e) {
                                    if (!w.html.defaultTag()) return e;
                                    var t = w.doc.createElement("div");
                                    t.innerHTML = e;
                                    for (var n = t.querySelectorAll(":scope > " + w.html.defaultTag()), r = n.length - 1; 0 <= r; r--) {
                                        var i = n[r];
                                        w.node.isBlock(i.previousSibling) || (i.previousSibling && !w.node.isEmpty(i) && Te("<br>").insertAfter(i.previousSibling), i.outerHTML = i.innerHTML)
                                    }
                                    return t.innerHTML
                                }(r)), !(o = w.markers.split())) return !1;
                            o.outerHTML = r
                        } else o.outerHTML = r
                    } else w.el.innerHTML = w.el.innerHTML + r
                }
                u(), w.keys.positionCaret(), w.events.trigger("html.inserted")
            },
            wrap: t,
            unwrap: function() {
                w.$el.find("div.fr-temp-div").each(function() {
                    this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && Te(this).before("<br>"), Te(this).attr("data-empty") || !this.nextSibling || w.node.isBlock(this.nextSibling) && !Te(this.nextSibling).hasClass("fr-temp-div") ? Te(this).replaceWith(Te(this).html()) : Te(this).replaceWith(Te(this).html() + "<br>")
                }), w.$el.find(".fr-temp-div").removeClass("fr-temp-div").filter(function() {
                    return "" === Te(this).attr("class")
                }).removeAttr("class")
            },
            ...
            extractDoctype: m,
            cleanBRs: function() {
                for (var e = w.el.getElementsByTagName("br"), t = 0; t < e.length; t++) d(e[t])
            },
            _init: function() {
                if (w.$wp) {
                    var e = function() {
                    ...
                    w.events.on("mouseup", e), w.events.on("keydown", e), w.events.on("contentChanged", i)
                }
            },
            _setHtml: v
        }
        ...
        language: null
    }), Te.FE.LANGUAGE = {}, Te.FE.MODULES.language = function(e) {
        var t;
        return {
            _init: function() {
                Te.FE.LANGUAGE && (t = Te.FE.LANGUAGE[e.opts.language]), t && t.direction && (e.opts.direction = t.direction)
            },
    ...
    }), Te.FE.MODULES.placeholder = function(f) {
        function e() {
            f.$placeholder || (f.$placeholder = Te('<span class="fr-placeholder"></span>'), f.$wp.append(f.$placeholder));
            var e, t = 0,
                n = 0,
                r = 0,
                i = 0,
        ...
        return {
            _init: function() {
                if (Te.FE.INSTANCES.push(d), d.drag_support = {
            ...
            injectStyle: function(e) {
                if (d.opts.iframe) {
                    ...
                    for (var t = Te('<style data-fr-style="true">' + e + "</style>").appendTo(d.$head)[0].sheet, n = 0; n < c.length; n++)
                        for (var r = t.insertRule(c[n].selector + "{}", t.cssRules.length), i = 0; i < c[n].style.length; i++) {
                            var a = c[n].style[i],
                                o = c[n].style[a];
                            d.browser.safari && "content" === a && (o = '"' + o + '"'), t.cssRules[r].style[a] = o
                        }
                    for (var s = 0; s < d.opts.iframeStyleFiles.length; s++) {
                        var l = Te('<link data-fr-style="true" rel="stylesheet" href="' + d.opts.iframeStyleFiles[s] + '">');
    ...
    }, Te.FE.MODULES.cursorLists = function(m) {
        function v(e) {
            for (var t = e;
        ...
        return {
            _startEnter: function(e) {
                ...
                if (m.node.isEmpty(n, !0) && r) {
                    for (var o = "", s = "", l = e.parentNode; !m.node.isList(l) && l.parentNode && ("LI" !== l.parentNode.tagName || l.parentNode === n);) o = m.node.openTagString(l) + o, s += m.node.closeTagString(l), l = l.parentNode;
                    o = m.node.openTagString(l) + o, s += m.node.closeTagString(l);
                    var d = "";
                    for (d = l.parentNode && "LI" == l.parentNode.tagName ? s + "<li>" + Te.FE.MARKERS + "<br>" + o : a ? s + "<" + a + ">" + Te.FE.MARKERS + "<br></" + a + ">" + o : s + Te.FE.MARKERS + "<br>" + o;
                        ["UL", "OL"].indexOf(l.tagName) < 0 || l.parentNode && "LI" === l.parentNode.tagName;) l = l.parentNode;
                    Te(n).replaceWith('<span id="fr-break"></span>');
                    var c = m.node.openTagString(l) + Te(l).html() + m.node.closeTagString(l);
                    c = c.replace(/<span id="fr-break"><\/span>/g, d), Te(l).replaceWith(c), m.$el.find("li:empty").remove()
                } else if (i && r || !m.node.isEmpty(n, !0)) {
                    for (var f, p = "<br>", u = e.parentNode; u && "LI" != u.tagName;) Te(u).is("span.fr-emoticon") || (f = "A" == u.tagName && m.cursor.isAtStart(e, u) ? "fr-to-remove" : "", p = m.node.openTagString(Te(u).clone().addClass(f).get(0)) + p + m.node.closeTagString(u)), u = u.parentNode;
                    Te(n).before("<li>" + p + "</li>"), Te(e).remove()
                } else if (i) {
                    t = E(n);
                    for (var h = Te.FE.MARKERS + "<br>", g = e.parentNode; g && "LI" != g.tagName;) h = m.node.openTagString(g) + h + m.node.closeTagString(g), g = g.parentNode;
                    t.parentNode && "LI" == t.parentNode.tagName ? Te(t.parentNode).after("<li>" + h + "</li>") : a ? Te(t).after("<" + a + ">" + h + "</" + a + ">") : Te(t).after(h), Te(n).remove()
                } else(t = E(n)).parentNode && "LI" == t.parentNode.tagName ? r ? Te(t.parentNode).before(m.node.openTagString(n) + Te.FE.MARKERS + "<br></li>") : Te(t.parentNode).after(m.node.openTagString(n) + Te.FE.MARKERS + "<br></li>") : a ? Te(t).before("<" + a + ">" + Te.FE.MARKERS + "<br></" + a + ">") : Te(t).before(Te.FE.MARKERS + "<br>"), Te(n).remove()
            },
            _middleEnter: function(e) {
                for (var t = v(e), n = "", r = e, i = "", a = "", o = !1; r != t;)
                    if (r = r.parentNode, !Te(r).is("span.fr-emoticon")) {
                        var s = "A" == r.tagName && m.cursor.isAtEnd(e, r) ? "fr-to-remove" : "";
                        o || r == t || m.node.isBlock(r) || (o = !0, i += Te.FE.INVISIBLE_SPACE), i = m.node.openTagString(Te(r).clone().addClass(s).get(0)) + i, a += m.node.closeTagString(r)
                    } n = a + n + i + Te.FE.MARKERS + (m.opts.keepFormatOnDelete ? Te.FE.INVISIBLE_SPACE : ""), Te(e).replaceWith('<span id="fr-break"></span>');
                var l = m.node.openTagString(t) + Te(t).html() + m.node.closeTagString(t);
                l = l.replace(/<span id="fr-break"><\/span>/g, n), Te(t).replaceWith(l)
            },
            _endEnter: function(e) {
                for (var t = v(e), n = Te.FE.MARKERS, r = "", i = e, a = !1; i != t;)
                    if (i = i.parentNode, !Te(i).is("span.fr-emoticon")) {
                        var o = "A" == i.tagName && m.cursor.isAtEnd(e, i) ? "fr-to-remove" : "";
                        a || i == t || m.node.isBlock(i) || (a = !0, r += Te.FE.INVISIBLE_SPACE), r = m.node.openTagString(Te(i).clone().addClass(o).get(0)) + r, n += m.node.closeTagString(i)
                    } var s = r + n;
                Te(e).remove(), Te(t).after(s)
            },
            _backspace: function(e) {
                var t = v(e),
                    n = t.previousSibling;
                if (n) {
                    n = Te(n).find(m.html.blockTagsQuery()).get(-1) || n, Te(e).replaceWith(Te.FE.MARKERS);
                    var r = m.node.contents(n);
                    r.length && "BR" == r[r.length - 1].tagName && Te(r[r.length - 1]).remove(), Te(t).find(m.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                        this.parentNode == t && Te(this).replaceWith(Te(this).html() + (m.node.isEmpty(this) ? "" : "<br>"))
                    });
                    for (var i, a = m.node.contents(t)[0]; a && !m.node.isList(a);) i = a.nextSibling, Te(n).append(a), a = i;
                    for (n = t.previousSibling; a;) i = a.nextSibling, Te(n).append(a), a = i;
                    1 < (r = m.node.contents(n)).length && "BR" === r[r.length - 1].tagName && Te(r[r.length - 1]).remove(), Te(t).remove()
                } else {
                    var o = E(t);
                    if (Te(e).replaceWith(Te.FE.MARKERS), o.parentNode && "LI" == o.parentNode.tagName) {
                        var s = o.previousSibling;
                        m.node.isBlock(s) ? (Te(t).find(m.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                            this.parentNode == t && Te(this).replaceWith(Te(this).html() + (m.node.isEmpty(this) ? "" : "<br>"))
                        }), Te(s).append(Te(t).html())) : Te(o).before(Te(t).html())
                    } else {
                        var l = m.html.defaultTag();
                        l && 0 === Te(t).find(m.html.blockTagsQuery()).length ? Te(o).before("<" + l + ">" + Te(t).html() + "</" + l + ">") : Te(o).before(Te(t).html())
                    }
                    Te(t).remove(), m.html.wrap(), 0 === Te(o).find("li").length && Te(o).remove()
                }
            },
            _del: function(e) {
                var t, n = v(e),
                    r = n.nextSibling;
                if (r) {
                    (t = m.node.contents(r)).length && "BR" == t[0].tagName && Te(t[0]).remove(), Te(r).find(m.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                        this.parentNode == r && Te(this).replaceWith(Te(this).html() + (m.node.isEmpty(this) ? "" : "<br>"))
                    });
                    for (var i, a = e, o = m.node.contents(r)[0]; o && !m.node.isList(o);) i = o.nextSibling, Te(a).after(o), a = o, o = i;
                    for (; o;) i = o.nextSibling, Te(n).append(o), o = i;
                    Te(e).replaceWith(Te.FE.MARKERS), Te(r).remove()
                } else {
                    for (var s = n; !s.nextSibling && s != m.el;) s = s.parentNode;
                    if (s == m.el) return !1;
                    if (s = s.nextSibling, m.node.isBlock(s)) Te.FE.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (Te(e).replaceWith(Te.FE.MARKERS), (t = m.node.contents(n)).length && "BR" == t[t.length - 1].tagName && Te(t[t.length - 1]).remove(), Te(n).append(Te(s).html()), Te(s).remove());
                    else
                        for ((t = m.node.contents(n)).length && "BR" == t[t.length - 1].tagName && Te(t[t.length - 1]).remove(), Te(e).replaceWith(Te.FE.MARKERS); s && !m.node.isBlock(s) && "BR" != s.tagName;) Te(n).append(Te(s)), s = s.nextSibling
                }
            }
        }
    }, Te.FE.NO_DELETE_TAGS = ["TH", "TD", "TR", "TABLE", "FORM"], Te.FE.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI", "DL", "DT", "FORM"], Te.FE.MODULES.cursor = function(u) {
        function a(e) {
        ...
        function s(e) {
            return 0 < Te(e).parentsUntil(u.$el, "LI").length && 0 === Te(e).parentsUntil("LI", "TABLE").length
        }
        ...
        function c(e) {
            ...
            if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType == Node.TEXT_NODE) {
                    ...
                    if (u.opts.tabSpaces && r.length >= u.opts.tabSpaces) 0 === r.substr(r.length - u.opts.tabSpaces, r.length - 1).replace(/ /g, "").replace(new RegExp(Te.FE.UNICODE_NBSP, "g"), "").length && (i = r.length - u.opts.tabSpaces + 1);
                    n.textContent = r.substring(0, i - d(r)), u.opts.htmlUntouched && !e.nextSibling && n.textContent.length && " " === n.textContent[n.textContent.length - 1] && (n.textContent = n.textContent.substring(0, n.textContent.length - 1) + Te.FE.UNICODE_NBSP);
                    var a = r.length != n.textContent.length;
                    if (0 === n.textContent.length)
                        if (a && u.opts.keepFormatOnDelete) Te(n).after(Te.FE.INVISIBLE_SPACE + Te.FE.MARKERS);
                        else if (0 !== r.length && u.node.isBlock(n.parentNode)) Te(n).after(Te.FE.MARKERS);
                        ...
                        for (; !u.node.isElement(n.parentNode) && u.node.isEmpty(n.parentNode) && Te.FE.NO_DELETE_TAGS.indexOf(n.parentNode.tagName) < 0 && !u.node.isBlock(n.parentNode);) {
                            var o = n;
                            n = n.parentNode, o.parentNode.removeChild(o)
                        }
                        Te(n).after(Te.FE.MARKERS), u.node.isElement(n.parentNode) && !e.nextSibling && n.previousSibling && "BR" == n.previousSibling.tagName && Te(e).after("<br>"), n.parentNode.removeChild(n)
                    } else Te(n.parentNode).after(Te.FE.MARKERS), Te(n.parentNode).remove();
                    else Te(n).after(Te.FE.MARKERS)
                } else u.node.isDeletable(n) ? (Te(n).after(Te.FE.MARKERS), Te(n).remove()) : e.nextSibling && "BR" == e.nextSibling.tagName && u.node.isVoid(n) && "BR" != n.tagName ? (Te(e.nextSibling).remove(), Te(e).replaceWith(Te.FE.MARKERS)) : !1 !== u.events.trigger("node.remove", [Te(n)]) && (Te(n).after(Te.FE.MARKERS), Te(n).remove())
            } else if (Te.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n)))
                if (u.node.isDeletable(n)) Te(e).replaceWith(Te.FE.MARKERS), Te(n).remove();
                else if (u.node.isEmpty(n) && !u.node.isList(n)) Te(n).remove(), Te(e).replaceWith(Te.FE.MARKERS);
            else {
                for (u.node.isList(n) && (n = Te(n).find("li:last").get(0)), (t = u.node.contents(n)) && "BR" == t[t.length - 1].tagName && Te(t[t.length - 1]).remove(), t = u.node.contents(n); t && u.node.isBlock(t[t.length - 1]);) n = t[t.length - 1], t = u.node.contents(n);
                Te(n).append(Te.FE.MARKERS);
                for (var s = e; !s.previousSibling;) s = s.parentNode;
                for (; s && "BR" !== s.tagName && !u.node.isBlock(s);) {
                    var l = s;
                    s = s.nextSibling, Te(n).append(l)
                }
                s && "BR" == s.tagName && Te(s).remove(), Te(e).remove()
            } else u.node.isEditable(n) ? e.nextSibling && "BR" == e.nextSibling.tagName && Te(e.nextSibling).remove() : (Te(n).after(Te.FE.MARKERS), Te(n).remove());
            return !0
        }

        function l(e) {
            var t = 0 < Te(e).parentsUntil(u.$el, "BLOCKQUOTE").length,
                n = u.node.deepestParent(e, [], !t);
            if (n && "BLOCKQUOTE" == n.tagName) {
                var r = u.node.deepestParent(e, [Te(e).parentsUntil(u.$el, "BLOCKQUOTE").get(0)]);
                r && r.nextSibling && (n = r)
            }
            if (null !== n) {
                var i, a = n.nextSibling;
                if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && a && Te.FE.NO_DELETE_TAGS.indexOf(a.tagName) < 0)
                    if (u.node.isDeletable(a) || !u.node.isEditable(a)) Te(a).remove(), Te(e).replaceWith(Te.FE.MARKERS);
                    else if (u.node.isBlock(a) && u.node.isEditable(a))
                    if (u.node.isList(a))
                        if (u.node.isEmpty(n, !0)) Te(n).remove(), Te(a).find("li:first").prepend(Te.FE.MARKERS);
                        else {
                            var o = Te(a).find("li:first");
                            "BLOCKQUOTE" == n.tagName && (i = u.node.contents(n)).length && u.node.isBlock(i[i.length - 1]) && (n = i[i.length - 1]), 0 === o.find("ul, ol").length && (Te(e).replaceWith(Te.FE.MARKERS), o.find(u.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                                this.parentNode == o.get(0) && Te(this).replaceWith(Te(this).html() + (u.node.isEmpty(this) ? "" : "<br>"))
                            }), Te(n).append(u.node.contents(o.get(0))), o.remove(), 0 === Te(a).find("li").length && Te(a).remove())
                        }
                else {
                    if ((i = u.node.contents(a)).length && "BR" == i[0].tagName && Te(i[0]).remove(), "BLOCKQUOTE" != a.tagName && "BLOCKQUOTE" == n.tagName)
                    ...
                    Te(e).replaceWith(Te.FE.MARKERS), Te(n).append(a.innerHTML), Te(a).remove()
                } else {
                    for (Te(e).replaceWith(Te.FE.MARKERS); a && "BR" !== a.tagName && !u.node.isBlock(a) && u.node.isEditable(a);) {
                        var s = a;
                        a = a.nextSibling, Te(n).append(s)
                    }
                    a && "BR" == a.tagName && u.node.isEditable(a) && Te(a).remove()
                }
            }
        }
        ...
        function n(e) {
            ...
            if ("BR" == (n = n.nextSibling).tagName && u.node.isEditable(n))
                if (n.nextSibling) {
                    if (u.node.isBlock(n.nextSibling) && u.node.isEditable(n.nextSibling)) {
                        if (!(Te.FE.NO_DELETE_TAGS.indexOf(n.nextSibling.tagName) < 0)) return void Te(n).remove();
                        n = n.nextSibling, Te(n.previousSibling).remove()
                    }
                } else if (a(n)) {
                if (s(e)) u.cursorLists._del(e);
                else u.node.deepestParent(n) && ((!u.node.isEmpty(u.node.blockParent(n)) || (u.node.blockParent(n).nextSibling && Te.FE.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) && Te(n).remove(), l(e));
                return
            }
            if (!u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                n.nodeType == Node.TEXT_NODE ? (Te(n).before(Te.FE.MARKERS), n.textContent.length && (n.textContent = n.textContent.substring(d(n.textContent, !0), n.textContent.length))) : u.node.isDeletable(n) ? (Te(n).before(Te.FE.MARKERS), Te(n).remove()) : !1 !== u.events.trigger("node.remove", [Te(n)]) && (Te(n).before(Te.FE.MARKERS), Te(n).remove()), Te(e).remove()
            } else if (Te.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n)))
                if (u.node.isDeletable(n)) Te(e).replaceWith(Te.FE.MARKERS), Te(n).remove();
                else if (u.node.isList(n)) e.previousSibling ? (Te(n).find("li:first").prepend(e), u.cursorLists._backspace(e)) : (Te(n).find("li:first").prepend(Te.FE.MARKERS), Te(e).remove());
            else if ((t = u.node.contents(n)) && t.length && "BR" == t[0].tagName && Te(t[0]).remove(), t && "BLOCKQUOTE" == n.tagName) {
                var r = t[0];
                for (Te(e).before(Te.FE.MARKERS); r && "BR" != r.tagName;) {
                    var i = r;
                    r = r.nextSibling, Te(e).before(i)
                }
                r && "BR" == r.tagName && Te(r).remove()
            } else Te(e).after(Te(n).html()).after(Te.FE.MARKERS), Te(n).remove();
            else u.node.isEditable(n) || (Te(e).replaceWith(Te.FE.MARKERS), Te(n).remove())
        }
        ...
        function p(e, t, n) {
            ...
            if (i && "BLOCKQUOTE" == i.tagName) return g(e, i) ? (r = u.html.defaultTag(), t ? Te(e).replaceWith("<br>" + Te.FE.MARKERS) : r ? Te(i).after("<" + r + ">" + Te.FE.MARKERS + "<br></" + r + ">") : Te(i).after(Te.FE.MARKERS + "<br>"), Te(e).remove()) : m(e, t, n), !1;
            if (null == i)(r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? Te(e).replaceWith("<" + r + ">" + Te.FE.MARKERS + "<br></" + r + ">") : !e.previousSibling || Te(e.previousSibling).is("br") || e.nextSibling ? Te(e).replaceWith("<br>" + Te.FE.MARKERS) : Te(e).replaceWith("<br>" + Te.FE.MARKERS + "<br>");
            else {
                var a = e,
                    o = "";
                ...
                var s, l = "",
                    ...
                    c = "",
                    f = "";
                (r = u.html.defaultTag()) && u.node.isBlock(i) && (c = "<" + r + ">", f = "</" + r + ">", i.tagName == r.toUpperCase() && (c = u.node.openTagString(Te(i).clone().removeAttr("id").get(0))));
                do {
                    if (a = a.parentNode, !t || a != i || t && !u.node.isBlock(i))
                        if (l += u.node.closeTagString(a), a == i && u.node.isBlock(i)) d = c + d;
                        else {
                            var p = ("A" == a.tagName || Te(a).hasClass("fa")) && g(e, a) ? "fr-to-remove" : "";
                            d = u.node.openTagString(Te(a).clone().addClass(p).get(0)) + d
                        }
                } while (a != i);
                o = l + o + d + (e.parentNode == i && u.node.isBlock(i) ? "" : Te.FE.INVISIBLE_SPACE) + Te.FE.MARKERS, u.node.isBlock(i) && !Te(i).find("*:last").is("br") && Te(i).append("<br/>"), Te(e).after('<span id="fr-break"></span>'), Te(e).remove(), i.nextSibling && !u.node.isBlock(i.nextSibling) || u.node.isBlock(i) || Te(i).after("<br>"), s = (s = !t && u.node.isBlock(i) ? u.node.openTagString(i) + Te(i).html() + f : u.node.openTagString(i) + Te(i).html() + u.node.closeTagString(i)).replace(/<span id="fr-break"><\/span>/g, o), Te(i).replaceWith(s)
            }
        }

        function m(e, t, n) {
            var r = u.node.deepestParent(e, [], !n);
            if (null == r) u.html.defaultTag() && e.parentNode === u.el ? Te(e).replaceWith("<" + u.html.defaultTag() + ">" + Te.FE.MARKERS + "<br></" + u.html.defaultTag() + ">") : (e.nextSibling && !u.node.isBlock(e.nextSibling) || Te(e).after("<br>"), Te(e).replaceWith("<br>" + Te.FE.MARKERS));
            else if (e.previousSibling && "IMG" == e.previousSibling.tagName || e.nextSibling && "IMG" == e.nextSibling.tagName) Te(e).replaceWith("<" + u.html.defaultTag() + ">" + Te.FE.MARKERS + "<br></" + u.html.defaultTag() + ">");
            else {
                var i = e,
                    a = "";
                ...
                do {
                    var l = i;
                    if (i = i.parentNode, "BLOCKQUOTE" == r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && 0 < Te(l).find(e).length && Te(l).after(e), "BLOCKQUOTE" != r.tagName || !g(e, i) && !h(e, i))
                        if (!t || i != r || t && !u.node.isBlock(r)) {
                            o += u.node.closeTagString(i);
                            var d = "A" == i.tagName && g(e, i) || Te(i).hasClass("fa") ? "fr-to-remove" : "";
                            s = u.node.openTagString(Te(i).clone().addClass(d).removeAttr("id").get(0)) + s
                        } else "BLOCKQUOTE" == r.tagName && t && (s = o = "")
                } while (i != r);
                var c = r == e.parentNode && u.node.isBlock(r) || e.nextSibling;
                if ("BLOCKQUOTE" == r.tagName)
                    if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" == e.nextSibling.tagName && (Te(e.nextSibling).after(e), e.nextSibling && "BR" == e.nextSibling.tagName && Te(e.nextSibling).remove()), t) a = o + a + Te.FE.MARKERS + s;
                    else {
                        var f = u.html.defaultTag();
                        a = o + a + (f ? "<" + f + ">" : "") + Te.FE.MARKERS + "<br>" + (f ? "</" + f + ">" : "") + s
                    }
                else a = o + a + s + (c ? "" : Te.FE.INVISIBLE_SPACE) + Te.FE.MARKERS;
                Te(e).replaceWith('<span id="fr-break"></span>');
                var p = u.node.openTagString(r) + Te(r).html() + u.node.closeTagString(r);
                p = p.replace(/<span id="fr-break"><\/span>/g, a), Te(r).replaceWith(p)
            }
        }
        return {
            enter: function(t) {
                ...
                for (var r = n.parentNode; r && !u.node.isElement(r);) {
                    if ("false" === r.getAttribute("contenteditable")) return Te(n).replaceWith(Te.FE.MARKERS), u.selection.restore(), !1;
                    if ("true" === r.getAttribute("contenteditable")) break;
                    r = r.parentNode
                }
                u.el.normalize();
                var i = !1;
                0 < Te(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (i = !0), Te(n).parentsUntil(u.$el, "TD, TH").length && (i = !1), a(n) ? !s(n) || t || i || 0 !== Te(n).parentsUntil("LI", ".fr-img-caption").length ? p(n, t, i) : u.cursorLists._endEnter(n) : o(n) ? !s(n) || t || i || 0 !== Te(n).parentsUntil("LI", ".fr-img-caption").length ? function e(t, n, r) {
                    var i, a = u.node.deepestParent(t, [], !r);
                    if (a && "TABLE" == a.tagName) return Te(a).find("td:first, th:first").prepend(t), e(t, n, r);
                    if (a && "BLOCKQUOTE" == a.tagName)
                        if (h(t, a)) {
                            if (!n) return (i = u.html.defaultTag()) ? Te(a).before("<" + i + ">" + Te.FE.MARKERS + "<br></" + i + ">") : Te(a).before(Te.FE.MARKERS + "<br>"), Te(t).remove(), !1
                        } else g(t, a) ? p(t, n, !0) : m(t, n, !0);
                    if (null == a)(i = u.html.defaultTag()) && u.node.isElement(t.parentNode) ? Te(t).replaceWith("<" + i + ">" + Te.FE.MARKERS + "<br></" + i + ">") : Te(t).replaceWith("<br>" + Te.FE.MARKERS);
                    else {
                        if (u.node.isBlock(a))
                            if ("PRE" == a.tagName && (n = !0), n) Te(t).remove(), Te(a).prepend("<br>" + Te.FE.MARKERS);
                            else {
                                if (u.node.isEmpty(a, !0)) return p(t, n, r);
                                if (t.nextSibling && "IMG" == t.nextSibling.tagName || t.nextSibling && t.nextSibling.nextElementSibling && "IMG" == t.nextSibling.nextElementSibling) Te(t).replaceWith("<" + u.html.defaultTag() + ">" + Te.FE.MARKERS + "<br></" + u.html.defaultTag() + ">");
                                else if (u.opts.keepFormatOnDelete) {
                                    for (var o = t, s = Te.FE.INVISIBLE_SPACE; o != a && !u.node.isElement(o);) o = o.parentNode, s = u.node.openTagString(o) + s + u.node.closeTagString(o);
                                    Te(a).before(s)
                                } else Te(a).before(u.node.openTagString(Te(a).clone().removeAttr("id").get(0)) + "<br>" + u.node.closeTagString(a))
                            }
                        else Te(a).before("<br>");
                        Te(t).remove()
                    }
                }(n, t, i) : u.cursorLists._startEnter(n) : !s(n) || t || i || 0 !== Te(n).parentsUntil("LI", ".fr-img-caption").length ? m(n, t, i) : u.cursorLists._middleEnter(n), u.$el.find(".fr-to-remove").each(function() {
                    for (var e = u.node.contents(this), t = 0; t < e.length; t++) e[t].nodeType == Node.TEXT_NODE && (e[t].textContent = e[t].textContent.replace(/\u200B/g, ""));
                    Te(this).replaceWith(this.innerHTML)
            ...
            backspace: function() {
                ...
                for (var n = t.parentNode; n && !u.node.isElement(n);) {
                    if ("false" === n.getAttribute("contenteditable")) return Te(t).replaceWith(Te.FE.MARKERS), u.selection.restore(), !1;
                ...
                if (r) {
                    var i = r.textContent;
                    i && i.length && 8203 == i.charCodeAt(i.length - 1) && (1 == i.length ? Te(r).remove() : r.textContent = r.textContent.substr(0, i.length - d(i)))
                }
                return a(t) ? s(t) && h(t, Te(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : e = c(t) : o(t) ? s(t) && h(t, Te(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : function(e) {
                    for (var t = 0 < Te(e).parentsUntil(u.$el, "BLOCKQUOTE").length, n = u.node.deepestParent(e, [], !t), r = n; n && !n.previousSibling && "BLOCKQUOTE" != n.tagName && n.parentElement != u.el && !u.node.hasClass(n.parentElement, "fr-inner") && Te.FE.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;) n = n.parentElement;
                    if (n && "BLOCKQUOTE" == n.tagName) {
                        var i = u.node.deepestParent(e, [Te(e).parentsUntil(u.$el, "BLOCKQUOTE").get(0)]);
                        i && i.previousSibling && (r = n = i)
                    }
                    if (null !== n) {
                        var a, o = n.previousSibling;
                        if (u.node.isBlock(n) && u.node.isEditable(n))
                            if (o && Te.FE.NO_DELETE_TAGS.indexOf(o.tagName) < 0) {
                                if (u.node.isDeletable(o) || !u.node.isEditable(o)) Te(o).remove(), Te(e).replaceWith(Te.FE.MARKERS);
                                else if (u.node.isEditable(o))
                                    if (u.node.isBlock(o))
                                        if (u.node.isEmpty(o) && !u.node.isList(o)) Te(o).remove(), Te(e).after(u.opts.keepFormatOnDelete ? Te.FE.INVISIBLE_SPACE : "");
                                        else {
                                            if (u.node.isList(o) && (o = Te(o).find("li:last").get(0)), (a = u.node.contents(o)).length && "BR" == a[a.length - 1].tagName && Te(a[a.length - 1]).remove(), "BLOCKQUOTE" == o.tagName && "BLOCKQUOTE" != n.tagName)
                                            ...
                                            if (u.node.isEmpty(n)) Te(e).remove(), u.selection.setAtEnd(o, !0);
                                            else {
                                                Te(e).replaceWith(Te.FE.MARKERS);
                                                var s = o.childNodes;
                                                u.node.isBlock(s[s.length - 1]) ? Te(s[s.length - 1]).append(r.innerHTML) : Te(o).append(r.innerHTML)
                                            }
                                            Te(r).remove(), u.node.isEmpty(n) && Te(n).remove()
                                        }
                                else Te(e).replaceWith(Te.FE.MARKERS), "BLOCKQUOTE" == n.tagName && o.nodeType == Node.ELEMENT_NODE ? Te(o).remove() : (Te(o).after(u.node.isEmpty(n) ? "" : Te(n).html()), Te(n).remove(), "BR" == o.tagName && Te(o).remove())
                            } else o || (n && "BLOCKQUOTE" === n.tagName && 0 === Te(n).text().replace(/\u200B/g, "").length ? Te(n).remove() : u.node.isEmpty(n) && n.parentNode && u.node.isEditable(n.parentNode) && n.parentNode != u.el && Te(n.parentNode).remove())
                    }
                }(t) : e = c(t), Te(t).remove(), f(), u.html.fillEmptyBlocks(!0), u.opts.htmlUntouched || (u.html.cleanEmptyTags(), u.clean.lists(), u.spaces.normalizeAroundCursor()), u.selection.restore(), e
            },
            del: function() {
                ...
                if (u.el.normalize(), a(e))
                    if (s(e))
                        if (0 === Te(e).parents("li:first").find("ul, ol").length) u.cursorLists._del(e);
                        else {
                            var t = Te(e).parents("li:first").find("ul:first, ol:first").find("li:first");
                            (t = t.find(u.html.blockTagsQuery()).get(-1) || t).prepend(e), u.cursorLists._backspace(e)
                        }
                else l(e);
                else o(e), n(e);
                Te(e).remove(), f(), u.html.fillEmptyBlocks(!0), u.opts.htmlUntouched || (u.html.cleanEmptyTags(), u.clean.lists()), u.spaces.normalizeAroundCursor(), u.selection.restore()
            },
            isAtEnd: g,
            isAtStart: h
        }
    }, Te.FE.ENTER_P = 0, Te.FE.ENTER_DIV = 1, Te.FE.ENTER_BR = 2, Te.FE.KEYCODE = {
        BACKSPACE: 8,
        TAB: 9,
        ENTER: 13,
        SHIFT: 16,
        ...
        function t() {
            l.selection.isFull() && setTimeout(function() {
                ...
                e ? l.$el.html("<" + e + ">" + Te.FE.MARKERS + "<br/></" + e + ">") : l.$el.html(Te.FE.MARKERS + "<br/>"), l.selection.restore(), l.placeholder.refresh(), l.button.bulkRefresh(), l.undo.saveStep()
            }, 0)
        }
        ...
        function f() {
            var e = l.html.defaultTag();
            e ? l.$el.html("<" + e + ">" + Te.FE.MARKERS + "<br/></" + e + ">") : l.$el.html(Te.FE.MARKERS + "<br/>"), l.selection.restore()
        }
        ...
        function o(e) {
            ...
            var n = e.which;
            if (16 === n) return !0;
            if ((d = n) === Te.FE.KEYCODE.IME) return c = !0;
            c = !1;
            var r, i, a, o = m(n) && !h(e) && !e.altKey,
                s = n == Te.FE.KEYCODE.BACKSPACE || n == Te.FE.KEYCODE.DELETE;
            if ((!(h(e) || e.shiftKey && (33 === n || 34 === n || 35 === n || 36 === n)) && l.selection.isFull() && !l.opts.keepFormatOnDelete && !l.placeholder.isVisible() || s && l.placeholder.isVisible() && l.opts.keepFormatOnDelete) && (o || s) && (f(), !m(n))) return e.preventDefault(), !0;
            n == Te.FE.KEYCODE.ENTER ? e.shiftKey ? ((a = e).preventDefault(), a.stopPropagation(), l.opts.multiLine && (l.selection.isCollapsed() || l.selection.remove(), l.cursor.enter(!0))) : (i = e, l.opts.multiLine ? (l.helpers.isIOS() || (i.preventDefault(), i.stopPropagation()), l.selection.isCollapsed() || l.selection.remove(), l.cursor.enter()) : (i.preventDefault(), i.stopPropagation())) : n === Te.FE.KEYCODE.BACKSPACE && (e.metaKey || e.ctrlKey) ? setTimeout(function() {
                l.events.disableBlur(), l.events.focus()
            }, 0) : n != Te.FE.KEYCODE.BACKSPACE || h(e) || e.altKey ? n != Te.FE.KEYCODE.DELETE || h(e) || e.altKey || e.shiftKey ? n == Te.FE.KEYCODE.SPACE ? function(e) {
                var t = l.selection.element();
                if (!l.helpers.isMobile() && t && "A" == t.tagName) {
                    ...
                    if (n) {
                        ...
                        !n.nextSibling && n.parentNode && "A" == n.parentNode.tagName ? (n.parentNode.insertAdjacentHTML("afterend", "&nbsp;" + Te.FE.MARKERS), n.parentNode.removeChild(n)) : (r && r.nodeType == Node.TEXT_NODE && 1 == r.textContent.length && 160 == r.textContent.charCodeAt(0) ? r.textContent = r.textContent + " " : n.insertAdjacentHTML("beforebegin", "&nbsp;"), n.outerHTML = Te.FE.MARKERS), l.selection.restore()
                    }
                }
            }(e) : n == Te.FE.KEYCODE.TAB ? function(e) {
            ...
            }(e) : h(e) || !m(e.which) || l.selection.isCollapsed() || e.ctrlKey || e.altKey || l.selection.remove() : l.placeholder.isVisible() ? (l.opts.keepFormatOnDelete || f(), e.preventDefault(), e.stopPropagation()) : ((r = e).preventDefault(), r.stopPropagation(), "" === l.selection.text() && "IMG" != l.selection.element().tagName ? l.cursor.del() : l.selection.remove(), l.placeholder.refresh()) : l.placeholder.isVisible() ? (l.opts.keepFormatOnDelete || f(), e.preventDefault(), e.stopPropagation()) : function(e) {
                if (l.selection.isCollapsed())
        ...
        function u(e) {
            ...
            if (c) return !1;
            if (e && l.helpers.isIOS() && e.which == Te.FE.KEYCODE.ENTER && l.doc.execCommand("undo"), !l.selection.isCollapsed()) return !0;
            if (e && (e.which === Te.FE.KEYCODE.META || e.which == Te.FE.KEYCODE.CTRL)) return !0;
            if (e && g(e.which)) return !0;
            if (e && !l.helpers.isIOS() && (e.which == Te.FE.KEYCODE.ENTER || e.which == Te.FE.KEYCODE.BACKSPACE || 37 <= e.which && e.which <= 40 && !l.browser.msie)) try {
                s()
            } catch (n) {}
            p()
        }
        ...
        function g(e) {
            if (e >= Te.FE.KEYCODE.ARROW_LEFT && e <= Te.FE.KEYCODE.ARROW_DOWN) {
        ...
        function m(e) {
            if (e >= Te.FE.KEYCODE.ZERO && e <= Te.FE.KEYCODE.NINE) return !0;
            if (e >= Te.FE.KEYCODE.NUM_ZERO && e <= Te.FE.KEYCODE.NUM_MULTIPLY) return !0;
            if (e >= Te.FE.KEYCODE.A && e <= Te.FE.KEYCODE.Z) return !0;
            if (l.browser.webkit && 0 === e) return !0;
            switch (e) {
                case Te.FE.KEYCODE.SPACE:
                case Te.FE.KEYCODE.QUESTION_MARK:
                case Te.FE.KEYCODE.NUM_PLUS:
                case Te.FE.KEYCODE.NUM_MINUS:
                case Te.FE.KEYCODE.NUM_PERIOD:
                case Te.FE.KEYCODE.NUM_DIVISION:
                case Te.FE.KEYCODE.SEMICOLON:
                case Te.FE.KEYCODE.FF_SEMICOLON:
                case Te.FE.KEYCODE.DASH:
                case Te.FE.KEYCODE.EQUALS:
                case Te.FE.KEYCODE.FF_EQUALS:
                case Te.FE.KEYCODE.COMMA:
                case Te.FE.KEYCODE.PERIOD:
                case Te.FE.KEYCODE.SLASH:
                case Te.FE.KEYCODE.APOSTROPHE:
                case Te.FE.KEYCODE.SINGLE_QUOTE:
                case Te.FE.KEYCODE.OPEN_SQUARE_BRACKET:
                case Te.FE.KEYCODE.BACKSLASH:
                case Te.FE.KEYCODE.CLOSE_SQUARE_BRACKET:
                    return !0;
                default:
                    return !1
            }
        ...
        function v(e) {
            var t = e.which;
            if (h(e) || 37 <= t && t <= 40 || !m(t) && t != Te.FE.KEYCODE.DELETE && t != Te.FE.KEYCODE.BACKSPACE && t != Te.FE.KEYCODE.ENTER && t != Te.FE.KEYCODE.IME) return !0;
        ...
        function b(e) {
            ...
            try {
                return 0 === (e.textContent || "").length && !Te(e).find("> br").length || e.childNodes && 1 == e.childNodes.length && e.childNodes[0].getAttribute && ("false" == e.childNodes[0].getAttribute("contenteditable") || l.node.hasClass(e.childNodes[0], "fr-img-caption"))
            } catch (t) {
                return !1
            }
        }
        ...
        function T(e) {
            ...
            return r && "TR" == r.tagName && Te(r).attr("contenteditable") == undefined && (r = Te(r).closest("table").length && Te(r).closest("table")[0]), !l.node.isEditable(e.target) || r && "false" == Te(r).attr("contenteditable") ? l.toolbar.disable() : l.toolbar.enable(), !(!e.target || e.target === l.el) || (0 === t.length || void(t[0].offsetHeight + t[0].offsetTop <= e.offsetY ? b(t[t.length - 1]) && (n ? l.$el.append("<" + n + ">" + Te.FE.MARKERS + "<br></" + n + ">") : l.$el.append(Te.FE.MARKERS + "<br>"), l.selection.restore(), s()) : e.offsetY <= 10 && b(t[0]) && (n ? l.$el.prepend("<" + n + ">" + Te.FE.MARKERS + "<br></" + n + ">") : l.$el.prepend(Te.FE.MARKERS + "<br>"), l.selection.restore(), s())))
        }
        ...
        return {
            ...
            isBrowserAction: function(e) {
                var t = e.which;
                return h(e) || t == Te.FE.KEYCODE.F5
            },
            positionCaret: s
        }
    }, Te.FE.MODULES.accessibility = function(f) {
        var a = !0;
        ...
        function r(r) {
            r && r.length && (f.events.$on(r, "keydown", function(e) {
                if (!Te(e.target).is("a.fr-command, button.fr-command, .fr-group span.fr-command")) return !0;
        ...
        function e(e) {
            ...
            if (e.which == Te.FE.KEYCODE.F10 && !t && !e.shiftKey && e.altKey) {
                f.shared.with_kb = !0;
        ...
        return {
                    ...
                    n = (d = e, c = f.popups.get(d), {
                        _tiKeydown: function(e) {
                            ...
                            if (Te.FE.KEYCODE.TAB == n) {
                                ...
                                if (0 <= o && o < a.length) return t.events.disableBlur(), Te(a[o]).focus(), e.stopPropagation(), !1;
                                var s = c.find(".fr-buttons");
                                if (s.length && p(s, !!e.shiftKey)) return e.stopPropagation(), !1;
                                if (u(i)) return e.stopPropagation(), !1
                            } else {
                                if (Te.FE.KEYCODE.ENTER != n || !e.target || "TEXTAREA" === e.target.tagName) return Te.FE.KEYCODE.ESC == n ? (e.preventDefault(), e.stopPropagation(), t.accessibility.restoreSelection(), t.popups.isVisible(d) && c.find(".fr-back:visible").length ? (t.opts.toolbarInline && (t.events.disableBlur(), t.events.focus()), t.button.exec(c.find(".fr-back:visible:first")), E(c)) : t.popups.isVisible(d) && c.find(".fr-dismiss:visible").length ? t.button.exec(c.find(".fr-dismiss:visible:first")) : (t.popups.hide(d), t.opts.toolbarInline && t.toolbar.showInline(null, !0), E(c)), !1) : Te.FE.KEYCODE.SPACE == n && (r.is(".fr-submit") || r.is(".fr-dismiss")) ? (e.preventDefault(), e.stopPropagation(), t.events.disableBlur(), t.button.exec(r), !0) : t.keys.isBrowserAction(e) ? void e.stopPropagation() : r.is("input[type=text], textarea") ? void e.stopPropagation() : Te.FE.KEYCODE.SPACE == n && (r.is(".fr-link-attr") || r.is("input[type=file]")) ? void e.stopPropagation() : (e.stopPropagation(), e.preventDefault(), !1);
                                var l = null;
            ...
            exec: function(e, t) {
                var n = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                    r = e.which,
                    i = !1;
                return r != Te.FE.KEYCODE.TAB || n || e.shiftKey || e.altKey ? r != Te.FE.KEYCODE.ARROW_RIGHT || n || e.shiftKey || e.altKey ? r != Te.FE.KEYCODE.TAB || n || !e.shiftKey || e.altKey ? r != Te.FE.KEYCODE.ARROW_LEFT || n || e.shiftKey || e.altKey ? r != Te.FE.KEYCODE.ARROW_UP || n || e.shiftKey || e.altKey ? r != Te.FE.KEYCODE.ARROW_DOWN || n || e.shiftKey || e.altKey ? r != Te.FE.KEYCODE.ENTER && r != Te.FE.KEYCODE.SPACE || n || e.shiftKey || e.altKey ? r != Te.FE.KEYCODE.ESC || n || e.shiftKey || e.altKey ? r != Te.FE.KEYCODE.F10 || n || e.shiftKey || !e.altKey || (i = l()) : i = function(e) {
                    if (f.shared.$f_el) {
                        var t = d();
    ...
    }, Te.FE.MODULES.format = function(m) {
        function g(e, t) {
            var n = "<" + e;
        ...
        function v(e, t, n) {
            ...
            if (e) {
                ...
                if (e) {
                    if (m.node.isBlock(e) && "HR" !== e.tagName) return m.node.hasClass(e.firstChild, "fr-marker") ? v(e.firstChild.nextSibling, t, n) : v(e.firstChild, t, n), !1;
                    var s = Te(g(t, n)).insertBefore(e);
                    (r = T(e)) && (0 <= ["strong", "em"].indexOf(t) || "span" === t && n.hasOwnProperty("style")) && ("span" === t ? (i = (o = n.style.replace(/\;$/, "").split(":"))[0].trim(), a = o[1].trim()) : (i = o[t].prop, a = o[t].val), "background-color" !== i && (Te(r).css(i, a), function(e, t) {
                        var n, r = e.childNodes;
                        for (n = 0; n < r.length; n++) 0 <= ["UL", "OL", "LI"].indexOf(r[n].tagName) && "" === r[n].style[t] && Te(r[n]).css(t, "initial")
                    }(r, i)));
                    for (var l = e; l && !Te(l).is(".fr-marker") && 0 === Te(l).find(".fr-marker").length && "UL" != l.tagName && "OL" != l.tagName;) {
                        var d = l;
                        if (m.node.isBlock(l) && "HR" !== e.tagName) return v(l.firstChild, t, n), !1;
                        l = l.nextSibling, s.append(d)
                    }
                    if (l) {
                        if (Te(l).find(".fr-marker").length || "UL" == l.tagName || "OL" == l.tagName) v(l.firstChild, t, n);
                        else if (m.browser.mozilla && m.node.hasClass(l, "fr-marker")) {
                            var c, f = m.selection.blocks(),
                                p = f.length;
                            for (c = 0; c < p; c++) f[c] != l.parentNode && f[c].childNodes.length && f[c].childNodes[0] != l.parentNode && (l = f[c].childNodes[1] || f[c].childNodes[0], (s = Te(g(t, n)).insertBefore(l)).append(l))
                        }
                    } else {
                        for (var u = s.get(0).parentNode; u && !u.nextSibling && !m.node.isElement(u);) u = u.parentNode;
                        if (u) {
                            var h = u.nextSibling;
                            h && (m.node.isBlock(h) ? "HR" === h.tagName ? v(h.nextSibling, t, n) : v(h.firstChild, t, n) : v(h, t, n))
                        }
                    }
                    s.is(":empty") && s.remove()
                }
        ...
        function n(e, t) {
            ...
            if (void 0 === t && (t = {}), t.style && delete t.style, m.selection.isCollapsed()) {
                m.markers.insert(), m.$el.find(".fr-marker").replaceWith(g(e, t) + Te.FE.INVISIBLE_SPACE + Te.FE.MARKERS + ("</" + e + ">")), m.selection.restore()
            } else {
                var r;
                m.selection.save(), v(m.$el.find('.fr-marker[data-type="true"]').length && m.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling, e, t);
                do {
                    for (r = m.$el.find(u(e, t) + " > " + u(e, t)), n = 0; n < r.length; n++) r[n].outerHTML = r[n].innerHTML
                } while (r.length);
                m.el.normalize();
                var i = m.el.querySelectorAll(".fr-marker");
                for (n = 0; n < i.length; n++) {
                    var a = Te(i[n]);
                    !0 === a.data("type") ? h(a.get(0).nextSibling, u(e, t)) && a.next().prepend(a) : h(a.get(0).previousSibling, u(e, t)) && a.prev().append(a)
                }
                m.selection.restore()
            }
        }
        ...
        function E(e, t, n, r) {
            if (!r) {
                var i = !1;
                if (!0 === e.data("type"))
                    for (; m.node.isFirstSibling(e.get(0)) && !e.parent().is(m.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().before(e), i = !0;
                else if (!1 === e.data("type"))
                    for (; m.node.isLastSibling(e.get(0)) && !e.parent().is(m.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().after(e), i = !0;
                if (i) return !0
            }
            if (e.parents(t).length || void 0 === t) {
                ...
                for (; !m.node.isBlock(l.parent().get(0)) && (void 0 === t || void 0 !== t && !h(l.get(0), u(t, n)));) o += m.node.closeTagString(l.get(0)), s = m.node.openTagString(l.get(0)) + s, l = l.parent();
                var d = e.get(0).outerHTML;
                return e.replaceWith('<span id="mark"></span>'), a = l.html().replace(/<span id="mark"><\/span>/, o + m.node.closeTagString(l.get(0)) + s + d + o + m.node.openTagString(l.get(0)) + s), l.replaceWith(m.node.openTagString(l.get(0)) + a + m.node.closeTagString(l.get(0))), !0
            }
            return !1
        }
        ...
        function r(t, n) {
            ...
            for (var i = !0; i;) {
                ...
                for (var a, o = m.node.contents(t.get(0)), s = {
                        strong: {
                            prop: "font-weight",
                            val: "bold"
                        },
                    ...
                    if ("false" !== d.isContentEditable && 0 != d.isContentEditable)
                        ...
                        if ((a = "LI" === d.tagName ? d : Te(d).parentsUntil(m.$el, "li").get(0)) && (void 0 === r || 0 <= ["strong", "em"].indexOf(r)) && (r ? Te(a).css(s[r].prop, "") : a.style = ""), 0 < Te(d).find(".fr-marker").length) n = e(Te(d), n, r, i);
                        else {
                            for (var c = Te(d).find(r || "*:not(br)"), f = c.length - 1; 0 <= f; f--) {
                                var p = c[f];
                                (a = "LI" === p.tagName ? p : Te(p).parentsUntil(m.$el, "li").get(0)) && (!r || 0 <= ["strong", "em"].indexOf(r)) && (r ? Te(a).css(s[r].prop, "") : a.style = ""), m.node.isBlock(p) || m.node.isVoid(p) || void 0 !== r && !h(p, u(r, i)) ? m.node.isBlock(p) && void 0 === r && "TABLE" != d.tagName && m.node.clearAttributes(p) : m.node.hasClass(p, "fr-clone") || (p.outerHTML = p.innerHTML)
                            }
                            void 0 === r && d.nodeType == Node.ELEMENT_NODE && !m.node.isVoid(d) || h(d, u(r, i)) ? m.node.isBlock(d) ? void 0 === r && d.nodeType == Node.ELEMENT_NODE && m.node.isBlock(d) && "TABLE" != d.tagName && m.node.clearAttributes(d) : m.node.hasClass(d, "fr-clone") || (d.outerHTML = d.innerHTML) : void 0 === r && d.nodeType == Node.ELEMENT_NODE && m.node.isBlock(d) && "TABLE" != d.tagName && m.node.clearAttributes(d)
                        }
                    else 0 < Te(d).find(".fr-marker").length && (n = e(Te(d), n, r, i))
                }
                return n
            }(m.$el, 0, t, n), r || (m.$el.find(".fr-marker").remove(), m.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")), r && m.$el.find(".fr-marker").before(Te.FE.INVISIBLE_SPACE).after(Te.FE.INVISIBLE_SPACE), !m.selection.text() && Te(m.selection.blocks()[0]).each(function(e, t) {
                var n = new RegExp(String.fromCharCode(8203), "g"),
                    r = Te(t),
                    i = r.html();
                i = i.replace(n, ""), r.html(i)
            }), m.html.cleanEmptyTags(), m.el.normalize(), m.selection.restore()
        }

        function t(e, t) {
            var n, r, i, a, o, s, l, d = null;
            if (m.selection.isCollapsed()) {
                m.markers.insert();
                var c = (r = m.$el.find(".fr-marker")).parent();
                if (m.node.openTagString(c.get(0)) == '<span style="' + e + ": " + c.css(e) + ';">') {
                    if (m.node.isEmpty(c.get(0))) d = Te('<span style="' + e + ": " + t + ';">' + Te.FE.INVISIBLE_SPACE + Te.FE.MARKERS + "</span>"), c.replaceWith(d);
                    else {
                        var f = {};
                        f["style*"] = e + ":", E(r, "span", f, !0), r = m.$el.find(".fr-marker"), t ? (d = Te('<span style="' + e + ": " + t + ';">' + Te.FE.INVISIBLE_SPACE + Te.FE.MARKERS + "</span>"), r.replaceWith(d)) : r.replaceWith(Te.FE.INVISIBLE_SPACE + Te.FE.MARKERS)
                    }
                    m.html.cleanEmptyTags()
                } else m.node.isEmpty(c.get(0)) && c.is("span") ? (r.replaceWith(Te.FE.MARKERS), c.css(e, t)) : (d = Te('<span style="' + e + ": " + t + ';">' + Te.FE.INVISIBLE_SPACE + Te.FE.MARKERS + "</span>"), r.replaceWith(d));
                d && b(d, e, t)
            } else {
                if (m.selection.save(), null == t || "color" == e && 0 < m.$el.find(".fr-marker").parents("u, a").length) {
                    var p = m.$el.find(".fr-marker");
                    for (n = 0; n < p.length; n++)
                        if (!0 === (r = Te(p[n])).data("type"))
                ...
                for (t && (h.style = e + ": " + t + ";"), v(u, "span", h), m.$el.find(".fr-marker + .fr-unprocessed").each(function() {
                        Te(this).prepend(Te(this).prev())
                    }), m.$el.find(".fr-unprocessed + .fr-marker").each(function() {
                        Te(this).prev().append(this)
                    }), (t || "").match(/\dem$/) && m.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed"); 0 < m.$el.find("span.fr-unprocessed").length;) {
                    if (i = T(d = m.$el.find("span.fr-unprocessed:first").removeClass("fr-unprocessed")), d.parent().get(0).normalize(), d.parent().is("span") && 1 == d.parent().get(0).childNodes.length) {
                        d.parent().css(e, t);
                        var g = d;
                        d = d.parent(), g.replaceWith(g.html())
                    }
                    for (a = d.find("span"), i && "background-color" !== e && (i.normalize(), a = Te(i).find("span:not(.fr-unprocessed)")), n = a.length - 1; 0 <= n; n--) o = a[n], s = e, l = void 0, (l = Te(o)).css(s, ""), "" === l.attr("style") && l.replaceWith(l.html());
                    b(d, e, t)
                }
            }! function() {
                var e;
                for (; 0 < m.$el.find(".fr-split:empty").length;) m.$el.find(".fr-split:empty").remove();
                m.$el.find(".fr-split").removeClass("fr-split"), m.$el.find('[style=""]').removeAttr("style"), m.$el.find('[class=""]').removeAttr("class"), m.html.cleanEmptyTags(), Te(m.$el.find("span").get().reverse()).each(function() {
                    this.attributes && 0 !== this.attributes.length || Te(this).replaceWith(this.innerHTML)
                }), m.el.normalize();
                ...
                m.$el.find("span[style] span[style]").each(function() {
                    if (0 <= Te(this).attr("style").indexOf("font-size")) {
                        var e = Te(this).parents("span[style]");
                        0 <= e.attr("style").indexOf("background-color") && (Te(this).attr("style", Te(this).attr("style") + ";" + e.attr("style")), E(Te(this), "span[style]", {}, !1))
                    }
        ...
        function b(e, t, n) {
            var r, i, a, o = e.parentsUntil(m.$el, "span[style]"),
                s = [];
            for (r = o.length - 1; 0 <= r; r--) i = o[r], a = t, 0 === Te(i).attr("style").indexOf(a + ":") || 0 <= Te(i).attr("style").indexOf(";" + a + ":") || 0 <= Te(i).attr("style").indexOf("; " + a + ":") || s.push(o[r]);
            if ((o = o.not(s)).length) {
                for (var l = "", d = "", c = "", f = "", p = e.get(0); p = p.parentNode, Te(p).addClass("fr-split"), l += m.node.closeTagString(p), d = m.node.openTagString(Te(p).clone().addClass("fr-split").get(0)) + d, o.get(0) != p && (c += m.node.closeTagString(p), f = m.node.openTagString(Te(p).clone().addClass("fr-split").get(0)) + f), o.get(0) != p;);
                var u = l + m.node.openTagString(Te(o.get(0)).clone().css(t, n || "").get(0)) + f + e.css(t, "").get(0).outerHTML + c + "</span>" + d;
                e.replaceWith('<span id="fr-break"></span>');
                var h = o.get(0).outerHTML;
                Te(o.get(0)).replaceWith(h.replace(/<span id="fr-break"><\/span>/g, function() {
                    return u
                }))
            }
        }
        ...
        function i(e, t) {
            ...
            if (r.nodeType == Node.ELEMENT_NODE && 0 < r.childNodes.length) {
                var i = n.startOffset;
                r.childNodes.length <= i && ("sup" == e || "sub" == e) && (i = r.childNodes.length - 1), r = r.childNodes[i] ? r.childNodes[i] : r
            }
            ...
            for (var a = r; a && a.nodeType == Node.ELEMENT_NODE && !h(a, u(e, t));) a = a.firstChild;
            if (a && a.nodeType == Node.ELEMENT_NODE && h(a, u(e, t))) return !0;
            var o = r;
            for (o && o.nodeType != Node.ELEMENT_NODE && (o = o.parentNode); o && o.nodeType == Node.ELEMENT_NODE && o != m.el && !h(o, u(e, t));) o = o.parentNode;
            return !(!o || o.nodeType != Node.ELEMENT_NODE || o == m.el || !h(o, u(e, t)))
        }

        function T(e) {
            var t, n, r, i, a, o;
            if (t = "LI" === e.tagName ? e : Te(e).parentsUntil(m.$el, "li").get(0)) {
                if ((o = m.selection.info(t)).atStart && o.atEnd) return t;
                if (o.atStart && !o.atEnd && (n = Te(t).find(".fr-marker[data-type=false]").get(0), r = Te(n).parentsUntil(m.$el, "li").get(0), i = Te(n).parent().get(0), (a = n.nextSibling) && (0 <= ["UL", "OL"].indexOf(a.tagName) || a.isSameNode(i.lastChild) && m.node.isVoid(a)) || !r.isSameNode(t) || !a && ("LI" === i.tagName || !i.nextSibling || 0 <= ["UL", "OL"].indexOf(i.nextSibling.tagName) || m.node.isVoid(i.nextSibling)))) return t
            }
        }
        return {
            is: i,
    ...
    }, Te.FE.RegisterCommand = function(e, t) {
        Te.FE.COMMANDS[e] = t
    }, Te.FE.MODULES.commands = function(o) {
        function i(e) {
        ...
        var a = {
            ...
            insertHR: function() {
                ...
                if (n.removeAttr("id"), 0 === n.next().length) {
                    ...
                    r ? n.after(Te("<" + r + ">").append("<br>")) : n.after("<br>")
                }
                n.prev().is("hr") ? t = o.selection.setAfter(n.get(0), !1) : n.next().is("hr") ? t = o.selection.setBefore(n.get(0), !1) : o.selection.setAfter(n.get(0), !1) || o.selection.setBefore(n.get(0), !1), t || void 0 === t || (e = i(e = Te.FE.MARKERS + "<br>"), n.after(e)), o.selection.restore()
            },
        ...
        function t(e, t) {
            if (!1 !== o.events.trigger("commands.before", Te.merge([e], t || []))) {
                var n = Te.FE.COMMANDS[e] && Te.FE.COMMANDS[e].callback || a[e],
                    r = !0,
                    i = !1;
                Te.FE.COMMANDS[e] && ("undefined" != typeof Te.FE.COMMANDS[e].focus && (r = Te.FE.COMMANDS[e].focus), "undefined" != typeof Te.FE.COMMANDS[e].accessibilityFocus && (i = Te.FE.COMMANDS[e].accessibilityFocus)), (!o.core.hasFocus() && r && !o.popups.areVisible() || !o.core.hasFocus() && i && o.accessibility.hasFocus()) && o.events.focus(!0), Te.FE.COMMANDS[e] && !1 !== Te.FE.COMMANDS[e].undo && (o.$el.find(".fr-marker").length && (o.events.disableBlur(), o.selection.restore()), o.undo.saveStep()), n && n.apply(o, Te.merge([e], t || [])), o.events.trigger("commands.after", Te.merge([e], t || [])), Te.FE.COMMANDS[e] && !1 !== Te.FE.COMMANDS[e].undo && o.undo.saveStep()
            }
        }
        ...
        function n(e) {
            ...
            for (var t = o.selection.blocks(), n = 0; n < t.length; n++)
                if ("LI" != t[n].tagName || "LI" != t[n].parentNode.tagName) {
                    var r = Te(t[n]);
                    "LI" != t[n].tagName && "LI" == t[n].parentNode.tagName && (r = Te(t[n].parentNode));
                    var i = "rtl" == o.opts.direction || "rtl" == r.css("direction") ? "margin-right" : "margin-left",
        ...
        return Te.extend(s, {
            ...
            _init: function() {
                o.events.on("keydown", function(e) {
                    ...
                    var t = o.selection.element();
                    if (t && "HR" == t.tagName)
                        if (e.which == Te.FE.KEYCODE.ARROW_LEFT || e.which == Te.FE.KEYCODE.ARROW_UP) {
                            if (t.previousSibling) return o.node.isBlock(t.previousSibling) ? o.selection.setAtEnd(t.previousSibling) : Te(t).before(Te.FE.MARKERS), o.selection.restore(), !1
                        } else if ((e.which == Te.FE.KEYCODE.ARROW_RIGHT || e.which == Te.FE.KEYCODE.ARROW_DOWN) && t.nextSibling) return o.node.isBlock(t.nextSibling) ? o.selection.setAtStart(t.nextSibling) : Te(t).after(Te.FE.MARKERS), o.selection.restore(), !1
                    ...
                    e == o.selection.endElement() && e && "HR" == e.tagName && (e.nextSibling && (o.node.isBlock(e.nextSibling) ? o.selection.setAtStart(e.nextSibling) : Te(e).after(Te.FE.MARKERS)), o.selection.restore())
                })
            }
        })
    }, Te.FE.MODULES.data = function(p) {
            ...
            _init: function() {
                ...
                for (var n, r, i, a = !(p.ul = !0), o = 0, s = 0; s < e.length; s++) {
                    ...
                    if (d === E(g(E("mcVRDoB1BGILD7YFe1BTXBA7B6=="))) || 0 <= d.indexOf(h, d.length - h.length) || C(h)) {
                        if (!((null === (n = l[1]) || new Date(n) < new Date(E("hA2B2C2H2C9B3C4C6F2A1=="))) && 0 < (h || "").length) || C(h)) {
                            p.ul = !1;
                            break
                        }
    ...
    }), Te.FE.MODULES.paste = function(N) {
        var x, o, i, w;
        ...
        function e(e) {
            ...
            n(t, Te("<div>").html(t).text()), "cut" == e.type && (N.undo.saveStep(), setTimeout(function() {
        ...
        function t(e) {
            ...
            if (N.$win.scrollTop(), e && e.clipboardData && e.clipboardData.getData) {
                var t = "",
                    n = e.clipboardData.types;
                if (N.helpers.isArray(n))
                    for (var r = 0; r < n.length; r++) t += n[r] + ";";
                else t = n;
                if (x = "", /text\/rtf/.test(t) && (o = e.clipboardData.getData("text/rtf")), /text\/html/.test(t) && !N.browser.safari ? x = e.clipboardData.getData("text/html") : /text\/rtf/.test(t) && N.browser.safari ? x = o : /public.rtf/.test(t) && N.browser.safari && (x = e.clipboardData.getData("text/rtf")), "" !== x) return s(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1;
                x = null
            }
            return function() {
                N.selection.save(), N.events.disableBlur(), x = null, i ? (i.html(""), N.browser.edge && N.opts.iframe && N.$el.append(i)) : (i = Te('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1"></div>'), N.browser.webkit || N.browser.mozilla ? (i.css("top", N.$sc.scrollTop()), N.$el.after(i)) : N.browser.edge && N.opts.iframe ? N.$el.append(i) : N.$box.after(i), N.events.on("destroy", function() {
                    i.remove()
                }));
                var e;
        ...
        function r(e) {
            if (e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData) {
                ...
                if (x = "", /text\/rtf/.test(t) && (o = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? x = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && N.browser.safari ? x = o : /text\/plain/.test(t) && !this.browser.mozilla && (x = N.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== x) {
                    N.keys.forceUndo(), w = N.snapshot.get(), N.selection.save(), N.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-helper");
                    var i = N.markers.insertAtPoint(e);
                    if (N.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"), N.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"), N.selection.restore(), N.selection.remove(), N.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"), !1 !== i) {
                        var a = N.el.querySelector(".fr-marker");
                        return Te(a).replaceWith(Te.FE.MARKERS), N.selection.restore(), s(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1
                    }
                } else x = null
            }
        }
        ...
        function s() {
            N.opts.iframe && N.$el.attr("contenteditable", "true"), N.browser.edge && N.opts.iframe && N.$box.after(i), w || (N.keys.forceUndo(), w = N.snapshot.get()), x || (x = i.get(0).innerHTML, N.selection.restore(), N.events.enableBlur());
            var e = x.match(/(class=\"?Mso|class=\'?Mso|class="?Xl|class='?Xl|class=Xl|style=\"[^\"]*\bmso\-|style=\'[^\']*\bmso\-|w:WordDocument|LibreOffice)/gi),
                t = x.match(/(LibreOffice)/gi),
                n = N.events.chainTrigger("paste.beforeCleanup", x);
            n && "string" == typeof n && (x = n), (!e || e && !1 !== N.events.trigger("paste.wordPaste", [x])) && l(x, e, !1, t)
        }
        ...
        function l(r, e, t, n) {
            ...
            if (0 <= r.toLowerCase().indexOf("<body")) {
                var s = "";
                0 <= r.indexOf("<style") && (s = r.replace(/[.\s\S\w\W<>]*(<style[^>]*>[\s]*[.\s\S\w\W<>]*[\s]*<\/style>)[.\s\S\w\W<>]*/gi, "$1")), r = s + r.replace(/[.\s\S\w\W<>]*<body[^>]*>[\s]*([.\s\S\w\W<>]*)[\s]*<\/body>[.\s\S\w\W<>]*/gi, "$1");
                var l = 0,
                    d = "";
                r.replace(/<pre.*?>([\s\S]*?)<\/pre>/gi, function(e, t, n) {
                    l < n && (d += r.substring(l, n).replace(/ \n/g, " ").replace(/\n /g, " ").replace(/([^>])\n([^<])/g, "$1 $2")), d += e, l = n + e.length
                }), r.length > l + 1 && (d += r.substring(l, r.length).replace(/ \n/g, " ").replace(/\n /g, " ").replace(/([^>])\n([^<])/g, "$1 $2")), r = d
            }
            var c = !1;
            0 <= r.indexOf('id="docs-internal-guid') && (r = r.replace(/^[\w\W\s\S]* id="docs-internal-guid[^>]*>([\w\W\s\S]*)<\/b>[\w\W\s\S]*$/g, "$1"), c = !0), 0 <= r.indexOf('content="Sheets"') && (r = r.replace(/width:0px;/g, ""));
            var f = !1,
                p = !1;
            if (!e)
                if (f = function(e) {
                        ...
                        return !(!t || Te("<div>").html(e).text().replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") != t.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, ""))
                    }(r), p = function() {
                        var e = null;
                        try {
                            e = N.win.localStorage.getItem("fr-dragged-content-text")
                        } catch (t) {}
                        return !(!e || Te("<div>").html(x).text().replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") != e.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, ""))
                    }(), f && (r = N.win.localStorage.getItem("fr-copied-html")), p && (f = !0, r = N.win.localStorage.getItem("fr-dragged-content-html")), f) r = N.clean.html(r, N.opts.pasteDeniedTags, N.opts.pasteDeniedAttrs);
                else {
                    var u = N.opts.htmlAllowedStyleProps;
                    N.opts.htmlAllowedStyleProps = N.opts.pasteAllowedStyleProps, N.opts.htmlAllowComments = !1, r = (r = (r = r.replace(/<span class="Apple-tab-span">\s*<\/span>/g, O(N.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function(e, t) {
                        return O(t.length * (N.opts.tabSpaces || 4))
                    })).replace(/\t/g, O(N.opts.tabSpaces || 4)), r = N.clean.html(r, N.opts.pasteDeniedTags, N.opts.pasteDeniedAttrs), N.opts.htmlAllowedStyleProps = u, N.opts.htmlAllowComments = !0, r = (r = (r = I(r)).replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, "")
                }! e || N.wordPaste && t || (0 === (r = r.replace(/^\n*/g, "").replace(/^ /g, "")).indexOf("<colgroup>") && (r = "<table>" + r + "</table>"), r = I(r = function(e) {
                var t;
                ...
                var a = N.o_doc.createElement("div");
                a.innerHTML = e;
                ...
                return N.html.cleanBlankSpaces(a), e = a.innerHTML
            }(r))), N.opts.pastePlain && !p && (r = function(e) {
                var t, n = null,
                    r = N.doc.createElement("div");
                r.innerHTML = e;
                var i = r.querySelectorAll("p, div, h1, h2, h3, h4, h5, h6, pre, blockquote");
                for (t = 0; t < i.length; t++)(n = i[t]).outerHTML = "<" + (N.html.defaultTag() || "DIV") + ">" + n.innerHTML + "</" + (N.html.defaultTag() || "DIV") + ">";
                ...
                var a = function(e) {
                    for (var t = N.node.contents(e), n = 0; n < t.length; n++) t[n].nodeType != Node.TEXT_NODE && t[n].nodeType != Node.ELEMENT_NODE ? t[n].parentNode.removeChild(t[n]) : a(t[n])
                };
                return a(r), r.innerHTML
            }(r));
            var h = N.events.chainTrigger("paste.afterCleanup", r);
            if ("string" == typeof h && (r = h), "" !== r) {
                var g = N.o_doc.createElement("div");
                if (0 <= (g.innerHTML = r).indexOf("<body>") ? (N.html.cleanBlankSpaces(g), N.spaces.normalize(g, !0)) : N.spaces.normalize(g), n) {
                    var m = g.getElementsByTagName("li");
                    for (i = m.length - 1; 0 <= i; i--) {
                        var v = m[i].getElementsByTagName("p");
                        if (1 == v.length) {
                            var E = v[0];
                            E.outerHTML = E.innerHTML
                        }
                ...
                var b = g.getElementsByTagName("span");
                for (i = b.length - 1; 0 <= i; i--) {
                    var T = b[i];
                    0 === T.attributes.length && (T.outerHTML = T.innerHTML)
                }
                if (!0 === N.opts.linkAlwaysBlank) {
                    var A = g.getElementsByTagName("a");
                    for (i = A.length - 1; 0 <= i; i--) {
                        var C = A[i];
                        C.getAttribute("target") || C.setAttribute("target", "_blank")
                    }
                }
                var S = N.selection.element(),
                    R = !1;
                if (S && Te(S).parentsUntil(N.el, "ul, ol").length && (R = !0), R) {
                    var y = g.children;
                    1 == y.length && 0 <= ["OL", "UL"].indexOf(y[0].tagName) && (y[0].outerHTML = y[0].innerHTML)
                }
                if (!c) {
                    var L = g.getElementsByTagName("br");
                    for (i = L.length - 1; 0 <= i; i--) {
                        var _ = L[i];
                        N.node.isBlock(_.previousSibling) && _.parentNode.removeChild(_)
                    }
                }
                if (N.opts.enter == Te.FE.ENTER_BR)
                    for (i = (a = g.querySelectorAll("p, div")).length - 1; 0 <= i; i--) 0 === (o = a[i]).attributes.length && (o.outerHTML = o.innerHTML + (o.nextSibling && !N.node.isEmpty(o) ? "<br>" : ""));
                else if (N.opts.enter == Te.FE.ENTER_DIV)
                    for (i = (a = g.getElementsByTagName("p")).length - 1; 0 <= i; i--) 0 === (o = a[i]).attributes.length && (o.outerHTML = "<div>" + o.innerHTML + "</div>");
                else N.opts.enter == Te.FE.ENTER_P && 1 == g.childNodes.length && "P" == g.childNodes[0].tagName && 0 === g.childNodes[0].attributes.length && (g.childNodes[0].outerHTML = g.childNodes[0].innerHTML);
                r = g.innerHTML, f && (r = function(e) {
                    var t, n = N.o_doc.createElement("div");
                    n.innerHTML = e;
                    var r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + Te.FE.VOID_ELEMENTS.join("):not(") + "):not(" + N.opts.htmlAllowedEmptyTags.join("):not(") + ")");
                    for (; r.length;) {
                        for (t = 0; t < r.length; t++) r[t].parentNode.removeChild(r[t]);
                        r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + Te.FE.VOID_ELEMENTS.join("):not(") + "):not(" + N.opts.htmlAllowedEmptyTags.join("):not(") + ")")
                    }
                    return n.innerHTML
                }(r)), N.html.insert(r, !0)
            }
            N.events.trigger("paste.after"), N.undo.saveStep(w), w = null, N.undo.saveStep()
        }
        ...
        function I(e) {
            ...
            for (var r = d(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length;) {
                var i = r[r.length - 1];
                if (N.html.defaultTag() && "div" != N.html.defaultTag()) i.querySelector(N.html.blockTagsQuery()) ? i.outerHTML = i.innerHTML : i.outerHTML = "<" + N.html.defaultTag() + ">" + i.innerHTML + "</" + N.html.defaultTag() + ">";
                else {
        ...
        function c(e) {
            if (e.originalEvent && e.originalEvent.target && e.originalEvent.target.nodeType == Node.TEXT_NODE) try {
                N.win.localStorage.setItem("fr-dragged-content-html", e.originalEvent.dataTransfer.getData("text/html")), N.win.localStorage.setItem("fr-dragged-content-text", e.originalEvent.dataTransfer.getData("text/plain"))
            } catch (t) {}
        }
        ...
        return {
            _init: function() {
                ...
                }, !0), N.events.on("beforepaste", t)), N.events.on("dragstart", c, !0), N.events.on("destroy", f)
            },
            cleanEmptyTagsAndDivs: I,
        ...
        shortcutsEnabled: [],
        shortcutsHint: !0
    }), Te.FE.SHORTCUTS_MAP = {}, Te.FE.RegisterShortcut = function(e, t, n, r, i, a) {
        Te.FE.SHORTCUTS_MAP[(i ? "^" : "") + (a ? "@" : "") + e] = {
            cmd: t,
            val: n,
            letter: r,
            shift: i,
            option: a
        }, Te.FE.DEFAULTS.shortcutsEnabled.push(t)
    }, Te.FE.RegisterShortcut(Te.FE.KEYCODE.E, "show", null, "E", !1, !1), Te.FE.RegisterShortcut(Te.FE.KEYCODE.B, "bold", null, "B", !1, !1), Te.FE.RegisterShortcut(Te.FE.KEYCODE.I, "italic", null, "I", !1, !1), Te.FE.RegisterShortcut(Te.FE.KEYCODE.U, "underline", null, "U", !1, !1), Te.FE.RegisterShortcut(Te.FE.KEYCODE.S, "strikeThrough", null, "S", !1, !1), Te.FE.RegisterShortcut(Te.FE.KEYCODE.CLOSE_SQUARE_BRACKET, "indent", null, "]", !1, !1), Te.FE.RegisterShortcut(Te.FE.KEYCODE.OPEN_SQUARE_BRACKET, "outdent", null, "[", !1, !1), Te.FE.RegisterShortcut(Te.FE.KEYCODE.Z, "undo", null, "Z", !1, !1), Te.FE.RegisterShortcut(Te.FE.KEYCODE.Z, "redo", null, "Z", !0, !1), Te.FE.RegisterShortcut(Te.FE.KEYCODE.Y, "redo", null, "Y", !1, !1), Te.FE.MODULES.shortcuts = function(l) {
        var r = null;
        var d = !1;
        ...
        function e(e) {
            ...
            if ("keyup" == e.type && d && t != Te.FE.KEYCODE.META) return d = !1;
            "keydown" == e.type && (d = !1);
            var r = (e.shiftKey ? "^" : "") + (e.altKey ? "@" : "") + t,
                i = l.node.blockParent(l.selection.blocks()[0]);
            if (i && "TR" == i.tagName && Te(i).attr("contenteditable") == undefined && (i = i.closest("table")), n && Te.FE.SHORTCUTS_MAP[r] && (!i || "false" != Te(i).attr("contenteditable"))) {
                var a = Te.FE.SHORTCUTS_MAP[r].cmd;
                if (a && 0 <= l.opts.shortcutsEnabled.indexOf(a)) {
                    var o, s = Te.FE.SHORTCUTS_MAP[r].val;
                    if (a && !s ? o = l.$tb.find('.fr-command[data-cmd="' + a + '"]') : a && s && (o = l.$tb.find('.fr-command[data-cmd="' + a + '"][data-param1="' + s + '"]')), o.length) return e.preventDefault(), e.stopPropagation(), o.parents(".fr-toolbar").data("instance", l), "keydown" == e.type && (l.button.exec(o), d = !0), !1;
                    if (a && (l.commands[a] || Te.FE.COMMANDS[a] && Te.FE.COMMANDS[a].callback)) return e.preventDefault(), e.stopPropagation(), "keydown" == e.type && ((l.commands[a] || Te.FE.COMMANDS[a].callback)(), d = !0), !1
                }
            }
        }
        return {
            ...
            get: function(e) {
                ...
                if (!r)
                    for (var t in r = {}, Te.FE.SHORTCUTS_MAP) Te.FE.SHORTCUTS_MAP.hasOwnProperty(t) && 0 <= l.opts.shortcutsEnabled.indexOf(Te.FE.SHORTCUTS_MAP[t].cmd) && (r[Te.FE.SHORTCUTS_MAP[t].cmd + "." + (Te.FE.SHORTCUTS_MAP[t].val || "")] = {
                        shift: Te.FE.SHORTCUTS_MAP[t].shift,
                        option: Te.FE.SHORTCUTS_MAP[t].option,
                        letter: Te.FE.SHORTCUTS_MAP[t].letter
                    });
                var n = r[e];
                return n ? (l.helpers.isMac() ? String.fromCharCode(8984) : l.language.translate("Ctrl") + "+") + (n.shift ? l.helpers.isMac() ? String.fromCharCode(8679) : l.language.translate("Shift") + "+" : "") + (n.option ? l.helpers.isMac() ? String.fromCharCode(8997) : l.language.translate("Alt") + "+" : "") + n.letter : null
            }
        }
    }, Te.FE.MODULES.snapshot = function(l) {
        function n(e) {
    ...
    }, Te.FE.DefineIconTemplate = function(e, t) {
        Te.FE.ICON_TEMPLATES[e] = t
    }, Te.FE.DefineIcon = function(e, t) {
        Te.FE.ICONS[e] = t
    }, Te.extend(Te.FE.DEFAULTS, {
        iconsTemplate: "font_awesome"
    }), Te.FE.MODULES.icon = function(i) {
        return {
            create: function(n) {
                var e = null,
                    r = Te.FE.ICONS[n];
                if (void 0 !== r) {
                    var t = r.template || Te.FE.ICON_DEFAULT_TEMPLATE || i.opts.iconsTemplate;
                    t && t.apply && (t = t.apply(i)), r.FA5NAME || (r.FA5NAME = r.NAME), t && (t = Te.FE.ICON_TEMPLATES[t]) && (e = t.replace(/\[([a-zA-Z0-9]*)\]/g, function(e, t) {
            ...
            getTemplate: function(e) {
                ...
                return void 0 !== t ? n = t.template || Te.FE.ICON_DEFAULT_TEMPLATE || i.opts.iconsTemplate : n
            }
        }
    }, Te.extend(Te.FE.DEFAULTS, {
        tooltips: !0
    }), Te.FE.MODULES.tooltip = function(i) {
        function r() {
        ...
        function a(e, t) {
            ...
            i.$tooltip || i.opts.tooltips && !i.helpers.isMobile() && (i.shared.$tooltip ? i.$tooltip = i.shared.$tooltip : (i.shared.$tooltip = Te('<div class="fr-tooltip"></div>'), i.$tooltip = i.shared.$tooltip, i.opts.theme && i.$tooltip.addClass(i.opts.theme + "-theme"), Te(i.o_doc).find("body:first").append(i.$tooltip)), i.events.on("shared.destroy", function() {
            ...
            n < 0 && (n = 0), n + i.$tooltip.outerWidth() > Te(i.o_win).width() && (n = Te(i.o_win).width() - i.$tooltip.outerWidth()), void 0 === t && (t = i.opts.toolbarBottom), e.offset().top - Te(window).scrollTop() + e.outerHeight() + 10 >= Te(window).height() && (t = !0);
            var r = t ? e.offset().top - i.$tooltip.height() : e.offset().top + e.outerHeight();
            i.$tooltip.css("position", ""), i.$tooltip.css("left", n), i.$tooltip.css("top", Math.ceil(r)), "static" != Te(i.o_doc).find("body:first").css("position") ? (i.$tooltip.css("margin-left", -Te(i.o_doc).find("body:first").offset().left), i.$tooltip.css("margin-top", -Te(i.o_doc).find("body:first").offset().top)) : (i.$tooltip.css("margin-left", ""), i.$tooltip.css("margin-top", ""))
        }
        return {
            hide: r,
            to: a,
        ...
        function t(e) {
            ...
            if (0 !== e.parents(".fr-popup").length || e.data("popup") || t.popups.hideAll(), t.popups.areVisible() && !t.popups.areVisible(t)) {
                for (var n = 0; n < Te.FE.INSTANCES.length; n++) Te.FE.INSTANCES[n] != t && Te.FE.INSTANCES[n].popups && Te.FE.INSTANCES[n].popups.areVisible() && Te.FE.INSTANCES[n].$el.find(".fr-marker").remove();
                t.popups.hideAll()
            }
            u.node.hasClass(e.get(0), "fr-dropdown") ? function(e) {
                ...
                if (i.helpers.isIOS() && !i.el.querySelector(".fr-marker") && (i.selection.save(), i.selection.clear(), i.selection.restore()), !n) {
                    var a = e.data("cmd");
                    t.find(".fr-command").removeClass("fr-active").attr("aria-selected", !1), Te.FE.COMMANDS[a] && Te.FE.COMMANDS[a].refreshOnShow && Te.FE.COMMANDS[a].refreshOnShow.apply(i, [e, t]), t.css("left", e.offset().left - e.parent().offset().left - ("rtl" == u.opts.direction ? t.width() - e.outerWidth() : 0)), t.addClass("test-height");
                    var o = t.outerHeight();
                    t.removeClass("test-height"), t.css("top", "").css("bottom", ""), (u.opts.toolbarBottom ? e.offset().top < o : t.offset().top + e.outerHeight() + o < Te(u.o_doc).height() || u.$el.offset().top - u.$tb.height() < o) ? (t.css("top", e.position().top + e.outerHeight()), t.css("margin-bottom", "5px")) : t.css("bottom", e.parents(".fr-popup, .fr-toolbar").first().height() - e.position().top)
                }
            ...
            }(e) : (r(e), Te.FE.COMMANDS[e.data("cmd")] && !1 !== Te.FE.COMMANDS[e.data("cmd")].refreshAfterCallback && t.button.bulkRefresh())
        }

        function a(e) {
            t(Te(e.currentTarget))
        }
        ...
        function h(e, t, n) {
            if (t = Te.extend(!0, {}, t), u.helpers.isMobile() && !1 === t.showOnMobile) return "";
            ...
            else i = '<span class="fr-sr-only">' + (u.language.translate(t.title) || "") + "</span>";
        ...
        function e(i) {
            ...
            setTimeout(function() {
                for (var e = a.selection.inEditor() && a.core.hasFocus(), t = 0; t < i.length; t++) {
                    var n = Te(i[t]),
                        r = n.data("cmd");
                    0 === n.parents(".fr-popup").length ? e || Te.FE.COMMANDS[r] && Te.FE.COMMANDS[r].forcedRefresh ? a.button.refresh(n) : u.node.hasClass(n.get(0), "fr-dropdown") || (n.removeClass("fr-active"), n.attr("aria-pressed") && n.attr("aria-pressed", !1)) : n.parents(".fr-popup").is(":visible") && a.button.refresh(n)
                }
            }, 0)
        }
        ...
        return {
            ...
            bindCommands: function(t, e) {
                ...
                var n = t.get(0).ownerDocument,
                    ...
                    i = function(e) {
                        (!e || e.type == u._mouseup && e.target != Te("html").get(0) || "keydown" == e.type && (u.keys.isCharacter(e.which) && !u.keys.ctrlKey(e) || e.which == Te.FE.KEYCODE.ESC)) && c(t)
                    };
                u.events.$on(Te(r), u._mouseup + " resize keydown", i, !0), u.opts.iframe && u.events.$on(u.$win, u._mouseup, i, !0), u.node.hasClass(t.get(0), "fr-popup") ? Te.merge(s, t.find(".fr-btn").toArray()) : Te.merge(o, t.find(".fr-btn").toArray()), u.tooltip.bind(t, ".fr-btn, .fr-title", e)
            },
            refresh: function(e) {
                var t, n = e.parents(".fr-popup, .fr-toolbar").data("instance") || u,
                    r = e.data("cmd");
                u.node.hasClass(e.get(0), "fr-dropdown") ? t = e.next() : (e.removeClass("fr-active"), e.attr("aria-pressed") && e.attr("aria-pressed", !1)), Te.FE.COMMANDS[r] && Te.FE.COMMANDS[r].refresh ? Te.FE.COMMANDS[r].refresh.apply(n, [e, t]) : u.refresh[r] && n.refresh[r](e, t)
            },
            bulkRefresh: n,
            exec: r,
            click: t,
    ...
    }, Te.FE.MODULES.modals = function(l) {
        ...
        function c(e, t) {
            if (d[e]) {
                var n = d[e].$modal,
                    r = n.data("instance") || l;
                r.events.enableBlur(), n.hide(), s.hide(), Te(r.o_doc).find("body:first").removeClass("prevent-scroll fr-mobile"), n.removeClass("fr-active"), t || (r.accessibility.restoreSelection(), r.events.trigger("modals.hide"))
            }
        }
        ...
        return {
            ...
            create: function(n, e, t) {
                if (l.shared.$overlay || (l.shared.$overlay = Te('<div class="fr-overlay">').appendTo("body:first")), s = l.shared.$overlay, l.opts.theme && s.addClass(l.opts.theme + "-theme"), !d[n]) {
                    var r = (i = e, a = t, o = '<div tabIndex="-1" class="fr-modal' + (l.opts.theme ? " " + l.opts.theme + "-theme" : "") + '"><div class="fr-modal-wrapper">', o += '<div class="fr-modal-head">' + i + '<span title="' + l.language.translate("Cancel") + '" class="fr-modal-close">&times;</span></div>', o += '<div tabIndex="-1" class="fr-modal-body">' + a + "</div>", Te(o += "</div></div>"));
                    d[n] = {
                        $modal: r,
                        ...
                        var t = e.which;
                        return t == Te.FE.KEYCODE.ESC ? (c(n), l.accessibility.focusModalButton(r), !1) : !(!Te(e.target).is("input[type=text], textarea") && t != Te.FE.KEYCODE.ARROW_UP && t != Te.FE.KEYCODE.ARROW_DOWN && !l.keys.isBrowserAction(e) && (e.preventDefault(), e.stopPropagation(), 1))
                    }, !0), c(n, !0)
                }
                var i, a, o;
                return d[n]
            ...
            show: function(e) {
                if (d[e]) {
                    var t = d[e].$modal;
                    t.data("instance", l), t.show(), s.show(), Te(l.o_doc).find("body:first").addClass("prevent-scroll"), l.helpers.isMobile() && Te(l.o_doc).find("body:first").addClass("fr-mobile"), t.addClass("fr-active"), l.accessibility.focusModal(t)
                }
            },
            hide: c,
            resize: function(e) {
    ...
    }, Te.FE.POPUP_TEMPLATES = {
        "text.edit": "[_EDIT_]"
    }, Te.FE.RegisterTemplate = function(e, t) {
        Te.FE.POPUP_TEMPLATES[e] = t
    }, Te.FE.MODULES.popups = function(c) {
        ...
        function i(e, t) {
            var n, r, i = function(e, t) {
                var n = Te.FE.POPUP_TEMPLATES[e];
                if (!n) return null;
                for (var r in "function" == typeof n && (n = n.apply(c)), t) t.hasOwnProperty(r) && (n = n.replace("[_" + r.toUpperCase() + "_]", t[r]));
                return n
            }(e, t);
            return i ? (n = Te('<div class="fr-popup' + (c.helpers.isMobile() ? " fr-mobile" : " fr-desktop") + (c.opts.toolbarInline ? " fr-inline" : "") + '"><span class="fr-arrow"></span>' + i + "</div>"), c.opts.theme && n.addClass(c.opts.theme + "-theme"), 1 < c.opts.zIndex && (c.opts.editInPopup ? n.css("z-index", c.opts.zIndex + 2) : c.$tb.css("z-index", c.opts.zIndex + 2)), "auto" != c.opts.direction && n.removeClass("fr-ltr fr-rtl").addClass("fr-" + c.opts.direction), n.find("input, textarea").attr("dir", c.opts.direction).attr("disabled", "disabled"), (r = Te("body:first")).append(n), n.data("container", r), f[e] = n, c.button.bindCommands(n, !1), n) : (n = Te('<div class="fr-popup fr-empty"></div>'), (r = Te("body:first")).append(n), n.data("container", r), f[e] = n)
        }
            ...
            return {
                ...
                _inputFocus: function(e) {
                    ...
                    if (n.is("input:file") && n.closest(".fr-layer").addClass("fr-input-focus"), e.preventDefault(), e.stopPropagation(), setTimeout(function() {
                        ...
                        var r = Te(t.o_win).scrollTop();
                        setTimeout(function() {
                            Te(t.o_win).scrollTop(r)
                        }, 0)
                    }
                },
                _inputBlur: function(e) {
                    var t = i.data("instance") || c,
                        n = Te(e.currentTarget);
                    n.is("input:file") && n.closest(".fr-layer").removeClass("fr-input-focus"), document.activeElement != this && Te(this).is(":visible") && (t.events.blurActive() && t.events.trigger("blur"), t.events.enableBlur())
                },
                _editorKeydown: function(e) {
                    var t = i.data("instance") || c;
                    t.keys.ctrlKey(e) || e.which == Te.FE.KEYCODE.ALT || e.which == Te.FE.KEYCODE.ESC || (u(r) && i.find(".fr-back:visible").length ? t.button.exec(i.find(".fr-back:visible:first")) : e.which != Te.FE.KEYCODE.ALT && t.popups.hide(r))
                },
                _preventFocus: function(e) {
                    var t = i.data("instance") || c,
                        n = e.originalEvent ? e.originalEvent.target || e.originalEvent.originalTarget : null;
                    "mouseup" == e.type || Te(n).is(":focus") || t.events.disableBlur(), "mouseup" != e.type || Te(n).hasClass("fr-command") || 0 < Te(n).parents(".fr-command").length || Te(n).hasClass("fr-dropdown-content") || c.button.hideActiveDropdowns(i), (c.browser.safari || c.browser.mozilla) && "mousedown" == e.type && Te(n).is("input[type=file]") && t.events.disableBlur();
                    var r = "input, textarea, button, select, label, .fr-command";
                    if (n && !Te(n).is(r) && 0 === Te(n).parents(r).length) return e.stopPropagation(), !1;
                    n && Te(n).is(r) && e.stopPropagation(), m()
                },
                ...
                _doPlaceholder: function() {
                    0 === Te(this).next().length && Te(this).attr("placeholder") && Te(this).after('<label for="' + Te(this).attr("id") + '">' + Te(this).attr("placeholder") + "</label>"), Te(this).toggleClass("fr-not-empty", "" !== Te(this).val())
                },
        ...
        function o(e, t) {
            c.events.on("mouseup", e._editorMouseup, !0), c.$wp && c.events.on("keydown", e._editorKeydown), c.events.on("blur", function() {
                h() && c.markers.remove(), f[t].find("iframe").length || g()
        ...
        return c.shared.exit_flag = !1, {
            _init: function() {
                c.events.on("shared.destroy", e, !0), c.events.on("window.mousedown", t), c.events.on("window.touchmove", m), c.events.$on(Te(c.o_win), "scroll", m), c.events.on("mousedown", function(e) {
            ...
            create: function(e, t) {
                ...
                return o(r, e), c.events.$on(n, "mousedown mouseup touchstart touchend touch", "*", r._preventFocus, !0), c.events.$on(n, "focus", "input, textarea, button, select", r._inputFocus, !0), c.events.$on(n, "blur", "input, textarea, button, select", r._inputBlur, !0), c.accessibility.registerPopup(e), c.events.$on(n, "keydown keyup change input", "input, textarea", r._doPlaceholder, !0), c.helpers.isIOS() && c.events.$on(n, "touchend", "label", function() {
                    Te("#" + Te(this).attr("for")).prop("checked", function(e, t) {
                        return !t
                    })
                }, !0), c.events.$on(Te(c.o_win), "resize", r._windowResize, !0), n
            },
            get: function(e) {
                var t = f[e];
    ...
    }, Te.FE.MODULES.position = function(E) {
        function i() {
            ...
            if (0 === e.top && 0 === e.left && 0 === e.width || 0 === e.height) {
                ...
                var r = n.offset(),
                    i = n.outerHeight();
                n.css("display", "none"), n.css("line-height", 0), (e = {}).left = r && r.left, e.width = 0, e.height = i, e.top = r && r.top - (E.opts.iframe ? 0 : E.helpers.scrollTop()), e.right = 1, e.bottom = 1, e.ok = !0, t && E.selection.restore()
            }
            return e
        }
        ...
        function a(e, t, n, r) {
            ...
            !i || "BODY" === i.get(0).tagName && "static" == i.css("position") || ("relative" === i.css("position") && (e && (e -= i.offset().left), t && (t -= i.offset().top)), "BODY" != i.get(0).tagName ? (e && (e += i.get(0).scrollLeft), t && (t += i.get(0).scrollTop)) : "absolute" == i.css("position") && (e && (e += i.position().left), t && (t += i.position().top))), E.opts.iframe && i && E.$tb && i.get(0) != E.$tb.get(0) && (e && (e += E.$iframe.offset().left), t && (t += E.$iframe.offset().top));
            var a, o, s, l, d = (o = e, s = (a = n).outerWidth(!0), l = a.parent().offset().left, E.$sc.is("BODY") || "relative" === E.$sc.css("position") || (l -= E.$sc.offset().left, E.$sc.is(a.parent()) && (l -= E.$sc.offset().left)), a.parent().get(0) == E.$sc.get(0) && (l -= a.parent().position().left), l + o + s > E.$sc.get(0).clientWidth - 10 && (o = E.$sc.get(0).clientWidth - s - l - 10), o < 0 && (o = 10), o);
            if (e) {
                n.css("left", d);
        ...
        function n(e) {
            ...
            if (void 0 === r) {
                n.data("sticky-top", 0);
                var a = Te('<div class="fr-sticky-dummy" style="height: ' + n.outerHeight() + 'px;"></div>');
                E.$box.prepend(a)
            ...
            } else clearTimeout(Te(e).css("sticky-timeout")), n.css("top", "0"), n.css("position", ""), n.width(""), n.data("sticky-top", 0), n.removeClass("fr-sticky-on"), E.$box.removeClass("fr-sticky-box")
        }
        ...
        function t(e) {
            if (e.offsetWidth) {
                var t, n, r = Te(e),
                    ...
                    s = Te("body" == E.opts.scrollableContainer ? E.o_win : E.opts.scrollableContainer).outerHeight(),
                    l = 0,
                    d = 0;
                "body" !== E.opts.scrollableContainer && (l = E.$sc.offset().top, d = Te(E.o_win).outerHeight() - l - s);
        ...
        return {
            _init: function() {
                ! function() {
                    if (E._stickyElements = [], E.helpers.isIOS()) {
                        ...
                        t(), E.events.$on(Te(E.o_win), "scroll", function() {
                            if (E.core.hasFocus())
                                for (var e = 0; e < E._stickyElements.length; e++) {
                                    var t = Te(E._stickyElements[e]),
                                        n = t.parent(),
                                        r = E.helpers.scrollTop();
                                    t.outerHeight() < r - n.offset().top && (t.addClass("fr-opacity-0"), t.data("sticky-top", -1), t.data("sticky-scheduled", -1))
                                }
                        }, !0)
                    } else "body" !== E.opts.scrollableContainer && E.events.$on(Te(E.opts.scrollableContainer), "scroll", e, !0), E.events.$on(Te(E.o_win), "scroll", e, !0), E.events.$on(Te(E.o_win), "resize", e, !0), E.events.on("initialized", e), E.events.on("focus", e), E.events.$on(Te(E.o_win), "resize", "textarea", e, !0);
            ...
            getTbarPupupTop: function(e, t) {
                var n = E.shared.popups[e],
                    r = t.offset().top;
                return n && (E.opts.toolbarBottom && n.outerHeight() < E.$tb.offset().top ? r += 10 : r = r + t.outerHeight() - 10), r
            }
        }
    }, Te.FE.MODULES.refresh = function(i) {
        function a(e, t) {
        ...
        return {
            ...
            outdent: function(e) {
                ...
                for (var t = i.selection.blocks(), n = 0; n < t.length; n++) {
                    var r = "rtl" == i.opts.direction || "rtl" == Te(t[n]).css("direction") ? "margin-right" : "margin-left";
                    if ("LI" == t[n].tagName || "LI" == t[n].parentNode.tagName) return a(e, !1), !0;
                    if (0 < i.helpers.getPX(Te(t[n]).css(r))) return a(e, !1), !0
                }
                a(e, !0)
            },
            indent: function(e) {
        ...
        editInPopup: !1
    }), Te.FE.MODULES.textEdit = function(n) {
        function t() {
    ...
    }, Te.FE.RegisterCommand("updateText", {
        focus: !1,
        undo: !1,
        callback: function() {
    ...
    }), Te.FE.TOOLBAR_BUTTONS = ["fullscreen", "bold", "italic", "underline", "strikeThrough", "subscript", "superscript", "|", "fontFamily", "fontSize", "color", "inlineClass", "inlineStyle", "paragraphStyle", "lineHeight", "|", "paragraphFormat", "align", "formatOL", "formatUL", "outdent", "indent", "quote", "-", "insertLink", "insertImage", "insertVideo", "embedly", "insertFile", "insertTable", "|", "emoticons", "fontAwesome", "specialCharacters", "insertHR", "selectAll", "clearFormatting", "|", "print", "getPDF", "spellChecker", "help", "html", "|", "undo", "redo"], Te.FE.TOOLBAR_BUTTONS_MD = null, Te.FE.TOOLBAR_BUTTONS_SM = ["bold", "italic", "underline", "|", "fontFamily", "fontSize", "insertLink", "insertImage", "table", "|", "undo", "redo"], Te.FE.TOOLBAR_BUTTONS_XS = ["bold", "italic", "fontFamily", "fontSize", "|", "undo", "redo"], Te.FE.MODULES.toolbar = function(i) {
        var r = [];
        ...
        function t(e, t) {
            setTimeout(function() {
                if ((!e || e.which != Te.FE.KEYCODE.ESC) && i.selection.inEditor() && i.core.hasFocus() && !i.popups.areVisible() && "false" != Te(i.selection.blocks()[0]).closest("table").attr("contenteditable") && (i.opts.toolbarVisibleWithoutSelection || !i.selection.isCollapsed() && !i.keys.isIME() || t)) {
        ...
        function d() {
            i.events.on("window.mousedown", n), i.events.on("keydown", n), i.events.on("blur", n), i.helpers.isMobile() || i.events.on("window.mouseup", t), i.helpers.isMobile() ? i.helpers.isIOS() || (i.events.on("window.touchend", t), i.browser.mozilla && setInterval(t, 200)) : i.events.on("window.keyup", l), i.events.on("keydown", function(e) {
                e && e.which == Te.FE.KEYCODE.ESC && n()
            }), i.events.on("keydown", function(e) {
                if (e.which == Te.FE.KEYCODE.ALT) return e.stopPropagation(), !1
            }, !0), i.events.$on(i.$wp, "scroll.toolbar", t), i.events.$on(i.$sc, "scroll.toolbar", t), i.events.on("commands.after", t), i.helpers.isMobile() && (i.events.$on(i.$doc, "selectionchange", l), i.events.$on(i.$doc, "orientationchange", t))
        }
        ...
        function p() {
            i.opts.theme && i.$tb.addClass(i.opts.theme + "-theme"), 1 < i.opts.zIndex && i.$tb.css("z-index", i.opts.zIndex + 1), "auto" != i.opts.direction && i.$tb.removeClass("fr-ltr fr-rtl").addClass("fr-" + i.opts.direction), i.helpers.isMobile() ? i.$tb.addClass("fr-mobile") : i.$tb.addClass("fr-desktop"), i.opts.toolbarContainer ? (i.opts.toolbarInline && (d(), n()), i.opts.toolbarBottom ? i.$tb.addClass("fr-bottom") : i.$tb.addClass("fr-top")) : i.opts.toolbarInline ? (i.$sc.append(i.$tb), i.$tb.data("container", i.$sc), i.$tb.addClass("fr-inline"), i.$tb.prepend('<span class="fr-arrow"></span>'), d(), i.opts.toolbarBottom = !1) : (i.opts.toolbarBottom && !i.helpers.isIOS() ? (i.$box.append(i.$tb), i.$tb.addClass("fr-bottom"), i.$box.addClass("fr-bottom")) : (i.opts.toolbarBottom = !1, i.$box.prepend(i.$tb), i.$tb.addClass("fr-top"), i.$box.addClass("fr-top")), i.$tb.addClass("fr-basic"), i.opts.toolbarSticky && (i.opts.toolbarStickyOffset && (i.opts.toolbarBottom ? i.$tb.css("bottom", i.opts.toolbarStickyOffset) : i.$tb.css("top", i.opts.toolbarStickyOffset)), i.position.addSticky(i.$tb))),
                function() {
                    var e = Te.merge([], o());
                    a(e, r[Te.FE.XS]), a(e, r[Te.FE.SM]), a(e, r[Te.FE.MD]), a(e, r[Te.FE.LG]);
                ...
                }(), i.events.$on(Te(i.o_win), "resize", e), i.events.$on(Te(i.o_win), "orientationchange", e), i.accessibility.registerToolbar(i.$tb), i.events.$on(i.$tb, i._mousedown + " " + i._mouseup, function(e) {
        ...
        return {
            _init: function() {
                if (i.$sc = Te(i.opts.scrollableContainer).first(), !i.$wp) return !1;
                i.opts.toolbarContainer ? (i.shared.$tb ? (i.$tb = i.shared.$tb, i.opts.toolbarInline && d()) : (i.shared.$tb = Te('<div class="fr-toolbar"></div>'), i.$tb = i.shared.$tb, Te(i.opts.toolbarContainer).append(i.$tb), p(), i.$tb.data("instance", i)), i.opts.toolbarInline ? i.$box.addClass("fr-inline") : i.$box.addClass("fr-basic"), i.events.on("focus", function() {
                    i.$tb.data("instance", i)
                }, !0), i.opts.toolbarInline = !1) : i.opts.toolbarInline ? (i.$box.addClass("fr-inline"), i.shared.$tb ? (i.$tb = i.shared.$tb, d(), i.button.bindCommands(i.$tb)) : (i.shared.$tb = Te('<div class="fr-toolbar"></div>'), i.$tb = i.shared.$tb, p())) : (i.$box.addClass("fr-basic"), i.$tb = Te('<div class="fr-toolbar"></div>'), p(), i.$tb.data("instance", i)), i.events.on("destroy", f, !0), i.events.on(i.opts.toolbarInline || i.opts.toolbarContainer ? "shared.destroy" : "destroy", c, !0)
            },
            hide: n,
            show: function() {
    ...
    }, Te.FE.PLUGINS.align = function(i) {
        return {
            apply: function(e) {
                var t = i.selection.element();
                if (Te(t).parents(".fr-img-caption").length) Te(t).css("text-align", e);
                else {
                    i.selection.save(), i.html.wrap(!0, !0, !0, !0), i.selection.restore();
                    for (var n = i.selection.blocks(), r = 0; r < n.length; r++) Te(n[r]).css("text-align", e).removeClass("fr-temp-div"), "" === Te(n[r]).attr("class") && Te(n[r]).removeAttr("class"), "" === Te(n[r]).attr("style") && Te(n[r]).removeAttr("style");
            ...
            refresh: function(e) {
                ...
                if (t.length) {
                    var n = i.helpers.getAlignment(Te(t[0]));
            ...
            refreshOnShow: function(e, t) {
                ...
                if (n.length) {
                    var r = i.helpers.getAlignment(Te(n[0]));
    ...
    }, Te.FE.DefineIcon("align", {
        NAME: "align-left"
    }), Te.FE.DefineIcon("align-left", {
        NAME: "align-left"
    }), Te.FE.DefineIcon("align-right", {
        NAME: "align-right"
    }), Te.FE.DefineIcon("align-center", {
        NAME: "align-center"
    }), Te.FE.DefineIcon("align-justify", {
        NAME: "align-justify"
    }), Te.FE.RegisterCommand("align", {
        type: "dropdown",
        title: "Align",
        options: {
            left: "Align Left",
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Te.FE.COMMANDS.align.options;
        ...
        plugin: "align"
    }), Te.FE.RegisterCommand("alignLeft", {
        type: "button",
        icon: "align-left",
        callback: function() {
    ...
    }), Te.FE.RegisterCommand("alignRight", {
        type: "button",
        icon: "align-right",
        callback: function() {
    ...
    }), Te.FE.RegisterCommand("alignCenter", {
        type: "button",
        icon: "align-center",
        callback: function() {
    ...
    }), Te.FE.RegisterCommand("alignJustify", {
        type: "button",
        icon: "align-justify",
        callback: function() {
        ...
        charCounterMax: -1,
        charCounterCount: !0
    }), Te.FE.PLUGINS.charCounter = function(n) {
        var r;
        ...
        function e(e) {
            ...
            var t = e.which;
            return !(!n.keys.ctrlKey(e) && n.keys.isCharacter(t) || t === Te.FE.KEYCODE.IME) || (e.preventDefault(), e.stopPropagation(), n.events.trigger("charCounter.exceeded"), !1)
        }

        function t(e) {
            return n.opts.charCounterMax < 0 ? e : Te("<div>").html(e).text().length + i() <= n.opts.charCounterMax ? e : (n.events.trigger("charCounter.exceeded"), "")
        }
        ...
        return {
            _init: function() {
                return !!n.$wp && !!n.opts.charCounterCount && ((r = Te('<span class="fr-counter"></span>')).css("bottom", n.$wp.css("border-bottom-width")), n.$box.append(r), n.events.on("keydown", e, !0), n.events.on("paste.afterCleanup", t), n.events.on("keyup contentChanged input", function() {
                    ...
                    Te(n.o_win).off("resize.char" + n.id), r.removeData().remove(), r = null
                }))
            },
            count: i
        }
    }, Te.FE.PLUGINS.codeBeautifier = function() {
        var e, t, n, r, Y = {};
        ...
        function N(r, e) {
            ...
            for (var L, _, N = {
                    "{": function(e) {
                        N.singleSpace(), x.push(e), N.newLine()
                    },
                    "}": function(e) {
                        N.newLine(), x.push(e), N.newLine()
                    },
                    _lastCharWhitespace: function() {
                        return f.test(x[x.length - 1])
                    },
                    newLine: function(e) {
                        x.length && (e || "\n" === x[x.length - 1] || N.trim(), x.push("\n"), C && x.push(C))
                    },
                    singleSpace: function() {
                        x.length && !N._lastCharWhitespace() && x.push(" ")
                    },
                    preserveSingleSpace: function() {
                        M && N.singleSpace()
                    },
                    trim: function() {
                        for (; N._lastCharWhitespace();) x.pop()
                    }
                }, x = [], w = !1, O = !1, I = !1, k = "", D = "";;) {
                var F = E(),
                    M = "" !== F,
                ...
                if ("/" === c && "*" === g()) {
                    var B = 0 === R;
                    ($ || B) && N.newLine(), x.push(b()), N.newLine(), B && N.newLine(!0)
                } else if ("/" === c && "/" === g()) $ || "{" === D || N.trim(), N.singleSpace(), x.push(b()), N.newLine();
                else if ("@" === c) {
                    N.preserveSingleSpace(), x.push(c);
                    var P = (void 0, L = p, _ = m(": ,;{}()[]/='\""), p = L - 1, h(), _);
                    P.match(/[ :]$/) && (h(), P = m(": ").replace(/\s$/, ""), x.push(P), N.singleSpace()), (P = P.replace(/\s$/, "")) in t && (y += 1, P in n && (I = !0))
                } else "#" === c && "{" === g() ? (N.preserveSingleSpace(), x.push(m("}"))) : "{" === c ? "}" === g(!0) ? (v(), h(), N.singleSpace(), x.push("{}"), N.newLine(), l && 0 === R && N.newLine(!0)) : (R++, C += S, N["{"](c), I ? (I = !1, w = y < R) : w = y <= R) : "}" === c ? (R--, C = C.slice(0, -i), N["}"](c), O = w = !1, y && y--, l && 0 === R && N.newLine(!0)) : ":" === c ? (v(), !w && !I || T("&") || A() ? ":" === g() ? (h(), x.push("::")) : x.push(":") : (O = !0, x.push(":"), N.singleSpace())) : '"' === c || "'" === c ? (N.preserveSingleSpace(), x.push(m(c))) : ";" === c ? (O = !1, x.push(c), N.newLine()) : "(" === c ? T("url") ? (x.push(c), v(), h() && (")" !== c && '"' !== c && "'" !== c ? x.push(m(")")) : p--)) : (u++, N.preserveSingleSpace(), x.push(c), v()) : ")" === c ? (x.push(c), u--) : "," === c ? (x.push(c), v(), o && !O && u < 1 ? N.newLine() : N.singleSpace()) : ("]" === c || ("[" === c ? N.preserveSingleSpace() : "=" === c ? (v(), c = "=") : N.preserveSingleSpace()), x.push(c))
            }
            var U = "";
            return C && (U += C), U += x.join("").replace(/[\r\n\t ]+$/, ""), s && (U += "\n"), "\n" != d && (U = U.replace(/[\n]/g, d)), U
        }
        ...
        function i(r, e) {
            ...
            for (u = {
                    TK_START_EXPR: function() {
                        ...
                        if ("[" === s.text) {
                            ...
                            e = D.ArrayLiteral, L(f.mode) && ("[" !== f.last_text && ("," !== f.last_text || "]" !== d && "}" !== d) || h.keep_array_indentation || A())
                        } else "TK_RESERVED" === l && "for" === f.last_text ? e = D.ForInitializer : "TK_RESERVED" === l && G(f.last_text, ["if", "while"]) && (e = D.Conditional);
                        ...
                        "(" === s.text && ("TK_EQUALS" !== l && "TK_OPERATOR" !== l || x() || T());
                        y(e), S(), h.space_in_paren && (o.space_before_token = !0);
                        R()
                    },
                    TK_END_EXPR: function() {
                        for (; f.mode === D.Statement;) N();
                        f.multiline_frame && T("]" === s.text && L(f.mode) && !h.keep_array_indentation);
                        h.space_in_paren && ("TK_START_EXPR" !== l || h.space_in_empty_paren ? o.space_before_token = !0 : (o.trim(), o.space_before_token = !1));
                        "]" === s.text && h.keep_array_indentation ? (S(), N()) : (N(), S());
                        o.remove_redundant_indentation(p), f.do_while && p.mode === D.Conditional && (p.mode = D.Expression, f.do_block = !1, f.do_while = !1)
                    },
                    TK_START_BLOCK: function() {
                        var e = I(1),
                            t = I(2);
                        t && (":" === t.text && G(e.type, ["TK_STRING", "TK_WORD", "TK_RESERVED"]) || G(e.text, ["get", "set"]) && G(t.type, ["TK_WORD", "TK_RESERVED"])) ? G(d, ["class", "interface"]) ? y(D.BlockStatement) : y(D.ObjectLiteral) : y(D.BlockStatement);
                        var n = !e.comments_before.length && "}" === e.text && "function" === f.last_word && "TK_END_EXPR" === l;
                        "expand" === h.brace_style || "none" === h.brace_style && s.wanted_newline ? "TK_OPERATOR" !== l && (n || "TK_EQUALS" === l || "TK_RESERVED" === l && O(f.last_text) && "else" !== f.last_text) ? o.space_before_token = !0 : A(!1, !0) : "TK_OPERATOR" !== l && "TK_START_EXPR" !== l ? "TK_START_BLOCK" === l ? A() : o.space_before_token = !0 : L(p.mode) && "," === f.last_text && ("}" === d ? o.space_before_token = !0 : A());
                        S(), R()
                    },
                    ...
                    TK_SEMICOLON: function() {
                        w() && (o.space_before_token = !1);
                        for (; f.mode === D.Statement && !f.if_block && !f.do_block;) N();
                        S()
                    },
                    TK_STRING: function() {
                        w() ? o.space_before_token = !0 : "TK_RESERVED" === l || "TK_WORD" === l ? o.space_before_token = !0 : "TK_COMMA" === l || "TK_START_EXPR" === l || "TK_EQUALS" === l || "TK_OPERATOR" === l ? x() || T() : A();
                        S()
                    },
                    TK_EQUALS: function() {
                        w();
                    ...
                    TK_COMMA: function() {
                        if (f.declaration_statement) return _(f.parent.mode) && (f.declaration_assignment = !1), S(), void(f.declaration_assignment ? A(f.declaration_assignment = !1, !0) : (o.space_before_token = !0, h.comma_first && T()));
                        S(), f.mode === D.ObjectLiteral || f.mode === D.Statement && f.parent.mode === D.ObjectLiteral ? (f.mode === D.Statement && N(), A()) : (o.space_before_token = !0, h.comma_first && T())
                    },
            ...
            function C() {
                o.just_added_newline() && (h.keep_array_indentation && L(f.mode) && s.wanted_newline ? (o.current_line.push(s.whitespace_before), o.space_before_token = !1) : o.set_indent(f.indentation_level) && (f.line_indent_level = f.indentation_level))
            }
            ...
            function _(e) {
                return G(e, [D.Expression, D.ForInitializer, D.Conditional])
            }

            function N() {
                0 < t.length && (p = f, f = t.pop(), p.mode === D.Statement && o.remove_redundant_indentation(p))
            }

            function x() {
                return f.parent.mode === D.ObjectLiteral && f.mode === D.Statement && (":" === f.last_text && 0 === f.ternary_depth || "TK_RESERVED" === l && G(f.last_text, ["get", "set"]))
            }

            function w() {
                return !!("TK_RESERVED" === l && G(f.last_text, ["var", "let", "const"]) && "TK_WORD" === s.type || "TK_RESERVED" === l && "do" === f.last_text || "TK_RESERVED" === l && "return" === f.last_text && !s.wanted_newline || "TK_RESERVED" === l && "else" === f.last_text && ("TK_RESERVED" !== s.type || "if" !== s.text) || "TK_END_EXPR" === l && (p.mode === D.ForInitializer || p.mode === D.Conditional) || "TK_WORD" === l && f.mode === D.BlockStatement && !f.in_case && "--" !== s.text && "++" !== s.text && "function" !== d && "TK_WORD" !== s.type && "TK_RESERVED" !== s.type || f.mode === D.ObjectLiteral && (":" === f.last_text && 0 === f.ternary_depth || "TK_RESERVED" === l && G(f.last_text, ["get", "set"]))) && (y(D.Statement), R(), "TK_RESERVED" === l && G(f.last_text, ["var", "let", "const"]) && "TK_WORD" === s.type && (f.declaration_statement = !0), x() || T("TK_RESERVED" === s.type && G(s.text, ["do", "for", "if", "while"])), !0)
            }
            ...
            function k() {
                ("TK_RESERVED" === s.type && f.mode !== D.ObjectLiteral && G(s.text, ["set", "get"]) && (s.type = "TK_WORD"), "TK_RESERVED" === s.type && f.mode === D.ObjectLiteral) && (":" == I(1).text && (s.type = "TK_WORD"));
                if (w() || !s.wanted_newline || _(f.mode) || "TK_OPERATOR" === l && "--" !== f.last_text && "++" !== f.last_text || "TK_EQUALS" === l || !h.preserve_newlines && "TK_RESERVED" === l && G(f.last_text, ["var", "let", "const", "set", "get"]) || A(), f.do_block && !f.do_while) {
            ...
            l = "TK_START_BLOCK", d = "", (o = new F(c, m)).raw = h.test_output_raw, t = [], y(D.BlockStatement), this.beautify = function() {
                var e, t;
        ...
        function F(t, n) {
            ...
            this.baseIndentString = n, this.indent_string = t, this.previous_line = null, this.current_line = null, this.space_before_token = !1, this.add_outputline = function() {
                ...
                if (!e.multiline_frame && e.mode !== D.ForInitializer && e.mode !== D.Conditional)
        ...
        function M(y, L, e) {
            ...
            var I, k, D, F, M, $, B = this.line_starters.concat(["do", "in", "else", "get", "set", "new", "catch", "finally", "typeof", "yield", "async", "await"]),
                P = /([\s\S]*?)((?:\*\/)|$)/g,
                U = /([^\n\r\u2028\u2029]*)/g,
                K = /\/\* beautify( \w+[:]\w+)+ \*\//g,
                H = / (\w+)[:](\w+)/g,
            ...
            function o() {
                ...
                if (n.length && (k = n.join("")), N.test(r)) {
                    var i = !0,
                        a = !0,
                        o = N;
                    for ("0" === r && M < $ && /[Xxo]/.test(y.charAt(M)) ? (a = i = !1, r += y.charAt(M), M += 1, o = /[o]/.test(y.charAt(M)) ? x : w) : (r = "", M -= 1); M < $ && o.test(y.charAt(M));) r += y.charAt(M), M += 1, i && M < $ && "." === y.charAt(M) && (r += y.charAt(M), M += 1, i = !1), a && M < $ && /[Ee]/.test(y.charAt(M)) && (r += y.charAt(M), (M += 1) < $ && /[+-]/.test(y.charAt(M)) && (r += y.charAt(M), M += 1), i = a = !1);
                    return [r, "TK_WORD"]
                }
                ...
                if ("`" === r || "'" === r || '"' === r || ("/" === r || L.e4x && "<" === r && y.slice(M - 1).match(/^<([-a-zA-Z:0-9_.]+|{[^{}]*}|!\[CDATA\[[\s\S]*?\]\])(\s+[-a-zA-Z:0-9_.]+\s*=\s*('[^']*'|"[^"]*"|{.*?}))*\s*(\/?)\s*>/)) && ("TK_RESERVED" === t.type && G(t.text, ["return", "case", "throw", "else", "do", "typeof", "yield"]) || "TK_END_EXPR" === t.type && ")" === t.text && t.parent && "TK_RESERVED" === t.parent.type && G(t.parent.text, ["if", "while", "for"]) || G(t.type, ["TK_COMMENT", "TK_START_EXPR", "TK_START_BLOCK", "TK_END_BLOCK", "TK_OPERATOR", "TK_EQUALS", "TK_EOF", "TK_SEMICOLON", "TK_COMMA"]))) {
                    var c = r,
                        f = !1,
                        p = !1;
                    if (e = r, "/" === c)
                    ...
                    if (p && L.unescape_strings && (e = function(e) {
                            var t, n = !1,
                                r = "",
                                i = 0,
                                a = "",
                ...
                if ("<" === r && "\x3c!--" === y.substring(M - 1, M + 3)) {
                    ...
                    return D = !0, [r, "TK_COMMENT"]
                }
                if ("-" === r && D && "--\x3e" === y.substring(M - 1, M + 2)) return D = !1, M += 2, ["--\x3e", "TK_COMMENT"];
            ...
            this.tokenize = function() {
                ...
                for (var r = null, i = [], a = []; !t || "TK_EOF" !== t.type;) {
                    for (n = o(), e = new X(n[1], n[0], I, k);
                        "TK_COMMENT" === e.type || "TK_BLOCK_COMMENT" === e.type || "TK_UNKNOWN" === e.type;) "TK_BLOCK_COMMENT" === e.type && (e.directives = n[2]), a.push(e), n = o(), e = new X(n[1], n[0], I, k);
                        ...
                        case "TK_SCRIPT":
                            if ("" !== n.token_text) {
                                ...
                                var A, C = n.token_text,
                                    S = 1;
                                "TK_SCRIPT" == n.token_type ? A = x : "TK_STYLE" == n.token_type && (A = N), "keep" == t.indent_scripts ? S = 0 : "separate" == t.indent_scripts && (S = -n.indent_level);
                                var R = n.get_full_indent(S);
                                if (A) C = A(C.replace(/^\s*/, R), t);
                                else {
                                    var y = C.match(/^\s*/)[0].match(/[^\n\r]*$/)[0].split(n.indent_string).length - 1,
                                        L = n.get_full_indent(S - y);
    ...
    }), Te.FE.PLUGINS.codeView = function(l) {
        var d, c;
        ...
        function u() {
            f() && (c && c.setSize(null, l.opts.height ? l.opts.height : "auto"), l.opts.heightMin || l.opts.height ? (l.$box.find(".CodeMirror-scroll, .CodeMirror-gutters").css("min-height", l.opts.heightMin || l.opts.height), d.css("height", l.opts.height)) : l.$box.find(".CodeMirror-scroll, .CodeMirror-gutters").css("min-height", ""))
        }
        var h, g = !1;
        ...
        function i(e) {
            d || (! function() {
                d = Te('<textarea class="fr-code" tabIndex="-1">'), l.$wp.append(d), d.attr("dir", l.opts.direction), l.$box.hasClass("fr-basic") || (h = Te('<a data-cmd="html" title="Code View" class="fr-command fr-btn html-switch' + (l.helpers.isMobile() ? "" : " fr-desktop") + '" role="button" tabIndex="-1"><i class="fa fa-code"></i></button>'), l.$box.append(h), l.events.bindClick(l.$box, "a.html-switch", function() {
            ...
            var n, r, i = !1;
            if (l.core.hasFocus() && (i = !0, l.events.disableBlur(), l.$el.blur()), t = (t = t.replace(/<span class="fr-tmp fr-sm">F<\/span>/, "FROALA-SM")).replace(/<span class="fr-tmp fr-em">F<\/span>/, "FROALA-EM"), l.codeBeautifier && !t.includes("fr-embedly") && (t = l.codeBeautifier.run(t, l.opts.codeBeautifierOptions)), c) {
                ...
                var s = Te(l.o_doc).scrollTop();
                g = !i, d.focus(), g = !0, d.get(0).setSelectionRange(n, r), Te(l.o_doc).scrollTop(s)
            }
            l.$tb.find(" > .fr-command, > .fr-btn-wrap > .fr-command").not(e).filter(function() {
                return l.opts.codeViewKeepActiveButtons.indexOf(Te(this).data("cmd")) < 0
        ...
        plugin: "codeView"
    }), Te.FE.DefineIcon("html", {
        NAME: "code"
    }), Te.extend(Te.FE.POPUP_TEMPLATES, {
    ...
    if (Te.FE.PLUGINS.colors = function(g) {
            function t() {
                ...
                showColorsPopup: function() {
                    ...
                    if (t || (t = function() {
                            ...
                            return h = i, g.events.on("popup.tab", function(e) {
                                ...
                                if (Te.FE.KEYCODE.TAB == n) {
                                ...
                                } else if (Te.FE.KEYCODE.ARROW_UP == n || Te.FE.KEYCODE.ARROW_DOWN == n || Te.FE.KEYCODE.ARROW_LEFT == n || Te.FE.KEYCODE.ARROW_RIGHT == n) {
                                    if (t.is("span.fr-select-color")) {
                                        var a = t.parent().find("span.fr-select-color"),
                                            ...
                                            f = c * s + d,
                                            p = l * s;
                                        Te.FE.KEYCODE.ARROW_UP == n ? f = ((f - s) % p + p) % p : Te.FE.KEYCODE.ARROW_DOWN == n ? f = (f + s) % p : Te.FE.KEYCODE.ARROW_LEFT == n ? f = ((f - 1) % p + p) % p : Te.FE.KEYCODE.ARROW_RIGHT == n && (f = (f + 1) % p);
                                        var u = Te(a.get(f));
                                        g.events.disableBlur(), u.focus(), r = !1
                                    }
                                } else Te.FE.KEYCODE.ENTER == n && (g.button.exec(t), r = !1);
                        ...
                        if (g.popups.setContainer("colors.picker", g.$tb), l.map(function(e) {
                            ...
                            var n = e.offset().left + e.outerWidth() / 2,
                                r = g.position.getTbarPupupTop("colors.picker", e);
        ...
        }, Te.FE.DefineIcon("colors", {
            NAME: "tint"
        }), Te.FE.RegisterCommand("color", {
            title: "Colors",
            undo: !1,
            focus: !0,
            refreshOnCallback: !1,
            ...
            plugin: "colors"
        }), Te.FE.RegisterCommand("textColor", {
            undo: !0,
            callback: function(e, t) {
                this.colors.text(t)
            }
        }), Te.FE.RegisterCommand("backgroundColor", {
            undo: !0,
            callback: function(e, t) {
                this.colors.background(t)
            }
        }), Te.FE.RegisterCommand("colorChangeSet", {
            undo: !1,
            focus: !1,
            callback: function(e, t) {
        ...
        }), Te.FE.DefineIcon("colorsBack", {
            NAME: "arrow-left"
        }), Te.FE.RegisterCommand("colorsBack", {
            title: "Back",
            undo: !1,
            focus: !1,
            back: !0,
        ...
        }), Te.FE.RegisterCommand("customColor", {
            title: "OK",
            undo: !0,
            callback: function() {
                this.colors.customColor()
            }
        }), Te.FE.DefineIcon("remove", {
            NAME: "eraser"
        }), Te.extend(Te.FE.DEFAULTS, {
            dragInline: !0
        }), Te.FE.PLUGINS.draggable = function(d) {
            function e(e) {
                if (e.originalEvent && e.originalEvent.target && e.originalEvent.target.nodeType == Node.TEXT_NODE) return !0;
                if (e.target && "A" == e.target.tagName && 1 == e.target.childNodes.length && "IMG" == e.target.childNodes[0].tagName && (e.target = e.target.childNodes[0]), !Te(e.target).hasClass("fr-draggable") && !0 !== e.target.draggable) return d.browser.msie || e.preventDefault(), !1;
                d.undo.canDo() || d.undo.saveStep();
                for (var t = e.target, n = t.parentElement; n != d.$el.get(0) && ("false" === n.isContentEditable || 0 == n.isContentEditable);) n = (t = n).parentElement;
                Te(t).addClass("fr-dragging"), d.opts.dragInline ? d.$el.attr("contenteditable", !0) : d.$el.attr("contenteditable", !1), d.opts.toolbarInline && d.toolbar.hide(), d.browser.msie || d.browser.edge || d.selection.clear(), e.originalEvent.dataTransfer.setData("text", "Froala")
            }
            ...
            function t(e) {
                e.originalEvent.dataTransfer.dropEffect = "move", d.opts.dragInline ? function() {
                    for (var e = null, t = 0; t < Te.FE.INSTANCES.length; t++)
                        if ((e = Te.FE.INSTANCES[t].$el.find(".fr-dragging")).length) return e.get(0)
                    ...
                    if (!c(t)) {
                        ...
                        for (var i = 0, a = t; !c(a) && a == t && e.originalEvent.pageY - d.win.pageYOffset + i < Te(d.doc).height();) i++, a = d.doc.elementFromPoint(e.originalEvent.pageX - d.win.pageXOffset, e.originalEvent.pageY - d.win.pageYOffset + i);
                        (!c(a) || p && 0 === d.$el.find(a).length && a != p.get(0)) && (a = null), t = null == a && r ? r : a && null == r ? a : a && r ? n < i ? r : a : null
                    }
                    if (Te(t).hasClass("fr-drag-helper")) return;
                    if (t && !d.node.isBlock(t) && (t = d.node.blockParent(t)), t && 0 <= ["TD", "TH", "TR", "THEAD", "TBODY"].indexOf(t.tagName) && (t = Te(t).parents("table").get(0)), t && 0 <= ["LI"].indexOf(t.tagName) && (t = Te(t).parents("UL, OL").get(0)), t && !Te(t).hasClass("fr-drag-helper")) {
                        var o;
                        p || (Te.FE.$draggable_helper || (Te.FE.$draggable_helper = Te('<div class="fr-drag-helper"></div>')), p = Te.FE.$draggable_helper, d.events.on("shared.destroy", function() {
                            p.html("").removeData().remove(), p = null
                        }, !0)), o = e.originalEvent.pageY < Te(t).offset().top + Te(t).outerHeight() / 2;
                        var s = Te(t),
                            l = 0;
                        o || 0 !== s.next().length ? (o || (s = s.next()), "before" == p.data("fr-position") && s.is(p.data("fr-tag")) || (0 < s.prev().length && (l = parseFloat(s.prev().css("margin-bottom")) || 0), l = Math.max(l, parseFloat(s.css("margin-top")) || 0), f(s.offset().top - l / 2 - d.$box.offset().top, s.offset().left - d.win.pageXOffset - d.$box.offset().left, s.width()), p.data("fr-position", "before"))) : "after" == p.data("fr-position") && s.is(p.data("fr-tag")) || (l = parseFloat(s.css("margin-bottom")) || 0, f(s.offset().top + Te(t).height() + l / 2 - d.$box.offset().top, s.offset().left - d.win.pageXOffset - d.$box.offset().left, s.width()), p.data("fr-position", "after")), p.data("fr-tag", s), p.addClass("fr-visible"), p.appendTo(d.$box)
            ...
            function i(e) {
                ...
                for (var r = 0; r < Te.FE.INSTANCES.length; r++)
                    if ((t = Te.FE.INSTANCES[r].$el.find(".fr-dragging")).length) {
                        n = Te.FE.INSTANCES[r];
                        break
                    } if (t.length) {
                    ...
                    else d.$el.find(".fr-marker").replaceWith(Te.FE.MARKERS), d.selection.restore();
                    if (n == d || d.undo.canDo() || d.undo.saveStep(), d.core.isEmpty()) d.$el.html(i);
                    else {
                        var a = d.markers.insert();
                        0 === i.find(a).length ? Te(a).replaceWith(i) : 0 === t.find(a).length && Te(a).replaceWith(t), t.after(Te.FE.MARKERS), d.selection.restore()
                    }
            ...
            return {
                _init: function() {
                    d.opts.enter == Te.FE.ENTER_BR && (d.opts.dragInline = !0), d.events.on("dragstart", e, !0), d.events.on("dragover", t, !0), d.events.on("dragenter", n, !0), d.events.on("document.dragend", r, !0), d.events.on("document.drop", r, !0), d.events.on("drop", i, !0), d.events.on("html.processGet", a)
                }
            }
        }, Te.extend(Te.FE.POPUP_TEMPLATES, {
            ...
            emoticonsUseImage: !0
        }), Te.FE.PLUGINS.emoticons = function(m) {
            function i() {
                    ...
                    e(), m.events.on("html.set", e), m.events.on("keydown", function(e) {
                        if (m.keys.isCharacter(e.which) && m.selection.inEditor()) {
                            var t = m.selection.ranges(0),
                                n = i();
                            m.node.hasClass(n, "fr-emoticon-img") && n && (0 === t.startOffset && m.selection.element() === n ? Te(n).before(Te.FE.MARKERS + Te.FE.INVISIBLE_SPACE) : Te(n).after(Te.FE.INVISIBLE_SPACE + Te.FE.MARKERS), m.selection.restore())
                        }
                    }), m.events.on("keyup", function(e) {
                        for (var t = m.el.querySelectorAll(".fr-emoticon"), n = 0; n < t.length; n++) "undefined" != typeof t[n].textContent && 0 === t[n].textContent.replace(/\u200B/gi, "").length && Te(t[n]).remove();
                        if (!(e.which >= Te.FE.KEYCODE.ARROW_LEFT && e.which <= Te.FE.KEYCODE.ARROW_DOWN)) {
                            var r = i();
                            m.node.hasClass(r, "fr-emoticon-img") && (Te(r).append(Te.FE.MARKERS), m.selection.restore())
                        }
                    })
                },
                insert: function(e, t) {
                ...
                showEmoticonsPopup: function() {
                    ...
                    if (t || (t = function() {
                            ...
                            return m.tooltip.bind(n, ".fr-emoticon"), g = n, m.events.on("popup.tab", function(e) {
                                ...
                                if (Te.FE.KEYCODE.TAB == a) {
                                ...
                                } else if (Te.FE.KEYCODE.ARROW_UP == a || Te.FE.KEYCODE.ARROW_DOWN == a || Te.FE.KEYCODE.ARROW_LEFT == a || Te.FE.KEYCODE.ARROW_RIGHT == a) {
                                    if (t.is("span.fr-emoticon")) {
                                        ...
                                        var d = m.opts.emoticonsStep,
                                            ...
                                            u = p * d + f,
                                            h = c * d;
                                        Te.FE.KEYCODE.ARROW_UP == a ? u = ((u - d) % h + h) % h : Te.FE.KEYCODE.ARROW_DOWN == a ? u = (u + d) % h : Te.FE.KEYCODE.ARROW_LEFT == a ? u = ((u - 1) % h + h) % h : Te.FE.KEYCODE.ARROW_RIGHT == a && (u = (u + 1) % h), i = Te(l.get(u)), m.events.disableBlur(), i.focus(), n = !1
                                    }
                                } else Te.FE.KEYCODE.ENTER == a && (t.is("a") ? t[0].click() : m.button.exec(t), n = !1);
                                return !1 === n && (e.preventDefault(), e.stopPropagation()), n
                            }, !0), n
                        }()), !t.hasClass("fr-active")) {
                        m.popups.refresh("emoticons"), m.popups.setContainer("emoticons", m.$tb);
                        var n = e.offset().left + e.outerWidth() / 2,
                            r = m.position.getTbarPupupTop("emoticons", e);
        ...
        }, Te.FE.DefineIcon("emoticons", {
            NAME: "smile-o",
            FA5NAME: "smile"
        }), Te.FE.RegisterCommand("emoticons", {
            title: "Emoticons",
            undo: !1,
            focus: !0,
            refreshOnCallback: !1,
            ...
            plugin: "emoticons"
        }), Te.FE.RegisterCommand("insertEmoticon", {
            callback: function(e, t) {
        ...
        }), Te.FE.DefineIcon("emoticonsBack", {
            NAME: "arrow-left"
        }), Te.FE.RegisterCommand("emoticonsBack", {
            title: "Back",
            undo: !1,
            focus: !1,
            back: !0,
        ...
        }), Te.FE.PLUGINS.entities = function(i) {
            var a, o;
            ...
            return {
                _init: function() {
                    ...
                    var e = Te("<div>").html(i.opts.entities).text(),
        ...
        }), Te.FE.PLUGINS.file = function(f) {
            var r, p = "https://i./upload",
                l = 2,
                d = 3,
                c = 4,
                u = 5,
            ...
            function g() {
                ...
                e || (e = C()), e.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), e.find(".fr-file-progress-bar-layer").addClass("fr-active"), e.find(".fr-buttons").hide(), a(f.language.translate("Uploading"), 0)
            }
            ...
            function m(e, t, n) {
                ...
                r.removeAttr("id"), f.popups.hide("file.insert"), f.undo.saveStep(), S(), f.events.trigger("file.inserted", [r, n])
            }
                ...
                try {
                    if (f.opts.fileUploadToS3)
                        if (201 == t) {
                            var a = function(e) {
                                try {
                                    var t = Te(e).find("Location").text(),
                                        n = Te(e).find("Key").text();
                                    return !1 === f.events.trigger("file.uploadedToS3", [t, n, e], !0) ? (f.edit.on(), !1) : t
                                } catch (r) {
                                    return T(c, e), !1
                                }
                            }(r);
            ...
            function E() {
                T(c, this.response || this.responseText || this.responseXML)
            }

            function b(e) {
                if (e.lengthComputable) {
                    var t = e.loaded / e.total * 100 | 0;
                    a(f.language.translate("Uploading"), t)
                }
            }
            ...
            function o(e) {
                if (void 0 !== e && 0 < e.length) {
                    ...
                    var t, n = e[0],
                        r = n.name.slice(n.name.lastIndexOf(".")),
                        i = f.opts.fileAllowedTypes;
                    if (i.indexOf("*") < 0 && i.indexOf(r) < 0 && i.indexOf(n.type.replace(/file\//g, "")) < 0) return T(h), !1;
                    if ((null === f.opts.fileUploadURL || f.opts.fileUploadURL == p) && !f.opts.fileUploadToS3) return d = n, (c = new FileReader).onload = function() {
                        for (var e = c.result, t = atob(c.result.split(",")[1]), n = [], r = 0; r < t.length; r++) n.push(t.charCodeAt(r));
                        e = window.URL.createObjectURL(new Blob([new Uint8Array(n)], {
                            type: d.type
                        })), f.file.insert(e, d.name, null)
                    }, g(), c.readAsDataURL(d), !1;
                    if (n.size > f.opts.fileMaxSize) return T(u), !1;
                    if (f.drag_support.formdata && (t = f.drag_support.formdata ? new FormData : null), t) {
                        var a;
                        if (!1 !== f.opts.fileUploadToS3)
                            for (a in t.append("key", f.opts.fileUploadToS3.keyStart + (new Date).getTime() + "-" + (n.name || "untitled")), t.append("success_action_status", "201"), t.append("X-Requested-With", "xhr"), t.append("Content-Type", n.type), f.opts.fileUploadToS3.params) f.opts.fileUploadToS3.params.hasOwnProperty(a) && t.append(a, f.opts.fileUploadToS3.params[a]);
                        for (a in f.opts.fileUploadParams) f.opts.fileUploadParams.hasOwnProperty(a) && t.append(a, f.opts.fileUploadParams[a]);
                        t.append(f.opts.fileUploadParam, n);
                        ...
                        var s = f.core.getXHR(o, f.opts.fileUploadMethod);
                        s.onload = function() {
                            v.call(s, n.name)
                        }, s.onerror = E, s.upload.onprogress = b, s.onabort = A, g();
                        var l = f.popups.get("file.insert");
                        l && l.off("abortUpload").on("abortUpload", function() {
            ...
            function t(e) {
                ...
                if (t && t.files && t.files.length) {
                    ...
                    if (n && "undefined" != typeof n.type) {
                        if (n.type.indexOf("image") < 0 || -1 < n.type.indexOf("svg")) {
                            if (!f.opts.fileUpload) return e.preventDefault(), e.stopPropagation(), !1;
                            f.markers.remove(), f.markers.insertAtPoint(e.originalEvent), f.$el.find(".fr-marker").replaceWith(Te.FE.MARKERS), f.popups.hideAll();
                            var r = f.popups.get("file.insert");
                            return r || (r = C()), f.popups.setContainer("file.insert", f.$sc), f.popups.show("file.insert", e.originalEvent.pageX, e.originalEvent.pageY), g(), o(t.files), e.preventDefault(), e.stopPropagation(), !1
                        }
            ...
            function S() {
                ...
                if (r)
                    for (e = 0; e < r.length; e++) n.indexOf(r[e].getAttribute("href")) < 0 && f.events.trigger("file.unlink", [r[e]]);
                r = t
            }
            return n[1] = "File cannot be loaded from the passed link.", n[l] = "No link in upload response.", n[d] = "Error during file upload.", n[c] = "Parsing response failed.", n[u] = "File is too large.", n[h] = "File file type is invalid.", n[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", {
                _init: function() {
                    f.events.on("drop", t), f.events.$on(f.$win, "keydown", function(e) {
                        var t = e.which,
                            n = f.popups.get("file.insert");
                        n && t == Te.FE.KEYCODE.ESC && n.trigger("abortUpload")
                    }), f.events.on("destroy", function() {
                        var e = f.popups.get("file.insert");
                        e && e.trigger("abortUpload")
                    }), f.events.on("link.beforeRemove", e), f.$wp && (S(), f.events.on("contentChanged", S)), C(!0)
                },
                showInsertPopup: function() {
                    ...
                    if (t || (t = C()), i(), !t.hasClass("fr-active"))
                        if (f.popups.refresh("file.insert"), f.popups.setContainer("file.insert", f.$tb), e.is(":visible")) {
                            var n = e.offset().left + e.outerWidth() / 2,
                                r = f.position.getTbarPupupTop("file.insert", e);
                            f.popups.show("file.insert", n, r, e.outerHeight())
        ...
        }, Te.FE.DefineIcon("insertFile", {
            NAME: "file-o",
            FA5NAME: "file"
        }), Te.FE.RegisterCommand("insertFile", {
            title: "Upload File",
            undo: !1,
            focus: !0,
            refreshAfterCallback: !1,
            ...
            plugin: "file"
        }), Te.FE.DefineIcon("fileBack", {
            NAME: "arrow-left"
        }), Te.FE.RegisterCommand("fileBack", {
            title: "Back",
            undo: !1,
            focus: !1,
            back: !0,
        ...
        }), Te.FE.RegisterCommand("fileDismissError", {
            title: "OK",
            callback: function() {
            ...
            function s() {
                var e = a(Te(i.selection.element()).css("font-family")),
                    t = [];
            ...
            return {
                ...
                refresh: function(e) {
                    if (i.opts.fontFamilySelection) {
                        var t = Te(i.selection.element()).css("font-family").replace(/(sans-serif|serif|monospace|cursive|fantasy)/gi, "").replace(/"|'|/g, "").split(",");
                        e.find("> span").text(i.opts.fontFamily[s()] || t[0] || i.language.translate(i.opts.fontFamilyDefaultSelection))
                    }
                }
            }
        }, Te.FE.RegisterCommand("fontFamily", {
            type: "dropdown",
            ...
            fontSizeUnit: "px"
        }), Te.FE.PLUGINS.fontSize = function(a) {
            return {
                apply: function(e) {
                    a.format.applyStyle("font-size", e)
                },
                refreshOnShow: function(e, t) {
                    var n = Te(a.selection.element()).css("font-size");
                ...
                refresh: function(e) {
                    if (a.opts.fontSizeSelection) {
                        var t = a.helpers.getPX(Te(a.selection.element()).css("font-size"));
                        "pt" === a.opts.fontSizeUnit && (t = Math.round(72 * parseFloat(t, 10) / 96) + "pt"), e.find("> span").text(t)
                    }
                }
            }
        }, Te.FE.RegisterCommand("fontSize", {
            type: "dropdown",
            title: "Font Size",
            displaySelection: function(e) {
        ...
        }), Te.FE.PLUGINS.forms = function(a) {
            var o;

            function e(e) {
                e.preventDefault(), a.selection.clear(), Te(this).data("mousedown", !0)
            }

            function t(e) {
                Te(this).data("mousedown") && (e.stopPropagation(), Te(this).removeData("mousedown"), l(o = this)), e.preventDefault()
            }
            ...
            return {
                ...
                applyStyle: function(e, t, n) {
                    ...
                    if (!n) {
                        var i = Object.keys(t);
                        i.splice(i.indexOf(e), 1), Te(r).removeClass(i.join(" "))
                    }
                    Te(r).toggleClass(e)
                },
        ...
        }, Te.FE.RegisterCommand("updateInput", {
            undo: !1,
            focus: !1,
            title: "Update",
            callback: function() {
        ...
        }), Te.FE.DefineIcon("inputStyle", {
            NAME: "magic"
        }), Te.FE.RegisterCommand("inputStyle", {
            title: "Style",
            type: "dropdown",
            html: function() {
            ...
            refreshOnShow: function(e, t) {
                ...
                if (n) {
                    ...
                    t.find(".fr-command").each(function() {
                        var e = Te(this).data("param1");
                        Te(this).toggleClass("fr-active", r.hasClass(e))
                    })
                }
            }
        }), Te.FE.DefineIcon("inputEdit", {
            NAME: "edit"
        }), Te.FE.RegisterCommand("inputEdit", {
            title: "Edit Button",
            undo: !1,
            refreshAfterCallback: !1,
            callback: function() {
        ...
        }), Te.FE.DefineIcon("inputBack", {
            NAME: "arrow-left"
        }), Te.FE.RegisterCommand("inputBack", {
            title: "Back",
            undo: !1,
            focus: !1,
            back: !0,
        ...
        }), Te.FE.PLUGINS.fullscreen = function(n) {
            var t, r, i, a;
            ...
            return {
                _init: function() {
                    if (!n.$wp) return !1;
                    n.events.$on(Te(n.o_win), "resize", function() {
                        o() && (s(), e())
        ...
        }, Te.FE.RegisterCommand("fullscreen", {
            title: "Fullscreen",
            undo: !1,
            focus: !1,
            ...
            plugin: "fullscreen"
        }), Te.FE.DefineIcon("fullscreen", {
            NAME: "expand"
        }), Te.FE.DefineIcon("fullscreenCompress", {
            NAME: "compress"
        }), Te.extend(Te.FE.DEFAULTS, {
            helpSets: [{
                title: "Inline Editor",
            ...
            return {
                ...
                show: function() {
                    if (!r) {
                        ...
                        r = n.$modal, n.$head, n.$body, o.events.$on(Te(o.o_win), "resize", function() {
                            o.modals.resize(i)
                        })
                    }
        ...
        }, Te.FroalaEditor.DefineIcon("help", {
            NAME: "question"
        }), Te.FE.RegisterShortcut(Te.FE.KEYCODE.SLASH, "help", null, "/"), Te.FE.RegisterCommand("help", {
            title: "Help",
            icon: "help",
            undo: !1,
            focus: !1,
            ...
            imageUpload: !0,
            imageUploadURL: null,
            imageCORSProxy: "https://cors-anywhere.",
            ...
            imageAddNewLine: !1
        }), Te.FE.PLUGINS.image = function(f) {
            var p, l, d, c, s, n, u = "https://i./upload",
                t = !1,
                r = 1,
                h = 2,
                g = 3,
            ...
            function a() {
                ...
                if (e || (e = N()), e) {
                    var t = ve();
                    Ee() && (t = t.find(".fr-img-wrap")), f.popups.setContainer("image.edit", f.$sc), f.popups.refresh("image.edit");
            ...
            function e() {
                for (var e, t, n = "IMG" == f.el.tagName ? [f.el] : f.el.querySelectorAll("img"), r = 0; r < n.length; r++) {
                    var i = Te(n[r]);
                    !f.opts.htmlUntouched && f.opts.useClasses ? ((f.opts.imageDefaultAlign || f.opts.imageDefaultDisplay) && (0 < (t = i).parents(".fr-img-caption").length && (t = t.parents(".fr-img-caption:first")), t.hasClass("fr-dii") || t.hasClass("fr-dib") || (t.addClass("fr-fi" + pe(t)[0]), t.addClass("fr-di" + ue(t)[0]), t.css("margin", ""), t.css("float", ""), t.css("display", ""), t.css("z-index", ""), t.css("position", ""), t.css("overflow", ""), t.css("vertical-align", ""))), f.opts.imageTextNear || (0 < i.parents(".fr-img-caption").length ? i.parents(".fr-img-caption:first").removeClass("fr-dii").addClass("fr-dib") : i.removeClass("fr-dii").addClass("fr-dib"))) : f.opts.htmlUntouched || f.opts.useClasses || (f.opts.imageDefaultAlign || f.opts.imageDefaultDisplay) && (0 < (e = i).parents(".fr-img-caption").length && (e = e.parents(".fr-img-caption:first")), fe(e, e.hasClass("fr-dib") ? "block" : e.hasClass("fr-dii") ? "inline" : null, e.hasClass("fr-fil") ? "left" : e.hasClass("fr-fir") ? "right" : pe(e)), e.removeClass("fr-dib fr-dii fr-fir fr-fil")), f.opts.iframe && i.on("load", f.size.syncIframe)
                }
            }
            ...
            function A(e) {
                ...
                var t, n = Array.prototype.slice.call(f.el.querySelectorAll("img")),
                    r = [];
                for (t = 0; t < n.length; t++)
                    if (r.push(n[t].getAttribute("src")), Te(n[t]).toggleClass("fr-draggable", f.opts.imageMove), "" === n[t].getAttribute("class") && n[t].removeAttribute("class"), "" === n[t].getAttribute("style") && n[t].removeAttribute("style"), n[t].parentNode && n[t].parentNode.parentNode && f.node.hasClass(n[t].parentNode.parentNode, "fr-img-caption")) {
                    ...
                    for (t = 0; t < s.length; t++) r.indexOf(s[t].getAttribute("src")) < 0 && f.events.trigger("image.removed", [Te(s[t])]);
                if (s && e) {
                    var o = [];
                    for (t = 0; t < s.length; t++) o.push(s[t].getAttribute("src"));
                    for (t = 0; t < n.length; t++) o.indexOf(n[t].getAttribute("src")) < 0 && f.events.trigger("image.loaded", [Te(n[t])])
                }
                s = n
            }
            ...
            function C() {
                if (l || function() {
                        ...
                        f.shared.$image_resizer ? (l = f.shared.$image_resizer, c = f.shared.$img_overlay, f.events.on("destroy", function() {
                            l.removeClass("fr-active").appendTo(Te("body:first"))
                        }, !0)) : (f.shared.$image_resizer = Te('<div class="fr-image-resizer"></div>'), l = f.shared.$image_resizer, f.events.$on(l, "mousedown", function(e) {
                            e.stopPropagation()
                        }, !0), f.opts.imageResize && (l.append(o("nw") + o("ne") + o("sw") + o("se")), f.shared.$img_overlay = Te('<div class="fr-image-overlay"></div>'), c = f.shared.$img_overlay, e = l.get(0).ownerDocument, Te(e).find("body:first").append(c)));
                        f.events.on("shared.destroy", function() {
                            l.html("").removeData().remove(), l = null, f.opts.imageResize && (c.remove(), c = null)
                        }, !0), f.helpers.isMobile() || f.events.$on(Te(f.o_win), "resize", function() {
                            p && !p.hasClass("fr-uploading") ? se(!0) : p && (C(), he(), x(!1))
                        });
                        if (f.opts.imageResize) {
                            e = l.get(0).ownerDocument, f.events.$on(l, f._mousedown, ".fr-handler", R), f.events.$on(Te(e), f._mousemove, y), f.events.$on(Te(e.defaultView || e.parentWindow), f._mouseup, L), f.events.$on(c, "mouseleave", L);
                            var r = 1,
                                i = null,
                                a = 0;
                            f.events.on("keydown", function(e) {
                                if (p) {
                                    var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                                        n = e.which;
                                    (n !== i || 200 < e.timeStamp - a) && (r = 1), (n == Te.FE.KEYCODE.EQUALS || f.browser.mozilla && n == Te.FE.KEYCODE.FF_EQUALS) && t && !e.altKey ? r = Q.call(this, e, 1, 1, r) : (n == Te.FE.KEYCODE.HYPHEN || f.browser.mozilla && n == Te.FE.KEYCODE.FF_HYPHEN) && t && !e.altKey ? r = Q.call(this, e, 2, -1, r) : f.keys.ctrlKey(e) || n != Te.FE.KEYCODE.ENTER || (p.before("<br>"), k(p)), i = n, a = e.timeStamp
                                }
                ...
                var r = ve();
                Ee() && (r = r.find(".fr-img-wrap")), l.css("top", (f.opts.iframe ? r.offset().top : r.offset().top + t) - 1).css("left", (f.opts.iframe ? r.offset().left : r.offset().left + n) - 1).css("width", r.get(0).getBoundingClientRect().width).css("height", r.get(0).getBoundingClientRect().height).addClass("fr-active")
            }
            ...
            function S(e) {
                Ee() ? p.parents(".fr-img-caption").css("width", e) : p.css("width", e)
            }
            ...
            function R(e) {
                ...
                if ("mousedown" == e.type) {
                    ...
                    i && r.frameElement && (t += f.helpers.getPX(Te(r.frameElement).offset().left) + r.frameElement.clientLeft)
                }(d = Te(this)).data("start-x", t), d.data("start-width", p.width()), d.data("start-height", p.height());
                var a = p.width();
                if (f.opts.imageResizeWithPercent) {
                    var o = p.parentsUntil(f.$el, f.html.blockTagsQuery()).get(0) || f.el;
                    a = (a / Te(o).outerWidth() * 100).toFixed(2) + "%"
                }
                S(a), c.show(), f.popups.hideAll(), ce()
            }
            ...
            function y(e) {
                ...
                if (d && p) {
                    ...
                    if ((d.hasClass("fr-hnw") || d.hasClass("fr-hsw")) && (r = 0 - r), f.opts.imageResizeWithPercent) {
                        ...
                        i = ((i + r) / Te(a).outerWidth() * 100).toFixed(2), f.opts.imageRoundPercent && (i = Math.round(i)), S(i + "%"), (t = Ee() ? (f.helpers.getPX(p.parents(".fr-img-caption").css("width")) / Te(a).outerWidth() * 100).toFixed(2) : (f.helpers.getPX(p.css("width")) / Te(a).outerWidth() * 100).toFixed(2)) === i || f.opts.imageRoundPercent || S(t + "%"), p.css("height", "").removeAttr("height")
                    } else i + r >= f.opts.imageMinWidth && (S(i + r), t = Ee() ? f.helpers.getPX(p.parents(".fr-img-caption").css("width")) : f.helpers.getPX(p.css("width"))), t !== i + r && S(t), ((p.attr("style") || "").match(/(^height:)|(; *height:)/) || p.attr("height")) && (p.css("height", d.data("start-height") * p.width() / d.data("start-width")), p.removeAttr("height"));
                    C(), f.events.trigger("image.resize", [me()])
                }
            }
            ...
            function L(e) {
                ...
                if (d && p) {
                    ...
                    d = null, c.hide(), C(), a(), f.undo.saveStep(), f.events.trigger("image.resizeEnd", [me()])
                }
            }

            function _(e, t, n) {
                f.edit.on(), p && p.addClass("fr-error"), i[e] ? I(i[e]) : I(f.language.translate("Something went wrong. Please try again.")), !p && n && Z(n), f.events.trigger("image.error", [{
                    code: e,
                    message: i[e]
                }, t, n])
            }
            ...
            function x(e) {
                ...
                if (t || (t = z()), t.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").addClass("fr-active"), t.find(".fr-buttons").hide(), p) {
                    var n = ve();
            ...
            function w(e) {
                ...
                if (t && (t.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").removeClass("fr-active"), t.find(".fr-buttons").show(), e || f.$el.find("img.fr-error").length)) {
                    if (f.events.focus(), f.$el.find("img.fr-error").length && (f.$el.find("img.fr-error").remove(), f.undo.saveStep(), f.undo.run(), f.undo.dropRedo()), !f.$wp && p) {
                        var n = p;
                        se(!0), f.selection.setAfter(n.get(0)), f.selection.restore()
                    }
            ...
            function D() {
                var e = Te(this);
                f.popups.hide("image.insert"), e.removeClass("fr-uploading"), e.next().is("br") && e.next().remove(), k(e), f.events.trigger("image.loaded", [e])
            }
            ...
            function F(o, e, s, l, d) {
                ...
                if (t.onload = function() {
                        var e, t;
                        if (f.opts.downloadCustomHeader && !Te.isEmptyObject(f.opts.requestHeaders) && (o = this.src), l) {
                        ...
                        } else e = P(o, s, D), A(!1), f.undo.saveStep(), f.events.disableBlur(), f.$el.blur(), f.events.trigger("image.inserted", [e, d])
                    }, t.onerror = function() {
                        _(r)
                    }, x(f.language.translate("Loading image")), f.opts.downloadCustomHeader && !Te.isEmptyObject(f.opts.requestHeaders)) {
                    var n = f.core.getXHR(o, "GET");
                    n.onload = function() {
                        200 == this.status ? t.src = URL.createObjectURL(this.response) : be()
                    }, n.onerror = be, n.onabort = be, n.responseType = "blob", n.send()
                } else t.src = o
            }
            ...
            function $() {
                _(m, this.response || this.responseText || this.responseXML)
            }
            ...
            function P(e, t, n) {
                ...
                a && "auto" != a && (a = f.opts.imageResizeWithPercent ? "100%" : a + "px");
                var o = Te('<img src="' + e + '"' + i + (a ? ' style="width: ' + a + ';"' : "") + ">");
                fe(o, f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign), o.on("load", n), o.on("error", n), f.edit.on(), f.events.focus(!0), f.selection.restore(), f.undo.saveStep(), f.opts.imageSplitHTML ? f.markers.split() : f.markers.insert(), f.html.wrap();
            ...
            function K(e, t) {
                if (void 0 !== e && 0 < e.length) {
                    ...
                    }, x(), l.readAsDataURL(o), !1;
                    if (r.name || (r.name = (new Date).getTime() + "." + (r.type || "image/jpeg").replace(/image\//g, "")), r.size > f.opts.imageMaxSize) return _(v), !1;
                    if (f.opts.imageAllowedTypes.indexOf(r.type.replace(/image\//g, "")) < 0) return _(E), !1;
                    if (f.drag_support.formdata && (n = f.drag_support.formdata ? new FormData : null), n) {
                        ...
                        f.opts.imageUploadToS3 && (a = f.opts.imageUploadToS3.uploadURL ? f.opts.imageUploadToS3.uploadURL : "https://" + f.opts.imageUploadToS3.region + ".amazonaws.com/" + f.opts.imageUploadToS3.bucket),
                            function(t, n, e, i) {
                                function a() {
                                    var e = Te(this);
                                    e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), f.placeholder.refresh(), k(e), C(), x(), f.edit.off(), t.onload = function() {
                                        M.call(t, e)
                                    }, t.onerror = $, t.upload.onprogress = B, t.onabort = U, e.off("abortUpload").on("abortUpload", function() {
                                        4 != t.readyState && (t.abort(), i ? (i.attr("src", i.data("fr-old-src")), i.removeClass("fr-uploading")) : e.remove(), se(!0))
                                    }), t.send(n)
                                }
                                ...
                                o.onload = function() {
                                    ...
                                    i ? (i.on("load", a), i.one("error", a), f.edit.on(), f.undo.saveStep(), i.data("fr-old-src", i.attr("src")), i.attr("src", e)) : P(e, null, a)
                                }, o.readAsDataURL(e)
            ...
            function W(e) {
                ...
                if (t && t.files && t.files.length) {
                    ...
                    if (n && n.type && -1 !== n.type.indexOf("image") && 0 <= f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, ""))) {
                        ...
                        f.markers.remove(), f.markers.insertAtPoint(e.originalEvent), f.$el.find(".fr-marker").replaceWith(Te.FE.MARKERS), 0 === f.$el.find(".fr-marker").length && f.selection.setAtEnd(f.el), f.popups.hideAll();
                        var r = f.popups.get("image.insert");
                        r || (r = z()), f.popups.setContainer("image.insert", f.$sc);
                        var i = e.originalEvent.pageX,
                            a = e.originalEvent.pageY;
                        return f.opts.iframe && (a += f.$iframe.offset().top, i += f.$iframe.offset().left), f.popups.show("image.insert", i, a), x(), 0 <= f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, "")) ? (se(!0), K(t.files)) : _(E), e.preventDefault(), e.stopPropagation(), !1
                    }
                }
            }
            ...
            function z(e) {
                ...
                return 1 <= f.opts.imageInsertButtons.length && (n = f.popups.create("image.insert", c)), f.$wp && f.events.$on(f.$wp, "scroll", function() {
                    p && f.popups.isVisible("image.insert") && he()
            ...
            function G() {
                ...
                e || (e = V()), w(), f.popups.refresh("image.alt"), f.popups.setContainer("image.alt", f.$sc);
                var t = ve();
            ...
            function V(e) {
                if (e) return f.popups.onRefresh("image.alt", Y), !0;
                var t = {
                ...
                return f.$wp && f.events.$on(f.$wp, "scroll.image-alt", function() {
                    p && f.popups.isVisible("image.alt") && G()
                }), n
            }
            ...
            function q() {
                var e = f.popups.get("image.size");
                e || (e = j()), w(), f.popups.refresh("image.size"), f.popups.setContainer("image.size", f.$sc);
                var t = ve();
                Ee() && (t = t.find(".fr-img-wrap"));
                var n = t.offset().left + t.outerWidth() / 2,
                    r = t.offset().top + t.outerHeight();
            ...
            function j(e) {
                if (e) return f.popups.onRefresh("image.size", X), !0;
                var t = {
            ...
            function Q(e, t, n, r) {
                return e.pageX = t, R.call(this, e), e.pageX = e.pageX + n * Math.floor(Math.pow(1.1, r)), y.call(this, e), L.call(this, e), ++r
            }

            function Z(e) {
                (e = e && e.get ? e : ve()) && e.get && !1 !== f.events.trigger("image.beforeRemove", [e]) && (f.popups.hideAll(), ge(), se(!0), f.undo.canDo() || f.undo.saveStep(), e.get(0) == f.el ? e.removeAttr("src") : (e.get(0).parentNode && "A" == e.get(0).parentNode.tagName ? (f.selection.setBefore(e.get(0).parentNode) || f.selection.setAfter(e.get(0).parentNode) || e.parent().after(Te.FE.MARKERS), Te(e.get(0).parentNode).remove()) : (f.selection.setBefore(e.get(0)) || f.selection.setAfter(e.get(0)) || e.after(Te.FE.MARKERS), e.remove()), f.html.fillEmptyBlocks(), f.selection.restore()), f.undo.saveStep())
            }

            function J(e) {
                var t = e.which;
                if (p && (t == Te.FE.KEYCODE.BACKSPACE || t == Te.FE.KEYCODE.DELETE)) return e.preventDefault(), e.stopPropagation(), Z(), !1;
                if (p && t == Te.FE.KEYCODE.ESC) {
                    var n = p;
                    return se(!0), f.selection.setAfter(n.get(0)), f.selection.restore(), e.preventDefault(), !1
                }
                if (p && (t == Te.FE.KEYCODE.ARROW_LEFT || t == Te.FE.KEYCODE.ARROW_RIGHT)) {
                    var r = p.get(0);
                    return se(!0), t == Te.FE.KEYCODE.ARROW_LEFT ? f.selection.setBefore(r) : f.selection.setAfter(r), f.selection.restore(), e.preventDefault(), !1
                }
                return p && t === Te.FE.KEYCODE.TAB ? (e.preventDefault(), e.stopPropagation(), se(!0), !1) : p && t != Te.FE.KEYCODE.F10 && !f.keys.isBrowserAction(e) ? (e.preventDefault(), e.stopPropagation(), !1) : void 0
            }
            ...
            function ee(e) {
                if (e && "IMG" == e.tagName) {
                    ...
                    for (var r = e.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), i = 0; i < r.length; i++) ee(r[i])
            }

            function te(e) {
                if (!1 === f.events.trigger("image.beforePasteUpload", [e])) return !1;
                p = Te(e), C(), a(), he(), x(), p.one("load", function() {
                    C(), Te(f.popups.get("image.insert").get(0)).find("div.fr-active.fr-error").length < 1 && x()
                });
                for (var t = Te(e).attr("src").split(","), n = atob(t[1]), r = [], i = 0; i < n.length; i++) r.push(n.charCodeAt(i));
                K([new Blob([new Uint8Array(r)], {
            ...
            function ne() {
                f.opts.imagePaste ? f.$el.find("img[data-fr-image-pasted]").each(function(e, r) {
                    if (f.opts.imagePasteProcess) {
                        ...
                        t && "auto" != t && (t += f.opts.imageResizeWithPercent ? "%" : "px"), Te(r).css("width", t).removeClass("fr-dii fr-dib fr-fir fr-fil"), fe(Te(r), f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign)
                    }
                    if (0 === r.src.indexOf("data:")) te(r);
                    ...
                    } else 0 !== r.src.indexOf("http") || 0 === r.src.indexOf("https://mail.google.com/mail") ? (f.selection.save(), Te(r).remove(), f.selection.restore()) : Te(r).removeAttr("data-fr-image-pasted")
            ...
            function re(e) {
                ...
                r && fe(r, f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign), f.events.trigger("paste.after")
            }
            ...
            function ie(e) {
                if (e && e.clipboardData && e.clipboardData.items) {
                    ...
                    if (n.types && -1 != [].indexOf.call(n.types, "text/rtf") || n.getData("text/rtf")) t = n.items[0].getAsFile();
                        ...
                        for (var r = 0; r < n.items.length && !(t = n.items[r].getAsFile()); r++);
                    if (t) return i = t, (a = new FileReader).onload = re, a.readAsDataURL(i), !1
                }
                var i, a
            }
            ...
            function oe(e) {
                if ("false" == Te(this).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable")) return !0;
                if (e && "touchend" == e.type && n) return !0;
                if (e && f.edit.isDisabled()) return e.stopPropagation(), e.preventDefault(), !1;
                for (var t = 0; t < Te.FE.INSTANCES.length; t++) Te.FE.INSTANCES[t] != f && Te.FE.INSTANCES[t].events.trigger("image.hideResizer");
                f.toolbar.disable(), e && (e.stopPropagation(), e.preventDefault()), f.helpers.isMobile() && (f.events.disableBlur(), f.$el.blur(), f.events.enableBlur()), f.opts.iframe && f.size.syncIframe(), p = Te(this), ge(), C(), a(), f.browser.msie ? (f.popups.areVisible() && f.events.disableBlur(), f.win.getSelection && (f.win.getSelection().removeAllRanges(), f.win.getSelection().addRange(f.doc.createRange()))) : f.selection.clear(), f.helpers.isIOS() && (f.events.disableBlur(), f.$el.blur()), f.button.bulkRefresh(), f.events.trigger("video.hideResizer")
            }

            function se(e) {
                p && (le || !0 === e) && (f.toolbar.enable(), l.removeClass("fr-active"), f.popups.hide("image.edit"), p = null, ce(), d = null, c && c.hide())
            }
            ...
            var le = !(i[8] = "Image file is corrupted.");
            ...
            function he() {
                ...
                e || (e = z()), f.popups.isVisible("image.insert") || (w(), f.popups.refresh("image.insert"), f.popups.setContainer("image.insert", f.$sc));
                var t = ve();
                Ee() && (t = t.find(".fr-img-wrap"));
                var n = t.offset().left + t.outerWidth() / 2,
                    r = t.offset().top + t.outerHeight();
            ...
            function ve() {
                return Ee() ? p.parents(".fr-img-caption:first") : p
            }
            ...
            return {
                _init: function() {
                    ...
                    f.events.$on(f.$el, f._mousedown, "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', function(e) {
                        ...
                        if (e.shiftKey && "" === f.selection.text().replace(/\n/g, "") && f.keys.isArrow(e.which)) {
                            ...
                            t && "IMG" == t.tagName ? k(Te(t)) : n && "IMG" == n.tagName && k(Te(n))
                        }
                    }, !0), f.events.on("drop", W), f.events.on("element.beforeDrop", H), f.events.on("mousedown window.mousedown", de), f.events.on("window.touchmove", ce), f.events.on("mouseup window.mouseup", function() {
                        if (p) return se(), !1;
                        ce()
                        ...
                        p && (ge(), f.selection.clear())
                    }), f.events.on("image.resizeEnd", function() {
                        f.win.getSelection && k(p)
                        ...
                        f.node.isElement(t) && (f.opts.enter === Te.FE.ENTER_BR ? e.after("<br>") : Te(f.node.blockParent(e.get(0))).after("<" + f.html.defaultTag() + "><br></" + f.html.defaultTag() + ">"))
                    }), "IMG" == f.el.tagName && f.$el.addClass("fr-view"), f.events.$on(f.$el, f.helpers.isMobile() && !f.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', oe), f.helpers.isMobile() && (f.events.$on(f.$el, "touchstart", "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', function() {
                        n = !1
                    }), f.events.$on(f.$el, "touchmove", function() {
                        n = !0
                    })), f.$wp ? (f.events.on("window.keydown keydown", J, !0), f.events.on("keyup", function(e) {
                        if (p && e.which == Te.FE.KEYCODE.ENTER) return !1
                    }, !0), f.events.$on(f.$el, "keydown", function() {
                        var e = f.selection.element();
                        (e.nodeType === Node.TEXT_NODE || "BR" == e.tagName && f.node.isLastSibling(e)) && (e = e.parentNode), f.node.hasClass(e, "fr-inner") || (f.node.hasClass(e, "fr-img-caption") || (e = Te(e).parents(".fr-img-caption").get(0)), f.node.hasClass(e, "fr-img-caption") && (Te(e).after(Te.FE.INVISIBLE_SPACE + Te.FE.MARKERS), f.selection.restore()))
                    })) : f.events.$on(f.$win, "keydown", J), f.events.on("toolbar.esc", function() {
                        if (p) {
                            if (f.$wp) f.events.disableBlur(), f.events.focus();
                            else {
                                var e = p;
                                se(!0), f.selection.setAfter(e.get(0)), f.selection.restore()
                            }
                            return !1
                        }
                        ...
                        if (p && f.popups.isVisible("image.edit") && !f.popups.get("image.edit").find(":focus").length) {
                            var t = ve();
                            Ee() ? (t.before(Te.FE.START_MARKER), t.after(Te.FE.END_MARKER), f.selection.restore(), f.paste.saveCopiedText(t.get(0).outerHTML, t.text())) : (ge(), f.paste.saveCopiedText(p.get(0).outerHTML, p.attr("alt"))), "copy" == e.type ? setTimeout(function() {
                                k(p)
                            }) : (se(!0), f.undo.saveStep(), setTimeout(function() {
                                f.undo.saveStep()
                            }, 0))
                        }
                        ...
                        var t = e.which;
                        t == Te.FE.KEYCODE.C && f.keys.ctrlKey(e) ? f.events.trigger("window.copy") : t == Te.FE.KEYCODE.X && f.keys.ctrlKey(e) && f.events.trigger("window.cut")
                    }), f.events.$on(Te(f.o_win), "keydown", function(e) {
                        var t = e.which;
                        if (p && t == Te.FE.KEYCODE.BACKSPACE) return e.preventDefault(), !1
                    }), f.events.$on(f.$win, "keydown", function(e) {
                        var t = e.which;
                        p && p.hasClass("fr-uploading") && t == Te.FE.KEYCODE.ESC && p.trigger("abortUpload")
                    }), f.events.on("destroy", function() {
                        p && p.hasClass("fr-uploading") && p.trigger("abortUpload")
                    }), f.events.on("paste.before", ie), f.events.on("paste.beforeCleanup", ae), f.events.on("paste.after", ne), f.events.on("html.set", e), f.events.on("html.inserted", e), e(), f.events.on("destroy", function() {
                        s = []
                    }), f.events.on("html.processGet", ee), f.opts.imageOutputSize && f.events.on("html.beforeGet", function() {
                        r = f.el.querySelectorAll("img");
                        for (var e = 0; e < r.length; e++) {
                            var t = r[e].style.width || Te(r[e]).width(),
                                n = r[e].style.height || Te(r[e]).height();
                            t && r[e].setAttribute("width", ("" + t).replace(/px/, "")), n && r[e].setAttribute("height", ("" + n).replace(/px/, ""))
                        }
                    }), f.opts.iframe && f.events.on("image.loaded", f.size.syncIframe), f.$wp && (A(), f.events.on("contentChanged", A)), f.events.$on(Te(f.o_win), "orientationchange.image", function() {
                        setTimeout(function() {
                            p && k(p)
                        }, 100)
                    }), N(!0), z(!0), j(!0), V(!0), f.events.on("node.remove", function(e) {
                ...
                showLayer: function(e) {
                    ...
                    if (p || f.opts.toolbarInline) {
                        ...
                        t = a.offset().left + a.outerWidth() / 2, n = f.position.getTbarPupupTop("image.insert", a)
                ...
                insertByURL: function() {
                    var e = f.popups.get("image.insert").find(".fr-image-by-url-layer input");
                    if (0 < e.val().length) {
                        x(), O(f.language.translate("Loading image"));
                        var t = e.val().trim();
                ...
                align: function(e) {
                    var t = ve();
                    t.removeClass("fr-fir fr-fil"), !f.opts.htmlUntouched && f.opts.useClasses ? "left" == e ? t.addClass("fr-fil") : "right" == e && t.addClass("fr-fir") : fe(t, ue(), e), ge(), C(), a(), f.selection.clear()
                },
                refreshAlign: function(e) {
                    p && e.find("> *:first").replaceWith(f.icon.create("image-align-" + pe()))
                },
                ...
                display: function(e) {
                    var t = ve();
                    t.removeClass("fr-dii fr-dib"), !f.opts.htmlUntouched && f.opts.useClasses ? "inline" == e ? t.addClass("fr-dii") : "block" == e && t.addClass("fr-dib") : fe(t, e, pe()), ge(), C(), a(), f.selection.clear()
                },
                refreshDisplayOnShow: function(e, t) {
                    p && t.find('.fr-command[data-param1="' + ue() + '"]').addClass("fr-active").attr("aria-selected", !0)
                },
                replace: he,
                back: function() {
                    p ? (f.events.disableBlur(), Te(".fr-popup input:focus").blur(), k(p)) : (f.events.disableBlur(), f.selection.restore(), f.events.enableBlur(), f.popups.hide("image.insert"), f.toolbar.showInline())
                },
                get: me,
                getEl: ve,
                insert: F,
                ...
                applyStyle: function(e, t, n) {
                    ...
                    "object" == typeof t[e] ? (r.removeAttr("style"), r.css(t[e].style)) : r.toggleClass(e), k(p)
                },
                showAltPopup: G,
                showSizePopup: q,
                setAlt: function(e) {
                    if (p) {
                        ...
                        p.attr("alt", e || t.find("input").val() || ""), t.find("input:focus").blur(), k(p)
                    }
                },
                setSize: function(e, t) {
                    if (p) {
                        ...
                        var r = /^[\d]+((px)|%)*$/g;
                        p.removeAttr("width").removeAttr("height"), e.match(r) ? p.css("width", e) : p.css("width", ""), t.match(r) ? p.css("height", t) : p.css("height", ""), Ee() && (p.parents(".fr-img-caption").removeAttr("width").removeAttr("height"), e.match(r) ? p.parents(".fr-img-caption").css("width", e) : p.parents(".fr-img-caption").css("width", ""), t.match(r) ? p.parents(".fr-img-caption").css("height", t) : p.parents(".fr-img-caption").css("height", "")), n && n.find("input:focus").blur(), k(p)
                    }
                },
                toggleCaption: function() {
                    var e, t = p.parentsUntil(f.$el, "li");
                    if (p && !Ee()) {
                        var n, r;
                        e = p, f.browser.safari && t.length && (t[0].style.listStylePosition = "initial"), p.parent().is("a") && (e = p.parent()), e.attr("style") && (r = -1 < (n = e.attr("style").split(":")).indexOf("width") ? n[n.indexOf("width") + 1].replace(";", "") : "");
                        var i = f.opts.imageResizeWithPercent ? (-1 < r.indexOf("px") ? null : r) || "100%" : p.width() + "px";
                        e.wrap("<span " + (f.browser.mozilla ? "" : 'contenteditable="false"') + 'class="fr-img-caption ' + p.attr("class") + '" style="' + (f.opts.useClasses ? "" : e.attr("style")) + '" draggable="false"></span>'), e.wrap('<span class="fr-img-wrap"></span>'), p.after('<span class="fr-inner"' + (f.browser.mozilla ? "" : ' contenteditable="true"') + ">" + Te.FE.START_MARKER + f.language.translate("Image Caption") + Te.FE.END_MARKER + "</span>"), p.removeAttr("class").removeAttr("style").removeAttr("width"), p.parents(".fr-img-caption").css("width", i), se(!0), f.selection.restore()
                    } else f.browser.safari && t.length && (t[0].style.listStylePosition = ""), e = ve(), p.insertAfter(e), p.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")), e.remove(), k(p)
                },
                hasCaption: Ee,
                exitEdit: se,
                edit: k
            }
        }, Te.FE.DefineIcon("insertImage", {
            NAME: "image"
        }), Te.FE.RegisterShortcut(Te.FE.KEYCODE.P, "insertImage", null, "P"), Te.FE.RegisterCommand("insertImage", {
            title: "Insert Image",
            undo: !1,
            focus: !0,
            refreshAfterCallback: !1,
            ...
            plugin: "image"
        }), Te.FE.DefineIcon("imageUpload", {
            NAME: "upload"
        }), Te.FE.RegisterCommand("imageUpload", {
            title: "Upload Image",
            undo: !1,
            focus: !1,
            toggle: !0,
        ...
        }), Te.FE.DefineIcon("imageByURL", {
            NAME: "link"
        }), Te.FE.RegisterCommand("imageByURL", {
            title: "By URL",
            undo: !1,
            focus: !1,
            toggle: !0,
        ...
        }), Te.FE.RegisterCommand("imageInsertByURL", {
            title: "Insert Image",
            undo: !0,
            refreshAfterCallback: !1,
            callback: function() {
        ...
        }), Te.FE.DefineIcon("imageDisplay", {
            NAME: "star"
        }), Te.FE.RegisterCommand("imageDisplay", {
            title: "Display",
            type: "dropdown",
            options: {
                inline: "Inline",
        ...
        }), Te.FE.DefineIcon("image-align", {
            NAME: "align-left"
        }), Te.FE.DefineIcon("image-align-left", {
            NAME: "align-left"
        }), Te.FE.DefineIcon("image-align-right", {
            NAME: "align-right"
        }), Te.FE.DefineIcon("image-align-center", {
            NAME: "align-justify"
        }), Te.FE.DefineIcon("imageAlign", {
            NAME: "align-justify"
        }), Te.FE.RegisterCommand("imageAlign", {
            type: "dropdown",
            title: "Align",
            options: {
                left: "Align Left",
            ...
            html: function() {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
                    t = Te.FE.COMMANDS.imageAlign.options;
        ...
        }), Te.FE.DefineIcon("imageReplace", {
            NAME: "exchange",
            FA5NAME: "exchange-alt"
        }), Te.FE.RegisterCommand("imageReplace", {
            title: "Replace",
            undo: !1,
            focus: !1,
            popup: !0,
        ...
        }), Te.FE.DefineIcon("imageRemove", {
            NAME: "trash"
        }), Te.FE.RegisterCommand("imageRemove", {
            title: "Remove",
            callback: function() {
                this.image.remove()
            }
        }), Te.FE.DefineIcon("imageBack", {
            NAME: "arrow-left"
        }), Te.FE.RegisterCommand("imageBack", {
            title: "Back",
            undo: !1,
            focus: !1,
            back: !0,
        ...
        }), Te.FE.RegisterCommand("imageDismissError", {
            title: "OK",
            undo: !1,
            callback: function() {
                this.image.hideProgressBar(!0)
            }
        }), Te.FE.DefineIcon("imageStyle", {
            NAME: "magic"
        }), Te.FE.RegisterCommand("imageStyle", {
            title: "Style",
            type: "dropdown",
            html: function() {
                var e = '<ul class="fr-dropdown-list" role="presentation">',
            ...
            refreshOnShow: function(e, t) {
                ...
                n && t.find(".fr-command").each(function() {
                    var e = Te(this).data("param1"),
                        t = n.hasClass(e);
                    Te(this).toggleClass("fr-active", t).attr("aria-selected", t)
                })
            }
        }), Te.FE.DefineIcon("imageAlt", {
            NAME: "info"
        }), Te.FE.RegisterCommand("imageAlt", {
            undo: !1,
            focus: !1,
            popup: !0,
        ...
        }), Te.FE.RegisterCommand("imageSetAlt", {
            undo: !0,
            focus: !1,
            title: "Update",
            refreshAfterCallback: !1,
        ...
        }), Te.FE.DefineIcon("imageSize", {
            NAME: "arrows-alt"
        }), Te.FE.RegisterCommand("imageSize", {
            undo: !1,
            focus: !1,
            popup: !0,
            title: "Change Size",
        ...
        }), Te.FE.RegisterCommand("imageSetSize", {
            undo: !0,
            focus: !1,
            title: "Update",
            refreshAfterCallback: !1,
        ...
        }), Te.FE.DefineIcon("imageCaption", {
            NAME: "commenting",
            FA5NAME: "comment-alt"
        }), Te.FE.RegisterCommand("imageCaption", {
            undo: !0,
            focus: !1,
            title: "Image Caption",
            ...
            imageManagerLoadURL: "https://i./load-files",
        ...
        }), Te.FE.PLUGINS.imageManager = function(s) {
            ...
            function t(i) {
                var a = new Image,
                    o = Te('<div class="fr-image-container fr-empty fr-image-' + u++ + '" data-loading="' + s.language.translate("Loading") + '.." data-deleting="' + s.language.translate("Deleting") + '..">');
                x(!1), a.onload = function() {
                    o.height(Math.floor(o.width() / a.width * a.height));
                    var n = Te("<img/>");
                    if (i.thumb) n.attr("src", i.thumb);
                    else {
                        if (k(b, i), !i.url) return k(T, i), !1;
                        n.attr("src", i.url)
                    }
                    ...
                    o.append(n).append(Te(s.icon.create("imageManagerDelete")).addClass("fr-delete-img").attr("title", s.language.translate("Delete"))).append(Te(s.icon.create("imageManagerInsert")).addClass("fr-insert-img").attr("title", s.language.translate("Insert"))), c.find(".fr-selected-tag").each(function(e, t) {
                        $(n, t.text) || o.hide()
                    }), n.on("load", function() {
                        o.removeClass("fr-empty"), o.height("auto"), p++, N(_(parseInt(n.parent().attr("class").match(/fr-image-(\d+)/)[1], 10) + 1)), x(!1), p % s.opts.imageManagerPageSize == 0 && y()
                    }), s.events.trigger("imageManager.imageLoaded", [n])
                }, a.onerror = function() {
                    p++, o.remove(), N(_(parseInt(o.attr("class").match(/fr-image-(\d+)/)[1], 10) + 1)), k(e, i), p % s.opts.imageManagerPageSize == 0 && y()
                }, a.src = i.thumb || i.url, L().append(o)
            }
            ...
            function _(e) {
                ...
                for (var t = [], n = u - 1; e <= n; n--) {
                    ...
                    r.length && (t.push(r), Te('<div id="fr-image-hidden-container">').append(r), a.find(".fr-image-" + n).remove())
                }
                return t
            }

            function N(e) {
                for (var t = e.length - 1; 0 <= t; t--) L().append(e[t])
            }
            ...
            function w(e) {
                var t = {},
                    n = e.data();
                for (var r in n) Te(n).attr(r) && "url" != r && "tag" != r && (t[r] = n[r]);
                return t
            }

            function O(e) {
                var t = Te(e.currentTarget).siblings("img"),
                    n = l.data("instance") || s,
                ...
                if (s.modals.hide(g), n.image.showProgressBar(), r) r.data("fr-old-src", r.attr("src")), r.trigger("click");
                    ...
                    var i = n.position.getBoundingRect(),
                        a = i.left + i.width / 2 + Te(s.doc).scrollLeft(),
                        o = i.top + i.height + Te(s.doc).scrollTop();
            ...
            function I(e) {
                var n = Te(e.currentTarget).siblings("img"),
                    t = s.language.translate("Are you sure? Image will be deleted.");
                confirm(t) && (s.opts.imageManagerDeleteURL ? !1 !== s.events.trigger("imageManager.beforeDeleteImage", [n]) && (n.parent().addClass("fr-image-deleting"), Te.ajax({
                    method: s.opts.imageManagerDeleteMethod,
                    url: s.opts.imageManagerDeleteURL,
                    data: Te.extend(Te.extend({
                        src: n.attr("src")
                    ...
                    var t = _(parseInt(n.parent().attr("class").match(/fr-image-(\d+)/)[1], 10) + 1);
                    n.parent().remove(), N(t), l.find("#fr-modal-tags > a").each(function() {
                        0 === l.find('#fr-image-list [data-tag*="' + Te(this).text() + '"]').length && Te(this).removeClass("fr-selected-tag").hide()
                    }), F(), x(!0)
                }).fail(function(e) {
                    k(A, e.response || e.responseText)
                })) : k(C))
            }

            function k(e, t) {
                10 <= e && e < 20 ? i.hide() : 20 <= e && e < 30 && Te(".fr-image-deleting").removeClass("fr-image-deleting"), s.events.trigger("imageManager.error", [{
                    code: e,
                    message: n[e]
                }, t])
            }
            ...
            return n[e] = "Image cannot be loaded from the passed link.", n[m] = "Error during load images request.", n[v] = "Missing imageManagerLoadURL option.", n[E] = "Parsing load response failed.", n[b] = "Missing image thumb.", n[T] = "Missing image URL.", n[A] = "Error during delete image request.", n[C] = "Missing imageManagerDeleteURL option.", {
                ...
                show: function() {
                    ...
                    l.data("current-image", s.image.get()), s.modals.show(g), i || (i = l.find("#fr-preloader"), a = l.find("#fr-image-list"), c = l.find("#fr-modal-tags"), h = S(), R(), d.css("height", d.find(".fr-modal-head-line").outerHeight()), s.events.$on(Te(s.o_win), "resize", function() {
                        x(!!o)
                    }), s.helpers.isMobile() && (s.events.bindClick(a, "div.fr-image-container", function(e) {
                        l.find(".fr-mobile-selected").removeClass("fr-mobile-selected"), Te(e.currentTarget).addClass("fr-mobile-selected")
                    ...
                    }), r.on("scroll", y), s.events.bindClick(l, "#fr-modal-more-" + s.sid, D), s.events.bindClick(c, "a", M)), i.show(), a.find(".fr-list-column").empty(), s.opts.imageManagerLoadURL ? Te.ajax({
        ...
        }, !Te.FE.PLUGINS.image) throw new Error("Image manager plugin requires image plugin.");
    Te.FE.DEFAULTS.imageInsertButtons.push("imageManager"), Te.FE.RegisterCommand("imageManager", {
        title: "Browse",
        undo: !1,
        focus: !1,
        modal: !0,
        ...
        plugin: "imageManager"
    }), Te.FE.DefineIcon("imageManager", {
        NAME: "folder"
    }), Te.FE.DefineIcon("imageManagerInsert", {
        NAME: "plus"
    }), Te.FE.DefineIcon("imageManagerDelete", {
        NAME: "trash"
    }), Te.extend(Te.FE.DEFAULTS, {
        inlineClasses: {
            "fr-class-code": "Code",
    ...
    }), Te.FE.PLUGINS.inlineClass = function(n) {
        return {
            apply: function(e) {
    ...
    }, Te.FE.RegisterCommand("inlineClass", {
        type: "dropdown",
        title: "Inline Class",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
    ...
    }), Te.FE.PLUGINS.inlineStyle = function(i) {
        return {
            apply: function(e) {
    ...
    }, Te.FE.RegisterCommand("inlineStyle", {
        type: "dropdown",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
        ...
        function s(e, t) {
            ...
            else if (null == t)(s = (a = e.parent()).offset().top + a.outerHeight()) < (d = e.offset().top + e.outerHeight()) && (s = (a = Te(a).parent()).offset().top + a.outerHeight()), n = d + Math.min(Math.abs(s - d) / 2, p.opts.lineBreakerOffset), i = a.outerWidth(), r = a.offset().left;
            else {
                a = e.parent();
        ...
        function l(e) {
            if (e) {
                ...
                if (0 < t.parents(p.opts.lineBreakerTags.join(",")).length) return e = t.parents(p.opts.lineBreakerTags.join(",")).get(0), 0 !== p.$el.find(e).length && Te(e).is(p.opts.lineBreakerTags.join(",")) ? Te(e) : null
            }
            return null
        }
        ...
        function a(e, t) {
            ...
            return n && !Te(n).closest(".fr-line-breaker").length && !p.node.isElement(n) && n != p.$wp.get(0) && function(e) {
        ...
        return {
            _init: function() {
                ...
                p.shared.$line_breaker || (p.shared.$line_breaker = Te('<div class="fr-line-breaker"><a class="fr-floating-btn" role="button" tabIndex="-1" title="' + p.language.translate("Break") + '"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><rect x="21" y="11" width="2" height="8"/><rect x="14" y="17" width="7" height="2"/><path d="M14.000,14.000 L14.000,22.013 L9.000,18.031 L14.000,14.000 Z"/></svg></a></div>')), u = p.shared.$line_breaker, p.events.on("shared.destroy", function() {
                    ...
                    e.stopPropagation()
                }, !0), p.events.bindClick(u, "a", h), t = !1, p.events.$on(p.$win, "mousemove", e), p.events.$on(Te(p.win), "scroll", r), p.events.on("popups.show.table.edit", r), p.events.on("commands.after", r), p.events.$on(Te(p.win), "mousedown", c), p.events.$on(Te(p.win), "mouseup", f)
            }
        }
    }, Te.extend(Te.FE.DEFAULTS, {
        lineHeights: {
    ...
    }), Te.FE.PLUGINS.lineHeight = function(i) {
        return {
            _init: function() {},
            apply: function(e) {
                i.selection.save(), i.html.wrap(!0, !0, !0, !0), i.selection.restore();
                var t = i.selection.blocks();
                t.length && Te(t[0]).parent().is("td") && i.format.applyStyle("line-height", e.toString()), i.selection.save();
                for (var n = 0; n < t.length; n++) Te(t[n]).css("line-height", e), "" === Te(t[n]).attr("style") && Te(t[n]).removeAttr("style");
    ...
    }, Te.FE.RegisterCommand("lineHeight", {
        type: "dropdown",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
        ...
        function p() {
            ...
            if (!e && f.$wp) {
                ...
                "A" == n.tagName || f.node.isElement(n) || (n = Te(n).parentsUntil(f.$el, "a:first").get(0)), "A" == r.tagName || f.node.isElement(r) || (r = Te(r).parentsUntil(f.$el, "a:first").get(0));
                try {
                        ...
                        if (e && !t) {
                            if (f.image) {
                                ...
                                if (1 == n.length && "IMG" == n[0].tagName) {
                                    ...
                                    return 0 === r.startOffset && 0 === r.endOffset ? Te(e).before(Te.FE.MARKERS) : Te(e).after(Te.FE.MARKERS), f.selection.restore(), !1
                                }
                            }
        ...
        function a(e) {
            ...
            var r = n.offset().left + Te(e).outerWidth() / 2,
                i = n.offset().top + n.outerHeight();
        ...
        function d() {
            ...
            if (t) {
                ...
                for (n = 0; n < a.length; n++)(r = Te(a[n])).val(i.attr(r.attr("name") || ""));
                for (o.prop("checked", !1), n = 0; n < o.length; n++) r = Te(o[n]), i.attr(r.attr("name")) == r.data("checked") && r.prop("checked", !0);
        ...
        function c(e, t, n) {
            ...
            if ("" === f.opts.linkAutoPrefix || new RegExp("^(" + Te.FE.LinkProtocols.join("|") + "):.", "i").test(e) || /^data:image.*/i.test(e) || /^(https?:|ftps?:|file:|)\/\//i.test(e) || /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) || ["/", "{", "[", "#", "(", "."].indexOf((e || "")[0]) < 0 && (e = f.opts.linkAutoPrefix + f.helpers.sanitizeURL(e)), e = f.helpers.sanitizeURL(e), f.opts.linkAlwaysBlank && (n.target = "_blank"), f.opts.linkAlwaysNoFollow && (n.rel = "nofollow"), f.helpers.isEmail(i) && (n.target = null, n.rel = null), "_blank" == n.target ? (f.opts.linkNoOpener && (n.rel ? n.rel += " noopener" : n.rel = "noopener"), f.opts.linkNoReferrer && (n.rel ? n.rel += " noreferrer" : n.rel = "noreferrer")) : null == n.target && (n.rel ? n.rel = n.rel.replace(/noopener/, "").replace(/noreferrer/, "") : n.rel = null), t = t || "", e === f.opts.linkAutoPrefix) return f.popups.get("link.insert").find('input[name="href"]').addClass("fr-error"), f.events.trigger("link.bad", [i]), !1;
            var a, o = p();
            if (o) {
                if ((a = Te(o)).attr("href", e), 0 < t.length && a.text() != t && !r) {
                    for (var s = a.get(0); 1 === s.childNodes.length && s.childNodes[0].nodeType == Node.ELEMENT_NODE;) s = s.childNodes[0];
                    Te(s).text(t)
                }
                r || a.prepend(Te.FE.START_MARKER).append(Te.FE.END_MARKER), a.attr(n), r || f.selection.restore()
            } else {
                r ? (r.wrap('<a href="' + e + '"></a>'), f.image.hasCaption() && r.parent().append(r.parents(".fr-img-caption").find(".fr-inner"))) : (f.format.remove("a"), f.selection.isCollapsed() ? (t = 0 === t.length ? i : t, f.html.insert('<a href="' + e + '">' + Te.FE.START_MARKER + t.replace(/&/g, "&amp;").replace(/</, "&lt;", ">", "&gt;") + Te.FE.END_MARKER + "</a>"), f.selection.restore()) : 0 < t.length && t != f.selection.text().replace(/\n/g, "") ? (f.selection.remove(), f.html.insert('<a href="' + e + '">' + Te.FE.START_MARKER + t.replace(/&/g, "&amp;") + Te.FE.END_MARKER + "</a>"), f.selection.restore()) : (! function() {
                ...
                for (var l = u(), d = 0; d < l.length; d++)(a = Te(l[d])).attr(n), a.removeAttr("_moz_dirty");
                1 == l.length && f.$wp && !r && (Te(l[0]).prepend(Te.FE.START_MARKER).append(Te.FE.END_MARKER), f.selection.restore())
            }
            if (r) {
        ...
        function g() {
            ...
            if (e) {
                ...
                var n = (f.image ? f.image.get() : null) || Te(e),
        ...
        return {
            ...
            remove: function() {
                ...
                t && e ? (t.unwrap(), f.image.edit(t)) : e && (f.selection.save(), Te(e).replaceWith(Te(e).html()), f.selection.restore(), o())
            },
            showInsertPopup: function() {
                ...
                if (t || (t = s()), !t.hasClass("fr-active"))
                    if (f.popups.refresh("link.insert"), f.popups.setContainer("link.insert", f.$tb || f.$sc), e.is(":visible")) {
                        var n = e.offset().left + e.outerWidth() / 2,
                            r = f.position.getTbarPupupTop("link.insert", e);
                        f.popups.show("link.insert", n, r, e.outerHeight())
            ...
            usePredefined: function(e) {
                ...
                for (r.rel && (i.rel = r.rel), n = 0; n < a.length; n++) r[(t = Te(a[n])).attr("name")] ? t.val(r[t.attr("name")]) : "text" != t.attr("name") && t.val("");
                for (n = 0; n < o.length; n++)(t = Te(o[n])).prop("checked", t.data("checked") == r[t.attr("name")]);
            ...
            insertCallback: function() {
                var e, t, n = f.popups.get("link.insert"),
                    ...
                    s = {};
                for (t = 0; t < r.length; t++) e = Te(r[t]), ["href", "text"].indexOf(e.attr("name")) < 0 && (s[e.attr("name")] = e.val());
                for (t = 0; t < i.length; t++)(e = Te(i[t])).is(":checked") ? s[e.attr("name")] = e.data("checked") : s[e.attr("name")] = e.data("unchecked") || null;
                n.rel && (s.rel = n.rel);
                var l = f.helpers.scrollTop();
                c(a, o, s), Te(f.o_win).scrollTop(l)
            },
            insert: c,
            update: g,
            get: p,
            ...
            applyStyle: function(e, t, n) {
                ...
                Te(r).toggleClass(e), h()
            }
        }
    }, Te.FE.DefineIcon("insertLink", {
        NAME: "link"
    }), Te.FE.RegisterShortcut(Te.FE.KEYCODE.K, "insertLink", null, "K"), Te.FE.RegisterCommand("insertLink", {
        title: "Insert Link",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
        ...
        plugin: "link"
    }), Te.FE.DefineIcon("linkOpen", {
        NAME: "external-link",
        FA5NAME: "external-link-alt"
    }), Te.FE.RegisterCommand("linkOpen", {
        title: "Open Link",
        undo: !1,
        refresh: function(e) {
        ...
        plugin: "link"
    }), Te.FE.DefineIcon("linkEdit", {
        NAME: "edit"
    }), Te.FE.RegisterCommand("linkEdit", {
        title: "Edit Link",
        undo: !1,
        refreshAfterCallback: !1,
        popup: !0,
        ...
        plugin: "link"
    }), Te.FE.DefineIcon("linkRemove", {
        NAME: "unlink"
    }), Te.FE.RegisterCommand("linkRemove", {
        title: "Unlink",
        callback: function() {
            this.link.remove()
        },
        ...
        plugin: "link"
    }), Te.FE.DefineIcon("linkBack", {
        NAME: "arrow-left"
    }), Te.FE.RegisterCommand("linkBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        plugin: "link"
    }), Te.FE.DefineIcon("linkList", {
        NAME: "search"
    }), Te.FE.RegisterCommand("linkList", {
        title: "Choose Link",
        type: "dropdown",
        focus: !1,
        undo: !1,
        ...
        plugin: "link"
    }), Te.FE.RegisterCommand("linkInsert", {
        focus: !1,
        refreshAfterCallback: !1,
        callback: function() {
        ...
        plugin: "link"
    }), Te.FE.DefineIcon("imageLink", {
        NAME: "link"
    }), Te.FE.RegisterCommand("imageLink", {
        title: "Insert Link",
        undo: !1,
        focus: !1,
        popup: !0,
        ...
        plugin: "link"
    }), Te.FE.DefineIcon("linkStyle", {
        NAME: "magic"
    }), Te.FE.RegisterCommand("linkStyle", {
        title: "Style",
        type: "dropdown",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
        ...
        listAdvancedTypes: !0
    }), Te.FE.PLUGINS.lists = function(f) {
        function p(e) {
        ...
        function i(e, t) {
            ...
            var n, r = f.html.defaultTag(),
                i = null;
            e.length && (n = "rtl" == f.opts.direction || "rtl" == Te(e[0]).css("direction") ? "margin-right" : "margin-left");
            for (var a = 0; a < e.length; a++)
                if ("TD" != e[a].tagName && "TH" != e[a].tagName && "LI" != e[a].tagName) {
                    var o = f.helpers.getPX(Te(e[a]).css(n)) || 0;
                    (e[a].style.marginLeft = null) === i && (i = o);
                    var s = 0 < i ? "<" + t + ' style="' + n + ": " + i + 'px;">' : "<" + t + ">",
                        l = "</" + t + ">";
                    for (o -= i; 0 < o / f.opts.indentMargin;) s += "<" + t + ">", l += l, o -= f.opts.indentMargin;
                    r && e[a].tagName.toLowerCase() == r ? Te(e[a]).replaceWith(s + "<li" + f.node.attributes(e[a]) + ">" + Te(e[a]).html() + "</li>" + l) : Te(e[a]).wrap(s + "<li></li>" + l)
                } f.clean.lists()
        }
        ...
        function a(e) {
            ...
            for (t = e.length - 1; 0 <= t; t--)
                for (n = t - 1; 0 <= n; n--)
                    if (Te(e[n]).find(e[t]).length || e[n] == e[t]) {
                        e.splice(t, 1);
                        break
                    } var r = [];
            for (t = 0; t < e.length; t++) {
                ...
                if (i.before(u(a.tagName)), "LI" == a.parentNode.tagName) i.before(u("LI")), i.after(p("LI"));
                    ...
                    f.helpers.getPX(Te(a).css(l)) && 0 <= (Te(a).attr("style") || "").indexOf(l + ":") && (s += ' style="' + l + ":" + f.helpers.getPX(Te(a).css(l)) + 'px;"'), f.html.defaultTag() && 0 === i.find(f.html.blockTagsQuery()).length && i.wrapInner("<" + f.html.defaultTag() + s + "></" + f.html.defaultTag() + ">"), f.node.isEmpty(i.get(0), !0) || 0 !== i.find(f.html.blockTagsQuery()).length || i.append("<br>"), i.append(p("LI")), i.prepend(u("LI"))
                }
        ...
        function o(e) {
            ...
            for (var t = 0; t < e.length; t++) {
                ...
                if (n) {
                    var r = Te(e[t]).find("> ul, > ol").last().get(0);
                    if (r) {
                        for (var i = Te("<li>").prependTo(Te(r)), a = f.node.contents(e[t])[0]; a && !f.node.isList(a);) {
                            var o = a.nextSibling;
                            i.append(a), a = o
                        }
                        Te(n).append(Te(r)), Te(e[t]).remove()
                    } else {
                        var s = Te(n).find("> ul, > ol").last().get(0);
                        if (s) Te(s).append(Te(e[t]));
                        else {
                            var l = Te("<" + e[t].parentNode.tagName + ">");
                            Te(n).append(l), l.append(Te(e[t]))
                        }
                    }
                }
            }
        ...
        function e(e) {
            if ("indent" == e || "outdent" == e) {
                var t = !1,
                    ...
                    r = [],
                    i = n[0].previousSibling || n[0].parentElement;
                if ("outdent" == e) {
                    if ("LI" == i.tagName || "LI" != i.parentNode.tagName) return
                } else if (!n[0].previousSibling || "LI" != n[0].previousSibling.tagName) return;
                for (var a = 0; a < n.length; a++) "LI" == n[a].tagName ? (t = !0, r.push(n[a])) : "LI" == n[a].parentNode.tagName && (t = !0, r.push(n[a].parentNode));
                t && ("indent" == e ? o(r) : s(r))
            }
        }
        return {
            ...
            format: function(e, t) {
                ...
                if (f.selection.save(), function(e, t) {
                    ...
                    for (n = 0; n < r.length; n++) "LI" == r[n].tagName && (Te(r[n].parentNode).css("list-style-type", "default" === t ? "" : t), 0 === (Te(r[n].parentNode).attr("style") || "").length && Te(r[n].parentNode).removeAttr("style"))
                }
            },
            refresh: function(e, t) {
                var n = Te(f.selection.element());
                if (n.get(0) != f.el) {
                    var r = n.get(0);
    ...
    }, Te.FE.RegisterCommand("formatUL", {
        ...
        plugin: "lists"
    }), Te.FE.RegisterCommand("formatOL", {
        title: "Ordered List",
        hasOptions: function() {
            return this.opts.listAdvancedTypes
        },
        ...
        plugin: "lists"
    }), Te.FE.DefineIcon("formatUL", {
        NAME: "list-ul"
    }), Te.FE.DefineIcon("formatOL", {
        NAME: "list-ol"
    }), Te.extend(Te.FE.DEFAULTS, {
        paragraphFormat: {
            N: "Normal",
    ...
    }), Te.FE.PLUGINS.paragraphFormat = function(p) {
        function u(e, t) {
        ...
        return {
            apply: function(e) {
                ...
                for (var c = 0; c < d.length; c++)
                    ...
                    Te(this).prev().append("<br>" + Te(this).html()), Te(this).remove()
    ...
    }, Te.FE.RegisterCommand("paragraphFormat", {
        type: "dropdown",
        displaySelection: function(e) {
    ...
    }), Te.FE.DefineIcon("paragraphFormat", {
        NAME: "paragraph"
    }), Te.extend(Te.FE.DEFAULTS, {
        paragraphStyles: {
            "fr-text-gray": "Gray",
    ...
    }), Te.FE.PLUGINS.paragraphStyle = function(s) {
        return {
            _init: function() {},
            apply: function(e, t, n) {
                ...
                s.selection.save();
                for (var a = Te(i[0]).hasClass(e), o = 0; o < i.length; o++) Te(i[o]).removeClass(r).toggleClass(e, !a), Te(i[o]).hasClass("fr-temp-div") && Te(i[o]).removeClass("fr-temp-div"), "" === Te(i[o]).attr("class") && Te(i[o]).removeAttr("class");
    ...
    }, Te.FE.RegisterCommand("paragraphStyle", {
        type: "dropdown",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
    ...
    }), Te.FE.DefineIcon("paragraphStyle", {
        NAME: "magic"
    }), Te.extend(Te.FE.DEFAULTS, {
        html2pdf: window.html2pdf
    }), Te.FE.PLUGINS.print = function(s) {
        return {
            run: function() {
                ! function(e) {
                    var t = s.$el.html(),
                    ...
                    }), i.document.write('</head><body style="height:auto;text-align: ' + ("rtl" == s.opts.direction ? "right" : "left") + "; direction: " + s.opts.direction + "; " + (s.opts.documentReady ? " padding: 2cm; width: 17cm; margin: 0;" : "") + '"><div class="fr-view">'), i.document.write(t), i.document.write("</div></body></html>"), i.document.close()
                }(function() {
                    setTimeout(function() {
    ...
    }, Te.FE.DefineIcon("print", {
        NAME: "print"
    }), Te.FE.RegisterCommand("print", {
        title: "Print",
        undo: !1,
        focus: !1,
        plugin: "print",
    ...
    }), Te.FE.DefineIcon("getPDF", {
        NAME: "file-pdf-o",
        FA5NAME: "file-pdf"
    }), Te.FE.RegisterCommand("getPDF", {
        title: "Download PDF",
        type: "button",
        focus: !1,
        undo: !1,
    ...
    }), Te.FE.QUICK_INSERT_BUTTONS = {}, Te.FE.DefineIcon("quickInsert", {
        ...
        template: "svg"
    }), Te.FE.RegisterQuickInsertButton = function(e, t) {
        Te.FE.QUICK_INSERT_BUTTONS[e] = Te.extend({
            undo: !0
        }, t)
    }, Te.FE.RegisterQuickInsertButton("image", {
        icon: "insertImage",
        ...
        callback: function() {
            var e = this;
            e.shared.$qi_image_input || (e.shared.$qi_image_input = Te('<input accept="image/' + e.opts.imageAllowedTypes.join(", image/").toLowerCase() + '" name="quickInsertImage' + this.id + '" style="display: none;" type="file">'), Te("body:first").append(e.shared.$qi_image_input), e.events.$on(e.shared.$qi_image_input, "change", function() {
                var e = Te(this).data("inst");
                this.files && (e.quickInsert.hide(), e.image.upload(this.files)), Te(this).val("")
    ...
    }), Te.FE.RegisterQuickInsertButton("video", {
        icon: "insertVideo",
    ...
    }), Te.FE.RegisterQuickInsertButton("embedly", {
        icon: "embedly",
    ...
    }), Te.FE.RegisterQuickInsertButton("table", {
        icon: "insertTable",
    ...
    }), Te.FE.RegisterQuickInsertButton("ol", {
        icon: "formatOL",
    ...
    }), Te.FE.RegisterQuickInsertButton("ul", {
        icon: "formatUL",
        requiredPlugin: "lists",
        title: "Unordered List",
        callback: function() {
    ...
    }), Te.FE.RegisterQuickInsertButton("hr", {
        icon: "insertHR",
        title: "Insert Horizontal Line",
        callback: function() {
            this.commands.insertHR()
        }
    }), Te.FE.PLUGINS.quickInsert = function(o) {
        var s, l;
        ...
        function n(e) {
            s || function() {
                o.shared.$quick_insert || (o.shared.$quick_insert = Te('<div class="fr-quick-insert"><a class="fr-floating-btn" role="button" tabIndex="-1" title="' + o.language.translate("Quick Insert") + '">' + o.icon.create("quickInsert") + "</a></div>"));
                s = o.shared.$quick_insert, o.tooltip.bind(o.$box, ".fr-quick-insert > a.fr-floating-btn"), o.events.on("destroy", function() {
                    s.removeClass("fr-on").appendTo(Te("body:first")).css("left", -9999).css("top", -9999), l && (d(), l.appendTo(Te("body:first")))
                    ...
                    var t = Te(e.currentTarget).data("cmd");
                    if (!1 === o.events.trigger("quickInsert.commands.before", [t])) return !1;
                    Te.FE.QUICK_INSERT_BUTTONS[t].callback.apply(o, [e.currentTarget]), Te.FE.QUICK_INSERT_BUTTONS[t].undo && o.undo.saveStep(), o.events.trigger("quickInsert.commands.after", [t]), o.quickInsert.hide()
        ...
        function r() {
            if (o.core.hasFocus()) {
                var e = o.selection.element();
                if (o.opts.enter == Te.FE.ENTER_BR || o.node.isBlock(e) || (e = o.node.blockParent(e)), o.opts.enter == Te.FE.ENTER_BR && !o.node.isBlock(e)) {
                    var t = o.node.deepestParent(e);
                    t && (e = t)
                }
                e && (o.opts.enter != Te.FE.ENTER_BR && o.node.isEmpty(e) && 0 <= o.opts.quickInsertTags.indexOf(e.tagName.toLowerCase()) || o.opts.enter == Te.FE.ENTER_BR && ("BR" == e.tagName && (!e.previousSibling || "BR" == e.previousSibling.tagName || o.node.isBlock(e.previousSibling)) || o.node.isEmpty(e) && (!e.previousSibling || "BR" == e.previousSibling.tagName || o.node.isBlock(e.previousSibling)) && (!e.nextSibling || "BR" == e.nextSibling.tagName || o.node.isBlock(e.nextSibling)))) ? s && s.data("tag").is(Te(e)) && s.hasClass("fr-on") ? d() : o.selection.isCollapsed() && n(Te(e)) : i()
            }
        }
            ...
            if (e && e.preventDefault(), s.hasClass("fr-on") && !s.hasClass("fr-hidden")) d();
                ...
                if (!o.shared.$qi_helper) {
                    for (var t = o.opts.quickInsertButtons, n = '<div class="fr-qi-helper">', r = 0, i = 0; i < t.length; i++) {
                        var a = Te.FE.QUICK_INSERT_BUTTONS[t[i]];
                        a && (!a.requiredPlugin || Te.FE.PLUGINS[a.requiredPlugin] && 0 <= o.opts.pluginsEnabled.indexOf(a.requiredPlugin)) && (n += '<a class="fr-btn fr-floating-btn" role="button" title="' + o.language.translate(a.title) + '" tabIndex="-1" data-cmd="' + t[i] + '" style="transition-delay: ' + .025 * r++ + 's;">' + o.icon.create(a.icon) + "</a>")
                    }
                    n += "</div>", o.shared.$qi_helper = Te(n), o.tooltip.bind(o.shared.$qi_helper, "> a.fr-btn"), o.events.$on(o.shared.$qi_helper, "mousedown", function(e) {
                        e.preventDefault()
                    }, !0)
        ...
        return {
            _init: function() {
                ...
                o.popups.onShow("image.edit", i), o.events.on("mouseup", r), o.helpers.isMobile() && o.events.$on(Te(o.o_doc), "selectionchange", r), o.events.on("blur", i), o.events.on("keyup", r), o.events.on("keydown", function() {
                    setTimeout(function() {
                        r()
                    }, 0)
                })
    ...
    }, Te.FE.PLUGINS.quote = function(r) {
        function i(e) {
        ...
        return {
            apply: function(e) {
                r.selection.save(), r.html.wrap(!0, !0, !0, !0), r.selection.restore(), "increase" == e ? function() {
                    ...
                    var e, t = r.selection.blocks();
                    for (e = 0; e < t.length; e++) "BLOCKQUOTE" != t[e].tagName && (t[e] = Te(t[e]).parentsUntil(r.$el, "BLOCKQUOTE").get(0));
                    for (r.selection.save(), e = 0; e < t.length; e++) t[e] && Te(t[e]).replaceWith(t[e].innerHTML);
                    r.html.unwrap(), r.selection.restore()
                }()
            }
        }
    }, Te.FE.RegisterShortcut(Te.FE.KEYCODE.SINGLE_QUOTE, "quote", "increase", "'"), Te.FE.RegisterShortcut(Te.FE.KEYCODE.SINGLE_QUOTE, "quote", "decrease", "'", !0), Te.FE.RegisterCommand("quote", {
        title: "Quote",
        type: "dropdown",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
    ...
    }, Te.FE.DefineIcon("save", {
        NAME: "floppy-o",
        FA5NAME: "save"
    }), Te.FE.RegisterCommand("save", {
        title: "Save",
        undo: !1,
        focus: !1,
        refreshAfterCallback: !1,
    ...
    }), Te.FE.PLUGINS.specialCharacters = function(s) {
        ...
        return {
            ...
            show: function() {
                if (!o) {
                    ...
                    o = n.$modal, n.$head, l = n.$body, s.events.$on(Te(s.o_win), "resize", function() {
                        ...
                        if (!(n.length || t != Te.FE.KEYCODE.F10 || s.keys.ctrlKey(e) || e.shiftKey) && e.altKey) return d(l.find("span.fr-special-character:first"), e), !1;
                        if (t == Te.FE.KEYCODE.TAB || t == Te.FE.KEYCODE.ARROW_LEFT || t == Te.FE.KEYCODE.ARROW_RIGHT) {
                            var r = null,
                                i = null,
                                a = !1;
                            return t == Te.FE.KEYCODE.ARROW_LEFT || t == Te.FE.KEYCODE.ARROW_RIGHT ? (i = t == Te.FE.KEYCODE.ARROW_RIGHT, a = !0) : i = !e.shiftKey, n.length ? (a && (r = i ? n.nextAll("span.fr-special-character:first") : n.prevAll("span.fr-special-character:first")), r && r.length || (r = i ? n.parent().next().find("span.fr-special-character:first") : n.parent().prev().find("span.fr-special-character:" + (a ? "last" : "first"))).length || (r = l.find("span.fr-special-character:" + (i ? "first" : "last")))) : r = l.find("span.fr-special-character:" + (i ? "first" : "last")), d(r, e), !1
                        }
                        if (t != Te.FE.KEYCODE.ENTER || !n.length) return !0;
    ...
    }, Te.FroalaEditor.DefineIcon("specialCharacters", {
        template: "text",
        NAME: "&#937;"
    }), Te.FE.RegisterCommand("specialCharacters", {
    ...
    }), Te.FE.PLUGINS.table = function(T) {
        var A, s, i, a, r, o, b;
            ...
            if (i) {
                ...
                a || (a = function() {
                    ...
                    return T.events.$on(T.$wp, "scroll.table-colors", function() {
                        ...
                        } else Te.FE.KEYCODE.ENTER == n && (T.button.exec(t), r = !1);
                        return !1 === r && (e.preventDefault(), e.stopPropagation()), r
                    }, !0), r;
                    var h
        ...
        function c(e) {
            ...
            return T.events.$on(i, "mouseenter", ".fr-table-size .fr-select-table-size .fr-table-cell", function(e) {
                ...
                var n, r = e.which;
                if (Te.FE.KEYCODE.ARROW_UP == r || Te.FE.KEYCODE.ARROW_DOWN == r || Te.FE.KEYCODE.ARROW_LEFT == r || Te.FE.KEYCODE.ARROW_RIGHT == r) {
                    if (t.is("span.fr-table-cell")) {
                        var i = t.parent().find("span.fr-table-cell"),
                            ...
                            s = a % o,
                            l = Math.floor(a / o);
                        Te.FE.KEYCODE.ARROW_UP == r ? l = Math.max(0, l - 1) : Te.FE.KEYCODE.ARROW_DOWN == r ? l = Math.min(T.opts.tableInsertMaxSize - 1, l + 1) : Te.FE.KEYCODE.ARROW_LEFT == r ? s = Math.max(0, s - 1) : Te.FE.KEYCODE.ARROW_RIGHT == r && (s = Math.min(T.opts.tableInsertMaxSize - 1, s + 1));
                        var d = l * o + s,
                            c = Te(i.get(d));
                        f(c), T.events.disableBlur(), c.focus(), n = !1
                    }
                } else Te.FE.KEYCODE.ENTER == r && (T.button.exec(t), n = !1);
                return !1 === n && (e.preventDefault(), e.stopPropagation()), n
            }, !0), i
        }
        ...
        function g(e) {
            ...
            if (0 < t.length) {
                ...
                for (n = 0; n < a[r].length; n++) {
                    ...
                    } else s += '<td style="' + Te(a[r][n]).attr("style") + '" ><br></td>'
                }
                s += "</tr>", i = 0 < T.$el.find("th.fr-selected-cell").length && "below" == e ? Te(t.find("tbody").not(t.find("table tbody"))) : Te(t.find("tr").not(t.find("table tr")).get(r)), "below" == e ? "TBODY" == i.prop("tagName") ? i.prepend(s) : i.after(s) : "above" == e && (i.before(s), T.popups.isVisible("table.edit") && u())
            }
        }
        ...
        function S(e) {
            ...
            return null == (e = e || null) && 0 < Q().length && (e = Z()), e && e.find("tr:visible").not(e.find("table tr")).each(function(s, e) {
                ...
                t.find("> th, > td").each(function(e, t) {
                    for (var n = Te(t), r = parseInt(n.attr("colspan"), 10) || 1, i = parseInt(n.attr("rowspan"), 10) || 1, a = s; a < s + i; a++)
        ...
        function w(e) {
            var t = x(e),
                n = Te(e[t.min_i][t.min_j]),
                r = Te(e[t.min_i][t.max_j]),
                i = Te(e[t.max_i][t.min_j]);
            return {
                left: n.length && n.offset().left,
                right: r.length && r.offset().left + r.outerWidth(),
                top: n.length && n.offset().top,
                bottom: i.length && i.offset().top + i.outerHeight()
            }
        }

        function O(t, n) {
            if (Te(t).is(n)) _(), Te(t).addClass("fr-selected-cell");
            else {
                N(), T.edit.off();
                var r = S(),
                    i = R(t, r),
                    ...
                    o = function e(t, n, r, i, a) {
                        var o, s, l, d, c = t,
                            ...
                            p = r,
                            u = i;
                        for (o = c; o <= f; o++)(1 < (parseInt(Te(a[o][p]).attr("rowspan"), 10) || 1) || 1 < (parseInt(Te(a[o][p]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[o][p], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u)), (1 < (parseInt(Te(a[o][u]).attr("rowspan"), 10) || 1) || 1 < (parseInt(Te(a[o][u]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[o][u], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u));
                        for (s = p; s <= u; s++)(1 < (parseInt(Te(a[c][s]).attr("rowspan"), 10) || 1) || 1 < (parseInt(Te(a[c][s]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[c][s], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u)), (1 < (parseInt(Te(a[f][s]).attr("rowspan"), 10) || 1) || 1 < (parseInt(Te(a[f][s]).attr("colspan"), 10) || 1)) && (d = y((l = R(a[f][s], a)).row, l.col, a), c = Math.min(l.row, c), f = Math.max(d.row, f), p = Math.min(l.col, p), u = Math.max(d.col, u));
                ...
                _(), t.classList.add("fr-cell-fixed"), n.classList.add("fr-cell-handler");
                for (var s = o.min_i; s <= o.max_i; s++)
                    for (var l = o.min_j; l <= o.max_j; l++) Te(r[s][l]).addClass("fr-selected-cell")
            }
        }
        ...
        function I(e) {
            var t = null,
                n = Te(e.target);
            return "TD" == e.target.tagName || "TH" == e.target.tagName ? t = e.target : 0 < n.closest("td", n.closest("tr")[0]).length ? t = n.closest("td", n.closest("tr")[0]).get(0) : 0 < n.closest("th", n.closest("thead")[0]).length && (t = n.closest("th", n.closest("thead")[0]).get(0)), 0 === T.$el.find(t).length ? null : t
        }

        function k() {
            _(), T.popups.hide("table.edit")
        }

        function e(e) {
            var t = I(e);
            if ("false" == Te(t).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable")) return !0;
            if (0 < Q().length && !t && k(), !T.edit.isDisabled() || T.popups.isVisible("table.edit"))
                if (1 != e.which || 1 == e.which && T.helpers.isMac() && e.ctrlKey)(3 == e.which || 1 == e.which && T.helpers.isMac() && e.ctrlKey) && t && k();
                else if (a = !0, t) {
                0 < Q().length && !e.shiftKey && k(), e.stopPropagation(), T.events.trigger("image.hideResizer"), T.events.trigger("video.hideResizer"), i = !0;
                var n = t.tagName.toLowerCase();
                e.shiftKey && 0 < T.$el.find(n + ".fr-selected-cell").length ? Te(T.$el.find(n + ".fr-selected-cell").closest("table")).is(Te(t).closest("table")) ? O(r, t) : N() : ((T.keys.ctrlKey(e) || e.shiftKey) && (1 < Q().length || 0 === Te(t).find(T.selection.element()).length && !Te(t).is(T.selection.element())) && N(), r = t, 0 < T.opts.tableEditButtons.length && O(r, r))
            }
        }

        function n(e) {
            if (T.popups.areVisible()) return !0;
            if (i || T.$tb.is(e.target) || T.$tb.is(Te(e.target).closest(T.$tb.get(0))) || (0 < Q().length && T.toolbar.enable(), _()), !(1 != e.which || 1 == e.which && T.helpers.isMac() && e.ctrlKey)) {
                if (a = !1, i) i = !1, I(e) || 1 != Q().length ? 0 < Q().length && (T.selection.isCollapsed() ? u() : (_(), T.edit.on())) : (_(), T.edit.on());
                if (b) {
                            ...
                            if (e !== t) {
                                ...
                                if (T.undo.canDo() || T.undo.saveStep(), null !== n && null !== r) {
                                    var o, s, l, d = S(i),
                                        ...
                                        p = [],
                                        u = [];
                                    for (o = 0; o < d.length; o++) s = Te(d[o][n]), l = Te(d[o][r]), c[o] = s.outerWidth(), p[o] = l.outerWidth(), f[o] = c[o] / a * 100, u[o] = p[o] / a * 100;
                                    for (o = 0; o < d.length; o++)
                                        if (s = Te(d[o][n]), l = Te(d[o][r]), d[o][n] != d[o][r]) {
        ...
        function D(e) {
            if (!0 === i && 0 < T.opts.tableEditButtons.length) {
                if (Te(e.currentTarget).closest("table").is(Z())) {
        ...
        function U(e, t) {
            ...
            if (t && "TD" != t.tagName && "TH" != t.tagName && (0 < n.closest("td").length ? t = n.closest("td") : 0 < n.closest("th").length && (t = n.closest("th"))), !t || "TD" != t.tagName && "TH" != t.tagName) A && n.get(0) != A.get(0) && n.parent().get(0) != A.get(0) && T.core.sameInstance(A) && B();
                ...
                if (n = Te(t), 0 === T.$el.find(n).length) return !1;
                ...
                if (Math.abs(e.pageX - a) <= T.opts.tableResizerOffset || Math.abs(o - e.pageX) <= T.opts.tableResizerOffset) {
                    ...
                    "rtl" != T.opts.direction ? e.pageX - a <= T.opts.tableResizerOffset ? (d = a, 0 < u.col ? (c = a - Y(u.col - 1, p) + T.opts.tableResizingLimit, f = a + Y(u.col, p) - T.opts.tableResizingLimit, s = u.col - 1, l = u.col) : (s = null, l = 0, c = r.offset().left - 1 - parseInt(r.css("margin-left"), 10), f = r.offset().left - 1 + r.width() - p[0].length * T.opts.tableResizingLimit)) : o - e.pageX <= T.opts.tableResizerOffset && (d = o, h.col < p[h.row].length && p[h.row][h.col + 1] ? (c = o - Y(h.col, p) + T.opts.tableResizingLimit, f = o + Y(h.col + 1, p) - T.opts.tableResizingLimit, s = h.col, l = h.col + 1) : (s = h.col, l = null, c = r.offset().left - 1 + p[0].length * T.opts.tableResizingLimit, f = i.offset().left - 1 + i.width() + parseFloat(i.css("padding-left")))) : o - e.pageX <= T.opts.tableResizerOffset ? (d = o, 0 < u.col ? (c = o - Y(u.col, p) + T.opts.tableResizingLimit, f = o + Y(u.col - 1, p) - T.opts.tableResizingLimit, s = u.col, l = u.col - 1) : (s = null, l = 0, c = r.offset().left + p[0].length * T.opts.tableResizingLimit, f = i.offset().left - 1 + i.width() + parseFloat(i.css("padding-left")))) : e.pageX - a <= T.opts.tableResizerOffset && (d = a, h.col < p[h.row].length && p[h.row][h.col + 1] ? (c = a - Y(h.col + 1, p) + T.opts.tableResizingLimit, f = a + Y(h.col, p) - T.opts.tableResizingLimit, s = h.col + 1, l = h.col) : (s = h.col, l = null, c = i.offset().left + parseFloat(i.css("padding-left")), f = r.offset().left - 1 + r.width() - p[0].length * T.opts.tableResizingLimit)), A || (T.shared.$table_resizer || (T.shared.$table_resizer = Te('<div class="fr-table-resizer"><div></div></div>')), A = T.shared.$table_resizer, T.events.$on(A, "mousedown", function(e) {
                        return !T.core.sameInstance(A) || (0 < Q().length && k(), 1 == e.which ? (T.selection.save(), b = !0, A.addClass("fr-moving"), N(), T.edit.off(), A.find("div").css("opacity", 1), !1) : void 0)
                        ...
                        T.$el.find(".fr-selected-cell").removeClass("fr-selected-cell"), A.hide().appendTo(Te("body:first"))
                ...
                if (0 === Q().length) {
                    ...
                    if (t && ("HTML" == t.tagName || "BODY" == t.tagName || T.node.isElement(t)))
                        for (n = 1; n <= T.opts.tableInsertHelperOffset; n++) {
                            if (r = T.doc.elementFromPoint(e.pageX - T.win.pageXOffset, e.pageY - T.win.pageYOffset + n), Te(r).hasClass("fr-tooltip")) return;
                            if (r && ("TH" == r.tagName || "TD" == r.tagName || "TABLE" == r.tagName) && (Te(r).parents(".fr-wrapper").length || T.opts.iframe) && "false" != Te(r).closest("table").attr("contenteditable")) return K(e, Te(r).closest("table"));
                            if (i = T.doc.elementFromPoint(e.pageX - T.win.pageXOffset + n, e.pageY - T.win.pageYOffset), Te(i).hasClass("fr-tooltip")) return;
                            if (i && ("TH" == i.tagName || "TD" == i.tagName || "TABLE" == i.tagName) && (Te(i).parents(".fr-wrapper").length || T.opts.iframe) && "false" != Te(i).closest("table").attr("contenteditable")) return H(e, Te(i).closest("table"))
                        }
        ...
        function Y(e, t) {
            var n, r = Te(t[0][e]).outerWidth();
            for (n = 1; n < t.length; n++) r = Math.min(r, Te(t[n][e]).outerWidth());
            return r
        }
        ...
        function V(e) {
            if (1 < Q().length && a && N(), !1 === a && !1 === i && !1 === b) o && clearTimeout(o), T.edit.isDisabled() && !T.popups.isVisible("table.edit") || (o = setTimeout(W, 30, e));
            else if (b) {
        ...
        function X(e) {
            T.node.isEmpty(e.get(0)) ? e.prepend(Te.FE.MARKERS) : e.prepend(Te.FE.START_MARKER).append(Te.FE.END_MARKER)
        }

        function q() {
            T.shared.$ti_helper || (T.shared.$ti_helper = Te('<div class="fr-insert-helper"><a class="fr-floating-btn" role="button" tabIndex="-1" title="' + T.language.translate("Insert") + '"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"><path d="M22,16.75 L16.75,16.75 L16.75,22 L15.25,22.000 L15.25,16.75 L10,16.75 L10,15.25 L15.25,15.25 L15.25,10 L16.75,10 L16.75,15.25 L22,15.25 L22,16.75 Z"/></svg></a></div>'), T.events.bindClick(T.shared.$ti_helper, "a", function() {
                ...
                e.stopPropagation()
            }, !0), T.events.$on(Te(T.o_win), "scroll", function() {
                P()
        ...
        function Z() {
            ...
            if (e.length) {
                ...
                return t && "TABLE" == t.tagName ? Te(t) : Te([])
            }
            return Te([])
        }
        return {
            _init: function() {
                ...
                if (!T.helpers.isMobile()) {
                    b = i = a = !1, T.events.$on(T.$el, "mousedown", e), T.popups.onShow("image.edit", function() {
                        ...
                        0 < e.parents(".fr-toolbar").length && _()
                    }), T.events.$on(T.$el, "mouseenter", "th, td", D), T.events.$on(T.$win, "mouseup", n), T.opts.iframe && T.events.$on(Te(T.o_win), "mouseup", n), T.events.$on(T.$win, "mousemove", V), T.events.$on(Te(T.o_win), "scroll", z), T.events.on("contentChanged", function() {
                        0 < Q().length && (u(), T.$el.find("img").on("load.selected-cells", function() {
                            Te(this).off("load.selected-cells"), 0 < Q().length && u()
                        }))
                    }), T.events.$on(Te(T.o_win), "resize", function() {
                        _()
                    }), T.events.on("toolbar.esc", function() {
                        if (0 < Q().length) return T.events.disableBlur(), T.events.focus(), !1
                    }, !0), T.events.$on(Te(T.o_win), "keydown", function() {
                        a && i && (i = a = !1, T.$el.removeClass("fr-no-selection"), T.edit.on(), T.selection.setAtEnd(T.$el.find(".fr-selected-cell:last").get(0)), T.selection.restore(), _())
                        ...
                        e.shiftKey ? !1 === function(e) {
                            ...
                            if (0 < t.length) {
                                ...
                                var o = R(r, i);
                                if (Te.FE.KEYCODE.ARROW_RIGHT == a) {
                                    if (o.col < i[0].length - 1) return O(n, i[o.row][o.col + 1]), !1
                                } else if (Te.FE.KEYCODE.ARROW_DOWN == a) {
                                    if (o.row < i.length - 1) return O(n, i[o.row + 1][o.col]), !1
                                } else if (Te.FE.KEYCODE.ARROW_LEFT == a) {
                                    if (0 < o.col) return O(n, i[o.row][o.col - 1]), !1
                                } else if (Te.FE.KEYCODE.ARROW_UP == a && 0 < o.row) return O(n, i[o.row - 1][o.col]), !1
                            }
                            ...
                            if (n.length && ("TD" == (n = n[0]).tagName || "TH" == n.tagName)) {
                                ...
                                if (r && "TABLE" == r.tagName && (Te.FE.KEYCODE.ARROW_LEFT == t || Te.FE.KEYCODE.ARROW_UP == t || Te.FE.KEYCODE.ARROW_RIGHT == t || Te.FE.KEYCODE.ARROW_DOWN == t) && (0 < Q().length && k(), T.browser.webkit && (Te.FE.KEYCODE.ARROW_UP == t || Te.FE.KEYCODE.ARROW_DOWN == t))) {
                                    var i = T.selection.ranges(0).startContainer;
                                    if (i.nodeType == Node.TEXT_NODE && (Te.FE.KEYCODE.ARROW_UP == t && (i.previousSibling && "BR" !== i.previousSibling.tagName || i.previousSibling && "BR" === i.previousSibling.tagName && i.previousSibling.previousSibling) || Te.FE.KEYCODE.ARROW_DOWN == t && (i.nextSibling && "BR" !== i.nextSibling.tagName || i.nextSibling && "BR" === i.nextSibling.tagName && i.nextSibling.nextSibling))) return;
                                    e.preventDefault(), e.stopPropagation();
                                    var a = S(Te(r)),
                                        o = R(n, a);
                                    Te.FE.KEYCODE.ARROW_UP == t ? M(o, r, a) : Te.FE.KEYCODE.ARROW_DOWN == t && $(o, r, a), T.selection.restore()
                                }
                            }
                        }(e)
                        ...
                        if (!1 === function(e) {
                                if (e.which == Te.FE.KEYCODE.TAB) {
                                    ...
                                    if (0 < Q().length) t = T.$el.find(".fr-selected-cell:last");
                                        ...
                                        "TD" == n.tagName || "TH" == n.tagName ? t = Te(n) : n != T.el && (0 < Te(n).parentsUntil(T.$el, "td").length ? t = Te(n).parents("td:first") : 0 < Te(n).parentsUntil(T.$el, "th").length && (t = Te(n).parents("th:first")))
                                    }
                                    if (t) return e.preventDefault(), !!(0 === T.selection.get().focusOffset && 0 < Te(T.selection.element()).parentsUntil(T.$el, "ol, ul").length && (0 < Te(T.selection.element()).closest("li").prev().length || Te(T.selection.element()).is("li") && 0 < Te(T.selection.element()).prev().length)) || (k(), e.shiftKey ? 0 < t.prev().length ? X(t.prev()) : 0 < t.closest("tr").length && 0 < t.closest("tr").prev().length ? X(t.closest("tr").prev().find("td:last")) : 0 < t.closest("tbody").length && 0 < t.closest("table").find("thead tr").length && X(t.closest("table").find("thead tr th:last")) : 0 < t.next().length ? X(t.next()) : 0 < t.closest("tr").length && 0 < t.closest("tr").next().length ? X(t.closest("tr").next().find("td:first")) : 0 < t.closest("thead").length && 0 < t.closest("table").find("tbody tr").length ? X(t.closest("table").find("tbody tr td:first")) : (t.addClass("fr-selected-cell"), g("below"), _(), X(t.closest("tr").next().find("td:first"))), T.selection.restore(), !1)
                                }
                            }(e)) return !1;
                        var t = Q();
                        if (0 < t.length) {
                            if (0 < t.length && T.keys.ctrlKey(e) && e.which == Te.FE.KEYCODE.A) return _(), T.popups.isVisible("table.edit") && T.popups.hide("table.edit"), t = [], !0;
                            if (e.which == Te.FE.KEYCODE.ESC && T.popups.isVisible("table.edit")) return _(), T.popups.hide("table.edit"), e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation(), !(t = []);
                            if (1 < t.length && (e.which == Te.FE.KEYCODE.BACKSPACE || e.which == Te.FE.KEYCODE.DELETE)) {
                                T.undo.saveStep();
                                for (var n = 0; n < t.length; n++) Te(t[n]).html("<br>"), n == t.length - 1 && Te(t[n]).prepend(Te.FE.MARKERS);
                                return T.selection.restore(), T.undo.saveStep(), !(t = [])
                            }
                            if (1 < t.length && e.which != Te.FE.KEYCODE.F10 && !T.keys.isBrowserAction(e)) return e.preventDefault(), !(t = [])
                        } else if (!(t = []) === function(e) {
                                if (e.altKey && e.which == Te.FE.KEYCODE.SPACE) {
                                    var t, n = T.selection.element();
                                    if ("TD" == n.tagName || "TH" == n.tagName ? t = n : 0 < Te(n).closest("td").length ? t = Te(n).closest("td").get(0) : 0 < Te(n).closest("th").length && (t = Te(n).closest("th").get(0)), t) return e.preventDefault(), O(t, t), u(), !1
                                }
                            }(e)) return !1
                    }, !0);
                    var t = [];
            ...
            insert: function(e, t) {
                var n, r, i = "<table " + (T.opts.tableDefaultWidth ? 'style="width: ' + T.opts.tableDefaultWidth + ';" ' : "") + 'class="fr-inserted-table"><tbody>',
                    a = 100 / t;
                for (n = 0; n < e; n++) {
                    for (i += "<tr>", r = 0; r < t; r++) i += "<td" + (T.opts.tableDefaultWidth ? ' style="width: ' + a.toFixed(4) + '%;"' : "") + ">", 0 === n && 0 === r && (i += Te.FE.MARKERS), i += "<br></td>";
                    i += "</tr>"
                }
                ...
                if (0 < e.length) {
                    ...
                    if (0 === a.min_i && a.max_i == i.length - 1) h();
                        ...
                        for (t = a.max_i; t >= a.min_i; t--) {
                            for (r = Te(e.find("tr").not(e.find("table tr")).get(t)), n = 0; n < i[t].length; n++)
                                if (0 === n || i[t][n] != i[t][n - 1]) {
                                    ...
                                    if (t < i.length - 1 && i[t][n] == i[t + 1][n] && (0 === t || i[t][n] != i[t - 1][n])) {
                                        ...
                                        0 === d ? Te(e.find("tr").not(e.find("table tr")).get(t + 1)).prepend(l) : Te(i[t + 1][d - 1]).after(l)
                                    }
                                } var c = r.parent();
            ...
            insertColumn: function(l) {
                ...
                if (0 < e.length) {
                    ...
                    e.find("th, td").each(function() {
                        (n = Te(this)).data("old-width", n.outerWidth() / e.outerWidth() * 100)
                    }), e.find("tr").not(e.find("table tr")).each(function(e) {
                        for (var t, n = Te(this), r = 0, i = 0; r - 1 < d;) {
                            if (!(t = n.find("> th, > td").get(i))) {
                                t = null;
                                break
                            }
                            t == c[e][r] ? (r += parseInt(Te(t).attr("colspan"), 10) || 1, i++) : (r += parseInt(Te(c[e][r]).attr("colspan"), 10) || 1, "after" == l && (t = 0 === i ? -1 : n.find("> th, > td").get(i - 1)))
                        }
                        var a, o = Te(t);
                        ...
                        (n = Te(this)).data("old-width") && (n.css("width", (n.data("old-width") * p / f).toFixed(4) + "%"), n.removeData("old-width"))
                    }), T.popups.isVisible("table.edit") && u()
                }
            },
            deleteColumn: function() {
                ...
                if (0 < e.length) {
                    ...
                    if (0 === a.min_j && a.max_j == i[0].length - 1) h();
                        ...
                        var o = 0;
                        for (t = 0; t < i.length; t++)
                            for (n = 0; n < i[0].length; n++)(r = Te(i[t][n])).hasClass("fr-selected-cell") || (r.data("old-width", r.outerWidth() / e.outerWidth() * 100), (n < a.min_j || n > a.max_j) && (o += r.outerWidth() / e.outerWidth() * 100));
                        for (o /= i.length, n = a.max_j; n >= a.min_j; n--)
                            for (t = 0; t < i.length; t++)
                                if (0 === t || i[t][n] != i[t - 1][n])
                                    if (r = Te(i[t][n]), 1 < (parseInt(r.attr("colspan"), 10) || 1)) {
                            ...
                            (r = Te(this)).data("old-width") && (r.css("width", (100 * r.data("old-width") / o).toFixed(4) + "%"), r.removeData("old-width"))
                        })
                    }
                }
            },
            mergeCells: function() {
                if (1 < Q().length && (0 === T.$el.find("th.fr-selected-cell").length || 0 === T.$el.find("td.fr-selected-cell").length)) {
                    ...
                    var e, t, n = x(S()),
                        ...
                        s = i.html(),
                        l = 0;
                    for (e = 0; e < a.length; e++) l += Te(a[e]).outerWidth();
                    for (i.css("width", Math.min(100, l / o.outerWidth() * 100).toFixed(4) + "%"), n.min_j < n.max_j && i.attr("colspan", n.max_j - n.min_j + 1), n.min_i < n.max_i && i.attr("rowspan", n.max_i - n.min_i + 1), e = 1; e < r.length; e++) "<br>" != (t = Te(r[e])).html() && "" !== t.html() && (s += "<br>" + t.html()), t.remove();
                    i.html(s), T.selection.setAtEnd(i.get(0)), T.selection.restore(), T.toolbar.enable(), v(n.min_i, n.max_i, o);
                    var d = o.find("tr:empty");
                    for (e = d.length - 1; 0 <= e; e--) Te(d[e]).remove();
            ...
            splitCellVertically: function() {
                if (1 == Q().length) {
                    ...
                    e.after(i), _(), T.popups.hide("table.edit")
                }
            },
            splitCellHorizontally: function() {
                if (1 == Q().length) {
                    ...
                    if (1 < r) {
                        ...
                        for (var l = a.row + s, d = 0 === a.col ? a.col : a.col - 1; 0 <= d && (i[l][d] == i[l][d - 1] || 0 < l && i[l][d] == i[l - 1][d]);) d--; - 1 == d ? Te(n.find("tr").not(n.find("table tr")).get(l)).prepend(o) : Te(i[l][d]).after(o)
                    } else {
                        var c, f = Te("<tr>").append(o);
            ...
            showInsertPopup: function() {
                ...
                if (t || (t = c()), !t.hasClass("fr-active")) {
                    ...
                    var n = e.offset().left + e.outerWidth() / 2,
                        r = T.position.getTbarPupupTop("table.insert", e);
    ...
    }, Te.FE.DefineIcon("insertTable", {
        NAME: "table"
    }), Te.FE.RegisterCommand("insertTable", {
        title: "Insert Table",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
        ...
        plugin: "table"
    }), Te.FE.RegisterCommand("tableInsert", {
        callback: function(e, t, n) {
            this.table.insert(t, n), this.popups.hide("table.insert")
        }
    }), Te.FE.DefineIcon("tableHeader", {
        NAME: "header",
        FA5NAME: "heading"
    }), Te.FE.RegisterCommand("tableHeader", {
        title: "Table Header",
        focus: !1,
        toggle: !0,
        callback: function() {
    ...
    }), Te.FE.DefineIcon("tableRows", {
        NAME: "bars"
    }), Te.FE.RegisterCommand("tableRows", {
        type: "dropdown",
        focus: !1,
        title: "Row",
        options: {
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Te.FE.COMMANDS.tableRows.options;
    ...
    }), Te.FE.DefineIcon("tableColumns", {
        NAME: "bars fa-rotate-90"
    }), Te.FE.RegisterCommand("tableColumns", {
        type: "dropdown",
        focus: !1,
        title: "Column",
        options: {
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Te.FE.COMMANDS.tableColumns.options;
    ...
    }), Te.FE.DefineIcon("tableCells", {
        NAME: "square-o",
        FA5NAME: "square"
    }), Te.FE.RegisterCommand("tableCells", {
        type: "dropdown",
        focus: !1,
        title: "Cell",
        options: {
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Te.FE.COMMANDS.tableCells.options;
    ...
    }), Te.FE.DefineIcon("tableRemove", {
        NAME: "trash"
    }), Te.FE.RegisterCommand("tableRemove", {
        title: "Remove Table",
        focus: !1,
        callback: function() {
            this.table.remove()
        }
    }), Te.FE.DefineIcon("tableStyle", {
        NAME: "paint-brush"
    }), Te.FE.RegisterCommand("tableStyle", {
        title: "Table Style",
        type: "dropdown",
        focus: !1,
        html: function() {
    ...
    }), Te.FE.DefineIcon("tableCellBackground", {
        NAME: "tint"
    }), Te.FE.RegisterCommand("tableCellBackground", {
    ...
    }), Te.FE.RegisterCommand("tableCellBackgroundColor", {
        undo: !0,
        focus: !1,
        callback: function(e, t) {
            this.table.setBackground(t)
        }
    }), Te.FE.DefineIcon("tableBack", {
        NAME: "arrow-left"
    }), Te.FE.RegisterCommand("tableBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), Te.FE.DefineIcon("tableCellVerticalAlign", {
        NAME: "arrows-v",
        FA5NAME: "arrows-alt-v"
    }), Te.FE.RegisterCommand("tableCellVerticalAlign", {
        type: "dropdown",
        focus: !1,
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Te.FE.COMMANDS.tableCellVerticalAlign.options;
    ...
    }), Te.FE.DefineIcon("tableCellHorizontalAlign", {
        NAME: "align-left"
    }), Te.FE.DefineIcon("align-left", {
        NAME: "align-left"
    }), Te.FE.DefineIcon("align-right", {
        ...
        NAME: "align-justify"
    }), Te.FE.RegisterCommand("tableCellHorizontalAlign", {
        type: "dropdown",
        focus: !1,
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Te.FE.COMMANDS.tableCellHorizontalAlign.options;
        ...
        refresh: function(e) {
            ...
            t.length && e.find("> *:first").replaceWith(this.icon.create("align-" + this.helpers.getAlignment(Te(t[0]))))
        },
        refreshOnShow: function(e, t) {
    ...
    }), Te.FE.DefineIcon("tableCellStyle", {
        NAME: "magic"
    }), Te.FE.RegisterCommand("tableCellStyle", {
        title: "Cell Style",
        type: "dropdown",
        focus: !1,
        html: function() {
    ...
    }), Te.FE.RegisterCommand("tableCellBackgroundCustomColor", {
        title: "OK",
        undo: !0,
        callback: function() {
            this.table.customColor()
        }
    }), Te.FE.DefineIcon("tableColorRemove", {
        NAME: "eraser"
    }), Te.FE.URLRegEx = "(^| |\\u00A0)(" + Te.FE.LinkRegEx + "|([a-z0-9+-_.]{1,}@[a-z0-9+-_.]{1,}\\.[a-z0-9+-_]{1,}))$", Te.FE.PLUGINS.url = function(a) {
        var o = null;
        ...
        function s() {
            return new RegExp(Te.FE.URLRegEx, "gi")
        }
        ...
        function n() {
            ...
            if (s().test(d(n.textContent))) {
                Te(n).before(l(n.textContent));
                var r = Te(n.parentNode).find("a[data-fr-linked]");
                ...
                s().test(d(i)) && (Te(n.previousSibling).replaceWith(l(i)), n.parentNode.removeChild(n))
            }
        }
        return {
            _init: function() {
                a.events.on("keypress", function(e) {
                    ...
                    var t = e.which;
                    !a.selection.isCollapsed() || t != Te.FE.KEYCODE.ENTER && t != Te.FE.KEYCODE.SPACE || n()
        ...
        test_regex: /^(http(s)?:\/\/|www\.).*(\.mp4|\.mkv|\.mpg|\.mp2|\.mpeg|\.mpv|\.m4p|\.m4v|\.webm|\.ogg|\.ogv|\.avi|\.wmv|\.mov|\.flv|\.swf)$/,
        url_regex: "",
        url_text: "",
        html: '<video width="640" height="360" controls><source src="{url}"></video>',
        provider: "unknown"
    }], Te.FE.VIDEO_EMBED_REGEX = /^\W*((<iframe(.|\n)*>(\s|\n)*<\/iframe>)|(<embed(.|\n)*>))\W*$/i, Te.FE.PLUGINS.video = function(p) {
        var s, c, f, u, r, n, l = "https://i./upload",
            d = 2,
            h = 3,
            g = 4,
            m = 5,
            ...
            if (e || (e = function() {
                    ...
                    if (0 < p.opts.videoEditButtons.length) {
                        ...
                        return p.events.$on(p.$wp, "scroll.video-edit", function() {
                            u && p.popups.isVisible("video.edit") && (p.events.disableBlur(), L(u))
                        }), n
                    }
                    return !1
                }()), e) {
        ...
        function b(e) {
            ...
            var t = !1;
            u && (V(), t = !0), p.html.insert('<span contenteditable="false" draggable="true" class="fr-jiv fr-video fr-deletable">' + e + "</span>", !1, p.opts.videoSplitHTML), p.popups.hide("video.insert");
        ...
        function T() {
            var e = Te(this);
            p.popups.hide("video.insert"), e.removeClass("fr-uploading"), e.parent().next().is("br") && e.parent().next().remove(), L(e.parent()), p.events.trigger("video.loaded", [e.parent()])
        }
            ...
            C("Loading video"),
                function() {
                    ...
                    if (d) {
                        ...
                        a && "auto" != a && (a += "px");
                        var o = Te('<span contenteditable="false" draggable="true" class="fr-video fr-dv' + p.opts.videoDefaultDisplay[0] + ("center" != p.opts.videoDefaultAlign ? " fr-fv" + p.opts.videoDefaultAlign[0] : "") + '"><video src="' + e + '" ' + i + (a ? ' style="width: ' + a + ';" ' : "") + " controls>" + p.language.translate("Your browser does not support HTML5 video.") + "</video></span>");
        ...
        function O(e) {
            ...
            if ("mousedown" == e.type) {
                ...
                a && i.frameElement && (t += p.helpers.getPX(Te(i.frameElement).offset().left) + i.frameElement.clientLeft, n = e.clientY + p.helpers.getPX(Te(i.frameElement).offset().top) + i.frameElement.clientTop)
            }
            p.undo.canDo() || p.undo.saveStep(), (c = Te(this)).data("start-x", t), c.data("start-y", n), s.show(), p.popups.hideAll(), P()
        }
        ...
        function D(e, t, n, r) {
            return e.pageX = t, e.pageY = t, O.call(this, e), e.pageX = e.pageX + n * Math.floor(Math.pow(1.1, r)), e.pageY = e.pageY + n * Math.floor(Math.pow(1.1, r)), I.call(this, e), k.call(this, e), ++r
        }

        function F() {
            var e, t = Array.prototype.slice.call(p.el.querySelectorAll("video, .fr-video > *")),
                n = [];
            for (e = 0; e < t.length; e++) n.push(t[e].getAttribute("src")), Te(t[e]).toggleClass("fr-draggable", p.opts.videoMove), "" === t[e].getAttribute("class") && t[e].removeAttribute("class"), "" === t[e].getAttribute("style") && t[e].removeAttribute("style");
            if (r)
                for (e = 0; e < r.length; e++) n.indexOf(r[e].getAttribute("src")) < 0 && p.events.trigger("video.removed", [Te(r[e])]);
            r = t
        }
        ...
        function M() {
            f || function() {
                ...
                if (p.shared.$video_resizer ? (f = p.shared.$video_resizer, s = p.shared.$vid_overlay, p.events.on("destroy", function() {
                        f.removeClass("fr-active").appendTo(Te("body:first"))
                    }, !0)) : (p.shared.$video_resizer = Te('<div class="fr-video-resizer"></div>'), f = p.shared.$video_resizer, p.events.$on(f, "mousedown", function(e) {
                        e.stopPropagation()
                    }, !0), p.opts.videoResize && (f.append(t("nw") + t("ne") + t("sw") + t("se")), p.shared.$vid_overlay = Te('<div class="fr-video-overlay"></div>'), s = p.shared.$vid_overlay, e = f.get(0).ownerDocument, Te(e).find("body:first").append(s))), p.events.on("shared.destroy", function() {
                        f.html("").removeData().remove(), f = null, p.opts.videoResize && (s.remove(), s = null)
                    }, !0), p.helpers.isMobile() || p.events.$on(Te(p.o_win), "resize.video", function() {
                        B(!0)
                    }), p.opts.videoResize) {
                    e = f.get(0).ownerDocument, p.events.$on(f, p._mousedown, ".fr-handler", O), p.events.$on(Te(e), p._mousemove, I), p.events.$on(Te(e.defaultView || e.parentWindow), p._mouseup, k), p.events.$on(s, "mouseleave", k);
                    var r = 1,
                        i = null,
                        a = 0;
                    p.events.on("keydown", function(e) {
                        if (u) {
                            var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                                n = e.which;
                            (n !== i || 200 < e.timeStamp - a) && (r = 1), (n == Te.FE.KEYCODE.EQUALS || p.browser.mozilla && n == Te.FE.KEYCODE.FF_EQUALS) && t && !e.altKey ? r = D.call(this, e, 1, 1, r) : (n == Te.FE.KEYCODE.HYPHEN || p.browser.mozilla && n == Te.FE.KEYCODE.FF_HYPHEN) && t && !e.altKey && (r = D.call(this, e, 2, -1, r)), i = n, a = e.timeStamp
                        }
        ...
        function $(e) {
            ...
            for (var t = 0; t < Te.FE.INSTANCES.length; t++) Te.FE.INSTANCES[t] != p && Te.FE.INSTANCES[t].events.trigger("video.hideResizer");
            p.toolbar.disable(), p.helpers.isMobile() && (p.events.disableBlur(), p.$el.blur(), p.events.enableBlur()), p.$el.find(".fr-video.fr-active").removeClass("fr-active"), (u = Te(this)).addClass("fr-active"), p.opts.iframe && p.size.syncIframe(), Q(), M(), a(), p.selection.clear(), p.button.bulkRefresh(), p.events.trigger("image.hideResizer")
        }
        ...
        function U(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (n && n.type && -1 !== n.type.indexOf("video")) {
                    ...
                    p.markers.remove(), p.markers.insertAtPoint(e.originalEvent), p.$el.find(".fr-marker").replaceWith(Te.FE.MARKERS), p.popups.hideAll();
        ...
        function K(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if ((null === p.opts.videoUploadURL || p.opts.videoUploadURL == l) && !p.opts.videoUploadToS3) return function(t) {
                    u && u.find("iframe") && u.find("iframe").length && V();
                    var n = new FileReader;
                    n.onload = function() {
                        var e = n.result;
                        A(e = window.URL.createObjectURL(new Blob([e], {
                            type: t.type
                        })), !1, null, u)
                    }, C(), n.readAsArrayBuffer(t)
                }(n), !1;
                if (p.drag_support.formdata && (t = p.drag_support.formdata ? new FormData : null), t) {
                    ...
                    a.onload = function() {
                        _.call(a, u)
                    }, a.onerror = N, a.upload.onprogress = x, a.onabort = w, C(), p.events.disableBlur(), p.edit.off(), p.events.enableBlur();
        ...
        function z(e) {
            ...
            return p.events.$on(p.$wp, "scroll", function() {
                u && p.popups.isVisible("video.size") && (p.events.disableBlur(), L(u))
            }), n
        }
        ...
        function j() {
            p.$el.find("video").filter(function() {
                return 0 === Te(this).parents("span.fr-video").length
            }).wrap('<span class="fr-video fr-deletable" contenteditable="false"></span>'), p.$el.find("embed, iframe").filter(function() {
                if (p.browser.safari && this.getAttribute("src") && this.setAttribute("src", this.src), 0 < Te(this).parents("span.fr-video").length) return !1;
                for (var e = Te(this).attr("src"), t = 0; t < Te.FE.VIDEO_PROVIDERS.length; t++) {
                    var n = Te.FE.VIDEO_PROVIDERS[t];
                    if (n.test_regex.test(e) && new RegExp(p.opts.videoAllowedProviders.join("|")).test(n.provider)) return !0
                }
                return !1
            }).map(function() {
                return 0 === Te(this).parents("object").length ? this : Te(this).parents("object").get(0)
        ...
        return i[1] = "Video cannot be loaded from the passed link.", i[d] = "No link in upload response.", i[h] = "Error during file upload.", i[g] = "Parsing response failed.", i[m] = "File is too large.", i[v] = "Video file type is invalid.", i[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", p.shared.vid_exit_flag = !1, {
            _init: function() {
                p.opts.videoResponsive && (p.opts.videoResize = !1), p.events.on("drop", U, !0), p.events.on("mousedown window.mousedown", e), p.events.on("window.touchmove", P), p.events.on("mouseup window.mouseup", B), p.events.on("commands.mousedown", function(e) {
                    ...
                    var t = e.which;
                    return !u || t != Te.FE.KEYCODE.BACKSPACE && t != Te.FE.KEYCODE.DELETE ? u && t == Te.FE.KEYCODE.ESC ? (B(!0), e.preventDefault(), !1) : u && t != Te.FE.KEYCODE.F10 && !p.keys.isBrowserAction(e) ? (e.preventDefault(), !1) : void 0 : (e.preventDefault(), V(), p.undo.saveStep(), !1)
            ...
            showInsertPopup: function() {
                ...
                if (t || (t = o()), S(), !t.hasClass("fr-active"))
                    if (p.popups.refresh("video.insert"), p.popups.setContainer("video.insert", p.$tb), e.is(":visible")) {
                        var n = e.offset().left + e.outerWidth() / 2,
                            r = p.position.getTbarPupupTop("video.insert", e);
            ...
            showLayer: function(e) {
                ...
                if (!u && !p.opts.toolbarInline) {
                    ...
                    t = i.offset().left + i.outerWidth() / 2, n = p.position.getTbarPupupTop("video.insert", i)
                }
            ...
            insertByURL: function(e) {
                ...
                if (/^http/.test(e) || (e = "https://" + e), p.helpers.isURL(e))
                    for (var n = 0; n < Te.FE.VIDEO_PROVIDERS.length; n++) {
                        var r = Te.FE.VIDEO_PROVIDERS[n];
            ...
            insertEmbed: function(e) {
                void 0 === e && (e = p.popups.get("video.insert").find(".fr-video-embed-layer textarea").val() || ""), 0 !== e.length && Te.FE.VIDEO_EMBED_REGEX.test(e) ? b(e) : (y(p.language.translate("Something went wrong. Please try again.")), p.events.trigger("video.codeError", [e]))
            },
            insert: b,
            align: function(e) {
    ...
    }, Te.FE.RegisterCommand("insertVideo", {
        title: "Insert Video",
        undo: !1,
        focus: !0,
        refreshAfterCallback: !1,
        ...
        plugin: "video"
    }), Te.FE.DefineIcon("insertVideo", {
        NAME: "video-camera",
        FA5NAME: "camera"
    }), Te.FE.DefineIcon("videoByURL", {
        NAME: "link"
    }), Te.FE.RegisterCommand("videoByURL", {
        title: "By URL",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), Te.FE.DefineIcon("videoEmbed", {
        NAME: "code"
    }), Te.FE.RegisterCommand("videoEmbed", {
        title: "Embedded Code",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), Te.FE.DefineIcon("videoUpload", {
        NAME: "upload"
    }), Te.FE.RegisterCommand("videoUpload", {
        title: "Upload Video",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), Te.FE.RegisterCommand("videoInsertByURL", {
        undo: !0,
        focus: !0,
        callback: function() {
            this.video.insertByURL()
        }
    }), Te.FE.RegisterCommand("videoInsertEmbed", {
        undo: !0,
        focus: !0,
        callback: function() {
            this.video.insertEmbed()
        }
    }), Te.FE.DefineIcon("videoDisplay", {
        NAME: "star"
    }), Te.FE.RegisterCommand("videoDisplay", {
        title: "Display",
        type: "dropdown",
        options: {
            inline: "Inline",
    ...
    }), Te.FE.DefineIcon("video-align", {
        NAME: "align-left"
    }), Te.FE.DefineIcon("video-align-left", {
        NAME: "align-left"
    }), Te.FE.DefineIcon("video-align-right", {
        NAME: "align-right"
    }), Te.FE.DefineIcon("video-align-center", {
        NAME: "align-justify"
    }), Te.FE.DefineIcon("videoAlign", {
        NAME: "align-center"
    }), Te.FE.RegisterCommand("videoAlign", {
        type: "dropdown",
        title: "Align",
        options: {
            left: "Align Left",
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Te.FE.COMMANDS.videoAlign.options;
    ...
    }), Te.FE.DefineIcon("videoReplace", {
        NAME: "exchange",
        FA5NAME: "exchange-alt"
    }), Te.FE.RegisterCommand("videoReplace", {
        title: "Replace",
        undo: !1,
        focus: !1,
        popup: !0,
    ...
    }), Te.FE.DefineIcon("videoRemove", {
        NAME: "trash"
    }), Te.FE.RegisterCommand("videoRemove", {
        title: "Remove",
        callback: function() {
            this.video.remove()
        }
    }), Te.FE.DefineIcon("videoSize", {
        NAME: "arrows-alt"
    }), Te.FE.RegisterCommand("videoSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
    ...
    }), Te.FE.DefineIcon("videoBack", {
        NAME: "arrow-left"
    }), Te.FE.RegisterCommand("videoBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), Te.FE.RegisterCommand("videoDismissError", {
        title: "OK",
        undo: !1,
        callback: function() {
            this.video.hideProgressBar(!0)
        }
    }), Te.FE.RegisterCommand("videoSetSize", {
        undo: !0,
        focus: !1,
        title: "Update",
        refreshAfterCallback: !1,
    ...
    }), Te.FE.PLUGINS.wordPaste = function(T) {
        ...
        function t(e) {
            ...
            e || (T.opts.wordAllowedStyleProps = []), 0 === r.indexOf("<colgroup>") && (r = "<table>" + r + "</table>"), r = function(e, t) {
                ...
                c(i, function(e) {
                    if (e.nodeType == Node.TEXT_NODE && /\n|\u00a0|\r/.test(e.data)) {
                        if (!/\S| /.test(e.data) && !/[\u00a0]+/.test(e.data)) return e.data == Te.FE.UNICODE_NBSP ? (e.data = "\u200b", !0) : 1 == e.data.length && 10 == e.data.charCodeAt(0) ? (e.data = " ", !0) : (A(e), !1);
                    ...
                    return e.nodeType != Node.ELEMENT_NODE || "V:IMAGEDATA" != e.tagName && "IMG" != e.tagName || function(e, t) {
                        ...
                        if (a) {
                            ...
                            "IMG" === e.tagName ? (e.src = s, e.setAttribute("data-fr-image-pasted", !0)) : Te(e.parentNode).before('<img data-fr-image-pasted="true" src="' + s + '" style="' + e.parentNode.getAttribute("style") + '">').remove()
                        }
                    }(e, t), !0
                });
                for (var a = i.querySelectorAll("ul > ul, ul > ol, ol > ul, ol > ol"), o = a.length - 1; 0 <= o; o--) a[o].previousElementSibling && "LI" === a[o].previousElementSibling.tagName && a[o].previousElementSibling.appendChild(a[o]);
                c(i, function(t) {
                    ...
                    if (t.nodeType == Node.ELEMENT_NODE) {
                        if (S(t)) {
                            var n = t.parentNode,
                                ...
                                i = function e(t, n, r) {
                                    ...
                                    var i = /[0-9a-zA-Z\\xa7\s]/gi;
                                    var a = !1;
                                    var o = t.querySelector('span[style="mso-list:Ignore"]');
                                    var s;
                                    var l;
                                    var d;
                                    var c;
                                    ...
                                    var g;
                                    var m = "";
                                    var v; - 1 != h.indexOf("safari") && (h = -1 < h.indexOf("chrome") ? 1 : "safari");
                                    null == o && "safari" == h && (o = t.querySelector('span[lang="PT-BR"]'));
                                    o && (a = a || i.test(o.textContent));
                                    null !== o && (g = o.textContent.trim().split(".")[0]);
                                    1 == a ? ("1" == g ? u = "decimal;" : "i" == g ? u = "lower-roman;" : "I" == g ? u = "upper-roman;" : "o" == g ? u = "circle;" : "\xa7" == g ? u = "square;" : g.match(/^v$/) || (g.match(/^[a-z]$/) || g.match(/^[a-z]\)$/) ? u = "lower-alpha;" : (g.match(/^[A-Z]$/) || g.match(/^[A-Z]\)$/)) && (u = "upper-alpha;")), u = "list-style-type: " + u, p = "ol") : p = "ul";
                                    o == undefined || o.textContent == undefined || isNaN(parseInt(o.textContent.trim().split(".")[1], 10)) || (m = ' class="decimal_type" ');
                                    var E;
                                    "list-style-type: upper-alpha;" == u ? (E = g.charCodeAt(0) - 64, v = u ? "<" + p + m + ' style = "' + u + '" start="' + E + '">' : "<" + p + ">") : "list-style-type: lower-alpha;" == u ? (E = g.charCodeAt(0) - 96, v = u ? "<" + p + m + ' style = "' + u + '" start="' + E + '">' : "<" + p + ">") : v = u ? "<" + p + m + ' style = "' + u + '">' : "<" + p + ">";
                                    for (; t;) {
                                        if (!S(t)) {
                                        ...
                                        if ((r = r || b) < b) f = e(t, n, b), v += f.el.outerHTML, t = f.currentNode;
                                        else {
                                            if (b < r) break;
                                            t.firstElementChild && t.firstElementChild.firstElementChild && t.firstElementChild.firstElementChild.firstChild && (i.lastIndex = 0, l = i.test(t.firstElementChild.firstElementChild.firstChild.data || t.firstElementChild.firstElementChild.firstChild.firstChild && t.firstElementChild.firstElementChild.firstChild.firstChild.data || "")), s && s.firstElementChild && s.firstElementChild.firstElementChild && s.firstElementChild.firstElementChild.firstChild && (i.lastIndex = 0, d = i.test(s.firstElementChild.firstElementChild.firstChild.data || s.firstElementChild.firstElementChild.firstChild.firstChild && s.firstElementChild.firstElementChild.firstChild.firstChild.data || "")), d === undefined || d === l ? (c = R(t, n), v += "<li>" + c + "</li>") : (f = e(t, n, b), v += f.el.outerHTML, t = f.currentNode);
                                            var T = t && t.nextElementSibling;
                                            T && (s = T.previousElementSibling), t && t.parentNode && t.parentNode.removeChild(t), t = T
                                        }
                                    }
                                    v += "</" + p + ">";
                        ...
                        return "FONT" === t.tagName && s["." + t.getAttribute("class")] && (t = v(t, "span")), p(t, s)
                    }
                    if (t.nodeType == Node.COMMENT_NODE) {
                        if (-1 < t.data.indexOf("[if !supportLineBreakNewLine]"))
                            for (var o = t.nextSibling; o;)(o = t.nextSibling) && A(o), o.data && -1 < o.data.indexOf("[endif]") && (o = null);
                        return A(t), !1
                    }
                    return !0
                }), c(i, function(e) {
            ...
            n.innerHTML = r, T.html.cleanBlankSpaces(n), r = n.innerHTML, r = (r = T.paste.cleanEmptyTagsAndDivs(r)).replace(/\u200b/g, ""), T.modals.hide(o), T.paste.clean(r, !0, !0, !0), T.opts.wordAllowedStyleProps = t
        }
        ...
        function R(e, i) {
            ...
            c(t, function(e) {
                if (e.nodeType == Node.COMMENT_NODE && (T.browser.msie || T.browser.safari || T.browser.edge)) try {
                ...
                if (e.nodeType == Node.ELEMENT_NODE) {
                    ...
                    n && "mso-list:Ignore" == n.replace(/\r?\n|\r/g, "") && e.parentNode.removeChild(e), e.setAttribute("style", function(e) {
                        var n = "",
        ...
        function p(e, t) {
            ...
            if ("TD" != n) {
                var o = e.getAttribute("class") || "MsoNormal";
                if (t && o) {
                    var s = (o = y(o)).split(" ");
                    for (i = 0; i < s.length; i++) {
                        ...
                        for (var c = 0; c < l.length; c++) t[l[c]] && L(e, t[l[c]])
                    }
            ...
            if (-1 != ["P", "H1", "H2", "H3", "H4", "H5", "H6", "PRE"].indexOf(n)) {
                ...
                if (f && (t && t[n.toLowerCase() + "." + f] && L(e, t[n.toLowerCase() + "." + f]), -1 != f.toLowerCase().indexOf("mso"))) {
                    var p = y(f);
            ...
            if ("TR" == n && function(e, t) {
                    ...
                    for (var n = e.firstElementChild, r = 0, i = !1, a = null; n;) {
                        n.firstElementChild && -1 != n.firstElementChild.tagName.indexOf("W:") && (n.innerHTML = n.firstElementChild.innerHTML), (a = n.getAttribute("width")) || i || (i = !0), r += parseInt(a, 10), (!n.firstChild || n.firstChild && n.firstChild.data == Te.FE.UNICODE_NBSP) && (n.firstChild && A(n.firstChild), n.innerHTML = "<br>");
                        for (var o = n.firstElementChild, s = 1 == n.children.length; o;) "P" != o.tagName || S(o) || s && C(o), o = o.nextElementSibling;
                        if (t) {
                            var l = n.getAttribute("class");
                            if (l) {
                                var d = (l = y(l)).match(/xl[0-9]+/gi);
                                if (d) {
                                    var c = "." + d[0];
                                    t[c] && ("TD" === n.tagName && (t[c] = t[c].replace(/(border[^:]*:)(\d*\.\d*)(pt)/g, function(e, t, n, r) {
                                        return [t, Math.round(2 * parseFloat(n)), r].join("")
                                    })), L(n, t[c]))
                                }
                            }
                            t.td && L(n, t.td)
                ...
                var g = e.querySelectorAll("span");
                for (i = 0; i < g.length; i++) g[i].innerText || (g[i].outerHTML = g[i].innerHTML)
            }
