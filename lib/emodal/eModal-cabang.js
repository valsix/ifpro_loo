...
; (function (define) {
    define(['jquery'], function ($, root) {
        ...
        function _getModalInstance(skipEventChageIfExists) {
            ...
            function createModalElement() {
                return $('<div class="modal fade" tabindex="-1"><style>.modal-xl{width:100%;} @media screen and (max-width:767px){ .modal-xl{width:calc(100% - 20px);}}</style>'
    ...
    define :
    function (args, mName) {
        this.eModalCabang = typeof module != 'undefined' && module.exports ?
